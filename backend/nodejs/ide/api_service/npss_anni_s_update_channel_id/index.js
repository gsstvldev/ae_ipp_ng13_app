...
app.post('/', function(appRequest, appResponse, next) {
    ...
    * 
    */
    var serviceName = ' NPSS ANNI (S) Update Channel ID'; //service name 
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = ' NPSS ANNI (S) Update Channel ID';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = ' NPSS ANNI (S) Update Channel ID';
            // Get DB Connection 
