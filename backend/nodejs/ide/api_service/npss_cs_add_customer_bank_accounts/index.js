...
app.post('/', function(appRequest, appResponse, next) {
    ...
    * 
    */
    var serviceName = 'NPSS Add Customer'; //service name 
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        ...
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = 'NPSS Add Customer';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = 'NPSS Add Customer';
            // Get DB Connection 
                                    ...
                                    "bankAccount": [
                                      {
                                        ...
                                        "instantPayment": params.instantPayment
                                      }
                                    ]
                                  }, headers: {
