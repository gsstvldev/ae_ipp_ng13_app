...
try {
    ...
    Reason for : 
    */
    var serviceName = 'NPSS BCT IPIR Posting Failure Retry';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE =  'NPSS BCT IPIR Posting Failure Retry';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS =  'NPSS BCT IPIR Posting Failure Retry';
            // Get DB Connection                                                                                                                                      
