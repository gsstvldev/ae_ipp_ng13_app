...
app.post('/', function(appRequest, appResponse, next) {
    ...
    */
    var serviceName = ' NPSS (CS) CBUAE Exception Hold ';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = ' NPSS (CS) CBUAE Exception Hold ';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = ' NPSS (CS) CBUAE Exception Hold ';
            // Get DB Connection 
                                    ...
                                    if (arrrule.length > 0) {
                                        ...
                                        ExecuteQuery1(TakedatafrmTrn, async function (arrdata) {
                                            if (arrdata.length > 0) {
                                                ...
                                                objcusTranprslog.ADDITIONAL_INFO = "Manual Hold"
