...
app.post('/', function(appRequest, appResponse, next) {
    ...
    */
    var serviceName = 'NPSS (CS) Daily Liquidity Position Response';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = 'NPSS (CS) Daily Liquidity Position Response';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = 'NPSS (CS) Daily Liquidity Position Response';
            // Get DB Connection 
                    ...
                    try {
                        ...
                        ExecuteQuery1(Taketran, function (arrTran) {
                            if (arrTran.length > 0) {
                                ...
                                objresponse.data = arrTran[0].response_data_json
