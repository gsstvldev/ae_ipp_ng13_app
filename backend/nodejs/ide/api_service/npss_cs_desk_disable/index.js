...
* 
*/
var serviceName = 'NPSS Desk UPDATE'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Desk Disable';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Desk Disable';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT DISABLE CASH DESK'  and tenant_id = '${params.TenantId}'`
                ExecuteQuery1(Takejson, function (arrjson) {
                    if (arrjson.length) {
                        ...
                        url=url+'?cashDeskId='+params.cashDeskId
