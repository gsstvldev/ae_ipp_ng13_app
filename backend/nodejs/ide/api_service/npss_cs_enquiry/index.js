        ...
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
                ...
                reqAuditLog.GetProcessToken(pSession, objLogInfo, function prct(error, prct_id) {
                    try {
                        var take_api_url = `Select param_category,param_code,param_detail from core_nc_system_setup where param_category='NPSS_ENQUIRY' and param_code='URL'`;
                        var take_batch_name = `Select param_category,param_code,param_detail from core_nc_system_setup where param_category='NPSS_ENQUIRY' and param_code='BATCH_NAME'`;
                        var take_api_params = `select  ns.cr_acct_identification,ns.cr_acct_id_code,ns.hdr_msg_id,ns.hdr_created_date,ns.hdr_total_records,ns.hdr_total_amount,ns.hdr_settlement_date,ns.hdr_settlement_method,
                        ...
                        ns.process_type,ns.status,ns.process_status,ns.remittance_info,ns.tran_ref_id txid
