                        ...
                        function apiCall(arrTranobj, arrUrl) {
                            return new Promise((resolve, reject) => {
                                ...
                                try {
                                    ...
                                    var apiURL =
                                        apiURL = arrUrl[0].param_detail +'/findLinkedRMessages?ref-type=' + arrTranobj.reftype + '&ref=' + arrTranobj.ref + '&sender=' + arrTranobj.senderbic + '&from-date=' + fd+'&to-date=' + td+'&datasource='+datasource;
                                    var options = {
                                        url: apiURL,
                                        timeout: 99999999,
                                        method: 'GET',
