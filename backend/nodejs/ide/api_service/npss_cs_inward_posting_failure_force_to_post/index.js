...
app.post('/', function(appRequest, appResponse, next) {
    try {
        ...
        reason :  credit posting  api call only in UAB
        ...
        */
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
            try {
                ...
                // Log Viewer Setup
                objSessionLogInfo.HANDLER_CODE = 'NPSS (CS) Inward Posting Failure Force to Post';
                objSessionLogInfo.ACTION = 'ACTION';
                objSessionLogInfo.PROCESS = 'NPSS (CS) Inward Posting Failure Force to Post';
                var cus_iban;
                // Get DB Connection                                                                                                                                      
                                ...
                                if (arrurlResult.length) {
                                    ...
                                    ExecuteQuery1(Takeurl, async function (arrurl) {
                                        if (arrurl.length > 0) {
                                                ...
                                                ExecuteQuery1(take_api_params, async function (arrTranparams) {
                                                    if (arrTranparams.length > 0) {
                                                        ...
                                                        ext_ident_value = await GetRetrycount(arrTranparams[0].uetr)
                                                         if (params.eligible_status == 'IP_RCT_CC_T24_POSTING_RETRY') { //credit                                     
                                            ...
                                            objresponse.status = 'FAILURE';
                                            objresponse.errdata = "credit posting Api url not found"
                                            sendResponse(null, objresponse)
                                        }
                                    })
                                                    ...
                                                    var options = {
                                                        ...
                                                        json: {
                                                                ...
                                                                "payload": {
                                                                    ...
                                                                    "NOSTRO_POOL_ACC": "Y",
                                                                    "retry_count": "0",
                                                                    "request_datetime": moment(new Date(), "DDMMYYYY").format("YYYY-MM-DD") || '',
                                                                    ...
                                                                    "error_code": "PI020,PI037,PI022",
                                                                    "op_pacs028_ttl_key": "npss-mh-6748f9bd48-8npc4_pacs_028_83951dfc-7b48-40c3-9080-dbb6a3c7b509",
                                                                    "cr_acc_ccy": "AUD",
                                                                    "ip_pacs028_ttl_key": "npss-mh-6748f9bd48-8npc4_pacs_028_83951dfc-7b48-40c3-9080-dbb6a3c7b509",
