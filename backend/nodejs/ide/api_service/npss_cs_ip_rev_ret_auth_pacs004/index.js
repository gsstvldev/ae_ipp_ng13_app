            ...
            try {
                ...
                reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                    ...
                    reqAuditLog.GetProcessToken(pSession, objLogInfo, async function prct(error, PRCT_ID) {
                        try {
                            var take_return_url = `Select param_category,param_code,param_detail from core_nc_system_setup where param_category='NPSS_LULU_CBS_Inward_Rev_posting' and param_code='URL' and need_sync = 'Y' and product_code='${params.PROD_CODE}'`;
