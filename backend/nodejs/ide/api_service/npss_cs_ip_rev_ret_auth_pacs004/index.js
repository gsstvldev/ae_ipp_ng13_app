                ...
                reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
                    ...
                    reqAuditLog.GetProcessToken(pSession, objLogInfo, function prct(error, prct_id) {
                        try {
                            ...
                            var take_return_url = `Select param_category,param_code,param_detail from core_nc_system_setup where param_category='NPSS_INAU_RESERVE_ACCEPT' and param_code='URL'`;
                            ...
                            var TakeprssRefno = `select process_ref_no ,cbuae_return_code ,contra_amount from npss_trn_process_log ns where ns.uetr = '${params.uetr}'`;
                                                ...
                                                if (arrActInf.length) {
                                                    ExecuteQuery1(TakeprssRefno, function (arrprssRefno) {
                                                        ...
                                                        if (arrprssRefno.length) {
                                                            ...
                                                            console.log("No Data found in Process log table");
                                                            objresponse.status = "FAILURE"
                                                            objresponse.errdata = "No Data found in Process log table"
                                                            sendResponse(objresponse, null)
                                                        }
                                                    })
                                                }
                    ...
                    function fn_doapicall2(url, arrprocesslog, arrprssRefno, callbackapi) {
                        try {
                            ...
                            var options = {
                                ...
                                json: {
                                    ...
                                    "payload": {
                                        ...
                                        "hdr_clearing_system": arrprocesslog[0].hdr_clearing_system || '',
                                        "txid": arrprocesslog[0].tran_ref_id || '',
                                        "post_reason_code": arrprssRefno[0].cbuae_return_code
