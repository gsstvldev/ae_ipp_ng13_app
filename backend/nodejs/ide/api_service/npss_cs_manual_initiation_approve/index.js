    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                                                    ...
                                                    amount = arrprocesslog[0].intrbk_sttlm_amnt
                                                            ...
                                                            ExecuteQuery1(take_api_url, function (arrurl) {
                                                                if (arrurl.length) {
                                                                    ...
                                                                    fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverandRefno,Objfiledata,Getdata, function (firstapiresult) {
                ...
                function fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverandRefno,Objfiledata,Getdata, callbackapi) {
                    try {
