    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                                            ...
                                            var PreparedData = async () => {
                                                ...
                                                ExecuteQuery1(take_api_url, function (arrurl) {
                                                    if (arrurl.length) {
                                                        ...
                                                        fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverandRefno, Objfiledata, Getdata,extend_retry_value, function (firstapiresult) {
                ...
                function fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverandRefno, Objfiledata, Getdata,extend_retry_value, callbackapi) {
                    try {
