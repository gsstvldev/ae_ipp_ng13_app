    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
      try {
        ...
        reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
            ...
            return new Promise(async (resolve, reject) => {
              ...
              if (ChkPrecdtCard.apitype == 0) {
                ...
                if (CheckAlredyApiCalled.apicalls == 1) {
                  let ppActNo = await getppacno(arrprocesslog)
          ...
          function getppacno(arrprocesslog) {
            return new Promise((resolve, reject) => {
              let chkData = `select account_number from <tran_db>.npss_trn_process_log where uetr='${arrprocesslog[0].additional_info}' and process_name='Prepaid Card Validation'`;
              let chkDataArc = `select account_number from <arc_tran_db>.npss_trn_process_log where uetr='${arrprocesslog[0].additional_info}' and process_name='Prepaid Card Validation'`;
