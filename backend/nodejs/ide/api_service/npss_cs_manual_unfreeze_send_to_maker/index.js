...
* 
*/
var serviceName = 'NPSS (CS) Manual Unfreeze Send to Maker'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS (CS) Manual Unfreeze Send to Maker';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS (CS) Manual Unfreeze Send to Maker';
        // Get DB Connection 
                            ...
                            ExecuteQuery1(Takedata, function (arrprocesslog) {
                                if (arrprocesslog.length > 0) {
                                    ...
                                    for (let i = 0; i < arrprocesslog.length; i++) {
                                        ...
                                        objCusTranInst.PROCESS_NAME = 'Send to Maker'
