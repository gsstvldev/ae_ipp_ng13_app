...
* 
*/
var serviceName = 'NPSS Merchant Add Bank Account'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Merchant Add Bank Account';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Merchant Add Bank Account';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT ADD BANK ACCOUNT' and tenant_id = '${params.TenantId}'`
