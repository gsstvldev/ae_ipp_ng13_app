...
* 
*/
var serviceName = 'NPSS Disable Account'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS DISABLE ACCOUNT';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS DISABLE ACCOUNT';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT DISABLE' and tenant_id = '${params.TenantId}'`
                    ...
                    try {
                       ...
                       var  apiURL = url // apiURL + apiName
                        var options = {
                            ...
                            method: 'DELETE',
                            json: {
                                "merchant_tag":params.merchant_tag
                            }, headers: {
