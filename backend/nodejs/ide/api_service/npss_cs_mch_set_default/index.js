...
* 
*/
var serviceName = 'NPSS Mch set Defult'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Mch set Defult';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Mch set Defult';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
            ...
            try {
                   ...
                   var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT CHANGE DEFAULT ACCOUNT' and tenant_id = '${params.TenantId}'`
