...
* 
*/
var serviceName = 'NPSS Merchant MCC'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Merchant MCC';
        ...
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT UPDATE MCC' and tenant_id = '${params.TenantId}'`
