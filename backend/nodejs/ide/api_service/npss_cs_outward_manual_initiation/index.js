                  ...
                  reqAuditLog.GetProcessToken(pSession, objLogInfo, function prct(error, prct_id) {
                      ...
                      function Getorgdata(arrprocesslog) {
                          return new Promise((resolve, reject) => {
                             ...
                             var orgflddata = `select process_ref_no from npss_trn_process_log where  uetr = '${arrprocesslog[0].uetr}' and status in ('IP_RCT_POSTING_SUCCESS','IP_RCT_PC_T24_POSTING_SUCCESS','IP_RCT_CC_T24_POSTING_SUCCESS')`
