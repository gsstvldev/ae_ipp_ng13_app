...
app.post('/', function(appRequest, appResponse, next) {
    ...
    Modified By : 
    Modified Date : 27/02/2023 7:01pm
    }
    */
                        ...
                        function apiCall(arrTranobj, arrUrl) {
                            return new Promise((resolve, reject) => {
                                ...
                                try {
                                    ...
                                    var dt = moment(arrTranobj.datetime).format("YYYY-MM-DD")+'T00:00:00'
                                    var apiURL =
                                        apiURL = arrUrl[0].param_detail +'/paymentDetail?ref-type=' + arrTranobj.reftype + '&ref=' + arrTranobj.ref + '&sender-bic=' + arrTranobj.senderbic + '&payment-date=' + dt;
                                    var options = {
                                        url: apiURL,
                                        timeout: 99999999,
                                        method: 'GET',
