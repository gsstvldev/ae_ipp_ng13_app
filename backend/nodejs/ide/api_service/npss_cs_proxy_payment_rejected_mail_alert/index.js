                                                        ...
                                                        ExecuteQuery1(TakeCometo, function (arrCometo) {
                                                            if (arrCometo.length > 0) {
                                                                reqAsync.forEachOfSeries(arrData, function (arrDataobj, i, nextobjctfunc) {
                                                                    var TakenpsstrRefno = `select npsstrrd_refno from npss_trn_process_log where process_name = 'SctInitiation' and uetr = '${arrDataobj.uetr}' and additional_info not in ('Mail_Sent')`
                                                                        ...
                                                                        if (arrnpstrefno.length > 0) {
                                                                            ...
                                                                            ExecuteQuery1(TaketranInf, function (arrInfrm) {
                                                                                if (arrInfrm.length > 0) {
                                                                                        ...
                                                                                        request(options, function (error, responseFromImagingService, responseBody) {
                                                                                            ...
                                                                                            if (error) {
                                                                                                ...
                                                                                                if (responseBody.status == 'SUCCESS') {
                                                                                                    var UpdateTrnTble = `Update npss_trn_process_log additional_info = 'Mail_Sent' ,MODIFIED_BY = '${params.CREATED_BY}',MODIFIED_DATE = '${reqDateFormatter.GetTenantCurrentDateTime(headers, objSessionLogInfo)}',MODIFIED_BY_NAME ='${params.CREATED_BY_NAME}',PRCT_ID ='${PRCT_ID}', MODIFIED_CLIENTIP = '${objSessionLogInfo.CLIENTIP}', MODIFIED_TZ = '${objSessionLogInfo.CLIENTTZ}', MODIFIED_TZ_OFFSET = '${objSessionLogInfo.CLIENTTZ_OFFSET}', MODIFIED_BY_SESSIONID = '${objSessionLogInfo.SESSION_ID}', MODIFIED_DATE_UTC = '${reqDateFormatter.GetCurrentDateInUTC(headers, objSessionLogInfo)}' where uetr = '${arrDataobj.uetr}'`
                                                                                    ...
                                                                                    reqInstanceHelper.PrintInfo(serviceName, '------------Tran Table details not found for uetr-------' + arrTrandataobj.uetr, objSessionLogInfo);
                                                                                    nextobjctfunc()
                                                                                }
