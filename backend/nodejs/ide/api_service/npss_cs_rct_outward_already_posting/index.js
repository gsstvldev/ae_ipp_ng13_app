...
*/
var serviceName = 'NPSS (CS) RCT Outward Already Posting';
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS (CS) RCT Outward Already Posting';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS (CS) RCT Outward Already Posting';
        // Get DB Connection 
                            ...
                            if (result.length) {
                                ...
                                ExecuteQuery(updtranqry, function (tranresult) {
                                    if (tranresult == 'SUCCESS') {
                                        ...
                                        objresponse.status = 'FAILURE IN Tran Table Update';
                                        sendResponse(null, objresponse)
                                    }
                                })
                            }
                                ...
                                objresponse.status = 'No data found in core nc workflow setup Table';
                                sendResponse(null, objresponse)
                            }
