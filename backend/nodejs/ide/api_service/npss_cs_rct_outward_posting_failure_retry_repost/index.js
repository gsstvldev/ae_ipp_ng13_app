                                  ...
                                  if (params.Roleid == '705' || params.Roleid == 705) {
                                      ...
                                      ExecuteQuery1(take_api_params, function (arrTranparams) {
                                          if (arrTranparams.length > 0) {
                                              ...
                                              var Apicalls
                                              if (params.eligible_status == 'OP_AC_REV_POSTING_RETRY' || params.eligible_status == 'OP_AC_RET_POSTING_RETRY' || params.eligible_status == 'OP_P2P_REV_POSTING_RETRY' || params.eligible_status == 'OR_P2P_POSTING_RETRY' || params.eligible_status == '' || params.eligible_status == 'OR_P2P_POSTING_RETRY') { //ORR
