...
try {
    ...
    Reason for : 
    */
    var serviceName = 'NPSS RCT IP Retry  Change State';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE =  'NPSS RCT IP Retry  Change State';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS =  'NPSS RCT IP Retry  Change State';
            // Get DB Connection                                                                                                                                      
