    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                                            ...
                                            if (arrpostrefno.length > 0) {
                                                ExecuteQuery1(take_api_url, function (arrurl) {
                                                    if (arrurl.length) {
                                                        ...
                                                        fn_doapicall(url, arrprocesslog, arrpostrefno, TakeAccountInformation, function (result) {
                                                            if (result == 'SUCCESS') {
                ...
                function fn_doapicall(url, arrprocesslog, arrpostrefno, TakeAccountInformation, callbackapi) {
                    try {
