                ...
                reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                    ...
                    reqAuditLog.GetProcessToken(pSession, objLogInfo, function prct(error, prct_id) {
                        try {
                            ...
                            var take_api_params = `select  ns.intrbk_sttlm_amnt,ns.department_code,ns.remittance_info,ns.cr_acct_identification,ns.cr_acct_id_code,ns.hdr_msg_id,ns.hdr_created_date,ns.hdr_total_records,ns.hdr_total_amount,ns.hdr_settlement_date,ns.hdr_settlement_method,
                                ...
                                if (arrrule.length > 0) {
                                    ...
                                    ExecuteQuery1(take_api_params, function (arrprocesslog) {
                                        if (arrprocesslog.length) {
                                            ...
                                            ExecuteQuery1(TakeAcctInf, function (acctInform) {
                                                    ...
                                                    if (arrpostrefno.length > 0) {
                                                        ExecuteQuery1(take_api_url, function (arrurl) {
                                                            if (arrurl.length) {
                                                                ...
                                                                fn_doapicall(url, arrprocesslog, arrpostrefno, acctInform, function (result) {
                                                                    if (result == 'SUCCESS') {
