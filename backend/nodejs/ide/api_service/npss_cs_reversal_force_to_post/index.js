...
app.post('/', function(appRequest, appResponse, next) {
    ...
    try {
        ...
        */
        var serviceName = 'NPSS (CS) Force To Post';
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
            try {
                ...
                // Log Viewer Setup
                objSessionLogInfo.HANDLER_CODE = 'NPSS (CS) Force To Post';
                objSessionLogInfo.ACTION = 'ACTION';
                objSessionLogInfo.PROCESS = 'NPSS (CS) Force To Post';
                var cus_iban;
                // Get DB Connection                                                                                                                                      
                                                    ...
                                                    if (arrprocesslog.length) {
                                                        ...
                                                        _BulkInsertProcessItem(arrCusTranInst, 'NPSS_TRN_PROCESS_LOG', function callbackInsert(CusTranInsertRes) {
                                                            ...
                                                            ExecuteQuery1(take_api_params, async function (arrprocesslog) {
                                                                ...
                                                                if (params.roleId == 705 || params.roleId == '705') { //for checking prepaid or credit only for maker
                        ...
                        try {
                            ...
                            request(options, function (error, responseFromImagingService, responseBodyFromImagingService) {
                                if (error) {
                                 ...
                                 reqInstanceHelper.PrintInfo(serviceName, '------------API JSON-------' + responseBodyFromImagingService, objSessionLogInfo);
                                    responseBodyFromImagingService.statuscode = responseFromImagingService.statusCode
