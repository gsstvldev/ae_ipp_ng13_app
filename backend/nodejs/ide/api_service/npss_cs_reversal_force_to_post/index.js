                                                                        ...
                                                                        ExecuteQuery1(Takecontraamount, async function (arramount) {
                                                                            if (arramount.length > 0) {
                                                                                if (arramount[0].contra_amount && arrprocesslog[0].reversal_amount) {
                                                                                    ...
                                                                                    var apiRes = apistatus.replace(/(\n)/g, "")
                                                                                    var apiCallResponse = JSON.parse(apiRes)

                                                                                    if (apiCallResponse.status == 'SUCCESS' || apiCallResponse.status == 'Success') {
                                                                                    ...
                                                                                    } else if (apiCallResponse.status == 'TIMEOUT') {
