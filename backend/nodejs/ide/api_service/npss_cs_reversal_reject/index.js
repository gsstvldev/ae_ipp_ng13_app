                            ...
                            if (result.length) {
                                ...
                                ExecuteQuery(updtranqry, function (tranresult) {
                                    if (tranresult == 'SUCCESS') {
                                        ...
                                        ExecuteQuery1(takeerrordesc, function (errocode) {
                                            if (errocode.length > 0) {
                                                var updateRescode = `Update npss_trn_process_log set  response_code = '${params.ResonCode}',additional_info = '${errocode[0].error_description}' where npsstpl_id='${params.tpl_id}'`
                                                ExecuteQuery(updateRescode, function (tranresult1) {
                                                    if(tranresult1 == 'SUCCESS'){
