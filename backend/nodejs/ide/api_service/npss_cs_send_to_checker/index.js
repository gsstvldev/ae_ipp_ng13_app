    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                                                        ...
                                                        var takedata = async () => {
                                                            ...
                                                            ExecuteQuery1(take_api_url, async function (arrurl) {
                                                                if (arrurl.length) {
                                                                    ...
                                                                    var callapi = async () => {
                                                                        var apistatus = await checkapiCalls(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, apicalls,extend_retry_value)
                ...
                function fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin,extend_retry_value, callbackapi) {
                    try {
                ...
                function checkapiCalls(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, apicalls,extend_retry_value) {
                    return new Promise((resolve, reject) => {
                        // reserve fund
                        if (apicalls == 0) {
                            fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin,extend_retry_value, function (result) {
