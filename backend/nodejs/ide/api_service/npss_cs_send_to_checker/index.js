        ...
        Reason for removing forceTopost checking 22/03/2023
          Reason for Adding ext_idnt_retry_count for all apis 29/03/2023
           Reason for CHANGING CBS ACCOUNTS TABLE QUERY 30/03/2023
            Reason for Removing TranProcesslog update 3/04/2023
            Reason for Adding dealrefno for fab and changes done in fh 4/4/2023
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
       try {
          ...
          reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                                           ...
                                           var takedata = async () => {
                                              ...
                                              ExecuteQuery1(take_api_url, async function (arrurl) {
                                                 if (arrurl.length) {
                                                    ...
                                                    var callapi = async () => {
                                                       var apistatus = await checkapiCalls(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, apicalls, extend_retry_value,takedealRefno)
             ...
             function fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, extend_retry_value,takedealRefno, callbackapi) {
                try {
             ...
             function checkapiCalls(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, apicalls, extend_retry_value,takedealRefno) {
                return new Promise((resolve, reject) => {
                   // reserve fund
                   if (apicalls == 0) {
                      fn_doapicall(url, arrprocesslog, lclinstrm, amount, reverseAcinfparam, Objfiledata, TakegmMargin, extend_retry_value,takedealRefno, function (result) {
