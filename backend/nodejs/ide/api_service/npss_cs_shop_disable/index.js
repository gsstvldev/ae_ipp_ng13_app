...
* 
*/
var serviceName = 'NPSS Disable Shop '; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        objSessionLogInfo = objLogInfo; // Assign log information
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Disable Shop';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Disable Shop';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT DISABLE SHOP' and tenant_id = '${params.TenantId}'`
