...
* 
*/
var serviceName = 'NPSS  Remove Shop Bank Account'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS  Remove  Shop Bank Account';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS  Remove REMOVE Shop Bank Account';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT REMOVESHOPBANKACCOUNT' and tenant_id = '${params.TenantId}'`
                ExecuteQuery1(Takejson, function (arrjson) {  //merchanttag,bankuserid,channelid,iban
                    if (arrjson.length) {
                        ...
                        var merchant_tag = params.merchant_tag
