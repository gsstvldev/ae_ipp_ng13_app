...
* 
*/
var serviceName = 'NPSS  set shop Account'; //service name 
...
var objresponse = {
    ...
    'data': '',
    'msg': ''
}; // Response to Client /npss-sm/groups/{groupCode}/banks/{bankCode}/bank-user/{bankUserId}/tag/{merchantTag}/shop/{shopId}/bank-account
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS  set shop Account';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS  set shop Account';
        // Get DB Connection 
