...
* 
*/
var serviceName = 'NPSS Update Shop'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Shop Update';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Shop Update';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            mTranConn = pSession; //  assign connection 
            //get prct id                              
            try {
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'MERCHANT UPDATE SHOP' and tenant_id = '${params.TenantId}'`
