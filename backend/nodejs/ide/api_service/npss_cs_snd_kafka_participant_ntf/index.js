                                              ...
                                              if (arrTopic.length > 0) {
                                                  ...
                                                  ExecuteQuery1(TakeComCat, function (arrComCat) {
                                                      if (arrComCat.length > 0) {
                                                          var takeparticipantList = `select * from core_nc_bank_part_avail where published is null or published = 'N' and need_sync = 'Y'`
                                                                  ...
                                                                  reqAsync.forEachOfSeries(arrresult, function (arrresultObj, i, nextobjctfunc) {
                                                                      try {
                                                                          ...
                                                                          var dataobj = {
                                                                              ...
                                                                              shortCode: arrresultObj.bank_short_code.slice(0,4) || '',
