...
* 
*/
var serviceName = 'NPSS Customer Unenrolment'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Customer Unenrolment';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Customer Unenrolment';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                ...
                var Takejson = `select param_value from core_rule_prod_params where rule_code = 'CUSTOMER UNENROLMENT' and tenant_id = '${params.TenantId}'`
                ExecuteQuery1(Takejson, function (arrjson) {
                    if (arrjson.length) {
                        ...
                        var optout = JsonValue["General"]["subgroup"][0]["optout"]
                        ...
                        fndoapicall(request_id, lang, url, bankcode, groupcode, optout,function (result) {
                ...
                function fndoapicall(requestid, lang, url, bankcode, groupcode,optout, callbackapi) {
                    try {
