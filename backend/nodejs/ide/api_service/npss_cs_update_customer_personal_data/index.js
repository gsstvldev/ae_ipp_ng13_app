...
app.post('/', function(appRequest, appResponse, next) {
    ...
    * 
    */
    var serviceName = 'NPSS Update Customer Personal'; //service name 
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        ...
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = 'NPSS Update Customer Personal';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = 'NPSS Update Customer Personal';
            // Get DB Connection 
            reqTranDBInstance.GetTranDBConn(headers, false, function (pSession) {
                ...
                try {
                    ...
                    var Takejson = `select param_value from core_rule_prod_params where rule_code = 'CUSTOMER UPDATE PERSONAL DATA'  and tenant_id = '${params.TenantId}'`
