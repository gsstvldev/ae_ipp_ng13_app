...
* 
*/
var serviceName = 'NPSS Verify Payment'; //service name 
...
reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    ...
    try {
        ...
        // Log Viewer Setup
        objSessionLogInfo.HANDLER_CODE = 'NPSS Verify Payment';
        objSessionLogInfo.ACTION = 'ACTION';
        objSessionLogInfo.PROCESS = 'NPSS Verify Payment';
        // Get DB Connection 
        reqTranDBInstance.GetTranDBConn(headers, true, function (pSession) {
            ...
            try {
                  ...
                  var Takejson = `select param_value from core_rule_prod_params where rule_code = 'P2P Verify Payment' and tenant_id = '${params.TenantId}'`
