...
app.post('/', function(appRequest, appResponse, next) {
    ...
    * 
    */
    var serviceName = ' NPSS LARI ANNI (S) Update Channel ID'; //service name 
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = ' NPSS LARI ANNI (S) Update Channel ID';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = ' NPSS LARI ANNI (S) Update Channel ID';
            // Get DB Connection 
