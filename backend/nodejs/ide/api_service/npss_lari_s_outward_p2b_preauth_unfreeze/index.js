...
*/
  var serviceName = 'NPSS LARI(S) P2B Preauth Unfreeze ';
  ...
  reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
    try {
      ...
      // Log Viewer Setup
      objSessionLogInfo.HANDLER_CODE = 'NPSS lari (S) P2B Preauth Unfreeze ';
      objSessionLogInfo.ACTION = 'ACTION';
      objSessionLogInfo.PROCESS = 'NPSS LARI (S) P2B Preauth Unfreeze';
      // Get DB Connection 
        ...
        reqAuditLog.GetProcessToken(pSession, objLogInfo, async function prct(error, prct_id) {
          try {
            ...
            if (arrTakehrs.length > 0) {
              ...
              var Formdate = utcMoment.subtract(arrTakehrs[0].param_detail, 'days')
