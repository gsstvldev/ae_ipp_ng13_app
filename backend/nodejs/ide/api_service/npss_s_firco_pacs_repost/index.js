                                ...
                                try {
                                    if (arrdata.length > 0) {
                                        reqAsync.forEachOfSeries(arrdata, function (arrdataObj, i, nextuetrobjfun) {
                                            let Callapis = async () => {
                                                if((arrdataObj.message_data != null && arrdataObj.message_data != '') && (arrdataObj.uetr != null && arrdataObj.uetr != '') && (arrdataObj.npsstrrd_refno != null && arrdataObj.npsstrrd_refno != '') && (arrdataObj.hdr_msg_id != null && arrdataObj.hdr_msg_id != '')  && (arrdataObj.process_name != null && arrdataObj.process_name != '')  && (arrdataObj.process_status != null && arrdataObj.process_status != '') && (arrdataObj.status != null && arrdataObj.status != '') && (arrdataObj.account_currency != null && arrdataObj.account_currency != '') && (arrdataObj.base_amount != null && arrdataObj.base_amount != '') && (arrdataObj.cr_sort_code != null && arrdataObj.cr_sort_code != '') && (arrdataObj.dr_sort_code != null && arrdataObj.dr_sort_code != '') && (arrdataObj.process_type != null && arrdataObj.process_type != '') && (arrdataObj.payment_endtoend_id != null && arrdataObj.payment_endtoend_id != '') && (arrdataObj.clrsysref != null && arrdataObj.clrsysref != '')                           ){
                                                    ...
                                                    if(Parameter != ''){
                                                                ...
                                                                if (error) {
                                                                    ...
                                                                    try {
                                                                        if (responseBodyFromImagingService == 'SUCCESS') {
                                                                            ...
                                                                            let UpdateTran = `update npss_trn_req_resp_dtls set  firco_repush_flag = 'Y' where npsstrrd_id = '${arrdataObj.npsstrrd_id}'`
                                                        ...
                                                        reqInstanceHelper.PrintInfo(serviceName, 'Something Error...status..' + arrdataObj.status + '....uetr.......' + arrdataObj.uetr, objSessionLogInfo);
                                                        nextuetrobjfun()
                                                    }
                                                }else{
                                                    reqInstanceHelper.PrintInfo(serviceName, 'Data Missing for...status..' + arrdataObj.status + '....uetr.......' + arrdataObj.uetr+'..............ProcessName.....'+arrdataObj.process_name+'........ProcessType....'+arrdataObj.process_type, objSessionLogInfo);
                                                    nextuetrobjfun() 
                                                } 
