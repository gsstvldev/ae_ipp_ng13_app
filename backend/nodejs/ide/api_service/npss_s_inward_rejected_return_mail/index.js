                                            ...
                                            ExecuteQuery1(takeCount, function (arrCount) {
                                                reqAsync.forEachOfSeries(arrCount, function (arrCountobj, i, nextobjctfunc) {
                                                    ...
                                                    if (arrCountobj.count > 0) {
                                                        var TakeCometo = `select param_value from CORE_NS_PARAMS  where process_name = '${params.process_name}' and destination_system = '${arrCountobj.department_code}' and param_name='COMM_TO'`
