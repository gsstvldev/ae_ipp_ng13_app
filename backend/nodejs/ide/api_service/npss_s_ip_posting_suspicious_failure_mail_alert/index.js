                    ...
                    try {
                        ...
                        ExecuteQuery1(takeurl, async function (arrUrl) {
                            if (arrUrl.length == 0) {
                                ...
                                var Takedata = `SELECT * FROM npss_trn_process_log AS log  INNER JOIN npss_transactions AS trans ON log.uetr = trans.uetr WHERE log.status IN ${status} AND log.process_status IN ${process_status}  AND log.process_type = 'IP'`
                                                                            ...
                                                                            if (arracccur.length > 0) {
                                                                                try {
                                                                                    var frtodata = [{
                                                                                        ...
                                                                                        POSTINGAPPLICATION: arrAllData.length > 0 ? arrAllData[0].processing_system : '',
                                                                                        MESSAGETYPE: arrAllData.length > 0 ? arrAllData[0].process_name : '',
