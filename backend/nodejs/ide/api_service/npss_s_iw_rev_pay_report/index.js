...
app.post('/', function (appRequest, appResponse, next) {
    ...
    */
    var serviceName = 'NPSS  AMB Inward Payment Reversal Report';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = 'NPSS  AMB Inward Payment Reversal Report';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = 'NPSS  AMB Inward Payment Reversal Report';
...
where
	...
	inner join  CORE_SYSTEM_EXTN CSE on CSE.department_code  = nt.DEPARTMENT_CODE) V where process_type = 'IP' and
process_name ='Receive Pacs.007' and  Date(created_date)=CURRENT_DATE- INTERVAL '${params.onOrBefore} days'`
