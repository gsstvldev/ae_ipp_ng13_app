...
app.post('/', function (appRequest, appResponse, next) {
    /*  Created By :Daseen WI 3327
Created Date :08/01/2024
 

*/
    var serviceName = 'NPSS LULU(S) P2B Preauth Unfreeze ';
    ...
    reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInformation) {
        try {
            ...
            // Log Viewer Setup
            objSessionLogInfo.HANDLER_CODE = 'NPSS LULU (S) P2B Preauth Unfreeze ';
            objSessionLogInfo.ACTION = 'ACTION';
            objSessionLogInfo.PROCESS = 'NPSS LULU (S) P2B Preauth Unfreeze';
            // Get DB Connection 
