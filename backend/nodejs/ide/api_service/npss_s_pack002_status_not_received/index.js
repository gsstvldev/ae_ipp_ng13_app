                                                    ...
                                                    reqAsync.forEachOfSeries(arrTrn, function (arrTrnobj, i, nextobjctfunc) {
                                                        ...
                                                        ExecuteQuery1(Takelog, function (arrlog) {
                                                            if (arrlog[0].process_name == 'Place Pacs002' || arrlog[0].process_name == 'Place Pacs004' || arrlog[0].process_name == 'Place Pacs008') {
                                                                var Takelog2 = `select l.uetr,l.Process_name,l.npsstpl_id from  npss_trn_process_log l where uetr='${arrTrnobj.uetr}' and npsstpl_id='${arrlog[0].npsstpl_id + 1}' order by npsstpl_id`
                                                                ExecuteQuery1(Takelog2, function (arrlog2) {
                                                                    if (arrlog2[0].process_name == 'Place Pacs028') {
                                                                        var Takelog3 = `select l.uetr,l.Process_name,l.npsstpl_id,l.process_type from  npss_trn_process_log l where uetr='${arrTrnobj.uetr}' and npsstpl_id='${arrlog[0].npsstpl_id + 2}' order by npsstpl_id`
                                                                        ExecuteQuery1(Takelog3, function (arrlog3) {
                                                                            if (arrlog3[0].process_name != 'Receive Pacs002') {
