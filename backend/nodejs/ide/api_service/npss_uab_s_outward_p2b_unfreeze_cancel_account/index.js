        ...
        try {
            ...
            reqTranDBInstance.GetTranDBConn(headers, false, async function (pSession) {
                ...
                function kafkaapi(arrpayverobj, arrurl, process_name1, process_name3) {
                    var postrefno;
                    return new Promise((resolve, reject) => {
                        var TakepostingRefno = `select process_ref_no from npss_trn_process_log where process_name='${postingrefnoprocess_name}' and uetr='${arrpayverobj.uetr}'`
                                                    ...
                                                    json: {
                                                        ...
                                                        data: {
                                                            "payload": {
                                                                ...
                                                                "channel_id": 'IPP',
                                                                "npsstrrd_refno": arrpayverobj.npsstrrd_refno
