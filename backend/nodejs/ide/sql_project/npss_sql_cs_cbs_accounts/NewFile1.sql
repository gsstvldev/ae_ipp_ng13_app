...
( 
    ...
    Posting_restriction_code numeric(2),
    Inactive_Marker character(1) COLLATE pg_catalog."default",
    Category_code numeric(6), 
    Category_Description character varying(35) COLLATE pg_catalog."default",
    Currency character varying(3) COLLATE pg_catalog."default",
    CUSTOMER_ID numeric(10), 
    Account_Title_2 character varying(35) COLLATE pg_catalog."default",
    ...
    Customer_Posting_restriction_code numeric(2),     
    ...
    Legal_ID character varying(35) COLLATE pg_catalog."default",
National_ID character varying(20) COLLATE pg_catalog."default",
Industry numeric(4),
Communication_Type character varying(16) COLLATE pg_catalog."default",
Customer_Mobile_Number character varying(20) COLLATE pg_catalog."default",
...
Trade_License_Number character varying(35) COLLATE pg_catalog."default",
...
Account_Postring_Type_Description character varying(35) COLLATE pg_catalog."default",
Account_Posting_Restrict_Type character varying(6) COLLATE pg_catalog."default",
Customer_Posting_restriction_Description character varying(35) COLLATE pg_catalog."default",
