...
SELECT res.type,
   ...
   FROM ( SELECT
            ...
            count(DISTINCT
                CASE
                    WHEN nppst.process_type::text = 'OP'::text AND npl.process_name::text = 'Place Pacs008'::text AND nppst.status in ('OP_P2P_REV_POSTING_FAILURE','OP_P2B_REV_POSTING_FAILURE','OP_AC_REV_POSTING_FAILURE','OP_AC_REQ_RECEIVED','OP_AC_REQ_INVEST_INITIATED') THEN nppst.npsst_id
