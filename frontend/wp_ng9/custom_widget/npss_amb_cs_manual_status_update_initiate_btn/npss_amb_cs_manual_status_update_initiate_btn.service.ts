...
@Injectable()
export class npss_amb_cs_manual_status_update_initiate_btnService {
    ...
    fn_npss_amb_cs_manual_status_update_initiate_btn(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_amb_cs_manual_status_update_initiate_btn/', ClientParams)
            .subscribe((res: any) => {
