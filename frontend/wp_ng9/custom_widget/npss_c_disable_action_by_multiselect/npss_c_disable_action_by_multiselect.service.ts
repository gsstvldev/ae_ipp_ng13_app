...
export class npss_c_disable_action_by_multiselectService {
    ...
    if (Product_Code === "NPSS_AEFAB" || Product_Code === "NPSS_AEFIN") {
            if (screenInstance.wftpa_description === "s_rct_posting_failures" || screenInstance.wftpa_description === "s_rct_rejected_returns" || screenInstance.wftpa_description === "s_op_rct_posting_failure") {
