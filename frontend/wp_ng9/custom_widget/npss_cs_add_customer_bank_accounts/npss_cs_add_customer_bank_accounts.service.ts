...
@Injectable()
export class npss_cs_add_customer_bank_accountsService {
    ...
    fn_npss_cs_add_customer_bank_accounts(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        let ClientParams = {}
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_add_customer_bank_accounts/', ClientParams)
            .subscribe((res: any) => {
                var event
                    if(res.data.status == 'SUCCESS'){ 
                                                                        
                        event = { eventId: "custom-connector", param:res.data.data , idename:"Addcustomer", internals: internals }
