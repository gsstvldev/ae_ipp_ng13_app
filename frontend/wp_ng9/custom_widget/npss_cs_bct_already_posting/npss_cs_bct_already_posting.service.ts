...
export class npss_cs_bct_already_postingService {
    ...
    fn_npss_cs_bct_already_posting(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.RULE_CODE = "BCT_IPIR_SUSP_ALPOST";
    ...
    //fn_customValidation(projName,screenInstance,message,callback){
       ...
       CallUrlforGetparamvalue(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_bct_already_posting/', ClientParams)
            .subscribe((res: any) => {
