...
@Injectable()
export class npss_cs_bct_checker_approveService {
    ...
    fn_npss_cs_bct_checker_approve(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.rule_code = "BCT_IP_INVEST_APPROVE";
        this.CallUrlWithData(ClientParams, screenInstance, internals);
    }
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_bct_checker_approve/', ClientParams)
            .subscribe((res: any) => {
