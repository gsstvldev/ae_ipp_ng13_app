...
@Injectable()
export class npss_cs_bct_ipir_posting_failure_retryService {
    ...
    fn_npss_cs_bct_ipir_posting_failure_retry(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.api_code = "BCT_IPIR_FAIL_RETRY";

            this.CallUrlWithData(ClientParams, screenInstance, internals);
    }
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_bct_ipir_posting_failure_retry/', ClientParams)
            .subscribe((res: any) => {
