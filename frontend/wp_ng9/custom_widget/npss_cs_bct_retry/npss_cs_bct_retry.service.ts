...
@Injectable()
export class npss_cs_bct_retryService {
    ...
    fn_npss_cs_bct_retry(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.api_code = "BCT_IPIR_SUSP_RETRY";
