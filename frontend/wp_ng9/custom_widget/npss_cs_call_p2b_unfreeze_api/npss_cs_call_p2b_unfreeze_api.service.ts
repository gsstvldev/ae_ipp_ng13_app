...
@Injectable()
export class npss_cs_call_p2b_unfreeze_apiService {
    ...
    fn_npss_cs_call_p2b_unfreeze_api(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.SYSTEM_NAME = this.sessionHelper.GetVariable(SCOPE.SESSION_LEVEL, "S_DESC");
         ClientParams.RULE_CODE = 'P2B_MAN_UNF_CALLAPI'
...
CallUrlWithData(ClientParams, screenInstance, internals) {
    this.httpHelper.HttpPost('/microsvc/npss_cs_call_p2b_unfreeze_api/', ClientParams)
        .subscribe((res: any) => {
