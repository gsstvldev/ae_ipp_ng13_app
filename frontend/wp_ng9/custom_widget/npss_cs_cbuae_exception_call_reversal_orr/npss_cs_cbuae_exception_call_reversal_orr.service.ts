...
@Injectable()
export class npss_cs_cbuae_exception_call_reversal_orrService {
    ...
    fn_npss_cs_cbuae_exception_call_reversal_orr(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        ...
        ClientParams.Rule_Code = 'CBUAE_EXCEPTION_REVERSAL'
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_cbuae_exception_call_reversal_orr/', ClientParams)
            .subscribe((res: any) => {
