...
@Injectable()
export class npss_cs_enquiryService {
    ...
    fn_npss_cs_enquiry(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
...
CallDLL(ClientParams, screenInstance, internals) {
    this.httpHelper.HttpPost('/microsvc/npss_cs_enquiry/', ClientParams)
        .subscribe((res: any) => {
