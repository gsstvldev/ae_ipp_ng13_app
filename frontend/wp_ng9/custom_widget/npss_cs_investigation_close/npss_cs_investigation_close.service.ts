...
@Injectable()
export class npss_cs_investigation_closeService {
    ...
    fn_npss_cs_investigation_close(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        let remarks = screenInstance['remark_ui'].f_npss_remarks_ui.model;
        ...
        ClientParams.Rule_Code = 'OP_INVEST_MAN_CLOSE'
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_investigation_close/', ClientParams)
            .subscribe((res: any) => {
