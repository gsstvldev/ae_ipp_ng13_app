...
@Injectable()
export class npss_cs_inward_rejected_return_re_submitService {
    ...
    fn_npss_cs_inward_rejected_return_re_submit(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_inward_rejected_return_re_submit/', ClientParams)
            .subscribe((res: any) => {
