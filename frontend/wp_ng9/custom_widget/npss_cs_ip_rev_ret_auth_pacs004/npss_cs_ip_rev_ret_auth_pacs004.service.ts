...
@Injectable()
export class npss_cs_ip_rev_ret_auth_pacs004Service {
    ...
    fn_npss_cs_ip_rev_ret_auth_pacs004(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
     ...
     CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_ip_rev_ret_auth_pacs004/', ClientParams)
            .subscribe((res: any) => {
