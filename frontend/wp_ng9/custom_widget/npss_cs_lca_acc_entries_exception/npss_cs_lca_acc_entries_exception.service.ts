...
@Injectable()
export class npss_cs_lca_acc_entries_exceptionService {
    ...
    fn_npss_cs_lca_acc_entries_exception(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        ...
        ClientParams.RULE_CODE = 'RCT_OP_MANUAL_APPROVE'
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_lca_acc_entries_exception/', ClientParams)
            .subscribe((res: any) => {
