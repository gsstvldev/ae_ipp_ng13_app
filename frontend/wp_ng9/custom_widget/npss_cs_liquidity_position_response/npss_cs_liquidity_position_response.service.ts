...
@Injectable()
export class npss_cs_liquidity_position_responseService {
    ...
    fn_npss_cs_liquidity_position_response(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals, status) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_liquidity_position_response/', ClientParams)
            .subscribe((res: any) => {
