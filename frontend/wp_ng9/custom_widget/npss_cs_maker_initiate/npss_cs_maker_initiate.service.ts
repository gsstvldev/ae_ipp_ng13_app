...
@Injectable()
export class npss_cs_maker_initiateService {
    ...
    fn_npss_cs_maker_initiate(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        if(screenInstance.wftpa_description=="s_op_rct_investigation"){
            ...
            ClientParams.rule_code = "BCT_IP_INVEST_INITIATE";
        }
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_maker_initiate/', ClientParams)
            .subscribe((res: any) => {
