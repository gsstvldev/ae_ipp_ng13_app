...
@Injectable()
export class npss_cs_manual_unfreeze_send_to_makerService {
    ...
    fn_npss_cs_manual_unfreeze_send_to_maker(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        ...
        ClientParams.RULE_CODE = 'P2B_MAN_UNF_SENDTOMAKER'
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_manual_unfreeze_send_to_maker/', ClientParams)
            .subscribe((res: any) => {
