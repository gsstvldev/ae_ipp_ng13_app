...
@Injectable()
export class npss_cs_outward_posting_failure_force_to_postService {
    ...
    fn_npss_cs_outward_posting_failure_force_to_post(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_outward_posting_failure_force_to_post/', ClientParams)
            .subscribe((res: any) => {
