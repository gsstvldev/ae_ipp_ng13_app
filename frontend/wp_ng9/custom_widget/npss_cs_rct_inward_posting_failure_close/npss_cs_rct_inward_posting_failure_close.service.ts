...
@Injectable()
export class npss_cs_rct_inward_posting_failure_closeService {
    ...
    fn_npss_cs_rct_inward_posting_failure_close(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        ...
        ClientParams.Rule_Code = 'RCT_IP_POSTING_MAN_CLOSE'
