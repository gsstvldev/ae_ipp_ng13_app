...
@Injectable()
export class npss_cs_rct_inward_posting_failure_retry_repostService {
    ...
    fn_npss_cs_rct_inward_posting_failure_retry_repost(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
