...
@Injectable()
export class npss_cs_rct_ipir_posting_failure_retryService {
    ...
    fn_npss_cs_rct_ipir_posting_failure_retry(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_rct_ipir_posting_failure_retry/', ClientParams)
            .subscribe((res: any) => {
