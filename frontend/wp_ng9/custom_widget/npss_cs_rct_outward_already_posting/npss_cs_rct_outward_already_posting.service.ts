...
@Injectable()
export class npss_cs_rct_outward_already_postingService {
    ...
    fn_npss_cs_rct_outward_already_posting(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlforGetparamvalue(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_rct_outward_already_posting/', ClientParams)
            .subscribe((res: any) => {
