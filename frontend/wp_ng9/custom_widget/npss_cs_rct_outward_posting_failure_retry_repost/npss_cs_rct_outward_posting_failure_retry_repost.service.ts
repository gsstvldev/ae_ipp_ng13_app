...
@Injectable()
export class npss_cs_rct_outward_posting_failure_retry_repostService {
    ...
    fn_npss_cs_rct_outward_posting_failure_retry_repost(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_rct_outward_posting_failure_retry_repost/', ClientParams)
            .subscribe((res: any) => {
