...
@Injectable()
export class npss_cs_rejected_payment_rejectService {
    ...
    fn_npss_cs_rejected_payment_reject(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        ClientParams.RULE_CODE = 'OP_RCT_REJ_PAY_REVPOST'
...
CallUrlWithData(ClientParams, screenInstance, internals) {
    this.httpHelper.HttpPost('/microsvc/npss_cs_rejected_payment_reject/', ClientParams)
        .subscribe((res: any) => {
