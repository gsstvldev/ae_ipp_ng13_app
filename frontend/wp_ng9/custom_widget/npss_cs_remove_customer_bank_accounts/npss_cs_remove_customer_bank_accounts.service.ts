...
@Injectable()
export class npss_cs_remove_customer_bank_accountsService {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_remove_customer_bank_accounts/', ClientParams)
            .subscribe((res: any) => {
                var event
                if(res.data.status == 'SUCCESS'){ 
                    ...
                    event = { eventId: "custom-connector", param:res.data.data , idename:"Removecustomer", internals: internals }
