...
@Injectable()
export class npss_cs_rev_rejectService {
    ...
    fn_npss_cs_rev_reject(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        ...
        if(screenInstance.wftpa_description=="s_op_rct_investigation"){
            ClientParams.rule_code = "RCT_OP_INVEST_REJECT";
        }else if(screenInstance.wftpa_description=="s_rct_investigation"){
            ClientParams.rule_code = "RCT_IP_INVEST_REJECT";
        }else if(screenInstance.wftpa_description=="s_bct_investigation"){
            ClientParams.rule_code = "BCT_IP_INVEST_REJECT";
        }
       /* if(screenInstance.wftpa_description=="op_rct_investigation"){
            ClientParams.rule_code = "RCT_OP_INVEST_REJECT";
        }else if(screenInstance.wftpa_description=="rct_investigation"){
            ClientParams.rule_code = "RCT_IP_INVEST_REJECT";
        }else if(screenInstance.wftpa_description=="bct_investigation"){
            ClientParams.rule_code = "BCT_IP_INVEST_REJECT";
        }*/
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_rev_reject/', ClientParams)
            .subscribe((res: any) => {
