...
@Injectable()
export class npss_cs_reversal_cancelService {
    ...
    fn_npss_cs_reversal_cancel(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
        ...
        ClientParams.RULE_CODE = "RCT_REV_CANCEL_REQ";
    ...
    CallUrlforGetparamvalue(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_reversal_cancel/', ClientParams)
            .subscribe((res: any) => {
