...
@Injectable()
export class npss_cs_shop_remove_bank_accountService {
    ...
    fn_npss_cs_shop_remove_bank_account(source_id, destn_id, parent_source_id, event_code, event_params, screenInstance, internals, handler_code, event_data, data_source) {
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_shop_remove_bank_account/', ClientParams)
            .subscribe((res: any) => {
                var event
