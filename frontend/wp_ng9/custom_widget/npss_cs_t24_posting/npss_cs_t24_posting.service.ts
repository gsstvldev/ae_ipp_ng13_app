...
@Injectable()
export class npss_cs_t24_postingService {
    ...
    fn_npss_cs_t24_posting(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
    ...
    this.httpHelper.HttpPost('/microsvc/npss_cs_t24_posting/', ClientParams)
        .subscribe((res: any) => {
