...
@Injectable()
export class npss_cs_update_customer_personal_dataService {
    ...
    fn_npss_cs_update_customer_personal_data(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
        let ClientParams = {}
            ...
            .subscribe((res: any) => {
                var event
                    if(res.data.status == 'SUCCESS'){ 
                       event = { eventId: "custom-connector", param:res.data.data , idename:"Updatecustomer", internals: internals }
