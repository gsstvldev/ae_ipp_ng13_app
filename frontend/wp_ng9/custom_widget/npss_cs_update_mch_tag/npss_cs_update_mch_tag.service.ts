...
@Injectable()
export class npss_cs_update_mch_tagService {
    ...
    fn_npss_cs_update_mch_tag(source_id,destn_id,parent_source_id,event_code,event_params,screenInstance,internals,handler_code,event_data,data_source){
   // console.log('hi');
   var ClientParams:any={}
   //var CtrlScope = screenInstance['customer_detail'].f_npss_customer_proxy_ui.model;
   ClientParams.npssmp_id=this.coreHelper.get_value_from_memory("MEMORY_VARIABLES", "MI_LEVEL_NPSSMP_ID")
   ClientParams.PROD_CODE = this.sessionHelper.GetVariable(SCOPE.SESSION_LEVEL, "PRODUCT_CODE");
    ...
    CallUrlWithData(ClientParams, screenInstance, internals) {
        this.httpHelper.HttpPost('/microsvc/npss_cs_update_mch_tag/', ClientParams)
            .subscribe((res: any) => {
                var event
