...
Build ID        : 35100 
Modified By     : Admin 
Modified Date   : 2024-Apr-05 7:6 AM 
...
import { s_batch_delayed_inward_paymentRoutingModule } from './s_batch_delayed_inward_payment.routing.module';
...
import { f_batch_delayed_inward_paymentComponent } from './f_batch_delayed_inward_payment/f_batch_delayed_inward_payment.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_batch_delayed_inward_paymentRoutingModule,
  ...
  declarations: [s_batch_delayed_inward_paymentComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_batch_delayed_inward_paymentComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_batch_delayed_inward_paymentModule { }
