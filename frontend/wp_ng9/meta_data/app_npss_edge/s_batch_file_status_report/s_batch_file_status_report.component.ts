...
@Component({
	selector: 's_batch_file_status_report',
	templateUrl: './s_batch_file_status_report.component.html',
	styleUrls: ['./s_batch_file_status_report.component.css'],
...
// Start of class 
export class s_batch_file_status_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_batch_file_status_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1712151079394_0"
	...
	ngOnInit() {
		...
		this.search.views = {"first":"DTT_1304_1681974988885","is_tab_mode":"N","dtt_1304_1681974988885":{"0":[{"dttv_id":"NPSS Batch File Status Report SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS BATCH FILE STS REPORT"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_batch_file_status_report_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_batch_file_status_report_srch"
