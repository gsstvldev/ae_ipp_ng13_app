...
import { s_batch_file_status_reportRoutingModule } from './s_batch_file_status_report.routing.module';
...
import { f_npss_batch_file_status_report_srchComponent } from './f_npss_batch_file_status_report_srch/f_npss_batch_file_status_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_batch_file_status_reportRoutingModule,
  ...
  declarations: [s_batch_file_status_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_batch_file_status_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_batch_file_status_reportModule { }
