...
@Component({
	selector: 's_bct_file_upload',
	templateUrl: './s_bct_file_upload.component.html',
	styleUrls: ['./s_bct_file_upload.component.css'],
	providers:[npss_c_trigger_exchange_componentService]
})
    
// Start of class 
export class s_bct_file_uploadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_bct_file_upload"
	wftpa_id : string = "WFT_NPSS_P_1304_1667481573906_0"
	...
	ngOnInit() {
		...
		this.queue.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dtt_code":"DTT_1304_1665901217208","ds_eligible":"DS_1667482898910","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS File Upload MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1667482555820","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1667482556090","date_format":false},{"column_name":"COUNT","alias_name":"","mq_id":"MQ_1667482556378","date_format":false},{"column_name":"QUEUE_DESC","alias_name":"","mq_id":"MQ_1667482556978","date_format":false}],"joins":[]},"eq_text":"SELECT PROCESS_STATUS,        STATUS,        COUNT(STATUS) COUNT,        DT_CODE,        DTT_CODE,        QUEUE_DESC,        Q_SORT_ORDER,        QS_SORT_ORDER,        PRODUCT_CODE,        FFG_CODE,        CREATE_FLAG,        UPLOAD_FLAG,        DOWNLOAD_FLAG,        GATEWAY_CODE,        ACCP_DATE_TIME   FROM (SELECT CCST.PROCESS_STATUS,                CCST.STATUS,                CCST.NPSST_ID,                CCST.CREATED_DATE,                CCST.SYSTEM_ID,                CCST.CREATED_BY,                CCST.DT_CODE,                CCST.DTT_CODE,                CCST.CREATED_BY_NAME,                QR.ROLE_ID,                QR.VPH_APP_ID,                QR.VPH_APP_CODE,                QR.QUEUE_CODE,                PQ.QUEUE_DESC,                PQ.QUEUE_CODE,                QR.SORT_ORDER AS QS_SORT_ORDER,                PQ.SORT_ORDER AS Q_SORT_ORDER,                CFP.FFG_CODE,                CFP.PRODUCT_CODE,                CFP.CREATE_FLAG,                CFP.UPLOAD_FLAG,                CFP.DOWNLOAD_FLAG,                CFP.GATEWAY_CODE,                CCST.ACCP_DATE_TIME,                PQ.VPH_APP_ID AS PQ_APP_ID,                CFP.VPH_APP_ID AS CFP_APP_ID,                CFP.SCREEN_MODULE AS CFP_SM,                CFP.SCREEN_MENU_GROUP AS CFP_SMG,                CFP.SCREEN_NAME AS CFP_SN,                QR.SCREEN_MODULE AS QR_SM,                QR.SCREEN_MENU_GROUP AS QR_SMG,                QR.SCREEN_NAME AS QR_SN           FROM NPSS_TRANSACTIONS CCST          INNER JOIN <tran_db>.CORE_Q_STATUS_ROLES QR ON CCST.STATUS =                                               QR.PROCESS_QUEUE_STATUS          INNER JOIN <tran_db>.CORE_APP_Q_SETUP PQ ON CCST.PROCESS_STATUS =                                            PQ.QUEUE_CODE          INNER JOIN <tran_db>.CORE_FFG_PRODUCT_Q CFP ON CFP.QUEUE_CODE =                                               CCST.PROCESS_STATUS) VW $WHERE  GROUP BY Q_SORT_ORDER,           PROCESS_STATUS,           QS_SORT_ORDER,           STATUS,           DT_CODE,           DTT_CODE,           QUEUE_DESC,           PRODUCT_CODE,           FFG_CODE,           CREATE_FLAG,           UPLOAD_FLAG,           DOWNLOAD_FLAG,           GATEWAY_CODE,           ACCP_DATE_TIME  ORDER BY Q_SORT_ORDER, QS_SORT_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS File Upload MQ CCD","filter":[{"filter_name":"CFP_APP_ID","binding_name":"CFP_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"CFP_SM","binding_name":"CFP_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SMG","binding_name":"CFP_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SN","binding_name":"CFP_SN","binding_value":"","source_name":"MENU_ITEM_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PQ_APP_ID","binding_name":"PQ_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PRODUCT_CODE","binding_name":"PRODUCT_CODE","binding_value":"","source_name":"ROOT_SCODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SM","binding_name":"QR_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SMG","binding_name":"QR_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SN","binding_name":"QR_SN","binding_value":"","source_name":"MENU_ITEM_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"ROLE_ID","binding_name":"ROLE_ID","binding_value":"","source_name":"APP_USER_ROLES","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"UPLOAD_FLAG","binding_name":"UPLOAD_FLAG","binding_value":"","source_name":"YES","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Queue","target_column":"QUEUE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
