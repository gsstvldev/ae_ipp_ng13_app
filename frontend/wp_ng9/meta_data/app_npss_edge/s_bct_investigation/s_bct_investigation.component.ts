...
export class s_bct_investigationComponent implements OnInit,AfterViewInit {
	...
	transaction_list__ee_for_vmd() { 
		...
		let destn_id="navigation_ui_view_message_detail"
		let parent_source_id=""
		let event_code="e_1669467653147"
