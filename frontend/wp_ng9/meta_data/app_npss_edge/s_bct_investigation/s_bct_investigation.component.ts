...
@Component({
	...
	providers:[npss_c_date_validation_for_reportService,npss_c_cond_ctrl_ui_validationService,torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_cs_maker_initiateService,npss_cs_bct_checker_approveService,npss_cs_rev_rejectService,npss_cs_maker_closeService]
})
...
export class s_bct_investigationComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private npss_c_date_validation_for_reportService:npss_c_date_validation_for_reportService,private npss_c_cond_ctrl_ui_validationService:npss_c_cond_ctrl_ui_validationService,private torus_cs_change_routingkeyService:torus_cs_change_routingkeyService,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_maker_initiateService:npss_cs_maker_initiateService,private npss_cs_bct_checker_approveService:npss_cs_bct_checker_approveService,private npss_cs_rev_rejectService:npss_cs_rev_rejectService,private npss_cs_maker_closeService:npss_cs_maker_closeService) {
