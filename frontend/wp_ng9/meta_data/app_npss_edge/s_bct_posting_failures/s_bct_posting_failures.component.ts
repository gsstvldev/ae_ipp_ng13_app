...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_bct_already_postingService,npss_cs_bct_ipir_posting_failure_retryService]
})
...
export class s_bct_posting_failuresComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_4","uicgc_6","uicgc_8","uicgc_3"]
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_bct_already_postingService:npss_cs_bct_already_postingService,private npss_cs_bct_ipir_posting_failure_retryService:npss_cs_bct_ipir_posting_failure_retryService) {
