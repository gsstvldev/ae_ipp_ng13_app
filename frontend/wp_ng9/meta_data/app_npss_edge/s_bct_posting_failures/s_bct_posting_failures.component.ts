...
export class s_bct_posting_failuresComponent implements OnInit,AfterViewInit {
	...
	uicgc_7 : string = "view_transaction_detail"
	...
	ngOnInit() {
		...
		this.view_transaction_detail.uicgc_code = "uicgc_7"
		this.view_transaction_detail.params = {"need_search":"N","need_vertical":"Y"}
		...
		this.view_transaction_detail.dynamic_param = {}
