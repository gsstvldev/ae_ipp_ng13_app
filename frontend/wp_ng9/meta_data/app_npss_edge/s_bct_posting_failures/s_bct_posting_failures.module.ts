...
@NgModule({
  ...
  declarations: [s_bct_posting_failuresComponent,p_main_layoutComponent,f_navigation_uiComponent,p_search_layoutComponent,f_npss_tran_srchComponent,p_view_detail_layoutComponent,f_back_uiComponent,p_view_history_layoutComponent,f_process_log_uiComponent,p_view_req_and_res_profileComponent,f_npss_target_request_uiComponent,f_npss_target_response_uiComponent,f_single_back_uiComponent,p_view_request_layoutComponent,p_view_response_layoutComponent,],
