...
export class s_bct_review_time_out_transactionsComponent implements OnInit,AfterViewInit {
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_for_retry_btn__info_msg_for_retry_btn","event_desc":"Info Msg for retry btn","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_retry","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
