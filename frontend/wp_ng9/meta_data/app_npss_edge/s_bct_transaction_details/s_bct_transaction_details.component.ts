...
export class s_bct_transaction_detailsComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_9","uicgc_4","uicgc_8","uicgc_11","uicgc_12","uicgc_5","uicgc_16","uicgc_15","uicgc_10","uicgc_3"]
	...
	transaction_list__selection_changed(){
		...
		this.transaction_list__e_1668585578100()
	}
	...
	history_detail__selection_changed(){
		...
		this.history_detail__e_1668585046894__request_ui()
	}
	...
	//Handler for INTERNAL event of "e 1668585046894"
	e_1668585046894__internal(parent_event_result){
		this.e_1668585046894__e_1668585057966__request_ui(parent_event_result)
	}
	...
	//Handler for SELECTION_CHANGED event of "transaction list"
	transaction_list__e_1668585578100() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"transaction_list__e_1668585578100","event_desc":"E_1668585578100","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "history detail"
	history_detail__e_1668585046894__request_ui() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"history_detail__e_1668585046894__request_ui","event_desc":"E_1668585046894","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"history_detail","raiseparam":{}}
		let handler_code="set_value_to_memory"
		let internals="e_1668585046894__e_1668585057966__request_ui,"
	...
	//Handler for INTERNAL event of "e 1668585046894"
	e_1668585046894__e_1668585057966__request_ui(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="e_1668585046894"
		let destn_id="npss_bct_request_ui_memory10"
		let parent_source_id=""
		let event_code="e_1668585057966"
		let event_params={"destn_comp_id":"request_ui","destn_ctrl_id":"memory10","caller_name":"e_1668585046894__e_1668585057966__request_ui","event_desc":"E_1668585057966","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"history_detail","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="bind_value_from_memory"
		let internals=""
