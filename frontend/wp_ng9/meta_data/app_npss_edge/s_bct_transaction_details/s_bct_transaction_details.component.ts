...
export class s_bct_transaction_detailsComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_9","uicgc_21","uicgc_18","uicgc_8","uicgc_12","uicgc_11","uicgc_4","uicgc_22","uicgc_15","uicgc_5","uicgc_19","uicgc_16","uicgc_10","uicgc_3"]
	...
	process_log_list__selection_changed(){
		...
		this.process_log_list__ssr_for_main_req()
	...
	navigation_ui_view_req_and_res__action_button_click(){
		...
		this.navigation_ui_view_req_and_res__bt_for_main_req()
	}
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__ssr_for_main_req() { 
		let Dest_Is_ctrl=true
		
		let source_id="process_log_list"
		let destn_id="main_request_ui"
		let parent_source_id=""
		let event_code="e_1673262932264"
		let event_params={"caller_name":"process_log_list__ssr_for_main_req","event_desc":"SSR for Main req","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"process_log_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	process_log_list__ssr_for_main_res() { 
		...
		let parent_source_id=""
		let event_code="e_1673262944760"
	...
	navigation_ui_view_req_and_res__bt_for_main_res() { 
		...
		let destn_id="main_response_ui"
		let parent_source_id=""
		let event_code="e_1673262878948"
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view req and res"
	navigation_ui_view_req_and_res__bt_for_main_req() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_req_and_res"
		let destn_id="main_request_ui"
		let parent_source_id=""
		let event_code="e_1673262888640"
		let event_params={"caller_name":"navigation_ui_view_req_and_res__bt_for_main_req","event_desc":"BT for Main req","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_req_and_res","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
