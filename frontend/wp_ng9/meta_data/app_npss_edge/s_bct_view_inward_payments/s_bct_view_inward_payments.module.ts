...
import { s_bct_view_inward_paymentsRoutingModule } from './s_bct_view_inward_payments.routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    s_bct_view_inward_paymentsRoutingModule,
    torus_cs_change_routingkeyModule,torus_cs_show_hideModule
  ],
  declarations: [s_bct_view_inward_paymentsComponent,p_main_layoutComponent,f_navigation_uiComponent,p_vertical_layoutComponent,f_back_uiComponent,p_search_layoutComponent,f_npss_rct_post_plog_srchComponent,p_view_history_layoutComponent,f_process_log_uiComponent,p_view_request_layoutComponent,f_npss_target_request_uiComponent,f_single_back_uiComponent,p_view_response_layoutComponent,f_npss_target_response_uiComponent,p_view_main_response_layoutComponent,f_npss_target_main_page_response_uiComponent,p_view_main_request_layoutComponent,f_npss_target_main_page_request_uiComponent,p_view_main_req_and_res_layoutComponent,p_view_req_and_res_layoutComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_bct_view_inward_paymentsModule { }
