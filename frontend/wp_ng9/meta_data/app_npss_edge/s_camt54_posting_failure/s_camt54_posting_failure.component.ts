...
// Start of class 
export class s_camt54_posting_failureComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_camt54_posting_failure"
	wftpa_id : string = "WFT_NPSS_P_1304_1721194522630_0"
	cg_code : string = "CG_1304_1721192701302"
	...
	forms : any = ["uicgc_4","uicgc_18","uicgc_16","uicgc_21","uicgc_22","uicgc_20","uicgc_17","uicgc_12","uicgc_14","uicgc_13","uicgc_15","uicgc_8","uicgc_6","uicgc_3"]
	...
	ngOnInit() {
		...
		this.queue.datasource = {"default":{"dt_1304_1672471156312":{"dtt_1304_1672471952205":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1672471952205","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721194868772","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Queue MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1721192786868","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1721192787275","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1721192787707","date_format":false}],"joins":[]},"eq_text":"select 'MBANK' as PROCESSING_SYSTEM, PROCESS_STATUS,  STATUS from  (  select   NCACN.CREATED_DATE,   NCACN.STATUS,   NCACN.PROCESS_STATUS,   NCACN.TENANT_ID,   NCACN.MODIFIED_DATE,   NCACN.MODIFIED_DATE_UTC,   NCACN.CREATED_BY,   NCACN.CREATED_BY_NAME,   NCACN.SYSTEM_ID,   QR.ROLE_ID,   QR.VPH_APP_ID as QR_APP_ID,   QR.VPH_APP_CODE,   QR.QUEUE_CODE,   QR.SCREEN_NAME as QR_SCREEN_NAME,   QR.SCREEN_MENU_GROUP as QR_MENU_GROUP,   QR.SCREEN_MODULE as QR_MODULE,   PQ.QUEUE_DESC,   PQ.QUEUE_CODE,   PQ.VPH_APP_ID as Q_APP_ID,   QR.SORT_ORDER as QS_SORT_ORDER,   PQ.SORT_ORDER as Q_SORT_ORDER,   NCACN.NOTIFICATION_ID,   NCACN.NTFN_CREATED_DATETIME,   NCACN.IBAN,   NCACN.CURRENCY,   NCACN.CR_DR_INDICATOR,   NCACN.END_TO_END_ID,   NCACN.HEADER_MSG_ID,   NCACN.LIMIT_AMOUNT,   NCACN.NTFN_STATUS,   NCACN.BOOKING_DATETIME,   NCACN.MESSAGE_DATA  from   NPSS_CAMT_ACC_CRDR_NTFN NCACN  inner join CORE_Q_STATUS_ROLES QR on   NCACN.STATUS = QR.PROCESS_QUEUE_STATUS   and NCACN.PROCESS_STATUS = QR.QUEUE_CODE  inner join CORE_APP_Q_SETUP PQ on   NCACN.PROCESS_STATUS = PQ.QUEUE_CODE  ) VW $WHERE order by  PROCESS_STATUS,  STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Queue CCD","filter":[{"filter_name":"CURRENT_MODULE_NAME","binding_name":"QR_MODULE","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"MENU_GROUP","binding_name":"QR_MENU_GROUP","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"Q_APP_ID","binding_name":"Q_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_APP_ID","binding_name":"QR_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"ROLE_ID","binding_name":"ROLE_ID","binding_value":"","source_name":"APP_USER_ROLES","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"SCREEN_NAME","binding_name":"QR_SCREEN_NAME","binding_value":"","source_name":"MENU_ITEM_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1672471952205","is_tab_mode":"N","dtt_1304_1672471952205":{"0":[{"dttv_id":"NPSS Camt54 Posting Failure SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS CAMT Acc Crdr Ntfn"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_camt54_posting_failure_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_camt54_posting_failure_srch"
		...
		this.view_transaction_list.datasource = {"default":{"dt_1304_1672471156312":{"dtt_1304_1672471952205":{"st_ds":{"default":{"uicgc_code":"UICGC_7","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1672471952205","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721197134989","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NCACN_ID","alias_name":"","mq_id":"MQ_1721192986872","date_format":false},{"column_name":"HEADER_MSG_ID","alias_name":"","mq_id":"MQ_1721192987208","date_format":false},{"column_name":"NOTIFICATION_ID","alias_name":"","mq_id":"MQ_1721192987376","date_format":false},{"column_name":"END_TO_END_ID","alias_name":"","mq_id":"MQ_1721192987808","date_format":false},{"column_name":"NTFN_CREATED_DATETIME","alias_name":"","mq_id":"MQ_1721193041288","date_format":true},{"column_name":"BOOKING_DATETIME","alias_name":"","mq_id":"MQ_1721193041608","date_format":true},{"column_name":"IBAN","alias_name":"","mq_id":"MQ_1721193041824","date_format":false},{"column_name":"CURRENCY","alias_name":"","mq_id":"MQ_1721193091231","date_format":false,"currency_format":false},{"column_name":"LIMIT_AMOUNT","alias_name":"","mq_id":"MQ_1721193091463","date_format":false},{"column_name":"CR_DR_INDICATOR","alias_name":"","mq_id":"MQ_1721193091687","date_format":false},{"column_name":"NTFN_STATUS","alias_name":"","mq_id":"MQ_1721193152550","date_format":false},{"column_name":"MESSAGE_DATA","alias_name":"","mq_id":"MQ_1721193152758","date_format":false}],"joins":[]},"eq_text":"select  NCACN_ID,  NOTIFICATION_ID,  NTFN_CREATED_DATETIME,  IBAN,  CURRENCY,  CR_DR_INDICATOR,  END_TO_END_ID,  HEADER_MSG_ID,  LIMIT_AMOUNT,  NTFN_STATUS,  BOOKING_DATETIME,  MESSAGE_DATA,  CREATED_DATE,  STATUS,  PROCESS_STATUS,  TENANT_ID,  MODIFIED_DATE,  MODIFIED_DATE_UTC,  CREATED_BY,  CREATED_BY_NAME,  SYSTEM_ID from  (  select   NCACN.NCACN_ID,   NCACN.CREATED_DATE,   NCACN.STATUS,   NCACN.PROCESS_STATUS,   NCACN.TENANT_ID,   NCACN.MODIFIED_DATE,   NCACN.MODIFIED_DATE_UTC,   NCACN.CREATED_BY,   NCACN.CREATED_BY_NAME,   NCACN.SYSTEM_ID,   NCACN.NOTIFICATION_ID,   NCACN.NTFN_CREATED_DATETIME,   NCACN.IBAN,   NCACN.CURRENCY,   NCACN.CR_DR_INDICATOR,   NCACN.END_TO_END_ID,   NCACN.HEADER_MSG_ID,   NCACN.LIMIT_AMOUNT,   NCACN.NTFN_STATUS,   NCACN.BOOKING_DATETIME,   NCACN.MESSAGE_DATA  from   NPSS_CAMT_ACC_CRDR_NTFN NCACN  order by   NCACN.NCACN_ID desc) VW $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Tran MQ","filter":[{"filter_name":"NCACN_ID","binding_name":"NCACN_ID","binding_value":"","source_name":"MI_LEVEL_LC_NCACN_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"NUMBER","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"NCACN_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Header Msg Id","target_column":"HEADER_MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Notification Id","target_column":"NOTIFICATION_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End To End Id","target_column":"END_TO_END_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ntfn Created Datetime","target_column":"NTFN_CREATED_DATETIME","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Booking Datetime","target_column":"BOOKING_DATETIME","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Iban","target_column":"IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"CURRENCY","alias_name":"","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Limit Amount","target_column":"LIMIT_AMOUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Cr Dr Indicator","target_column":"CR_DR_INDICATOR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ntfn Status","target_column":"NTFN_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Data","target_column":"MESSAGE_DATA","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.history_detail.datasource = {"default":{"dt_1304_1672471156312":{"dtt_1304_1721132786653":{"st_ds":{"default":{"uicgc_code":"UICGC_11","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1721132786653","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721200442485","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Process Log List MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1721193667934","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1721193668206","date_format":false},{"column_name":"T24_Return_Description","alias_name":"","mq_id":"MQ_1721193668398","date_format":false},{"column_name":"CBUAE_Return_Description","alias_name":"","mq_id":"MQ_1721193668582","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1721193741756","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1721193757892","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1721193758348","date_format":false}],"joins":[]},"eq_text":"select  NPSSCPL_ID,  MSG_ID,  UETR,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  CREATEDDATEMILISEC,  CREATED_DATE,  PROCESS_STATUS,  STATUS,  DT_CODE,  DTT_CODE,  TENANT_ID,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  ADDITIONAL_INFO,  PROCESS_TYPE,  REMARKS,  REVERSAL_CODE,  PROCESS_TIME,  END_TO_END_ID,  T24_Return_Description,  CBUAE_Return_Description,  REVERSAL_DESCRIPTION from  (  select   A.NPSSCPL_ID,   A.MSG_ID,   A.UETR,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.CBUAE_RETURN_CODE,   A.ADDITIONAL_INFO,   A.PROCESS_TYPE,   A.REMARKS,   A.REVERSAL_CODE,   A.PROCESS_TIME,   NCACN.END_TO_END_ID,   CONCAT(A.T24_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) as T24_Return_Description,   CONCAT(A.CBUAE_RETURN_CODE, '-', CNRC.RETURN_DESCRIPTION) as CBUAE_Return_Description,   CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   NPSS_CAMT_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'T24'   and CBUAERC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CNRC on   CNRC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CNRC.PROCESSING_SYSTEM = 'CBUAE'   and CNRC.NEED_SYNC = 'Y'  left join NPSS_CAMT_ACC_CRDR_NTFN NCACN on   NCACN.END_TO_END_ID = A.PROCESS_REF_NO  order by   A.NPSSCPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Process Log List CCD","filter":[{"filter_name":"PROCESS_REF_NO","binding_name":"PROCESS_REF_NO","binding_value":"","source_name":"MI_LEVEL_END_TO_END_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"T24 Return Description","target_column":"T24_Return_Description","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_Return_Description","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.request_ui.views = {"first":"DTT_1304_1721132786653","is_tab_mode":"N","dtt_1304_1721132786653":{"0":[{"dttv_id":"NPSS Camt54 Request UI","tab_order":0,"tab_name":"","uicgc_description":"Request UI","role_description":"default","dtt_description":"NPSS Camt Process Log"}]}}
		this.request_ui.onChangecomponent = new EventEmitter<any>()
		this.request_ui.show = true
		this.request_ui.dynamic_param = {}
		this.request_ui.f_npss_camt54_request_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.request_ui.form_name = "f_npss_camt54_request_ui"
		...
		this.response_ui.views = {"first":"DTT_1304_1721132786653","is_tab_mode":"N","dtt_1304_1721132786653":{"0":[{"dttv_id":"NPSS Camt54 Responce UI","tab_order":0,"tab_name":"","uicgc_description":"Response UI","role_description":"default","dtt_description":"NPSS Camt Process Log"}]}}
		this.response_ui.onChangecomponent = new EventEmitter<any>()
		this.response_ui.show = true
		this.response_ui.dynamic_param = {}
		this.response_ui.f_npss_camt54_responce_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.response_ui.form_name = "f_npss_camt54_responce_ui"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1672471156312":{"dtt_1304_1672471952205":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1672471952205","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721194868772","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Queue MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1721192786868","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1721192787275","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1721192787707","date_format":false}],"joins":[]},"eq_text":"select 'MBANK' as PROCESSING_SYSTEM, PROCESS_STATUS,  STATUS from  (  select   NCACN.CREATED_DATE,   NCACN.STATUS,   NCACN.PROCESS_STATUS,   NCACN.TENANT_ID,   NCACN.MODIFIED_DATE,   NCACN.MODIFIED_DATE_UTC,   NCACN.CREATED_BY,   NCACN.CREATED_BY_NAME,   NCACN.SYSTEM_ID,   QR.ROLE_ID,   QR.VPH_APP_ID as QR_APP_ID,   QR.VPH_APP_CODE,   QR.QUEUE_CODE,   QR.SCREEN_NAME as QR_SCREEN_NAME,   QR.SCREEN_MENU_GROUP as QR_MENU_GROUP,   QR.SCREEN_MODULE as QR_MODULE,   PQ.QUEUE_DESC,   PQ.QUEUE_CODE,   PQ.VPH_APP_ID as Q_APP_ID,   QR.SORT_ORDER as QS_SORT_ORDER,   PQ.SORT_ORDER as Q_SORT_ORDER,   NCACN.NOTIFICATION_ID,   NCACN.NTFN_CREATED_DATETIME,   NCACN.IBAN,   NCACN.CURRENCY,   NCACN.CR_DR_INDICATOR,   NCACN.END_TO_END_ID,   NCACN.HEADER_MSG_ID,   NCACN.LIMIT_AMOUNT,   NCACN.NTFN_STATUS,   NCACN.BOOKING_DATETIME,   NCACN.MESSAGE_DATA  from   NPSS_CAMT_ACC_CRDR_NTFN NCACN  inner join CORE_Q_STATUS_ROLES QR on   NCACN.STATUS = QR.PROCESS_QUEUE_STATUS   and NCACN.PROCESS_STATUS = QR.QUEUE_CODE  inner join CORE_APP_Q_SETUP PQ on   NCACN.PROCESS_STATUS = PQ.QUEUE_CODE  ) VW $WHERE order by  PROCESS_STATUS,  STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Queue CCD","filter":[{"filter_name":"CURRENT_MODULE_NAME","binding_name":"QR_MODULE","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"MENU_GROUP","binding_name":"QR_MENU_GROUP","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"Q_APP_ID","binding_name":"Q_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_APP_ID","binding_name":"QR_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"ROLE_ID","binding_name":"ROLE_ID","binding_value":"","source_name":"APP_USER_ROLES","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"SCREEN_NAME","binding_name":"QR_SCREEN_NAME","binding_value":"","source_name":"MENU_ITEM_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
	...
	navigation_ui_retry__cc_for_retry() { 
		...
		let data_source={}
		try {
			this.npss_amb_cs_camt54_posting_failre_retryService.fn_npss_amb_cs_camt54_posting_failre_retry(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
			console.log(e); 
 		} 
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_for_retry__info_for_retry","event_desc":"INFO for Retry","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Posting has been completed successfully","root_source_id":"navigation_ui_retry","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	navigation_ui_view_tran__brfq_for_vertical_tran_detail() { 
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1672471156312":{"dtt_1304_1672471952205":{"st_ds":{"default":{"uicgc_code":"UICGC_7","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1672471952205","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721197134989","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NCACN_ID","alias_name":"","mq_id":"MQ_1721192986872","date_format":false},{"column_name":"HEADER_MSG_ID","alias_name":"","mq_id":"MQ_1721192987208","date_format":false},{"column_name":"NOTIFICATION_ID","alias_name":"","mq_id":"MQ_1721192987376","date_format":false},{"column_name":"END_TO_END_ID","alias_name":"","mq_id":"MQ_1721192987808","date_format":false},{"column_name":"NTFN_CREATED_DATETIME","alias_name":"","mq_id":"MQ_1721193041288","date_format":true},{"column_name":"BOOKING_DATETIME","alias_name":"","mq_id":"MQ_1721193041608","date_format":true},{"column_name":"IBAN","alias_name":"","mq_id":"MQ_1721193041824","date_format":false},{"column_name":"CURRENCY","alias_name":"","mq_id":"MQ_1721193091231","date_format":false,"currency_format":false},{"column_name":"LIMIT_AMOUNT","alias_name":"","mq_id":"MQ_1721193091463","date_format":false},{"column_name":"CR_DR_INDICATOR","alias_name":"","mq_id":"MQ_1721193091687","date_format":false},{"column_name":"NTFN_STATUS","alias_name":"","mq_id":"MQ_1721193152550","date_format":false},{"column_name":"MESSAGE_DATA","alias_name":"","mq_id":"MQ_1721193152758","date_format":false}],"joins":[]},"eq_text":"select  NCACN_ID,  NOTIFICATION_ID,  NTFN_CREATED_DATETIME,  IBAN,  CURRENCY,  CR_DR_INDICATOR,  END_TO_END_ID,  HEADER_MSG_ID,  LIMIT_AMOUNT,  NTFN_STATUS,  BOOKING_DATETIME,  MESSAGE_DATA,  CREATED_DATE,  STATUS,  PROCESS_STATUS,  TENANT_ID,  MODIFIED_DATE,  MODIFIED_DATE_UTC,  CREATED_BY,  CREATED_BY_NAME,  SYSTEM_ID from  (  select   NCACN.NCACN_ID,   NCACN.CREATED_DATE,   NCACN.STATUS,   NCACN.PROCESS_STATUS,   NCACN.TENANT_ID,   NCACN.MODIFIED_DATE,   NCACN.MODIFIED_DATE_UTC,   NCACN.CREATED_BY,   NCACN.CREATED_BY_NAME,   NCACN.SYSTEM_ID,   NCACN.NOTIFICATION_ID,   NCACN.NTFN_CREATED_DATETIME,   NCACN.IBAN,   NCACN.CURRENCY,   NCACN.CR_DR_INDICATOR,   NCACN.END_TO_END_ID,   NCACN.HEADER_MSG_ID,   NCACN.LIMIT_AMOUNT,   NCACN.NTFN_STATUS,   NCACN.BOOKING_DATETIME,   NCACN.MESSAGE_DATA  from   NPSS_CAMT_ACC_CRDR_NTFN NCACN  order by   NCACN.NCACN_ID desc) VW $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Tran MQ","filter":[{"filter_name":"NCACN_ID","binding_name":"NCACN_ID","binding_value":"","source_name":"MI_LEVEL_LC_NCACN_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"NUMBER","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"NCACN_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Header Msg Id","target_column":"HEADER_MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Notification Id","target_column":"NOTIFICATION_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End To End Id","target_column":"END_TO_END_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ntfn Created Datetime","target_column":"NTFN_CREATED_DATETIME","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Booking Datetime","target_column":"BOOKING_DATETIME","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Iban","target_column":"IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"CURRENCY","alias_name":"","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Limit Amount","target_column":"LIMIT_AMOUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Cr Dr Indicator","target_column":"CR_DR_INDICATOR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ntfn Status","target_column":"NTFN_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Data","target_column":"MESSAGE_DATA","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	navigation_ui_view_process_log__brfq_for_hd() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1672471156312":{"dtt_1304_1721132786653":{"st_ds":{"default":{"uicgc_code":"UICGC_11","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1721132786653","dtt_desc":"NPSS Camt Process Log","ds_eligible":"DS_1721200442485","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Camt54 Posting Failure Process Log List MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1721193667934","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1721193668206","date_format":false},{"column_name":"T24_Return_Description","alias_name":"","mq_id":"MQ_1721193668398","date_format":false},{"column_name":"CBUAE_Return_Description","alias_name":"","mq_id":"MQ_1721193668582","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1721193741756","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1721193757892","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1721193758348","date_format":false}],"joins":[]},"eq_text":"select  NPSSCPL_ID,  MSG_ID,  UETR,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  CREATEDDATEMILISEC,  CREATED_DATE,  PROCESS_STATUS,  STATUS,  DT_CODE,  DTT_CODE,  TENANT_ID,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  ADDITIONAL_INFO,  PROCESS_TYPE,  REMARKS,  REVERSAL_CODE,  PROCESS_TIME,  END_TO_END_ID,  T24_Return_Description,  CBUAE_Return_Description,  REVERSAL_DESCRIPTION from  (  select   A.NPSSCPL_ID,   A.MSG_ID,   A.UETR,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.CBUAE_RETURN_CODE,   A.ADDITIONAL_INFO,   A.PROCESS_TYPE,   A.REMARKS,   A.REVERSAL_CODE,   A.PROCESS_TIME,   NCACN.END_TO_END_ID,   CONCAT(A.T24_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) as T24_Return_Description,   CONCAT(A.CBUAE_RETURN_CODE, '-', CNRC.RETURN_DESCRIPTION) as CBUAE_Return_Description,   CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   NPSS_CAMT_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'T24'   and CBUAERC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CNRC on   CNRC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CNRC.PROCESSING_SYSTEM = 'CBUAE'   and CNRC.NEED_SYNC = 'Y'  left join NPSS_CAMT_ACC_CRDR_NTFN NCACN on   NCACN.END_TO_END_ID = A.PROCESS_REF_NO  order by   A.NPSSCPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Camt54 Posting Failure Process Log List CCD","filter":[{"filter_name":"PROCESS_REF_NO","binding_name":"PROCESS_REF_NO","binding_value":"","source_name":"MI_LEVEL_END_TO_END_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"T24 Return Description","target_column":"T24_Return_Description","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_Return_Description","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
