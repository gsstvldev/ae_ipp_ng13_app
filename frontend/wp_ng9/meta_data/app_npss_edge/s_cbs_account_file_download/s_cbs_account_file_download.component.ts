...
@Component({
	selector: 's_cbs_account_file_download',
	templateUrl: './s_cbs_account_file_download.component.html',
	styleUrls: ['./s_cbs_account_file_download.component.css'],
	providers:[npss_c_trigger_exchange_componentService]
})
    
// Start of class 
export class s_cbs_account_file_downloadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_cbs_account_file_download"
	wftpa_id : string = "WFT_NPSS_P_1304_1667212878502_0"
