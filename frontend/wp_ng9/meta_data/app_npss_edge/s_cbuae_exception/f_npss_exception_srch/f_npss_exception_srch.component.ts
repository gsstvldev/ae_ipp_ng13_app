...
Form Name       : NPSS Exception SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_exception_srch',
  templateUrl: './f_npss_exception_srch.component.html',
  styleUrls: ['./f_npss_exception_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_exception_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_exception_srch') form;
  @ViewChild('npss_exception_srch_value_date') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.value_date.view_name = "f_npss_exception_srch"
		this.ctrl.value_date.ctrl_id = "npss_exception_srch_value_date"
		this.ctrl.npss_exception_srch_value_date = {}
		this.ctrl.npss_exception_srch_value_date.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.memory63.view_name = "f_npss_exception_srch"
		this.ctrl.memory63.ctrl_id = "npss_exception_srch_memory63"
		this.ctrl.npss_exception_srch_memory63 = {}
		this.ctrl.npss_exception_srch_memory63.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cdtr_iban.view_name = "f_npss_exception_srch"
		this.ctrl.cdtr_iban.ctrl_id = "npss_exception_srch_cdtr_iban"
		this.ctrl.npss_exception_srch_cdtr_iban = {}
		this.ctrl.npss_exception_srch_cdtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cr_acct_identification.view_name = "f_npss_exception_srch"
		this.ctrl.cr_acct_identification.ctrl_id = "npss_exception_srch_cr_acct_identification"
		this.ctrl.npss_exception_srch_cr_acct_identification = {}
		this.ctrl.npss_exception_srch_cr_acct_identification.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cdtr_acct_name
		this.ctrl.cdtr_acct_name = {}
		this.ctrl.cdtr_acct_name.id = "RN21CN5"
		...
		this.ctrl.cdtr_acct_name.view_name = "f_npss_exception_srch"
		this.ctrl.cdtr_acct_name.ctrl_id = "npss_exception_srch_cdtr_acct_name"
		this.ctrl.npss_exception_srch_cdtr_acct_name = {}
		this.ctrl.npss_exception_srch_cdtr_acct_name.onChangecomponent = new EventEmitter<any>()
	
		//Properties of dbtr_iban
		this.ctrl.dbtr_iban = {}
		this.ctrl.dbtr_iban.id = "RN21CN7"
		...
		this.ctrl.dbtr_iban.view_name = "f_npss_exception_srch"
		this.ctrl.dbtr_iban.ctrl_id = "npss_exception_srch_dbtr_iban"
		this.ctrl.npss_exception_srch_dbtr_iban = {}
		this.ctrl.npss_exception_srch_dbtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.uetr.view_name = "f_npss_exception_srch"
		this.ctrl.uetr.ctrl_id = "npss_exception_srch_uetr"
		this.ctrl.npss_exception_srch_uetr = {}
		this.ctrl.npss_exception_srch_uetr.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.clrsysref.view_name = "f_npss_exception_srch"
		this.ctrl.clrsysref.ctrl_id = "npss_exception_srch_clrsysref"
		this.ctrl.npss_exception_srch_clrsysref = {}
		this.ctrl.npss_exception_srch_clrsysref.onChangecomponent = new EventEmitter<any>()
	
		//Properties of payment_endtoend_id
		this.ctrl.payment_endtoend_id = {}
		this.ctrl.payment_endtoend_id.id = "RN41CN9"
		...
		this.ctrl.payment_endtoend_id.view_name = "f_npss_exception_srch"
		this.ctrl.payment_endtoend_id.ctrl_id = "npss_exception_srch_payment_endtoend_id"
		this.ctrl.npss_exception_srch_payment_endtoend_id = {}
		this.ctrl.npss_exception_srch_payment_endtoend_id.onChangecomponent = new EventEmitter<any>()
	
		//Properties of processing_system
		this.ctrl.processing_system = {}
		this.ctrl.processing_system.id = "RN41CN10"
		...
		this.ctrl.processing_system.view_name = "f_npss_exception_srch"
		this.ctrl.processing_system.ctrl_id = "npss_exception_srch_processing_system"
		this.ctrl.npss_exception_srch_processing_system = {}
		this.ctrl.npss_exception_srch_processing_system.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_exception_srch.model = {"VALUE_DATE":"setcurrentdate(),{}","MEMORY63":"setcurrentdate(),{}","CDTR_IBAN":"","CR_ACCT_IDENTIFICATION":"","CDTR_ACCT_NAME":"","DBTR_IBAN":"","UETR":"","CLRSYSREF":"","PAYMENT_ENDTOEND_ID":"","PROCESSING_SYSTEM":""}
		this.screen_instance[this.comp_id].f_npss_exception_srch.Meta = [{"CTLR_CODE":"CDN_DATE","DATA_TYPE":"DATETIME","TARGET_COLUMN":"VALUE_DATE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CR_ACCT_IDENTIFICATION"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_ACCT_NAME"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"DBTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CLRSYSREF"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PAYMENT_ENDTOEND_ID"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESSING_SYSTEM"}]
		this.screen_instance[this.comp_id].f_npss_exception_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_exception_srch.dtt_code = "dtt_1304_1665901217208"
		this.screen_instance[this.comp_id].f_npss_exception_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_exception_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_exception_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_exception_srch[control][property] = value;
  }
