...
export class s_cbuae_exceptionComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.transaction_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS TRN REQ RESP DTLS","ds_eligible":"DS_1679582835225","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Exception Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1679582409592","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1679582409782","date_format":false},{"column_name":"CDTR_IBAN","alias_name":"","mq_id":"MQ_1679582409966","date_format":false},{"column_name":"CDTR_ACCT_NAME","alias_name":"","mq_id":"MQ_1679582410150","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1679582447325","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1679582447525","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1679582447701","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1679582469341","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1679582469645","date_format":false}],"joins":[]},"eq_text":"select  distinct UETR,  NPSST_ID,  CREATED_DATE,DATEMI,  VALUE_DATE,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  CDTR_IBAN,  CR_ACCT_IDENTIFICATION,  CDTR_ACCT_NAME,  PAYMENT_ENDTOEND_ID,  CLRSYSREF,  DEPARTMENT_CODE,  DBTR_IBAN,  STATUS,  PROCESS_STATUS,  PROCESSING_SYSTEM,  PROCESS_NAME from  (  select   NTPL.PROCESS_NAME,   NTPL.PROCESSING_SYSTEM,   NTPL.PROCESS_STATUS,   NTPL.STATUS,   NT.TENANT_ID,   TS.TS_ID,   TS.LOCKED_BY,   TS.LOCKED_BY_NAME,   NT.CREATED_DATE,   TO_CHAR(NT.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') AS DATEMI,   NT.VALUE_DATE,   NT.INTRBK_STTLM_AMNT,   NT.CDTR_IBAN,   NT.CR_ACCT_IDENTIFICATION,   NT.CDTR_ACCT_NAME,   NT.PAYMENT_ENDTOEND_ID,   NT.UETR,   NT.CLRSYSREF,   NT.DBTR_IBAN,   NT.DEPARTMENT_CODE,   NT.INTRBK_STTLM_CUR,   NT.NPSST_ID  from   NPSS_TRN_PROCESS_LOG NTPL  inner join NPSS_TRANSACTIONS NT on   NTPL.UETR = NT.UETR  left join TRANSACTION_SET TS on   NT.NPSST_ID = TS.TRN_ID   and NT.DTT_CODE = TS.DTT_CODE) VW  $WHERE order by  CREATED_DATE,  NPSST_ID,  VALUE_DATE,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  CDTR_IBAN,  CR_ACCT_IDENTIFICATION,  CDTR_ACCT_NAME,  PAYMENT_ENDTOEND_ID,  CLRSYSREF,  DEPARTMENT_CODE,  DBTR_IBAN,  STATUS,  PROCESS_STATUS,  PROCESSING_SYSTEM,  PROCESS_NAME"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Exception Transaction CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_NAME","binding_name":"PROCESS_NAME","binding_value":"","source_name":"MI_LEVEL_PROCESS_NAME","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date and time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CR IBAN","target_column":"CDTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Cr Account Name","target_column":"CDTR_ACCT_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DR IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E REF ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing Sys Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"NPSS Exception SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_exception_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_exception_srch"
	...
	transaction_list__ee_for_retry_btn() { 
		...
		let event_params={"caller_name":"transaction_list__ee_for_retry_btn","event_desc":"EE for Retry Btn","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
