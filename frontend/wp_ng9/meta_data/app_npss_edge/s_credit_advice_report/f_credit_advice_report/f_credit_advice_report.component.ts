...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory151 = {}
		this.ctrl.memory151.id = "RN01CN4"
		...
		this.ctrl.memory151.view_name = "f_credit_advice_report"
		this.ctrl.memory151.ctrl_id = "credit_advice_report_memory151"
		this.ctrl.credit_advice_report_memory151 = {}
		this.ctrl.credit_advice_report_memory151.onChangecomponent = new EventEmitter<any>()
		...
		this.screen_instance[this.comp_id].f_credit_advice_report.model = {"UETR":"","MEMORY151":"","PAYMENT_ENDTOEND_ID":""}
