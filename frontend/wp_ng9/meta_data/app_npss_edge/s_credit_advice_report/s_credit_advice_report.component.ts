...
export class s_credit_advice_reportComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712205983694","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Credit Advice Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"Creditor_Name","alias_name":"","mq_id":"MQ_1712153225867","date_format":false},{"column_name":"account_number","alias_name":"","mq_id":"MQ_1712153226049","date_format":false},{"column_name":"Creditor_Account","alias_name":"","mq_id":"MQ_1712153226225","date_format":false},{"column_name":"Debtor_Name","alias_name":"","mq_id":"MQ_1712153226385","date_format":false},{"column_name":"dr_sort_code","alias_name":"","mq_id":"MQ_1712153226553","date_format":false},{"column_name":"Debtor_Account","alias_name":"","mq_id":"MQ_1712153226698","date_format":false},{"column_name":"T24_FT_REFERENCE_NUMBER","alias_name":"","mq_id":"MQ_1712153227505","date_format":false},{"column_name":"TRANSACTION_AMOUNT_RANGE","alias_name":"","mq_id":"MQ_1712153227747","date_format":false},{"column_name":"category_purpose_prty","alias_name":"","mq_id":"MQ_1712153355050","date_format":false},{"column_name":"created_date","alias_name":"","mq_id":"MQ_1712153355233","date_format":false},{"column_name":"status","alias_name":"","mq_id":"MQ_1712153355425","date_format":false},{"column_name":"E2E_REF_NUMBER","alias_name":"","mq_id":"MQ_1712153387666","date_format":false},{"column_name":"IPP_REFERENCE_NUMBER","alias_name":"","mq_id":"MQ_1712153387881","date_format":false},{"column_name":"tran_ref_id","alias_name":"","mq_id":"MQ_1712153525578","date_format":false},{"column_name":"clrsysref","alias_name":"","mq_id":"MQ_1712153526009","date_format":false},{"column_name":"remittance_info","alias_name":"","mq_id":"MQ_1712153526378","date_format":false}],"joins":[]},"eq_text":"select  distinct uetr,  Creditor_Name,  Creditor_Account,  Debtor_Name,  dr_sort_code,  Debtor_Account,  TRANSACTION_AMOUNT_RANGE,  category_purpose_prty,  created_date,  CREATEDDATE,  SENDER_BANK,  remittance_info,  tran_ref_id,  clrsysref,  status,  tenant_id,  process_type,  DEPARTMENT_NAME,  payment_endtoend_id,  T24_FT_REFERENCE_NUMBER,  account_number,  coalesce(Split_part(report_icon_data,  'base64',  2),  '') report_icon_data from  (  select   NT.cdtr_acct_name as Creditor_Name,   NT.cdtr_iban as Creditor_Account,   NT.dbtr_acct_name as Debtor_Name,   nt.dr_sort_code,   NT.dbtr_iban as Debtor_Account,   NT.intrbk_sttlm_amnt as TRANSACTION_AMOUNT_RANGE,   nt.department_code as DEPARTMENT_NAME,   nt.category_purpose_prty,   cmb.bank_name as SENDER_BANK,   hdr_created_date as CREATEDDATE,   nt.CREATED_DATE,   nt.tenant_id,   nt.uetr,   nt.tran_ref_id,   nt.clrsysref,   nt.remittance_info,   nt.process_type,   L.report_icon_data,   ntpl.process_name,   NT.process_status,   NT.status,   NT.value_date,   ntpl.T24_RETURN_CODE,   NT.payment_endtoend_id,   ntpl.process_ref_no as T24_FT_REFERENCE_NUMBER,   cnca.account_number  from   npss_transactions nt  inner join npss_trn_process_log ntpl on   nt.UETR = ntpl.UETR  left join core_nc_cbs_accounts cnca on   nt.cdtr_iban = cnca.alternate_account_id  left join CORE_RPT_LOGO_SETUP L on   L.tenant_id = NT.TENANT_ID  left join core_member_banks cmb on   cmb.bic_code = nt.cr_sort_code   and cmb.NEED_SYNC = 'Y'  where   ntpl.process_name = 'Posting Enquiry'   and ntpl.status = 'IP_RCT_POSTING_SUCCESS'   or ntpl.process_name = 'Inward Credit Posting'   and ntpl.status = 'IP_BCT_POSTING_SUCCESS'   or ntpl.process_name = 'Inward Credit Posting'   and ntpl.status = 'IP_RCT_POSTING_SUCCESS' )v where  process_type = 'IP' $AND"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Credit Advice Report","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Beneficiary Customer Name","target_column":"Creditor_Name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Beneficiary Account","target_column":"account_number","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Beneficiary Customer IBAN","target_column":"Creditor_Account","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Customer Name","target_column":"Debtor_Name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Bank Code","target_column":"dr_sort_code","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Customer IBAN","target_column":"Debtor_Account","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Ref","target_column":"T24_FT_REFERENCE_NUMBER","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount (AED)","target_column":"TRANSACTION_AMOUNT_RANGE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Code","target_column":"category_purpose_prty","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Received Time","target_column":"created_date","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"status","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End-to-End ID","target_column":"E2E_REF_NUMBER","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"IPP_REFERENCE_NUMBER","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Reference","target_column":"tran_ref_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing Reference","target_column":"clrsysref","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Other Reference","target_column":"remittance_info","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
