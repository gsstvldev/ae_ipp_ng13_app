...
// Start of class 
export class s_credit_transfer_inwardComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_credit_transfer_inward"
	wftpa_id : string = "WFT_NPSS_P_1304_1665739115817_0"
	cg_code : string = "CG_1408_1665648073132"
	...
	uicgc_26 : string = "ip_payment_form_action"
	uicgc_27 : string = "ip_cust__transactions"
	uicgc_28 : string = "ip_transactions"
	key_events : any = {}
	...
	forms : any = ["uicgc_25","uicgc_6","uicgc_24","uicgc_26","uicgc_19","uicgc_10","uicgc_17","uicgc_9","uicgc_13","uicgc_1","uicgc_2"]
	...
	ip_payment_form_action_response : any = {}
	ip_payment_form_action_verify_recipient_iban : any = {}
	...
	ngOnInit() {
		...
		this.transactions.datasource = {"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_3","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739598656","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Transaction MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734579675","date_format":false},{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734580049","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734580241","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734580409","date_format":false},{"column_name":"LASTACCESSEDDATE","alias_name":"","mq_id":"MQ_1665734580577","date_format":true},{"column_name":"LASTACCESSEDDATEUTC","alias_name":"","mq_id":"MQ_1665734619329","date_format":true},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1665753803205","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1665753803476","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1665753803701","date_format":false},{"column_name":"PRODUCT","alias_name":"","mq_id":"MQ_1665753803868","date_format":false},{"column_name":"SUB_PRODUCT","alias_name":"","mq_id":"MQ_1665753846147","date_format":false},{"column_name":"TRANSACTION_CODE","alias_name":"","mq_id":"MQ_1665753846307","date_format":false},{"column_name":"PROCESSDATA","alias_name":"","mq_id":"MQ_1665753846491","date_format":false},{"column_name":"PRNT_MSG","alias_name":"","mq_id":"MQ_1665755731729","date_format":false}],"joins":[]},"eq_text":"SELECT     A.TRNID,     A.MSGID,     A.PROCESSTYPE,     A.PROCESS,     A.CHANNEL_ID,     A.CHANNEL_REFNO,     A.CHANNEL_USERID,     A.PRODUCT ,     A.SUB_PRODUCT ,     A.TRANSACTION_CODE ,     A.LASTACCESSEDDATE,     A.LASTACCESSEDDATEUTC,     A.PROCESSDATA,     CASE         WHEN (A.PARENT_MSGID = '0'         OR A.PARENT_MSGID IS NULL) THEN 'NO_PRNTMSG'         ELSE 'PRNTMSG'     END AS PRNT_MSG FROM     NPSS_EDGE_PT_TRANSACTIONS A     $WHERE ORDER BY     TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Transaction MQ CCD","filter":[{"filter_name":"PRNT_MSG","binding_name":"PRNT_MSG","binding_value":"","source_name":"NO_PRNTMSG","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"INWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message ID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Accessed Date","target_column":"LASTACCESSEDDATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true}]}}}}}}
...
// "View" Button of "Transactions" component 
		...
		this.payment_tabview.params = [{"desc":"Inward","profile_code":"BTL_1408_1664944837564","id":1634879677420}]
		...
		this.payment_tabview.tab_profiles = {"p_history_layout":{"header":"Inward","profile_code":"BTL_1408_1664944837564","index":0,"selected":false,"disabled":false,"show":true,"invalid":false,"dynamic_class":"","app_user_role":[],"component":["uicgc_26","uicgc_6"],"showclass":"show"}}
...
// "Edit" Button of "Failure Transactions" component 
		...
		this.transaction_detail.datasource = {"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739554224","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Transaction Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734694647","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734694831","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734695143","date_format":false},{"column_name":"LASTACCESSEDDATE","alias_name":"","mq_id":"MQ_1665734695343","date_format":true},{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665755862289","date_format":false},{"column_name":"PRNT_MSG","alias_name":"","mq_id":"MQ_1665755892185","date_format":false}],"joins":[]},"eq_text":"SELECT     A.TRNID,     A.MSGID,     A.PROCESSTYPE,     A.PROCESS,     A.CHANNEL_ID,     A.CHANNEL_REFNO,     A.CHANNEL_USERID,     A.PRODUCT ,     A.SUB_PRODUCT ,     A.TRANSACTION_CODE ,     A.LASTACCESSEDDATE,     A.LASTACCESSEDDATEUTC,     A.PROCESSDATA,     CASE         WHEN (A.PARENT_MSGID = '0'         OR A.PARENT_MSGID IS NULL) THEN 'NO_PRNTMSG'         ELSE 'PRNTMSG'     END AS PRNT_MSG FROM     NPSS_EDGE_PT_TRANSACTIONS A     $WHERE ORDER BY     TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Transaction Detail CCD","filter":[{"filter_name":"MSGID","binding_name":"MSGID","binding_value":"","source_name":"MI_LEVEL_MesageID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TRNID","binding_name":"TRNID","binding_value":"","source_name":"MI_LEVEL_TRNID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"NUMBER","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Accessed Date","target_column":"LASTACCESSEDDATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true}]}}}}}}
		...
		this.pacs008_ui.views = {"first":"DTT_1304_1665385772257","is_tab_mode":"N","dtt_1304_1665385772257":{"0":[{"dttv_id":"NPSS IP Pacs008","tab_order":0,"tab_name":"","uicgc_description":"Pacs008 UI","role_description":"default","dtt_description":"NPSS Cust Transactions"}]}}
		this.pacs008_ui.onChangecomponent = new EventEmitter<any>()
		this.pacs008_ui.show = true
		this.pacs008_ui.dynamic_param = {}
		this.pacs008_ui.f_npss_ip_pacs008 = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.pacs008_ui.form_name = "f_npss_ip_pacs008"
		...
		this.pacs002_ui.views = {"first":"DTT_1304_1665385772257","is_tab_mode":"N","dtt_1304_1665385772257":{"0":[{"dttv_id":"NPSS IP Pacs002","tab_order":0,"tab_name":"","uicgc_description":"Pacs002 UI","role_description":"default","dtt_description":"NPSS Cust Transactions"}]}}
		this.pacs002_ui.onChangecomponent = new EventEmitter<any>()
		this.pacs002_ui.show = true
		this.pacs002_ui.dynamic_param = {}
		this.pacs002_ui.f_npss_ip_pacs002 = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.pacs002_ui.form_name = "f_npss_ip_pacs002"
		...
		// Component level properties - "IP Payment Form Action" 
		this.ip_payment_form_action.uictrl_code = "dynamic_ui"
		this.ip_payment_form_action.uicgc_desc = "IP Payment Form Action"
		this.ip_payment_form_action.uicgc_code = "uicgc_26"
		this.ip_payment_form_action.params = {}
		this.ip_payment_form_action.datasource = {}
		this.ip_payment_form_action.context_menu = []
		this.ip_payment_form_action.views = {}
		this.ip_payment_form_action.onChangecomponent = new EventEmitter<any>()
		this.ip_payment_form_action.show = true
		this.ip_payment_form_action.dynamic_param = {}
		this.ip_payment_form_action.f_ip_payment_form_action = {"show":true}
		this.ip_payment_form_action.current_view = "f_ip_payment_form_action"
		
		// "Response" Button of "IP Payment Form Action" component
		this.ip_payment_form_action_response.label_name = "Response"
		this.ip_payment_form_action_response.show = true
		this.ip_payment_form_action_response.disabled = false
		this.ip_payment_form_action_response.params = {"icon_only":false,"uicgcc_style":""}
		this.ip_payment_form_action_response.dynamic_param = {}
		this.ip_payment_form_action_response.role = []
		this.ip_payment_form_action_response.action = ""
		
		// "Verify Recipient IBAN" Button of "IP Payment Form Action" component
		this.ip_payment_form_action_verify_recipient_iban.label_name = "Verify Recipient IBAN"
		this.ip_payment_form_action_verify_recipient_iban.show = true
		this.ip_payment_form_action_verify_recipient_iban.disabled = false
		this.ip_payment_form_action_verify_recipient_iban.params = {"icon_only":false,"uicgcc_style":""}
		this.ip_payment_form_action_verify_recipient_iban.dynamic_param = {}
		this.ip_payment_form_action_verify_recipient_iban.role = []
		this.ip_payment_form_action_verify_recipient_iban.action = ""
	
		// Component level properties - "IP Cust  transactions" 
		this.ip_cust__transactions.uictrl_code = "datatable"
		this.ip_cust__transactions.uicgc_desc = "IP Cust  transactions"
		this.ip_cust__transactions.uicgc_code = "uicgc_27"
		this.ip_cust__transactions.params = {}
		this.ip_cust__transactions.datasource = {"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739477567","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Cust details MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSCT_ID","alias_name":"","mq_id":"MQ_1665735123774","date_format":false},{"column_name":"CDTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735123972","date_format":false},{"column_name":"DBTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735124204","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1665735124604","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSCT_ID,        CDTR_PHONE_NO,        DBTR_PHONE_NO,        INTRBK_STTLM_AMNT,        DTT_CODE,        TENANT_ID   FROM NPSS_CUST_TRANSACTIONS $WHERE  ORDER BY NPSSCT_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Cust details MQ ccd","filter":[],"databinding":[{"header":"NPSSCT_ID","target_column":"NPSSCT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CDTR_PHONE_NO","target_column":"CDTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DBTR_PHONE_NO","target_column":"DBTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"INTRBK_STTLM_AMNT","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		this.ip_cust__transactions.context_menu = []
		this.ip_cust__transactions.views = {}
		this.ip_cust__transactions.onChangecomponent = new EventEmitter<any>()
		this.ip_cust__transactions.show = true
		this.ip_cust__transactions.dynamic_param = {}
	
		// Component level properties - "IP Transactions" 
		this.ip_transactions.uictrl_code = "datatable"
		this.ip_transactions.uicgc_desc = "IP Transactions"
		this.ip_transactions.uicgc_code = "uicgc_28"
		this.ip_transactions.params = {}
		this.ip_transactions.datasource = {"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_28","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739516354","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Message id MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734775349","date_format":false},{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734775491","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734801325","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734801547","date_format":false}],"joins":[]},"eq_text":"SELECT A.TRNID, A.MSGID, A.PROCESSTYPE, A.PROCESS, A.LASTACCESSEDDATE   FROM TRANSACTIONS A $WHERE  ORDER BY TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Message id MQ ccd","filter":[{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"OUTWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"TRNID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"MSGID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESSTYPE","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESS","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		this.ip_transactions.context_menu = []
		this.ip_transactions.views = {}
		this.ip_transactions.onChangecomponent = new EventEmitter<any>()
		this.ip_transactions.show = true
		this.ip_transactions.dynamic_param = {}
	}
	// Methods
	ngAfterViewInit() {
		this.page_load();
	...
	page_load(){
		...
		this.page_load__he_for_ip_cust_transactions()
		this.page_load__brfq_for_ip_transaction()
		this.page_load__brfq_for_ip_cust_transaction()
		this.page_load__he_for_ip_transaction()
		this.page_load__he_for_ip_response()
	}
	...
	//Handler for INTERNAL event of "brfq for ip transaction"
	brfq_for_ip_transaction__internal(){
		this.brfq_for_ip_transaction__sfr_for_ip_transaction()
	}

	//Handler for INTERNAL event of "brfq for ip cust transaction"
	brfq_for_ip_cust_transaction__internal(){
		this.brfq_for_ip_cust_transaction__sfr__for_ip_cust_transaction()
	}
	...
	cc_for_tran_insert__internal(parent_event_result){
		this.cc_for_tran_insert__cc_for_call_save_api(parent_event_result)
	}

	//Handler for INTERNAL event of "cc for call save api"
	cc_for_call_save_api__internal(parent_event_result){
		this.cc_for_call_save_api__info_for_cnfm(parent_event_result)
	}
	...
	history_search_view_pacs008__action_button_click(){
		...
		this.history_search_view_pacs008__bvm_for_ip_pacs008__pacs008_ui()
	}
	...
	history_search_view_pacs002__action_button_click(){
		...
		this.history_search_view_pacs002__bvm_for_pacs__pacs002_ui()
	}

	//Handler for SELECTION_CHANGED event of "ip cust  transactions"
	ip_cust__transactions__selection_changed(){
		this.ip_cust__transactions__svm_for_ip_cust_transaction()
	}

	//Handler for SELECTION_CHANGED event of "ip transactions"
	ip_transactions__selection_changed(){
		this.ip_transactions__svm_for_ip_transaction()
	}

	//Handler for ACTION_BUTTON_CLICK event of "ip payment form action verify recipient iban"
	ip_payment_form_action_verify_recipient_iban__action_button_click(){
		this.ip_payment_form_action_verify_recipient_iban__cc_for_ip_vri()
	}

	//Handler for INTERNAL event of "cc for ip vri"
	cc_for_ip_vri__internal(parent_event_result){
		this.cc_for_ip_vri__im_for_ip_vri(parent_event_result)
	}

	//Handler for ACTION_BUTTON_CLICK event of "ip payment form action response"
	ip_payment_form_action_response__action_button_click(){
		this.ip_payment_form_action_response__cc_for_ip_responce()
	}
	...
	im_for_ip_responce__internal(parent_event_result){
		this.im_for_ip_responce__rs_for_ip_responce(parent_event_result)
	}
	...
	//Handler for DPSINIT event of "page_load"
	page_load__he_for_ip_cust_transactions() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="ip_cust__transactions"
		let parent_source_id=""
		let event_code="e_1665656039325"
		let event_params={"caller_name":"page_load__he_for_ip_cust_transactions","event_desc":"HE for ip cust transactions","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739477567","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Cust details MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSCT_ID","alias_name":"","mq_id":"MQ_1665735123774","date_format":false},{"column_name":"CDTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735123972","date_format":false},{"column_name":"DBTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735124204","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1665735124604","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSCT_ID,        CDTR_PHONE_NO,        DBTR_PHONE_NO,        INTRBK_STTLM_AMNT,        DTT_CODE,        TENANT_ID   FROM NPSS_CUST_TRANSACTIONS $WHERE  ORDER BY NPSSCT_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Cust details MQ ccd","filter":[],"databinding":[{"header":"NPSSCT_ID","target_column":"NPSSCT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CDTR_PHONE_NO","target_column":"CDTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DBTR_PHONE_NO","target_column":"DBTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"INTRBK_STTLM_AMNT","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.hide_element(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for DPSINIT event of "page_load"
	page_load__brfq_for_ip_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="ip_transactions"
		let parent_source_id=""
		let event_code="e_1665657055017"
		let event_params={"caller_name":"page_load__brfq_for_ip_transaction","event_desc":"BRFQ for ip transaction","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals="brfq_for_ip_transaction__sfr_for_ip_transaction,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_28","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739516354","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Message id MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734775349","date_format":false},{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734775491","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734801325","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734801547","date_format":false}],"joins":[]},"eq_text":"SELECT A.TRNID, A.MSGID, A.PROCESSTYPE, A.PROCESS, A.LASTACCESSEDDATE   FROM TRANSACTIONS A $WHERE  ORDER BY TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Message id MQ ccd","filter":[{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"OUTWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"TRNID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"MSGID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESSTYPE","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESS","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for DPSINIT event of "page_load"
	page_load__brfq_for_ip_cust_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="ip_cust__transactions"
		let parent_source_id=""
		let event_code="e_1665657082062"
		let event_params={"caller_name":"page_load__brfq_for_ip_cust_transaction","event_desc":"BRFQ for ip cust transaction","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals="brfq_for_ip_cust_transaction__sfr__for_ip_cust_transaction,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739477567","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Cust details MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSCT_ID","alias_name":"","mq_id":"MQ_1665735123774","date_format":false},{"column_name":"CDTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735123972","date_format":false},{"column_name":"DBTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735124204","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1665735124604","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSCT_ID,        CDTR_PHONE_NO,        DBTR_PHONE_NO,        INTRBK_STTLM_AMNT,        DTT_CODE,        TENANT_ID   FROM NPSS_CUST_TRANSACTIONS $WHERE  ORDER BY NPSSCT_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Cust details MQ ccd","filter":[],"databinding":[{"header":"NPSSCT_ID","target_column":"NPSSCT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CDTR_PHONE_NO","target_column":"CDTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DBTR_PHONE_NO","target_column":"DBTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"INTRBK_STTLM_AMNT","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for DPSINIT event of "page_load"
	page_load__he_for_ip_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="ip_transactions"
		let parent_source_id=""
		let event_code="e_1665660749132"
		let event_params={"caller_name":"page_load__he_for_ip_transaction","event_desc":"HE for ip transaction","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_28","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739516354","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Message id MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734775349","date_format":false},{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734775491","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734801325","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734801547","date_format":false}],"joins":[]},"eq_text":"SELECT A.TRNID, A.MSGID, A.PROCESSTYPE, A.PROCESS, A.LASTACCESSEDDATE   FROM TRANSACTIONS A $WHERE  ORDER BY TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Message id MQ ccd","filter":[{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"OUTWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"TRNID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"MSGID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESSTYPE","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESS","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	//Handler for DPSINIT event of "page_load"
	page_load__he_for_ip_response() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="ip_payment_form_action_response"
		let parent_source_id=""
		let event_code="e_1665669742690"
		let event_params={"caller_name":"page_load__he_for_ip_response","event_desc":"HE for IP response","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "brfq for ip transaction"
	brfq_for_ip_transaction__sfr_for_ip_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="brfq_for_ip_transaction"
		let destn_id="ip_transactions"
		let parent_source_id="page_load"
		let event_code="e_1665657773959"
		let event_params={"caller_name":"brfq_for_ip_transaction__sfr_for_ip_transaction","event_desc":"SFR for ip transaction","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{}}
	...
	//Handler for INTERNAL event of "brfq for ip cust transaction"
	brfq_for_ip_cust_transaction__sfr__for_ip_cust_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="brfq_for_ip_cust_transaction"
		let destn_id="ip_cust__transactions"
		let parent_source_id="page_load"
		let event_code="e_1665660018741"
		let event_params={"caller_name":"brfq_for_ip_cust_transaction__sfr__for_ip_cust_transaction","event_desc":"SFR  for ip cust transaction","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{}}
		let handler_code="select_first_record"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739477567","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Cust details MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSCT_ID","alias_name":"","mq_id":"MQ_1665735123774","date_format":false},{"column_name":"CDTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735123972","date_format":false},{"column_name":"DBTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735124204","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1665735124604","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSCT_ID,        CDTR_PHONE_NO,        DBTR_PHONE_NO,        INTRBK_STTLM_AMNT,        DTT_CODE,        TENANT_ID   FROM NPSS_CUST_TRANSACTIONS $WHERE  ORDER BY NPSSCT_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Cust details MQ ccd","filter":[],"databinding":[{"header":"NPSSCT_ID","target_column":"NPSSCT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CDTR_PHONE_NO","target_column":"CDTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DBTR_PHONE_NO","target_column":"DBTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"INTRBK_STTLM_AMNT","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	history_search_search__cui_for_search() { 
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739554224","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Transaction Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734694647","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734694831","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734695143","date_format":false},{"column_name":"LASTACCESSEDDATE","alias_name":"","mq_id":"MQ_1665734695343","date_format":true},{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665755862289","date_format":false},{"column_name":"PRNT_MSG","alias_name":"","mq_id":"MQ_1665755892185","date_format":false}],"joins":[]},"eq_text":"SELECT     A.TRNID,     A.MSGID,     A.PROCESSTYPE,     A.PROCESS,     A.CHANNEL_ID,     A.CHANNEL_REFNO,     A.CHANNEL_USERID,     A.PRODUCT ,     A.SUB_PRODUCT ,     A.TRANSACTION_CODE ,     A.LASTACCESSEDDATE,     A.LASTACCESSEDDATEUTC,     A.PROCESSDATA,     CASE         WHEN (A.PARENT_MSGID = '0'         OR A.PARENT_MSGID IS NULL) THEN 'NO_PRNTMSG'         ELSE 'PRNTMSG'     END AS PRNT_MSG FROM     NPSS_EDGE_PT_TRANSACTIONS A     $WHERE ORDER BY     TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Transaction Detail CCD","filter":[{"filter_name":"MSGID","binding_name":"MSGID","binding_value":"","source_name":"MI_LEVEL_MesageID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TRNID","binding_name":"TRNID","binding_value":"","source_name":"MI_LEVEL_TRNID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"NUMBER","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Accessed Date","target_column":"LASTACCESSEDDATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true}]}}}}}}
		try {
			this.handler.clear_ui(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_3","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739598656","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Transaction MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734579675","date_format":false},{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734580049","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734580241","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734580409","date_format":false},{"column_name":"LASTACCESSEDDATE","alias_name":"","mq_id":"MQ_1665734580577","date_format":true},{"column_name":"LASTACCESSEDDATEUTC","alias_name":"","mq_id":"MQ_1665734619329","date_format":true},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1665753803205","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1665753803476","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1665753803701","date_format":false},{"column_name":"PRODUCT","alias_name":"","mq_id":"MQ_1665753803868","date_format":false},{"column_name":"SUB_PRODUCT","alias_name":"","mq_id":"MQ_1665753846147","date_format":false},{"column_name":"TRANSACTION_CODE","alias_name":"","mq_id":"MQ_1665753846307","date_format":false},{"column_name":"PROCESSDATA","alias_name":"","mq_id":"MQ_1665753846491","date_format":false},{"column_name":"PRNT_MSG","alias_name":"","mq_id":"MQ_1665755731729","date_format":false}],"joins":[]},"eq_text":"SELECT     A.TRNID,     A.MSGID,     A.PROCESSTYPE,     A.PROCESS,     A.CHANNEL_ID,     A.CHANNEL_REFNO,     A.CHANNEL_USERID,     A.PRODUCT ,     A.SUB_PRODUCT ,     A.TRANSACTION_CODE ,     A.LASTACCESSEDDATE,     A.LASTACCESSEDDATEUTC,     A.PROCESSDATA,     CASE         WHEN (A.PARENT_MSGID = '0'         OR A.PARENT_MSGID IS NULL) THEN 'NO_PRNTMSG'         ELSE 'PRNTMSG'     END AS PRNT_MSG FROM     NPSS_EDGE_PT_TRANSACTIONS A     $WHERE ORDER BY     TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Transaction MQ CCD","filter":[{"filter_name":"PRNT_MSG","binding_name":"PRNT_MSG","binding_value":"","source_name":"NO_PRNTMSG","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"INWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message ID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Accessed Date","target_column":"LASTACCESSEDDATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	payment_form_action_confirm__cc_for_tran_insert() { 
		...
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1665661143895"
	...
	//Handler for INTERNAL event of "cc for tran insert"
	cc_for_tran_insert__cc_for_call_save_api(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1665661159948"
		let event_params={"caller_name":"cc_for_tran_insert__cc_for_call_save_api","event_desc":"CC for Call Save API","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"payment_form_action_confirm","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
		let internals="cc_for_call_save_api__info_for_cnfm,"
		let event_data={}
		let data_source={}
		try {
			this.torus_cs_show_hideService.fn_torus_cs_show_hide(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "cc for call save api"
	cc_for_call_save_api__info_for_cnfm(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1665661196800"
		let event_params={"caller_name":"cc_for_call_save_api__info_for_cnfm","event_desc":"info for cnfm","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Customer Credit Transfer IPP API (P2P – Money Send) has been Initiated.","root_source_id":"payment_form_action_confirm","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	transactions__svm_for_view_transactionlist() { 
		...
		let event_data={"transactions":{"e_1647260212080":{"dts":{"dt_1304_1665384453253":{"dtts":{"":{"uicgc_code":"UICGC_3","event_code":"E_1647260212080","dt_code":"DT_1304_1665384453253","dtt_code":"","dt_desc":"Customer DTG","dtt_desc":"NPSS Cust Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"PROCESSDATA","level":"MI_LEVEL","name":"MI_LEVEL_IP_Pacs008_PROCESSDATA","setd3name":"PROCESSDATA"},{"type":"LOCAL","column_name":"TRNID","level":"MI_LEVEL","name":"MI_LEVEL_TRNID","setd3name":"TRNID"},{"type":"LOCAL","column_name":"MSGID","level":"MI_LEVEL","name":"MI_LEVEL_MesageID","setd3name":"MSGID"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_3","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739598656","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Transaction MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734579675","date_format":false},{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734580049","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734580241","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734580409","date_format":false},{"column_name":"LASTACCESSEDDATE","alias_name":"","mq_id":"MQ_1665734580577","date_format":true},{"column_name":"LASTACCESSEDDATEUTC","alias_name":"","mq_id":"MQ_1665734619329","date_format":true},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1665753803205","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1665753803476","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1665753803701","date_format":false},{"column_name":"PRODUCT","alias_name":"","mq_id":"MQ_1665753803868","date_format":false},{"column_name":"SUB_PRODUCT","alias_name":"","mq_id":"MQ_1665753846147","date_format":false},{"column_name":"TRANSACTION_CODE","alias_name":"","mq_id":"MQ_1665753846307","date_format":false},{"column_name":"PROCESSDATA","alias_name":"","mq_id":"MQ_1665753846491","date_format":false},{"column_name":"PRNT_MSG","alias_name":"","mq_id":"MQ_1665755731729","date_format":false}],"joins":[]},"eq_text":"SELECT     A.TRNID,     A.MSGID,     A.PROCESSTYPE,     A.PROCESS,     A.CHANNEL_ID,     A.CHANNEL_REFNO,     A.CHANNEL_USERID,     A.PRODUCT ,     A.SUB_PRODUCT ,     A.TRANSACTION_CODE ,     A.LASTACCESSEDDATE,     A.LASTACCESSEDDATEUTC,     A.PROCESSDATA,     CASE         WHEN (A.PARENT_MSGID = '0'         OR A.PARENT_MSGID IS NULL) THEN 'NO_PRNTMSG'         ELSE 'PRNTMSG'     END AS PRNT_MSG FROM     NPSS_EDGE_PT_TRANSACTIONS A     $WHERE ORDER BY     TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Transaction MQ CCD","filter":[{"filter_name":"PRNT_MSG","binding_name":"PRNT_MSG","binding_value":"","source_name":"NO_PRNTMSG","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"INWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message ID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Accessed Date","target_column":"LASTACCESSEDDATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
	...
	//Handler for ACTION_BUTTON_CLICK event of "history search view pacs008"
	history_search_view_pacs008__bvm_for_ip_pacs008__pacs008_ui() { 
		let Dest_Is_ctrl=true
		
		let source_id="history_search_view_pacs008"
		let destn_id="npss_ip_pacs008_memory64"
		let parent_source_id=""
		let event_code="e_1665741290199"
		let event_params={"destn_comp_id":"pacs008_ui","destn_ctrl_id":"memory64","caller_name":"history_search_view_pacs008__bvm_for_ip_pacs008__pacs008_ui","event_desc":"BVM for ip Pacs008","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"history_search_view_pacs008","raiseparam":{}}
		let handler_code="bind_value_from_memory"
		let internals=""
		let event_data={"control":{"e_1665741290199":{"dts":{"dt_1304_1665384453253":{"dtts":{"dtt_1304_1665385772257":{"uicgc_code":"CONTROL","event_code":"E_1665741290199","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[],"get_from_memory":[{"level":"MI_LEVEL","value":"MI_LEVEL_IP_Pacs008_PROCESSDATA","tb_data":"","column":"","d3name":""}],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={}
		try {
	...
	//Handler for ACTION_BUTTON_CLICK event of "history search view pacs002"
	history_search_view_pacs002__bvm_for_pacs__pacs002_ui() { 
		let Dest_Is_ctrl=true
		
		let source_id="history_search_view_pacs002"
		let destn_id="npss_ip_pacs002_memory65"
		let parent_source_id=""
		let event_code="e_1665741512771"
		let event_params={"destn_comp_id":"pacs002_ui","destn_ctrl_id":"memory65","caller_name":"history_search_view_pacs002__bvm_for_pacs__pacs002_ui","event_desc":"BVM for Pacs","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"history_search_view_pacs002","raiseparam":{}}
		let handler_code="bind_value_from_memory"
		let internals=""
		let event_data={"control":{"e_1665741512771":{"dts":{"dt_1304_1665384453253":{"dtts":{"dtt_1304_1665385772257":{"uicgc_code":"CONTROL","event_code":"E_1665741512771","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[],"get_from_memory":[{"level":"MI_LEVEL","value":"MI_LEVEL_IP_Pacs002_PROCESSDATA","tb_data":"","column":"","d3name":""}],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={}
		try {
			this.handler.bind_value_from_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
	...
	//Handler for SELECTION_CHANGED event of "ip cust  transactions"
	ip_cust__transactions__svm_for_ip_cust_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="ip_cust__transactions"
		let destn_id="ip_cust__transactions"
		let parent_source_id=""
		let event_code="e_1665657895841"
		let event_params={"caller_name":"ip_cust__transactions__svm_for_ip_cust_transaction","event_desc":"SVM FOR IP cust transaction","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"ip_cust__transactions","raiseparam":{}}
		let handler_code="set_value_to_memory"
		let internals=""
		let event_data={"ip_cust__transactions":{"e_1665657895841":{"dts":{"dt_1304_1665384453253":{"dtts":{"":{"uicgc_code":"UICGC_27","event_code":"E_1665657895841","dt_code":"DT_1304_1665384453253","dtt_code":"","dt_desc":"Customer DTG","dtt_desc":"NPSS Cust Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"CDTR_PHONE_NO","level":"MI_LEVEL","name":"MI_LEVEL_CR_PHN_NO","setd3name":"CDTR_PHONE_NO"},{"type":"LOCAL","column_name":"DBTR_PHONE_NO","level":"MI_LEVEL","name":"MI_LEVEL_DR_PHN_NO","setd3name":"DBTR_PHONE_NO"},{"type":"LOCAL","column_name":"INTRBK_STTLM_AMNT","level":"MI_LEVEL","name":"MI_LEVEL_AMOUNT","setd3name":"INTRBK_STTLM_AMNT"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739477567","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Cust details MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSCT_ID","alias_name":"","mq_id":"MQ_1665735123774","date_format":false},{"column_name":"CDTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735123972","date_format":false},{"column_name":"DBTR_PHONE_NO","alias_name":"","mq_id":"MQ_1665735124204","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1665735124604","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSCT_ID,        CDTR_PHONE_NO,        DBTR_PHONE_NO,        INTRBK_STTLM_AMNT,        DTT_CODE,        TENANT_ID   FROM NPSS_CUST_TRANSACTIONS $WHERE  ORDER BY NPSSCT_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Cust details MQ ccd","filter":[],"databinding":[{"header":"NPSSCT_ID","target_column":"NPSSCT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CDTR_PHONE_NO","target_column":"CDTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"DBTR_PHONE_NO","target_column":"DBTR_PHONE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"INTRBK_STTLM_AMNT","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
	...
	//Handler for SELECTION_CHANGED event of "ip transactions"
	ip_transactions__svm_for_ip_transaction() { 
		let Dest_Is_ctrl=true
		
		let source_id="ip_transactions"
		let destn_id="ip_transactions"
		let parent_source_id=""
		let event_code="e_1665657952144"
		let event_params={"caller_name":"ip_transactions__svm_for_ip_transaction","event_desc":"SVM for ip transaction","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"ip_transactions","raiseparam":{}}
		let handler_code="set_value_to_memory"
		let internals=""
		let event_data={"ip_transactions":{"e_1665657952144":{"dts":{"dt_1304_1665384453253":{"dtts":{"":{"uicgc_code":"UICGC_28","event_code":"E_1665657952144","dt_code":"DT_1304_1665384453253","dtt_code":"","dt_desc":"Customer DTG","dtt_desc":"NPSS Cust Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"MSGID","level":"MI_LEVEL","name":"MI_LEVEL_MSG_ID","setd3name":"MSGID"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_28","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dt_desc":"Customer DTG","dtt_code":"DTT_1304_1665385772257","dtt_desc":"NPSS Cust Transactions","ds_eligible":"DS_1665739516354","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Message id MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"MSGID","alias_name":"","mq_id":"MQ_1665734775349","date_format":false},{"column_name":"TRNID","alias_name":"","mq_id":"MQ_1665734775491","date_format":false},{"column_name":"PROCESSTYPE","alias_name":"","mq_id":"MQ_1665734801325","date_format":false},{"column_name":"PROCESS","alias_name":"","mq_id":"MQ_1665734801547","date_format":false}],"joins":[]},"eq_text":"SELECT A.TRNID, A.MSGID, A.PROCESSTYPE, A.PROCESS, A.LASTACCESSEDDATE   FROM TRANSACTIONS A $WHERE  ORDER BY TRNID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Message id MQ ccd","filter":[{"filter_name":"PROCESSTYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"OUTWARD","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"TRNID","target_column":"TRNID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"MSGID","target_column":"MSGID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESSTYPE","target_column":"PROCESSTYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"PROCESS","target_column":"PROCESS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
	...
	//Handler for ACTION_BUTTON_CLICK event of "ip payment form action verify recipient iban"
	ip_payment_form_action_verify_recipient_iban__cc_for_ip_vri() { 
		let Dest_Is_ctrl=true
		
		let source_id="ip_payment_form_action_verify_recipient_iban"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1665663527684"
		let event_params={"caller_name":"ip_payment_form_action_verify_recipient_iban__cc_for_ip_vri","event_desc":"CC for IP VRI","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"ip_payment_form_action_verify_recipient_iban","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals="cc_for_ip_vri__im_for_ip_vri,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for ip vri"
	cc_for_ip_vri__im_for_ip_vri(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="cc_for_ip_vri"
		let destn_id=""
		let parent_source_id="ip_payment_form_action_verify_recipient_iban"
		let event_code="e_1665663559747"
		let event_params={"caller_name":"cc_for_ip_vri__im_for_ip_vri","event_desc":"IM for IP VRI","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"ip_payment_form_action_verify_recipient_iban","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "ip payment form action response"
	ip_payment_form_action_response__cc_for_ip_responce() { 
		let Dest_Is_ctrl=true
		
		let source_id="ip_payment_form_action_response"
		let destn_id=""
		let parent_source_id=""
	...
	//Handler for INTERNAL event of "im for ip responce"
	im_for_ip_responce__rs_for_ip_responce(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
