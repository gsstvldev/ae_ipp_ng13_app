...
--------------------------------------------------------------------------- */
    ...
    @Component({
      selector: 't_payment_tabview',
      templateUrl: './t_payment_tabview.component.html',
      styleUrls: ['./t_payment_tabview.component.css'],
      providers:[ComponenthelperService]
    })

    // Start of class 
    export class t_payment_tabviewComponent implements OnInit {
