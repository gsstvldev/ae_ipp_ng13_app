...
Form Name       : OP Pacs002--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_op_pacs002',
  templateUrl: './f_op_pacs002.component.html',
  styleUrls: ['./f_op_pacs002.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_op_pacs002Component implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_op_pacs002') form;
  @ViewChild('op_pacs002_memory65') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory65.desc = "Pacs002"
		this.ctrl.memory65.visible = false
		this.ctrl.memory65.label_name = "Pacs002"
		...
		this.ctrl.memory65.view_name = "f_op_pacs002"
		this.ctrl.memory65.ctrl_id = "op_pacs002_memory65"
		this.ctrl.op_pacs002_memory65 = {}
		this.ctrl.op_pacs002_memory65.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_op_pacs002.model = {"MEMORY65":""}
		this.screen_instance[this.comp_id].f_op_pacs002.Meta = []
		this.screen_instance[this.comp_id].f_op_pacs002.dt_code = "dt_1304_1665384453253"
		this.screen_instance[this.comp_id].f_op_pacs002.dtt_code = "dtt_1304_1665385772257"
		this.screen_instance[this.comp_id].f_op_pacs002.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_op_pacs002[control]==undefined) {
      this.screen_instance[this.comp_id].f_op_pacs002[control] = {}
    }
    this.screen_instance[this.comp_id].f_op_pacs002[control][property] = value;
  }
