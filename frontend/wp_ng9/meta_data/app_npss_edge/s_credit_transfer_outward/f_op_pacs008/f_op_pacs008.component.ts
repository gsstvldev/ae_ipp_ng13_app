...
Form Name       : OP Pacs008--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_op_pacs008',
  templateUrl: './f_op_pacs008.component.html',
  styleUrls: ['./f_op_pacs008.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_op_pacs008Component implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_op_pacs008') form;
  @ViewChild('op_pacs008_memory64') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory64.desc = "Pacs008"
		this.ctrl.memory64.visible = false
		this.ctrl.memory64.label_name = "Pacs008"
		...
		this.ctrl.memory64.view_name = "f_op_pacs008"
		this.ctrl.memory64.ctrl_id = "op_pacs008_memory64"
		this.ctrl.op_pacs008_memory64 = {}
		this.ctrl.op_pacs008_memory64.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_op_pacs008.model = {"MEMORY64":""}
		this.screen_instance[this.comp_id].f_op_pacs008.Meta = []
		this.screen_instance[this.comp_id].f_op_pacs008.dt_code = "dt_1304_1665384453253"
		this.screen_instance[this.comp_id].f_op_pacs008.dtt_code = "dtt_1304_1665385772257"
		this.screen_instance[this.comp_id].f_op_pacs008.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_op_pacs008[control]==undefined) {
      this.screen_instance[this.comp_id].f_op_pacs008[control] = {}
    }
    this.screen_instance[this.comp_id].f_op_pacs008[control][property] = value;
  }
