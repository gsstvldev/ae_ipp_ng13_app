...
export class s_customer_enrolmentComponent implements OnInit,AfterViewInit {
	...
	components : any = []
	current_profile : string = "p_customer_edit_layout"
	...
	forms : any = ["uicgc_10","uicgc_9","uicgc_8","uicgc_7","uicgc_4","uicgc_3","uicgc_2"]
...
// "Modify Personal Data" Button of "Customer Details" component 
		...
		this.bank_account_details.datasource = {}
...
// "View" Button of "Bank Account Details" component 
		...
		this.corporate_accounts_ui.views = {}
		...
		this.corporate_accounts_ui.f_corporate_accounts_ui = {"show":true}
		this.corporate_accounts_ui.current_view = "f_corporate_accounts_ui"
