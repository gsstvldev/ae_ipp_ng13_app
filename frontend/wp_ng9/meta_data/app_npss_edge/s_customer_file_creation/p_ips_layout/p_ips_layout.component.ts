...
Profile Name    : IPS Layout--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input } from '@angular/core';
@Component({
  selector: 'p_ips_layout',
  templateUrl: './p_ips_layout.component.html',
  styleUrls: ['./p_ips_layout.component.css']
})

// Start of class 
export class p_ips_layoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.screen_instance['p_ips_layout'] = {};
    this.screen_instance['p_ips_layout']['checkHeader']=(component)=>{
