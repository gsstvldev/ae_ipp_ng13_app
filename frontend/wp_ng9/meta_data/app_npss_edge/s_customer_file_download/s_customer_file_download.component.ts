...
@Component({
	selector: 's_customer_file_download',
	templateUrl: './s_customer_file_download.component.html',
	styleUrls: ['./s_customer_file_download.component.css'],
	providers:[npss_c_trigger_exchange_componentService]
})
    
// Start of class 
export class s_customer_file_downloadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_customer_file_download"
	wftpa_id : string = "WFT_NPSS_P_1304_1665401380530_0"
	...
	ngOnInit() {
		...
		this.queue.datasource = {"e_1591706487697":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"E_1591706487697","dt_code":"DT_1304_1665384453253","dtt_code":"DTT_1304_1665385772257","ds_eligible":"DS_1666165369938","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Cus EXG FD MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"QUEUE_DESC","alias_name":"","mq_id":"MQ_1666165252248","date_format":false}],"joins":[]},"eq_text":"SELECT  QUEUE_DESC,  PROCESSQUEUECODE,  PRODUCT_CODE,  FFG_CODE,  CREATE_FLAG,  UPLOAD_FLAG,  DOWNLOAD_FLAG,  GATEWAY_CODE FROM  (  SELECT   PQ.QUEUE_DESC,   PQ.QUEUE_CODE AS PROCESSQUEUECODE,   CFP.PRODUCT_CODE,   CFP.FFG_CODE,   CFP.CREATE_FLAG,   CFP.UPLOAD_FLAG,   CFP.DOWNLOAD_FLAG,   CFP.GATEWAY_CODE,   CFP.SCREEN_MODULE AS CFP_SM,   CFP.SCREEN_MENU_GROUP AS CFP_SMG,   CFP.SCREEN_NAME AS CFP_SN,   CFP.VPH_APP_ID AS CFP_APP_ID   FROM   CORE_APP_Q_SETUP PQ   INNER JOIN CORE_FFG_PRODUCT_Q CFP ON   CFP.QUEUE_CODE = PQ.QUEUE_CODE) VW $WHERE GROUP BY  QUEUE_DESC,  PROCESSQUEUECODE,  PRODUCT_CODE,  FFG_CODE,  CREATE_FLAG,  UPLOAD_FLAG,  DOWNLOAD_FLAG,  GATEWAY_CODE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS CBS ACC EXG FD CCD","filter":[{"filter_name":"App ID","binding_name":"CFP_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"DOWNLOAD_FLAG","binding_name":"DOWNLOAD_FLAG","binding_value":"","source_name":"YES","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Queue","target_column":"QUEUE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}},"default":{"dt_1304_1665384453253":{"dtt_1304_1665384533560":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dtt_code":"DTT_1304_1665384533560","ds_eligible":"DS_1665403215740","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Exchange File Download upload MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"queue_desc","alias_name":"","mq_id":"MQ_1665396927201","date_format":false},{"column_name":"ffg_code","alias_name":"","mq_id":"MQ_1665396927791","date_format":false},{"column_name":"create_flag","alias_name":"","mq_id":"MQ_1665396928047","date_format":false},{"column_name":"upload_flag","alias_name":"","mq_id":"MQ_1665396928279","date_format":false},{"column_name":"download_flag","alias_name":"","mq_id":"MQ_1665396963886","date_format":false},{"column_name":"gateway_code","alias_name":"","mq_id":"MQ_1665396973222","date_format":false},{"column_name":"processqueuecode","alias_name":"","mq_id":"MQ_1665397000902","date_format":false}],"joins":[]},"eq_text":"SELECT queue_desc,        queue_code,        product_code,        ffg_code,        create_flag,        upload_flag,        download_flag,        gateway_code   FROM (SELECT qr.role_id,                qr.queue_code,                pq.queue_desc,                pq.queue_code as processqueuecode,                CFP.product_code,                CFP.ffg_code,                CFP.create_flag,                CFP.upload_flag,                CFP.download_flag,                CFP.gateway_code,                CFP.screen_module as CFP_SM,                CFP.screen_menu_group as CFP_SMG,                CFP.screen_name as CFP_SN,                qr.Screen_Module as QR_SM,                qr.screen_menu_group as QR_SMG,                qr.screen_name as QR_SN           FROM core_q_status_roles qr          INNER JOIN core_app_q_setup pq ON pq.queue_code = qr.queue_code          INNER JOIN core_ffg_product_q CFP ON CFP.queue_code = qr.queue_code) vw $WHERE  GROUP BY queue_desc,           queue_code,           product_code,           ffg_code,           create_flag,           upload_flag,           download_flag,           gateway_code"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Exchange File Download upload MQ CCD","filter":[{"filter_name":"CFP_SM","binding_name":"CFP_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SMG","binding_name":"CFP_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SN","binding_name":"CFP_SN","binding_value":"","source_name":"MENU_ITEM","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"Download Flag","binding_name":"DOWNLOAD_FLAG","binding_value":"","source_name":"YES","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PRODUCT_CODE","binding_name":"PRODUCT_CODE","binding_value":"","source_name":"ROOT_SCODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SM","binding_name":"QR_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SMG","binding_name":"QR_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SN","binding_name":"QR_SN","binding_value":"","source_name":"MENU_ITEM","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"ROLE_ID","binding_name":"ROLE_ID","binding_value":"","source_name":"APP_USER_ROLES","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Queue","target_column":"queue_desc","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	page_load__brfq_for_queue() { 
		...
		let internals=""
		let event_data={}
		let data_source={"e_1591706487697":{"dt_1304_1665384453253":{"dtt_1304_1665385772257":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"E_1591706487697","dt_code":"DT_1304_1665384453253","dtt_code":"DTT_1304_1665385772257","ds_eligible":"DS_1666165369938","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Cus EXG FD MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"QUEUE_DESC","alias_name":"","mq_id":"MQ_1666165252248","date_format":false}],"joins":[]},"eq_text":"SELECT  QUEUE_DESC,  PROCESSQUEUECODE,  PRODUCT_CODE,  FFG_CODE,  CREATE_FLAG,  UPLOAD_FLAG,  DOWNLOAD_FLAG,  GATEWAY_CODE FROM  (  SELECT   PQ.QUEUE_DESC,   PQ.QUEUE_CODE AS PROCESSQUEUECODE,   CFP.PRODUCT_CODE,   CFP.FFG_CODE,   CFP.CREATE_FLAG,   CFP.UPLOAD_FLAG,   CFP.DOWNLOAD_FLAG,   CFP.GATEWAY_CODE,   CFP.SCREEN_MODULE AS CFP_SM,   CFP.SCREEN_MENU_GROUP AS CFP_SMG,   CFP.SCREEN_NAME AS CFP_SN,   CFP.VPH_APP_ID AS CFP_APP_ID   FROM   CORE_APP_Q_SETUP PQ   INNER JOIN CORE_FFG_PRODUCT_Q CFP ON   CFP.QUEUE_CODE = PQ.QUEUE_CODE) VW $WHERE GROUP BY  QUEUE_DESC,  PROCESSQUEUECODE,  PRODUCT_CODE,  FFG_CODE,  CREATE_FLAG,  UPLOAD_FLAG,  DOWNLOAD_FLAG,  GATEWAY_CODE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS CBS ACC EXG FD CCD","filter":[{"filter_name":"App ID","binding_name":"CFP_APP_ID","binding_value":"","source_name":"APP_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"DOWNLOAD_FLAG","binding_name":"DOWNLOAD_FLAG","binding_value":"","source_name":"YES","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Queue","target_column":"QUEUE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}},"default":{"dt_1304_1665384453253":{"dtt_1304_1665384533560":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665384453253","dtt_code":"DTT_1304_1665384533560","ds_eligible":"DS_1665403215740","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Exchange File Download upload MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"queue_desc","alias_name":"","mq_id":"MQ_1665396927201","date_format":false},{"column_name":"ffg_code","alias_name":"","mq_id":"MQ_1665396927791","date_format":false},{"column_name":"create_flag","alias_name":"","mq_id":"MQ_1665396928047","date_format":false},{"column_name":"upload_flag","alias_name":"","mq_id":"MQ_1665396928279","date_format":false},{"column_name":"download_flag","alias_name":"","mq_id":"MQ_1665396963886","date_format":false},{"column_name":"gateway_code","alias_name":"","mq_id":"MQ_1665396973222","date_format":false},{"column_name":"processqueuecode","alias_name":"","mq_id":"MQ_1665397000902","date_format":false}],"joins":[]},"eq_text":"SELECT queue_desc,        queue_code,        product_code,        ffg_code,        create_flag,        upload_flag,        download_flag,        gateway_code   FROM (SELECT qr.role_id,                qr.queue_code,                pq.queue_desc,                pq.queue_code as processqueuecode,                CFP.product_code,                CFP.ffg_code,                CFP.create_flag,                CFP.upload_flag,                CFP.download_flag,                CFP.gateway_code,                CFP.screen_module as CFP_SM,                CFP.screen_menu_group as CFP_SMG,                CFP.screen_name as CFP_SN,                qr.Screen_Module as QR_SM,                qr.screen_menu_group as QR_SMG,                qr.screen_name as QR_SN           FROM core_q_status_roles qr          INNER JOIN core_app_q_setup pq ON pq.queue_code = qr.queue_code          INNER JOIN core_ffg_product_q CFP ON CFP.queue_code = qr.queue_code) vw $WHERE  GROUP BY queue_desc,           queue_code,           product_code,           ffg_code,           create_flag,           upload_flag,           download_flag,           gateway_code"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Exchange File Download upload MQ CCD","filter":[{"filter_name":"CFP_SM","binding_name":"CFP_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SMG","binding_name":"CFP_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"CFP_SN","binding_name":"CFP_SN","binding_value":"","source_name":"MENU_ITEM","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"Download Flag","binding_name":"DOWNLOAD_FLAG","binding_value":"","source_name":"YES","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PRODUCT_CODE","binding_name":"PRODUCT_CODE","binding_value":"","source_name":"ROOT_SCODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SM","binding_name":"QR_SM","binding_value":"","source_name":"CURRENT_MODULE_NAME","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SMG","binding_name":"QR_SMG","binding_value":"","source_name":"MENU_GROUP","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"QR_SN","binding_name":"QR_SN","binding_value":"","source_name":"MENU_ITEM","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"ROLE_ID","binding_name":"ROLE_ID","binding_value":"","source_name":"APP_USER_ROLES","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Queue","target_column":"queue_desc","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
