...
@Component({
	selector: 's_customer_file_upload',
	templateUrl: './s_customer_file_upload.component.html',
	styleUrls: ['./s_customer_file_upload.component.css'],
	providers:[npss_c_trigger_exchange_componentService]
})
    
// Start of class 
export class s_customer_file_uploadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_customer_file_upload"
	wftpa_id : string = "WFT_NPSS_P_1304_1665401671917_0"
