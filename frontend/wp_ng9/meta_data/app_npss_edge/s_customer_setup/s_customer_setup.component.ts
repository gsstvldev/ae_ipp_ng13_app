...
export class s_customer_setupComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_search__action_button_click(){
		...
		this.navigation_ui_search__e_1671000510784()
	}
	...
	search_clear__action_button_click(){
		this.search_clear__e_1670997498922()
	}
	...
	svm_for_queue__internal(parent_event_result){
		this.svm_for_queue__e_1671004537813(parent_event_result)
	}

	//Handler for INTERNAL event of "e 1671004537813"
	e_1671004537813__internal(parent_event_result){
		this.e_1671004537813__ssp_for_queue_to_cl(parent_event_result)
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui search"
	navigation_ui_search__e_1671000510784() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_search"
		let destn_id="customers"
		let parent_source_id=""
		let event_code="e_1671000510784"
		let event_params={"caller_name":"navigation_ui_search__e_1671000510784","event_desc":"E_1671000510784","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_search","raiseparam":{"need_reset_key_column":"N"}}
	...
	search_clear__e_1670997498922() { 
		...
		let event_params={"caller_name":"search_clear__e_1670997498922","event_desc":"E_1670997498922","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"search_clear","raiseparam":{"need_reset_key_column":"N"}}
		let handler_code="clear_ui"
		let internals=""
		let event_data={}
		let data_source={}
	...
	queue__svm_for_queue() { 
		...
		let handler_code="set_value_to_memory"
		let internals="svm_for_queue__e_1671004537813,"
	...
	//Handler for INTERNAL event of "svm for queue"
	svm_for_queue__e_1671004537813(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"svm_for_queue__e_1671004537813","event_desc":"E_1671004537813","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"queue","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
		let internals="e_1671004537813__ssp_for_queue_to_cl,"
		let event_data={}
		let data_source={}
		try {
			this.torus_cs_show_hideService.fn_torus_cs_show_hide(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "e 1671004537813"
	e_1671004537813__ssp_for_queue_to_cl(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="e_1671004537813"
		let destn_id="search"
		let parent_source_id="svm_for_queue"
		let event_code="e_1671004558050"
		let event_params={"caller_name":"e_1671004537813__ssp_for_queue_to_cl","event_desc":"SSP for Queue to CL","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"queue","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id="customers"
		let parent_source_id="e_1671004537813"
