...
Form Name       : NPSS Daily Liq Pos UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_daily_liq_pos_ui',
  templateUrl: './f_npss_daily_liq_pos_ui.component.html',
  styleUrls: ['./f_npss_daily_liq_pos_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_daily_liq_pos_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_daily_liq_pos_ui') form;
  @ViewChild('npss_daily_liq_pos_ui_process_name') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.process_name.id = "9adfa21c-9dcf-4ea3-ba7f-65608530f2b6_1678172636953"
		...
		this.ctrl.process_name.default_value = "dailyLiquidityPosition"
		...
		this.ctrl.process_name.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.process_name.ctrl_id = "npss_daily_liq_pos_ui_process_name"
		this.ctrl.npss_daily_liq_pos_ui_process_name = {}
		this.ctrl.npss_daily_liq_pos_ui_process_name.onChangecomponent = new EventEmitter<any>()
	
		//Properties of currency
		this.ctrl.currency = {}
		this.ctrl.currency.id = "add895b1-69f5-42bc-8bfb-08928ae89143_1678172636953"
		...
		this.ctrl.currency.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.currency.ctrl_id = "npss_daily_liq_pos_ui_currency"
		this.ctrl.npss_daily_liq_pos_ui_currency = {}
		this.ctrl.npss_daily_liq_pos_ui_currency.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.currency = {}
	
		//Properties of accountholderbic
		this.ctrl.accountholderbic = {}
		this.ctrl.accountholderbic.id = "3e874593-ff29-4c78-9c2c-1d37ab99ebc1_1678172636954"
		...
		this.ctrl.accountholderbic.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.accountholderbic.ctrl_id = "npss_daily_liq_pos_ui_accountholderbic"
		this.ctrl.npss_daily_liq_pos_ui_accountholderbic = {}
		this.ctrl.npss_daily_liq_pos_ui_accountholderbic.onChangecomponent = new EventEmitter<any>()
	
		//Properties of accountnumber
		this.ctrl.accountnumber = {}
		this.ctrl.accountnumber.id = "b75615bd-37c8-45da-8999-2f99f6b999a0_1678172636954"
		...
		this.ctrl.accountnumber.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.accountnumber.ctrl_id = "npss_daily_liq_pos_ui_accountnumber"
		this.ctrl.npss_daily_liq_pos_ui_accountnumber = {}
		this.ctrl.npss_daily_liq_pos_ui_accountnumber.onChangecomponent = new EventEmitter<any>()
	
		//Properties of datetime
		this.ctrl.datetime = {}
		this.ctrl.datetime.id = "f2bb8b74-137c-41c1-b2c8-b39fdf6be138_1678172636954"
		...
		this.ctrl.datetime.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.datetime.ctrl_id = "npss_daily_liq_pos_ui_datetime"
		this.ctrl.npss_daily_liq_pos_ui_datetime = {}
		this.ctrl.npss_daily_liq_pos_ui_datetime.onChangecomponent = new EventEmitter<any>()
	
		//Properties of datasource
		this.ctrl.datasource = {}
		this.ctrl.datasource.id = "1d397560-0175-418e-8c37-c49464b984b3_1678172636954"
		...
		this.ctrl.datasource.view_name = "f_npss_daily_liq_pos_ui"
		this.ctrl.datasource.ctrl_id = "npss_daily_liq_pos_ui_datasource"
		this.ctrl.npss_daily_liq_pos_ui_datasource = {}
		this.ctrl.npss_daily_liq_pos_ui_datasource.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.model = {"PROCESS_NAME":"dailyLiquidityPosition","CURRENCY":"","ACCOUNTHOLDERBIC":"","ACCOUNTNUMBER":"","DATETIME":"setcurrentdate(),{}","DATASOURCE":"PRODUCTION"}
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_NAME"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"CURRENCY"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTHOLDERBIC"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTNUMBER"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"DATETIME"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"DATASOURCE"}]
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.dtt_code = "dtt_1304_1670589169341"
		this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_daily_liq_pos_ui[control][property] = value;
  }
