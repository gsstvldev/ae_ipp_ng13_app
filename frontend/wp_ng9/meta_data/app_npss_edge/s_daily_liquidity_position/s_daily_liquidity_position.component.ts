...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_daily_liquidity_positionService,npss_cs_daily_liquidity_position_responseService]
})
...
export class s_daily_liquidity_positionComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_daily_liquidity_positionService:npss_cs_daily_liquidity_positionService,private npss_cs_daily_liquidity_position_responseService:npss_cs_daily_liquidity_position_responseService) {
