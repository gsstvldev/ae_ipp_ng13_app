...
export class s_debit_advice_reportComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712206281173","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Debit Advice Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"Debtor_Name","alias_name":"","mq_id":"MQ_1712152844067","date_format":false},{"column_name":"account_number","alias_name":"","mq_id":"MQ_1712152844435","date_format":false},{"column_name":"Debtor_Account","alias_name":"","mq_id":"MQ_1712152844587","date_format":false},{"column_name":"Creditor_Name","alias_name":"","mq_id":"MQ_1712152844762","date_format":false},{"column_name":"Creditor_Account","alias_name":"","mq_id":"MQ_1712152845090","date_format":false},{"column_name":"dr_sort_code","alias_name":"","mq_id":"MQ_1712152927666","date_format":false},{"column_name":"T24_FT_REFERENCE_NUMBER","alias_name":"","mq_id":"MQ_1712152927995","date_format":false},{"column_name":"TRANSACTION_AMOUNT_RANGE","alias_name":"","mq_id":"MQ_1712152928146","date_format":false},{"column_name":"categorypurpose","alias_name":"","mq_id":"MQ_1712152928386","date_format":false},{"column_name":"CREATEDDATE","alias_name":"","mq_id":"MQ_1712152984923","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1712152985291","date_format":false},{"column_name":"payment_endtoend_id","alias_name":"","mq_id":"MQ_1712153010796","date_format":false},{"column_name":"uetr","alias_name":"","mq_id":"MQ_1712153011155","date_format":false},{"column_name":"tran_ref_id","alias_name":"","mq_id":"MQ_1712153011378","date_format":false},{"column_name":"clrsysref","alias_name":"","mq_id":"MQ_1712153049339","date_format":false},{"column_name":"otherreference","alias_name":"","mq_id":"MQ_1712153049674","date_format":false}],"joins":[]},"eq_text":"select  distinct uetr,  Debtor_Name,  Debtor_Account,  Creditor_Name,  Creditor_Account,  dr_sort_code,  TRANSACTION_AMOUNT_RANGE,  categorypurpose,  created_date,  CREATEDDATE,  payment_endtoend_id,  SOURCE_CHANNEL,  tran_ref_id,  STATUS,  otherreference,  clrsysref,  BENEFICIARY_BANK,  End_to_End_ID,  T24_FT_REFERENCE_NUMBER,  process_type,  API_Success_Failure,  Purpose_codes,  channel_refno,  account_number,  coalesce(Split_part(report_icon_data,  'base64',  2),  '') report_icon_data from  (  select   NT.dbtr_acct_name as Debtor_Name,   nt.dbtr_iban as Debtor_Account,   nt.cdtr_acct_name,   NT.cdtr_iban as Creditor_Account,   nt.dr_sort_code,   nt.intrbk_sttlm_amnt as TRANSACTION_AMOUNT_RANGE,   case    when nt.process_group = 'MANUAL' then nt.instruction_id    when nt.process_group = 'P2P' then nt.remittance_info    when nt.process_group = 'P2B' then nt.remittance_info    when nt.process_group = 'IBAN' then nt.remittance_info    when nt.process_group = 'BCT' then nt.remittance_info    when nt.process_group = 'RCT' then nt.remittance_info   end as otherreference,   case    when nt.process_group = 'MANUAL' then nt.category_purpose_prty    when nt.process_group = 'IBAN' then nt.category_purpose    when nt.process_group = 'P2P' then nt.category_purpose    when nt.process_group = 'P2B' then nt.category_purpose    when nt.process_group = 'BCT' then nt.category_purpose    when nt.process_group = 'RCT' then nt.category_purpose   end as categorypurpose,   NT.cdtr_acct_name as Creditor_Name,   NT.channel_refno,   NT.channel_id as SOURCE_CHANNEL,   hdr_created_date as CREATEDDATE,   nt.CREATED_DATE,   nt.payment_endtoend_id,   nt.uetr,   nt.tran_ref_id,   nt.clrsysref,   nt.TENANT_ID,   cmb.bank_name as BENEFICIARY_BANK,   nt.process_type,   nt.PAYMENT_ENDTOEND_ID as End_to_End_ID,   L.report_icon_data,   nt.STATUS,   nt.process_status as API_Success_Failure,   nt.department_code as DEPARTMENT_NAME,   nt.VALUE_DATE,   NT.ext_purpose_code as Purpose_codes,   case    when ntpl.process_name = 'OP Debit Posting'    and nt.process_group = 'P2P' then ntpl.process_ref_no    when ntpl.process_name = 'Fund AUTH Posting'    and nt.process_group = 'P2B' then ntpl.process_ref_no    when ntpl.process_name = 'Manual Fund AUTH Posting'    and nt.process_group = 'MANUAL' then ntpl.process_ref_no    when nt.process_group = 'IBAN' then nt.tran_ref_id    when nt.process_group = 'BCT' then nt.tran_ref_id    when nt.process_group = 'RCT' then nt.tran_ref_id   end as T24_FT_REFERENCE_NUMBER,   ntpl.PROCESS_NAME,   cnca.account_number  from   npss_transactions nt  inner join npss_trn_process_log ntpl on   nt.UETR = ntpl.UETR  left join core_nc_cbs_accounts cnca on   nt.dbtr_iban = cnca.alternate_account_id  left join CORE_RPT_LOGO_SETUP L on   L.tenant_id = NT.TENANT_ID  left join core_member_banks cmb on   cmb.bic_code = nt.cr_sort_code   and cmb.NEED_SYNC = 'Y' )v where  process_type = 'OP' $AND"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"Debit Advice Report CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Ordering Customer Name","target_column":"Debtor_Name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Account","target_column":"account_number","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Customer Iban","target_column":"Debtor_Account","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Beneficiary Customer Name","target_column":"Creditor_Name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Beneficiary Customer IBAN","target_column":"Creditor_Account","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Beneficiary Bank Code","target_column":"dr_sort_code","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Ref","target_column":"T24_FT_REFERENCE_NUMBER","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount (AED)","target_column":"TRANSACTION_AMOUNT_RANGE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Code","target_column":"categorypurpose","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Received Time","target_column":"CREATEDDATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End-to-End ID","target_column":"payment_endtoend_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"uetr","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Reference","target_column":"tran_ref_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing Reference","target_column":"clrsysref","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Other Reference","target_column":"otherreference","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
