...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.screen_instance[this.comp_id].f_npss_find_linked_r_message_ui.model = {"PROCESS_NAME":"findLinkedRMessages","REFTYPE":"","REF":"","SENDERBIC":"","FROMDATE":"setcurrentdate(),{}","TODATE":"setcurrentdate(),{}","DATASOURCE":"PRODUCTION"}
