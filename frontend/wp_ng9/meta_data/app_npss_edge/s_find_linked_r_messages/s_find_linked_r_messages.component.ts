...
export class s_find_linked_r_messagesComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.api_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS Find Linked R message UI","tab_order":0,"tab_name":"","uicgc_description":"API Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
		this.api_details.onChangecomponent = new EventEmitter<any>()
		this.api_details.show = true
		this.api_details.dynamic_param = {}
		this.api_details.f_npss_find_linked_r_message_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.api_details.form_name = "f_npss_find_linked_r_message_ui"
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__e_1677333737575__api_details()
	}
	...
	request__tbc_from_list() { 
		...
		let destn_id="api_input_ui_actions_trg_view_response"
		let parent_source_id=""
		let event_code="e_1678191255770"
	...
	request__svtm_from_selection_change() { 
		...
		let handler_code="set_value_to_memory"
		let internals="svtm_from_selection_change__show_hide_ide_call,"
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__e_1677333737575__api_details() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"destn_comp_id":"api_details","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__e_1677333737575__api_details","event_desc":"E_1677333737575","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
