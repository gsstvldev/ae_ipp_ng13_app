...
Build ID        : 28378 
Modified By     : Admin 
Modified Date   : 2023-Feb-28 10:1 AM 
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.model = {"PROCESS_NAME":"findRMessages","SENDERBIC":"","FROMDATE":"setcurrentdate(),{}","TODATE":"setcurrentdate(),{}","DATASOURCE":"PRODUCTION"}
