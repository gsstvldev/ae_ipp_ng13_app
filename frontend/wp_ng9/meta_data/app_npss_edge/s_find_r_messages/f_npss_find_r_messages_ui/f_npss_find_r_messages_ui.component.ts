...
Form Name       : NPSS Find R Messages UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_find_r_messages_ui',
  templateUrl: './f_npss_find_r_messages_ui.component.html',
  styleUrls: ['./f_npss_find_r_messages_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_find_r_messages_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_find_r_messages_ui') form;
  @ViewChild('npss_find_r_messages_ui_process_name') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.process_name.default_value = "findRMessages"
		...
		this.ctrl.process_name.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.process_name.ctrl_id = "npss_find_r_messages_ui_process_name"
		this.ctrl.npss_find_r_messages_ui_process_name = {}
		this.ctrl.npss_find_r_messages_ui_process_name.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.senderbic.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.senderbic.ctrl_id = "npss_find_r_messages_ui_senderbic"
		this.ctrl.npss_find_r_messages_ui_senderbic = {}
		this.ctrl.npss_find_r_messages_ui_senderbic.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.fromdate.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.fromdate.ctrl_id = "npss_find_r_messages_ui_fromdate"
		this.ctrl.npss_find_r_messages_ui_fromdate = {}
		this.ctrl.npss_find_r_messages_ui_fromdate.onChangecomponent = new EventEmitter<any>()
	
		//Properties of todate
		this.ctrl.todate = {}
		this.ctrl.todate.id = "RN11CN5"
		...
		this.ctrl.todate.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.todate.ctrl_id = "npss_find_r_messages_ui_todate"
		this.ctrl.npss_find_r_messages_ui_todate = {}
		this.ctrl.npss_find_r_messages_ui_todate.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.fromtime.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.fromtime.ctrl_id = "npss_find_r_messages_ui_fromtime"
		this.ctrl.npss_find_r_messages_ui_fromtime = {}
		this.ctrl.npss_find_r_messages_ui_fromtime.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.totime.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.totime.ctrl_id = "npss_find_r_messages_ui_totime"
		this.ctrl.npss_find_r_messages_ui_totime = {}
		this.ctrl.npss_find_r_messages_ui_totime.onChangecomponent = new EventEmitter<any>()
	
		//Properties of datasource
		this.ctrl.datasource = {}
		this.ctrl.datasource.id = "RN21CN4"
		...
		this.ctrl.datasource.view_name = "f_npss_find_r_messages_ui"
		this.ctrl.datasource.ctrl_id = "npss_find_r_messages_ui_datasource"
		this.ctrl.npss_find_r_messages_ui_datasource = {}
		this.ctrl.npss_find_r_messages_ui_datasource.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.model = {"PROCESS_NAME":"findRMessages","SENDERBIC":"","FROMDATE":"setcurrentdate(),{}","TODATE":"setcurrentdate(),{}","FROMTIME":"","TOTIME":"","DATASOURCE":"PRODUCTION"}
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_NAME"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"SENDERBIC"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"FROMDATE"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"TODATE"},{"CTLR_CODE":"TMR","DATA_TYPE":"TEXT","TARGET_COLUMN":"FROMTIME"},{"CTLR_CODE":"TMR","DATA_TYPE":"TEXT","TARGET_COLUMN":"TOTIME"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"DATASOURCE"}]
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.dtt_code = "dtt_1304_1670589169341"
		this.screen_instance[this.comp_id].f_npss_find_r_messages_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_find_r_messages_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_find_r_messages_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_find_r_messages_ui[control][property] = value;
  }
