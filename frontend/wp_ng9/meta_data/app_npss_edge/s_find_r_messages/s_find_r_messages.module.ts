...
@NgModule({
  ...
  imports: [
    ...
    torus_cs_show_hideModule,npss_cs_find_messageModule
  ],
  declarations: [s_find_r_messagesComponent,p_main_layoutComponent,f_npss_find_r_messages_srchComponent,f_npss_find_r_messages_uiComponent,f_api_input_ui_actionsComponent,],
