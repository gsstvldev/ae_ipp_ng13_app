...
export class s_home_dashboardComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.nav_ui_search.params = {"icon_only":false,"uicgcc_style":""}
	...
	nav_ui_search__action_button_click(){
		this.nav_ui_search__spap_for_search_trg()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "nav ui search"
	nav_ui_search__spap_for_search_trg() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"nav_ui_search__spap_for_search_trg","event_desc":"SPAP for search trg","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"nav_ui_search","raiseparam":{"popup_category":"profile","variable":"p_search_layout__spap_for_search_trg","selector":"p_search_layout","profile_code":"BTL_1408_1598521300065","window_title":"Search","window_height":"","window_width":"auto","window_close_icon":"Y","eventdes":"spap_for_search_trg","eventcode":"E_1679030820022"}}
	...
	navigation_back__tbc_for_back_to_hist_list_trg() { 
		...
		let event_params={"caller_name":"navigation_back__tbc_for_back_to_hist_list_trg","event_desc":"TBC for Back to Hist List TRG","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_back","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
