...
export class s_home_dashboardComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.message_detail.params = {"need_pag_datatable":"Y","need_responsive":"N","advance_dynamic_search":"N"}
