...
export class s_iban_view_transactions_groupComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.group_detail.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_25","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1670072332245","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Group Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"QUEUE_CODE","alias_name":"","mq_id":"MQ_1670072175267","date_format":false},{"column_name":"PROCESS_QUEUE_STATUS","alias_name":"","mq_id":"MQ_1670072175755","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1670072176075","date_format":false}],"joins":[]},"eq_text":"SELECT  QUEUE_CODE ,  PROCESS_QUEUE_STATUS ,  TENANT_ID ,  RULE_GROUP FROM  CORE_NC_STATUS_GROUP CNSG $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Group Detail CCD","filter":[{"filter_name":"RULE_GROUP","binding_name":"RULE_GROUP","binding_value":"","source_name":"RCT_OP_AC_AC_IBAN","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Queue","target_column":"QUEUE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"PROCESS_QUEUE_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
