...
@Component({
	selector: 's_inward_arc_transactions_details',
	templateUrl: './s_inward_arc_transactions_details.component.html',
	styleUrls: ['./s_inward_arc_transactions_details.component.css'],
...
// Start of class 
export class s_inward_arc_transactions_detailsComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_inward_arc_transactions_details"
	wftpa_id : string = "WFT_NPSS_P_1304_1712205558518_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712223738261","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Inward ARC Transactions Details Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"department_code","alias_name":"","mq_id":"MQ_1712222555226","date_format":false},{"column_name":"intrbk_sttlm_amnt","alias_name":"","mq_id":"MQ_1712222591866","date_format":false,"currency_format":true},{"column_name":"created_date","alias_name":"","mq_id":"MQ_1712222614049","date_format":true},{"column_name":"channel_refno","alias_name":"","mq_id":"MQ_1712222640866","date_format":false},{"column_name":"dbtr_iban","alias_name":"","mq_id":"MQ_1712222681441","date_format":false},{"column_name":"dbtr_acct_name","alias_name":"","mq_id":"MQ_1712222707041","date_format":false},{"column_name":"cdtr_iban","alias_name":"","mq_id":"MQ_1712222733192","date_format":false},{"column_name":"cdtr_acct_name","alias_name":"","mq_id":"MQ_1712222799032","date_format":false},{"column_name":"SENDER_BANK","alias_name":"","mq_id":"MQ_1712222822136","date_format":false},{"column_name":"status","alias_name":"","mq_id":"MQ_1712222849695","date_format":false},{"column_name":"value_date","alias_name":"","mq_id":"MQ_1712222862784","date_format":true},{"column_name":"ext_purpose_code","alias_name":"","mq_id":"MQ_1712222887191","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1712222966159","date_format":false},{"column_name":"Core_Bank_Errors","alias_name":"","mq_id":"MQ_1712222990615","date_format":false},{"column_name":"CB_ERRORS","alias_name":"","mq_id":"MQ_1712223027925","date_format":false},{"column_name":"maker","alias_name":"","mq_id":"MQ_1712223043710","date_format":false},{"column_name":"checker","alias_name":"","mq_id":"MQ_1712223053150","date_format":false}],"joins":[]},"eq_text":"select   distinct UETR,   process_status ,  status ,  created_date ,  value_date ,  department_code ,  intrbk_sttlm_amnt ,  ext_purpose_code,  payment_endtoend_id ,  dbtr_iban ,  dbtr_acct_name ,  cdtr_iban ,  clrsysref,  cdtr_acct_name ,  dr_sort_code ,  SOURCE_CHANNEL,  SENDER_BANK,  CB_ERRORS,  Core_Bank_Errors,  channel_refno,  maker,  checker  from (select  NTPL.UETR ,   NT.process_status ,  NT.status ,  NT.created_date ,  NT.value_date ,  nt.department_code,  NT.intrbk_sttlm_amnt,  NT.ext_purpose_code ,  NT.payment_endtoend_id ,  NT.dbtr_iban ,  NT.dbtr_acct_name,  NT.cdtr_iban ,  NT.cdtr_acct_name ,  NT.dr_sort_code ,  NT.channel_id as SOURCE_CHANNEL ,  NT.channel_refno ,  nt.clrsysref,  NT.process_type ,  NT.tenant_id ,     NT.maker,  NT.checker,     NTPL.process_name ,  plcduae.CBUAE_RETURN_CODE as CB_ERRORS,  PLT24.t24_return_code as Core_Bank_Errors,  cmb.bank_name as SENDER_BANK,  cse.s_description,   case      when      ntpl.process_name = 'Inward Credit Posting' and ntpl.status = 'IP_RCT_POSTING_SUCCESS' then ntpl.PROCESS_REF_NO     else 'Others'     end as T24_FT_REFERENCE_NUMBER from  <TRAN_DB>.npss_transactions nt  inner join <TRAN_DB>.NPSS_TRN_PROCESS_LOG NTPL on NT.UETR = NTPL.uetr  left join (select  plr.npsstpl_id,  plr.uetr,  plr.CBUAE_RETURN_CODE,  plr.row_num from  (  select   a.npsstpl_id,   a.uetr,   a.CBUAE_RETURN_CODE,   row_number() over( partition by a.uetr  order by   a.npsstpl_id desc) as row_num  from   <TRAN_DB>.npss_trn_process_log a where A.CBUAE_RETURN_CODE is not null) plr where  plr.row_num = 1 ) plcduae on plcduae.uetr = nt.uetr  left join (select  plr1.npsstpl_id,  plr1.uetr,  plr1.T24_RETURN_CODE,  plr1.row_num from  (  select   a1.npsstpl_id,   a1.uetr,   a1.T24_RETURN_CODE,   row_number() over( partition by a1.uetr  order by   a1.npsstpl_id desc) as row_num  from   <TRAN_DB>.npss_trn_process_log a1 where A1.T24_RETURN_CODE is not null) plr1 where  plr1.row_num = 1 ) plt24 on plt24.uetr = nt.uetr   left join <TRAN_DB>.core_member_banks cmb on cmb.bic_code = nt.dr_sort_code and cmb.NEED_SYNC = 'Y'  inner join  <TRAN_DB>.CORE_SYSTEM_EXTN CSE on CSE.department_code  = nt.DEPARTMENT_CODE) V $WHERE and process_type = 'IP'"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Inward ARC Transactions Details Report MQ CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Department Name","target_column":"department_code","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Amount Range","target_column":"intrbk_sttlm_amnt","alias_name":"","alignment":"Right","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Transaction Date Range","target_column":"created_date","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Sender Reference Number","target_column":"channel_refno","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Debtor Account","target_column":"dbtr_iban","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Debtor Name","target_column":"dbtr_acct_name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Creditor Account","target_column":"cdtr_iban","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Creditor Name","target_column":"cdtr_acct_name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Sender Bank","target_column":"SENDER_BANK","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Status","target_column":"status","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Transaction Date","target_column":"value_date","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Purpose code","target_column":"ext_purpose_code","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"IPP Reference Number","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Core bank Error","target_column":"Core_Bank_Errors","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Central Bank Error","target_column":"CB_ERRORS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Maker","target_column":"maker","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Checker","target_column":"checker","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"NPSS IP ARC Transaction Report SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_ip_arc_transaction_report_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_ip_arc_transaction_report_srch"
