...
@NgModule({
  ...
  declarations: [s_inward_arc_transactions_detailsComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_op_arc_transaction_report_srchComponent,],
