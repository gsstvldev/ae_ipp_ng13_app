...
@Component({
	selector: 's_inward_cb_nak_enquiry_report',
	templateUrl: './s_inward_cb_nak_enquiry_report.component.html',
	styleUrls: ['./s_inward_cb_nak_enquiry_report.component.css'],
...
// Start of class 
export class s_inward_cb_nak_enquiry_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_inward_cb_nak_enquiry_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1710148232776_0"
	cg_code : string = "CG_1304_1710216800143"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1710241117107","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Inward CB NAK Enquiry Report","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"npsstrrd_refno","alias_name":"","mq_id":"MQ_1710226997553","date_format":false},{"column_name":"payment_endtoend_id","alias_name":"","mq_id":"MQ_1710227038857","date_format":false},{"column_name":"cdtr_iban","alias_name":"","mq_id":"MQ_1710227053217","date_format":false},{"column_name":"created_date","alias_name":"","mq_id":"MQ_1710227073473","date_format":true},{"column_name":"dbtr_iban","alias_name":"","mq_id":"MQ_1710227092593","date_format":false},{"column_name":"dbtr_acct_name","alias_name":"","mq_id":"MQ_1710227132657","date_format":false},{"column_name":"bank_name","alias_name":"","mq_id":"MQ_1710227149025","date_format":false},{"column_name":"intrbk_sttlm_amnt","alias_name":"","mq_id":"MQ_1710227165385","date_format":false,"currency_format":true}],"joins":[]},"eq_text":"select  npsst_id,  accp_date_time,  intrbk_sttlm_cur,  exhf_id,  value_date,  cdtr_acct_no,  dbtr_acct_no,  dr_sort_code,  cr_sort_code,  uetr,  product_code,  process_type,  tenant_id,  tran_ref_id,  processing_system,  process_group,  bank_name,  department_code,   payment_endtoend_id,   cdtr_iban,   created_date,   dbtr_iban,   intrbk_sttlm_amnt,   cdtr_acct_name,   dbtr_acct_name,   BENEFICIARY_BANK,   npsstrrd_refno from  (  select   a.npsst_id,   a.value_date,   a.created_date,   a.cdtr_acct_no,   a.department_code,   a.cdtr_acct_name,   a.intrbk_sttlm_amnt,   a.intrbk_sttlm_cur,   a.dbtr_acct_name,   a.dr_sort_code,   a.cr_sort_code,   a.uetr,   a.ext_purpose_code,   a.product_code,   a.channel_id,   a.process_type,   a.dbtr_iban,   a.cdtr_iban,   a.clrsysref,   a.payment_endtoend_id,   a.accp_date_time,      a.dbtr_acct_no,   a.exhf_id,   a.tenant_id,   a.processing_system,   a.process_group,      a.tran_ref_id,   cmb.bank_name,   cmb.bank_name as BENEFICIARY_BANK,   ntpl.ADDITIONAL_INFO,   NTPL.npsstrrd_refno,   cse.s_description  from   npss_transactions a  inner join npss_trn_process_log ntpl on a.uetr = ntpl.uetr    left join core_member_banks cmb on cmb.bic_code = a.cr_sort_code and cmb.NEED_SYNC = 'Y'   inner join  CORE_SYSTEM_EXTN CSE on CSE.department_code  = A.DEPARTMENT_CODE )VW  where process_type = 'IP' $AND  order by  npsst_id"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Inward CB NAK Enquiry Report CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Transaction ID","target_column":"npsstrrd_refno","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End To End ID","target_column":"payment_endtoend_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payee Account Number","target_column":"cdtr_iban","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Date","target_column":"created_date","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Ordering Account Number","target_column":"dbtr_iban","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Cust Name","target_column":"dbtr_acct_name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Ordering Bank Name","target_column":"bank_name","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"intrbk_sttlm_amnt","alias_name":"","alignment":"Right","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"NPSS Inward CB NAK Enquiry Report SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_inward_cb_nak_enquiry_report_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_inward_cb_nak_enquiry_report_srch"
