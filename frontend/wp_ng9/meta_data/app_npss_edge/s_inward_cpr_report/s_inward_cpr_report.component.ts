...
@Component({
	selector: 's_inward_cpr_report',
	templateUrl: './s_inward_cpr_report.component.html',
	styleUrls: ['./s_inward_cpr_report.component.css'],
...
// Start of class 
export class s_inward_cpr_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_inward_cpr_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1712205744773_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712208732334","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Inward CPR Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1712208181217","date_format":false},{"column_name":"CDTR_IBAN","alias_name":"","mq_id":"MQ_1712208189383","date_format":false},{"column_name":"CDTR_ACCT_NO","alias_name":"","mq_id":"MQ_1712208201559","date_format":false},{"column_name":"CDTR_DOCUMENT_ID","alias_name":"","mq_id":"MQ_1712208235646","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1712208265022","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1712208281822","date_format":false,"currency_format":true},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1712208305038","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1712208314062","date_format":false},{"column_name":"TRAN_REF_ID","alias_name":"","mq_id":"MQ_1712208324190","date_format":false},{"column_name":"CPR_DW_FILE_NAME","alias_name":"","mq_id":"MQ_1712208334982","date_format":false},{"column_name":"CPR_REJECT_REASON","alias_name":"","mq_id":"MQ_1712208347709","date_format":false}],"joins":[]},"eq_text":"select  DBTR_IBAN,  CDTR_IBAN,  CDTR_ACCT_NO,  CDTR_DOCUMENT_ID,  INTRBK_STTLM_CUR,  INTRBK_STTLM_AMNT,  UETR,  CLRSYSREF,  TRAN_REF_ID,  CPR_DW_FILE_NAME,  CPRDWFLAG,  CPR_REJECT_REASON from  (  select   A.NPSST_ID,   A.DBTR_IBAN,   A.CDTR_IBAN,   A.CDTR_ACCT_NO,   A.CDTR_DOCUMENT_ID,   A.INTRBK_STTLM_CUR,   A.INTRBK_STTLM_AMNT,   A.UETR,   A.CLRSYSREF,   A.TRAN_REF_ID,   A.CPR_CR_FILE_NAME,   A.CPR_DW_FILE_NAME,   A.CPR_REJECT_REASON,   A.CPR_DW_FLAG,   case    when A.CPR_DW_FLAG = 'A' then INITCAP('Accepted')    when A.CPR_DW_FLAG = 'R' then INITCAP('Rejected')   end as CPRDWFLAG,   A.CPR_CR_FLAG,   A.MODIFIED_DATE,   A.CREATED_DATE,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.VERSION_NO  from   <TRAN_DB>.NPSS_TRANSACTIONS A  where   A.CPR_DW_FLAG in('A', 'R') )v $WHERE order by  CPRDWFLAG"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Inward CPR Report MQ CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Sender BIC","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Receiver BIC","target_column":"CDTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Cr Account","target_column":"CDTR_ACCT_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Customer Id Doc","target_column":"CDTR_DOCUMENT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Right","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UAEIPP ID","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Tran Ref No","target_column":"TRAN_REF_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"File Name","target_column":"CPR_DW_FILE_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Return Reason","target_column":"CPR_REJECT_REASON","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
