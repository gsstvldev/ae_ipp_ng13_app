...
import { s_inward_cpr_reportComponent } from './s_inward_cpr_report.component';
import { s_inward_cpr_reportRoutingModule } from './s_inward_cpr_report.routing.module';
...
import { f_npss_inward_cpr_report_srchComponent } from './f_npss_inward_cpr_report_srch/f_npss_inward_cpr_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_inward_cpr_reportRoutingModule,
  ...
  declarations: [s_inward_cpr_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_inward_cpr_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_inward_cpr_reportModule { }
