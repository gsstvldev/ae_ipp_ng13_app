...
import { s_inward_general_enquiry_reportRoutingModule } from './s_inward_general_enquiry_report.routing.module';
...
import { f_npss_inward_general_enquiry_report_srchComponent } from './f_npss_inward_general_enquiry_report_srch/f_npss_inward_general_enquiry_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_inward_general_enquiry_reportRoutingModule,
  ...
  declarations: [s_inward_general_enquiry_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_inward_general_enquiry_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_inward_general_enquiry_reportModule { }
