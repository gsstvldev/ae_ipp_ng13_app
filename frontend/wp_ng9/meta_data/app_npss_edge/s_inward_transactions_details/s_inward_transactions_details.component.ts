...
Build ID        : 36105 
Modified By     : Admin 
Modified Date   : 2024-Jul-23 8:17 AM 
...
export class s_inward_transactions_detailsComponent implements OnInit,AfterViewInit {
	...
	cg_code : string = "CG_1304_1719906431200"
	...
	search_search__action_button_click(peventcontext){
		if(!peventcontext) { 
 			peventcontext = this.search_search__sec_from_search()
		 }
		this.search_search__cc_for_control(peventcontext)
		this.search_search__cc_from_search(peventcontext)
	}
	...
	ssp_from_serach__internal(parent_event_result){
		this.ssp_from_serach__brfq_from_manager(parent_event_result)
	}

	//Handler for INTERNAL event of "cc from search"
	cc_from_search__internal(parent_event_result){
		this.cc_from_search__cp_from_cc(parent_event_result)
		this.cc_from_search__ssp_from_cc(parent_event_result)
	}

	//Handler for INTERNAL event of "ssp from cc"
	ssp_from_cc__internal(parent_event_result){
		this.ssp_from_cc__brfq_from_maker_checker(parent_event_result)
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "search search"
	search_search__sec_from_search() { 
		let Dest_Is_ctrl=true
		
		let source_id="search_search"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1719906611489"
		let event_params={"caller_name":"search_search__sec_from_search","event_desc":"SEC From Search","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{}}
		let handler_code="set_event_context"
		let internals=""
		let event_data={"search_search":{"e_1719906611489":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGCC_7","event_code":"E_1719906611489","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[],"get_from_memory":[],"set_event_context":"Y","sec_value":{"type":"SESSION_LEVEL","value":"APP_USER_ROLES"}}}}}}}}}
		let data_source={}
		try {
	...
	//Handler for ACTION_BUTTON_CLICK event of "search search"
	search_search__cc_for_control(peventcontext) { 
		let Dest_Is_ctrl=true
		let eventcontext =["730"]
		if(eventcontext.indexOf(peventcontext)==-1) return true;
		let source_id="search_search"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1710480264849"
		let event_params={"caller_name":"search_search__cc_for_control","event_desc":"CC for control","event_type":"ACTION_BUTTON_CLICK","caller_event_context":730,"root_source_id":"search_search","raiseparam":{},"eventcontext":["730"]}
		let handler_code="custom_connectors"
	...
	//Handler for ACTION_BUTTON_CLICK event of "search search"
	search_search__cc_from_search(peventcontext) { 
		let Dest_Is_ctrl=true
		let eventcontext =["705","708"]
		if(eventcontext.indexOf(peventcontext)==-1) return true;
		let source_id="search_search"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1719906664616"
		let event_params={"caller_name":"search_search__cc_from_search","event_desc":"CC From Search","event_type":"ACTION_BUTTON_CLICK","caller_event_context":705,"root_source_id":"search_search","raiseparam":{},"eventcontext":["705","708"]}
		let handler_code="custom_connectors"
		let internals="cc_from_search__cp_from_cc,cc_from_search__ssp_from_cc,"
		let event_data={}
		let data_source={}
		try {
			this.npss_c_cond_ctrl_validationService.fn_npss_c_cond_ctrl_validation(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let internals="ssp_from_serach__brfq_from_manager,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "ssp from serach"
	ssp_from_serach__brfq_from_manager(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
	...
	//Handler for INTERNAL event of "cc from search"
	cc_from_search__cp_from_cc(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id=""
		let parent_source_id="search_search"
		let event_code="e_1719906767864"
		let event_params={"popup_info":{"context":""},"caller_name":"cc_from_search__cp_from_cc","event_desc":"CP From cc","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="close_popup"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "cc from search"
	cc_from_search__ssp_from_cc(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="cc_from_search"
		let destn_id="search"
		let parent_source_id="search_search"
		let event_code="e_1719906816182"
		let event_params={"caller_name":"cc_from_search__ssp_from_cc","event_desc":"SSP From CC","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_from_cc__brfq_from_maker_checker,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp from cc"
	ssp_from_cc__brfq_from_maker_checker(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_from_cc"
		let destn_id="list"
