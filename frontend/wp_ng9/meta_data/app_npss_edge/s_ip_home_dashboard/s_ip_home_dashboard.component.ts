...
export class s_ip_home_dashboardComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.transaction_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1677933941116","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS IP Home Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"totalcount","alias_name":"","mq_id":"MQ_1677933613596","date_format":false}],"joins":[]},"eq_text":"SELECT totalcount,        pendingmakercount,        pendingcheckercount,        pendingscreencount,        successfullypostedcount,        pendingreturnsmakercount,        pendingreturnscheckercount,        returnedcount,        pendingt1count   FROM ad_gss_tran.vw_dashboard_inward_data;"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS IP Home Dashboard MQ CCD","filter":[],"databinding":[{"header":"totalcount","target_column":"totalcount","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
