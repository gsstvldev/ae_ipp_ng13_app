...
Build ID        : 30840 
Modified By     : Admin 
Modified Date   : 2023-Jul-04 10:50 AM 
...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_c_disable_action_by_multiselectService,npss_cs_check_uetrService,npss_cs_lca_acc_entries_exceptionService,npss_cs_rct_inward_posting_failure_closeService,npss_cs_rct_inward_posting_failure_retry_repostService,npss_cs_rct_already_postingService,npss_cs_cc_postingService,npss_cs_enquiryService,npss_cs_t24_postingService,npss_cs_rct_completeService,npss_cs_inward_posting_failure_force_to_postService,npss_cs_outward_posting_failure_send_to_checkerService]
})
