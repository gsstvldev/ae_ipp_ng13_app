...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_liquidity_cycleService]
})
...
export class s_liquidity_cycleComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_liquidity_cycleService:npss_cs_liquidity_cycleService) {
