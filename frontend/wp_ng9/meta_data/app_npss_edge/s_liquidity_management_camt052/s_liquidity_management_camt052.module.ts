...
import { s_liquidity_management_camt052RoutingModule } from './s_liquidity_management_camt052.routing.module';
...
import { f_npss_liquidity_management_camt052_srchComponent } from './f_npss_liquidity_management_camt052_srch/f_npss_liquidity_management_camt052_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_liquidity_management_camt052RoutingModule,
  ...
  declarations: [s_liquidity_management_camt052Component,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_liquidity_management_camt052_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_liquidity_management_camt052Module { }
