...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_liquidity_positionService,npss_c_disable_action_by_multiselectService]
})
...
export class s_liquidity_positionComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_liquidity_positionService:npss_cs_liquidity_positionService,private npss_c_disable_action_by_multiselectService:npss_c_disable_action_by_multiselectService) {
	...
	ngOnInit() {
		...
		this.api_input_ui.uicgc_code = "uicgc_4"
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__de_for_cotrol__api_input_ui()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__de_for_cotrol__api_input_ui() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"destn_comp_id":"api_input_ui","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__de_for_cotrol__api_input_ui","event_desc":"DE for cotrol","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
