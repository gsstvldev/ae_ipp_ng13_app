...
export class s_liquidity_positionComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.input_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS Liq Pos UI","tab_order":0,"tab_name":"","uicgc_description":"Input Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
		this.input_details.onChangecomponent = new EventEmitter<any>()
		this.input_details.show = true
		this.input_details.dynamic_param = {}
		this.input_details.f_npss_liq_pos_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.input_details.form_name = "f_npss_liq_pos_ui"
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__de_for_cotrol__input_details()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__de_for_cotrol__input_details() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"destn_comp_id":"input_details","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__de_for_cotrol__input_details","event_desc":"DE for cotrol","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
