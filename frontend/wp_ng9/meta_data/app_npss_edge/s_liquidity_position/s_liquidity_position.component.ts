...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_liquidity_positionService,npss_cs_liquidity_position_responseService]
})
...
export class s_liquidity_positionComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_liquidity_positionService:npss_cs_liquidity_positionService,private npss_cs_liquidity_position_responseService:npss_cs_liquidity_position_responseService) {
	...
	ngOnInit() {
		...
		this.api_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS Liq Pos UI","tab_order":0,"tab_name":"","uicgc_description":"API Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
		this.api_details.onChangecomponent = new EventEmitter<any>()
		this.api_details.show = true
		this.api_details.dynamic_param = {}
		this.api_details.f_npss_liq_pos_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.api_details.form_name = "f_npss_liq_pos_ui"
	...
	api_input_ui_actions_view_response__action_button_click(){
		this.api_input_ui_actions_view_response__ide_call()
	}
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__de_for_cotrol__api_details()
	}
	...
	page_load__de_for_call_api_btn_from_pg() { 
		...
		let source_id="page_load"
		let destn_id="api_input_ui_actions_view_response"
		let parent_source_id=""
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_from_fetch_btn_click__im_from_fetch_btn_click","event_desc":"IM from fetch btn click","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Core API liquidityPosition has been called successfully","root_source_id":"api_input_ui_actions_fetch","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions view response"
	api_input_ui_actions_view_response__ide_call() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"api_input_ui_actions_view_response__ide_call","event_desc":"ide call","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_view_response","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__de_for_cotrol__api_details() { 
		let Dest_Is_ctrl=true
		
		let source_id="api_input_ui_actions_trg_hide"
		let destn_id="npss_liq_pos_ui_process_name"
		let parent_source_id=""
		let event_code="e_1677308930354"
		let event_params={"destn_comp_id":"api_details","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__de_for_cotrol__api_details","event_desc":"DE for cotrol","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
