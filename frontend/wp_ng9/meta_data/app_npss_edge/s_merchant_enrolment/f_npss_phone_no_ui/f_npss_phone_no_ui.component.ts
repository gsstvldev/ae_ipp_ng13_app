...
Form Name       : NPSS Phone No UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_phone_no_ui',
  templateUrl: './f_npss_phone_no_ui.component.html',
  styleUrls: ['./f_npss_phone_no_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_phone_no_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_phone_no_ui') form;
  @ViewChild('npss_phone_no_ui_phone_no') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.phone_no.view_name = "f_npss_phone_no_ui"
		this.ctrl.phone_no.ctrl_id = "npss_phone_no_ui_phone_no"
		this.ctrl.npss_phone_no_ui_phone_no = {}
		this.ctrl.npss_phone_no_ui_phone_no.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_phone_no_ui.model = {"PHONE_NO":""}
		this.screen_instance[this.comp_id].f_npss_phone_no_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PHONE_NO"}]
		this.screen_instance[this.comp_id].f_npss_phone_no_ui.dt_code = "dt_1304_1665384579126"
		this.screen_instance[this.comp_id].f_npss_phone_no_ui.dtt_code = "dtt_1304_1665384653050"
		this.screen_instance[this.comp_id].f_npss_phone_no_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_phone_no_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_phone_no_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_phone_no_ui[control][property] = value;
  }
