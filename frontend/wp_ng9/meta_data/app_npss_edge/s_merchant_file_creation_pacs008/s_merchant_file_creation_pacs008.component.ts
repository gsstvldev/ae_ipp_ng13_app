...
@Component({
	selector: 's_merchant_file_creation_pacs008',
	templateUrl: './s_merchant_file_creation_pacs008.component.html',
	styleUrls: ['./s_merchant_file_creation_pacs008.component.css'],
	providers:[]
})
    
// Start of class 
export class s_merchant_file_creation_pacs008Component implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_merchant_file_creation_pacs008"
	wftpa_id : string = "WFT_NPSS_P_1304_1665471511682_0"
