...
// Start of class 
export class s_merchant_file_downloadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_merchant_file_download"
	wftpa_id : string = "WFT_NPSS_P_1304_1665400471995_0"
