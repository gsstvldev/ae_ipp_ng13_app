...
// Start of class 
export class s_merchant_file_uploadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_merchant_file_upload"
	wftpa_id : string = "WFT_NPSS_P_1304_1665400845915_0"
