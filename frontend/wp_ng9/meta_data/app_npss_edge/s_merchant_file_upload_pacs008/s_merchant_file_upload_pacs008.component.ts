...
Screen Name     : s_merchant_file_upload_pacs008
--------------------------------------------------------------------------- */
...
@Component({
	selector: 's_merchant_file_upload_pacs008',
	templateUrl: './s_merchant_file_upload_pacs008.component.html',
	styleUrls: ['./s_merchant_file_upload_pacs008.component.css'],
	providers:[torus_cs_show_hideService]
})
    
// Start of class 
export class s_merchant_file_upload_pacs008Component implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_merchant_file_upload_pacs008"
	wftpa_id : string = "WFT_NPSS_P_1304_1665471635274_0"
