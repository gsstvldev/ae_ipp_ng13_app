...
export class s_merchant_setupComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_6","uicgc_4","uicgc_7","uicgc_8","uicgc_1","uicgc_11"]
	...
	ngOnInit() {
		...
		this.customer_detail.f_customer_detail = {"show":true}
		this.customer_detail.current_view = "f_customer_detail"
		...
		this.account__detail.f_account__detail = {"show":true}
		this.account__detail.current_view = "f_account__detail"
