...
import { f_shop_detailComponent } from './f_shop_detail/f_shop_detail.component'
...
@NgModule({
  ...
  declarations: [s_merchant_setupComponent,p_main_layoutComponent,f_navigation_uiComponent,f_sub_navigation_uiComponent,p_search_layoutComponent,f_npss_merchant_srchComponent,p_action_layoutComponent,f_npss_merchant_uiComponent,f_npss_mer_account_uiComponent,f_shop_detailComponent,f_actionComponent,],
