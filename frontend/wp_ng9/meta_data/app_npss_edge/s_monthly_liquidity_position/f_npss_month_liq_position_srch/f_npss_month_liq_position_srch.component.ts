...
Form Name       : NPSS Month Liq Position SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_month_liq_position_srch',
  templateUrl: './f_npss_month_liq_position_srch.component.html',
  styleUrls: ['./f_npss_month_liq_position_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_month_liq_position_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_month_liq_position_srch') form;
  @ViewChild('npss_month_liq_position_srch_currency') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.currency.default_value = "setcurrentdate(),{}"
		...
		this.ctrl.currency.view_name = "f_npss_month_liq_position_srch"
		this.ctrl.currency.ctrl_id = "npss_month_liq_position_srch_currency"
		this.ctrl.npss_month_liq_position_srch_currency = {}
		this.ctrl.npss_month_liq_position_srch_currency.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.currency = {}
	
		//Properties of accountholderbic
		this.ctrl.accountholderbic = {}
		this.ctrl.accountholderbic.id = "RN01CN2"
		...
		this.ctrl.accountholderbic.view_name = "f_npss_month_liq_position_srch"
		this.ctrl.accountholderbic.ctrl_id = "npss_month_liq_position_srch_accountholderbic"
		this.ctrl.npss_month_liq_position_srch_accountholderbic = {}
		this.ctrl.npss_month_liq_position_srch_accountholderbic.onChangecomponent = new EventEmitter<any>()
	
		//Properties of accountnumber
		this.ctrl.accountnumber = {}
		this.ctrl.accountnumber.id = "RN11CN3"
		...
		this.ctrl.accountnumber.view_name = "f_npss_month_liq_position_srch"
		this.ctrl.accountnumber.ctrl_id = "npss_month_liq_position_srch_accountnumber"
		this.ctrl.npss_month_liq_position_srch_accountnumber = {}
		this.ctrl.npss_month_liq_position_srch_accountnumber.onChangecomponent = new EventEmitter<any>()
	
		//Properties of datetime
		this.ctrl.datetime = {}
		this.ctrl.datetime.id = "RN11CN4"
		...
		this.ctrl.datetime.view_name = "f_npss_month_liq_position_srch"
		this.ctrl.datetime.ctrl_id = "npss_month_liq_position_srch_datetime"
		this.ctrl.npss_month_liq_position_srch_datetime = {}
		this.ctrl.npss_month_liq_position_srch_datetime.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.model = {"CURRENCY":"setcurrentdate(),{}","ACCOUNTHOLDERBIC":"","ACCOUNTNUMBER":"","DATETIME":"setcurrentdate(),{}"}
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.Meta = [{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"CURRENCY"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTHOLDERBIC"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTNUMBER"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"DATETIME"}]
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.dtt_code = "dtt_1304_1670589169341"
		this.screen_instance[this.comp_id].f_npss_month_liq_position_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_month_liq_position_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_month_liq_position_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_month_liq_position_srch[control][property] = value;
  }
