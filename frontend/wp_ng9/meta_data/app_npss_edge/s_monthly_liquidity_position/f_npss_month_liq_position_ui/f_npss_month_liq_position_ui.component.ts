...
Form Name       : NPSS Month Liq Position UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_month_liq_position_ui',
  templateUrl: './f_npss_month_liq_position_ui.component.html',
  styleUrls: ['./f_npss_month_liq_position_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_month_liq_position_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_month_liq_position_ui') form;
  @ViewChild('npss_month_liq_position_ui_process_name') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.process_name.default_value = "monthlyLiquidityPosition"
		...
		this.ctrl.process_name.view_name = "f_npss_month_liq_position_ui"
		this.ctrl.process_name.ctrl_id = "npss_month_liq_position_ui_process_name"
		this.ctrl.npss_month_liq_position_ui_process_name = {}
		this.ctrl.npss_month_liq_position_ui_process_name.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.currency.view_name = "f_npss_month_liq_position_ui"
		this.ctrl.currency.ctrl_id = "npss_month_liq_position_ui_currency"
		this.ctrl.npss_month_liq_position_ui_currency = {}
		this.ctrl.npss_month_liq_position_ui_currency.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.currency = {}
		...
		this.ctrl.accountholderbic.view_name = "f_npss_month_liq_position_ui"
		this.ctrl.accountholderbic.ctrl_id = "npss_month_liq_position_ui_accountholderbic"
		this.ctrl.npss_month_liq_position_ui_accountholderbic = {}
		this.ctrl.npss_month_liq_position_ui_accountholderbic.onChangecomponent = new EventEmitter<any>()
	
		//Properties of accountnumber
		this.ctrl.accountnumber = {}
		this.ctrl.accountnumber.id = "RN11CN4"
		...
		this.ctrl.accountnumber.view_name = "f_npss_month_liq_position_ui"
		this.ctrl.accountnumber.ctrl_id = "npss_month_liq_position_ui_accountnumber"
		this.ctrl.npss_month_liq_position_ui_accountnumber = {}
		this.ctrl.npss_month_liq_position_ui_accountnumber.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.datetime.ctrl_id = "npss_month_liq_position_ui_datetime"
		this.ctrl.npss_month_liq_position_ui_datetime = {}
		this.ctrl.npss_month_liq_position_ui_datetime.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.model = {"PROCESS_NAME":"monthlyLiquidityPosition","CURRENCY":"","ACCOUNTHOLDERBIC":"","ACCOUNTNUMBER":"","DATETIME":"setcurrentdate(),{}"}
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_NAME"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"CURRENCY"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTHOLDERBIC"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"ACCOUNTNUMBER"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"DATETIME"}]
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.dtt_code = "dtt_1304_1670589169341"
		this.screen_instance[this.comp_id].f_npss_month_liq_position_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_month_liq_position_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_month_liq_position_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_month_liq_position_ui[control][property] = value;
  }
