...
@NgModule({
  ...
  imports: [
    ...
    torus_cs_show_hideModule,npss_cs_monthly_liquidity_positionModule
  ],
  declarations: [s_monthly_liquidity_positionComponent,p_main_layoutComponent,f_npss_month_liq_position_srchComponent,f_npss_month_liq_position_uiComponent,f_api_input_ui_actionsComponent,],
