...
import { s_op_home_dashboardRoutingModule } from './s_op_home_dashboard.routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    s_op_home_dashboardRoutingModule,
    torus_cs_show_hideModule
  ],
  declarations: [s_op_home_dashboardComponent,p_default_profileComponent,f_navigationComponent,p_search_layoutComponent,f_npss_home_dashboard_uiComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_op_home_dashboardModule { }
