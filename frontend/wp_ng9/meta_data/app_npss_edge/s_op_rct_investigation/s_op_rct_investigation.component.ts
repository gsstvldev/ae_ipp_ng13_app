...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_cs_maker_initiateService,npss_cs_maker_closeService,npss_cs_investigation_pac_028Service,npss_cs_rev_rejectService]
})
    
// Start of class 
export class s_op_rct_investigationComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_op_rct_investigation"
	wftpa_id : string = "WFT_NPSS_P_1304_1676293893278_0"
	cg_code : string = "CG_1304_1676293829824"
	...
	key_events : any = {}
	btl_1304_1676972448420 : string = "p_remarks_ui"
	...
	forms : any = ["uicgc_4","uicgc_11","uicgc_15","uicgc_10","uicgc_18","uicgc_16","uicgc_12","uicgc_13","uicgc_14","uicgc_7","uicgc_3"]
	p_search_layout__spap_for_search_showpopup : boolean = false
	p_remarks_ui__spap_fro_close_btn_showpopup : boolean = false
	queue : any = {}
	...
	ngOnInit() {
		...
		this.transaction_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.remark_ui_save.params = {"icon_only":false,"uicgcc_style":"fa fa-save"}
	...
	page_load(){
		...
		this.page_load__e_1679473254444()
		this.page_load__e_1679749485315()
	}
	...
	transaction_list__selection_changed(){
		...
		this.transaction_list__ee_for_aprove()
	}
	...
	cc_for_initiate__internal(parent_event_result){
		this.cc_for_initiate__ssp_from_initaite_ide_call(parent_event_result)
	}

	//Handler for INTERNAL event of "ssp from initaite ide call"
	ssp_from_initaite_ide_call__internal(parent_event_result){
		this.ssp_from_initaite_ide_call__brfq_for_after_ssp(parent_event_result)
	}

	//Handler for INTERNAL event of "brfq for after ssp"
	brfq_for_after_ssp__internal(parent_event_result){
		this.brfq_for_after_ssp__sfr_for_after_brfq(parent_event_result)
	}

	//Handler for INTERNAL event of "sfr for after brfq"
	sfr_for_after_brfq__internal(parent_event_result){
		this.sfr_for_after_brfq__inmsg_for_sfr_success(parent_event_result)
		this.sfr_for_after_brfq__inmsg_for_sfr_failure(parent_event_result)
	}

	//Handler for INTERNAL event of "inmsg for sfr failure"
	inmsg_for_sfr_failure__internal(parent_event_result){
		this.inmsg_for_sfr_failure__rs_for_initiate_failure(parent_event_result)
	}
	...
	navigation_ui_close__action_button_click(){
		this.navigation_ui_close__spap_fro_close_btn()
	...
	ssp_after_close_cc_success__internal(parent_event_result){
		this.ssp_after_close_cc_success__brfq_after_close_cc_success(parent_event_result)
	}

	//Handler for INTERNAL event of "brfq after close cc success"
	brfq_after_close_cc_success__internal(parent_event_result){
		this.brfq_after_close_cc_success__sfr_after_close_cc_success(parent_event_result)
	}

	//Handler for INTERNAL event of "sfr after close cc success"
	sfr_after_close_cc_success__internal(parent_event_result){
		this.sfr_after_close_cc_success__tbc_after_close_and_brfq_failure(parent_event_result)
		this.sfr_after_close_cc_success__tbc_after_close_and_brfq_success(parent_event_result)
	}

	//Handler for ACTION_BUTTON_CLICK event of "navigation ui approve"
	navigation_ui_approve__action_button_click(){
		this.navigation_ui_approve__cc_for_show_hide_for_approve()
	}

	//Handler for INTERNAL event of "cc for show hide for approve"
	cc_for_show_hide_for_approve__internal(parent_event_result){
		this.cc_for_show_hide_for_approve__ssp_from_approve_ide_call(parent_event_result)
	}

	//Handler for INTERNAL event of "ssp from approve ide call"
	ssp_from_approve_ide_call__internal(parent_event_result){
		this.ssp_from_approve_ide_call__approve_brfq_for_after_ssp(parent_event_result)
	}

	//Handler for INTERNAL event of "approve brfq for after ssp"
	approve_brfq_for_after_ssp__internal(parent_event_result){
		this.approve_brfq_for_after_ssp__approve_sfr_for_after_brfq(parent_event_result)
	}

	//Handler for INTERNAL event of "approve sfr for after brfq"
	approve_sfr_for_after_brfq__internal(parent_event_result){
		this.approve_sfr_for_after_brfq__approve_inmsg_for_sfr_success(parent_event_result)
		this.approve_sfr_for_after_brfq__approve_inmsg_for_sfr_failure(parent_event_result)
	}

	//Handler for INTERNAL event of "approve inmsg for sfr failure"
	approve_inmsg_for_sfr_failure__internal(parent_event_result){
		this.approve_inmsg_for_sfr_failure__rs_for_approve_failure(parent_event_result)
	}

	//Handler for ACTION_BUTTON_CLICK event of "navigation ui reject"
	navigation_ui_reject__action_button_click(){
		this.navigation_ui_reject__cc_for_show_hide_for_reject()
	}

	//Handler for INTERNAL event of "cc for show hide for reject"
	cc_for_show_hide_for_reject__internal(parent_event_result){
		this.cc_for_show_hide_for_reject__ssp_from_reject_ide_call(parent_event_result)
	}

	//Handler for INTERNAL event of "ssp from reject ide call"
	ssp_from_reject_ide_call__internal(parent_event_result){
		this.ssp_from_reject_ide_call__reject_brfq_for_after_ssp(parent_event_result)
	}

	//Handler for INTERNAL event of "reject brfq for after ssp"
	reject_brfq_for_after_ssp__internal(parent_event_result){
		this.reject_brfq_for_after_ssp__reject_sfr_for_after_brfq(parent_event_result)
	}

	//Handler for INTERNAL event of "reject sfr for after brfq"
	reject_sfr_for_after_brfq__internal(parent_event_result){
		this.reject_sfr_for_after_brfq__inmsg_for_sfr_reject_success(parent_event_result)
		this.reject_sfr_for_after_brfq__inmsg_for_sfr_reject__failure(parent_event_result)
	}

	//Handler for INTERNAL event of "inmsg for sfr reject  failure"
	inmsg_for_sfr_reject__failure__internal(parent_event_result){
		this.inmsg_for_sfr_reject__failure__rs_for_reject_failure(parent_event_result)
	}
	...
	navigation_ui_trg_failure_close_info_btn__action_button_click(peventcontext){
		if(!peventcontext) { 
 			peventcontext = this.navigation_ui_trg_failure_close_info_btn__sec_for_close_info_message()
		 }
	...
	navigation_ui_trg_success_close_info_btn__action_button_click(peventcontext){
		...
		this.navigation_ui_trg_success_close_info_btn__im_for_manually_closed(peventcontext)
		this.navigation_ui_trg_success_close_info_btn__im_sent_to_checker(peventcontext)
	}
	...
	page_load__he_for_close_btn() { 
		...
		let parent_source_id=""
		let event_code="e_1676981930252"
	...
	page_load__he_for_approve() { 
		...
		let parent_source_id=""
		let event_code="e_1678278435352"
	...
	page_load__he_for_reject() { 
		...
		let parent_source_id=""
		let event_code="e_1678278449567"
	...
	//Handler for DPSINIT event of "page_load"
	page_load__e_1679473254444() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="navigation_ui_trg_failure_close_info_btn"
		let parent_source_id=""
		let event_code="e_1679473254444"
		let event_params={"caller_name":"page_load__e_1679473254444","event_desc":"E_1679473254444","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for DPSINIT event of "page_load"
	page_load__e_1679749485315() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="navigation_ui_trg_success_close_info_btn"
		let parent_source_id=""
		let event_code="e_1679749485315"
		let event_params={"caller_name":"page_load__e_1679749485315","event_desc":"E_1679749485315","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	transaction_list__ee_for_close_btn() { 
		...
		let destn_id="navigation_ui_close"
		let parent_source_id=""
		let event_code="e_1676983013537"
	...
	transaction_list__ee_for_reject() { 
		...
		let destn_id="navigation_ui_reject"
		let parent_source_id=""
		let event_code="e_1678278492887"
	...
	//Handler for SELECTION_CHANGED event of "transaction list"
	transaction_list__ee_for_aprove() { 
		let Dest_Is_ctrl=true
		
		let source_id="transaction_list"
		let destn_id="navigation_ui_approve"
		let parent_source_id=""
		let event_code="e_1678278509722"
		let event_params={"caller_name":"transaction_list__ee_for_aprove","event_desc":"ee for aprove","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	navigation_ui_initiate__cc_for_initiate() { 
		...
		let handler_code="custom_connectors"
		let internals="cc_for_initiate__ssp_from_initaite_ide_call,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for initiate"
	cc_for_initiate__ssp_from_initaite_ide_call(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1679742710472"
		let event_params={"caller_name":"cc_for_initiate__ssp_from_initaite_ide_call","event_desc":"SSP from initaite ide call","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_initiate","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_from_initaite_ide_call__brfq_for_after_ssp,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp from initaite ide call"
	ssp_from_initaite_ide_call__brfq_for_after_ssp(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_from_initaite_ide_call"
		let destn_id="transaction_list"
		let parent_source_id="cc_for_initiate"
		let event_code="e_1679742746824"
		let event_params={"caller_name":"ssp_from_initaite_ide_call__brfq_for_after_ssp","event_desc":"BRFQ for after ssp","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_initiate","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="brfq_for_after_ssp__sfr_for_after_brfq,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "brfq for after ssp"
	brfq_for_after_ssp__sfr_for_after_brfq(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="brfq_for_after_ssp"
		let destn_id="transaction_list"
		let parent_source_id="ssp_from_initaite_ide_call"
		let event_code="e_1679742765694"
		let event_params={"caller_name":"brfq_for_after_ssp__sfr_for_after_brfq","event_desc":"SFR for after BRFQ","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_initiate","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals="sfr_for_after_brfq__inmsg_for_sfr_success,sfr_for_after_brfq__inmsg_for_sfr_failure,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.select_first_record(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "sfr for after brfq"
	sfr_for_after_brfq__inmsg_for_sfr_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="sfr_for_after_brfq"
		let destn_id=""
		let parent_source_id="brfq_for_after_ssp"
		let event_code="e_1679742779849"
		let event_params={"caller_name":"sfr_for_after_brfq__inmsg_for_sfr_success","event_desc":"INMSG for sfr success","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Data has been initiated successfully","root_source_id":"navigation_ui_initiate","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	//Handler for INTERNAL event of "sfr for after brfq"
	sfr_for_after_brfq__inmsg_for_sfr_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id=""
		let parent_source_id="brfq_for_after_ssp"
		let event_code="e_1679742811333"
		let event_params={"caller_name":"sfr_for_after_brfq__inmsg_for_sfr_failure","event_desc":"INMSG for sfr failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Data has been initiated successfully","root_source_id":"navigation_ui_initiate","raiseparam":{"info_msg":""},"parent_event_result":"FAILURE"}
		let handler_code="info_msg"
		let internals="inmsg_for_sfr_failure__rs_for_initiate_failure,"
		let event_data={}
		let data_source={}
		try {
			this.handler.info_msg(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "inmsg for sfr failure"
	inmsg_for_sfr_failure__rs_for_initiate_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="inmsg_for_sfr_failure"
		let destn_id=""
		let parent_source_id="sfr_for_after_brfq"
		let event_code="e_1679742830373"
		let event_params={"caller_name":"inmsg_for_sfr_failure__rs_for_initiate_failure","event_desc":"RS for initiate failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_initiate","raiseparam":{},"parent_event_result":"SUCCESS"}
	...
	navigation_ui_view_message_log__brfq_for_vm() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665903906193":{"st_ds":{"default":{"uicgc_code":"UICGC_9","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665903906193","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676294750354","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS REQ RESP MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_CODE","alias_name":"","mq_id":"MQ_1668573850306","date_format":false},{"column_name":"PROCESS_DETAIL","alias_name":"","mq_id":"MQ_1668573852117","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1668573852786","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1668573853731","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1668573854459","date_format":false},{"column_name":"NPSSTRRD_ID","alias_name":"","mq_id":"MQ_1668573869044","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1668573871186","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573874178","date_format":false},{"column_name":"PARENT_NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573876315","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1668573884586","date_format":false},{"column_name":"EXHF_ID","alias_name":"","mq_id":"MQ_1668573900766","date_format":false},{"column_name":"MESSAGE_DESC","alias_name":"","mq_id":"MQ_1668573911947","date_format":false},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1668573917043","date_format":false},{"column_name":"CHANNEL_PRODUCT","alias_name":"","mq_id":"MQ_1668573918291","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1668573918796","date_format":false},{"column_name":"CHANNEL_SUB_PRODUCT","alias_name":"","mq_id":"MQ_1668573919355","date_format":false},{"column_name":"CHANNEL_TRAN_CODE","alias_name":"","mq_id":"MQ_1668573919955","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1668573925605","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1668587107858","date_format":false}],"joins":[]},"eq_text":"select  NPSSTRRD_ID,  MSG_ID,  UETR,  PARENT_NPSSTRRD_REFNO,  NPSSTRRD_REFNO,  PROCESS_CODE,  PROCESS_DETAIL,  EXHF_ID,  PROCESS_NAME,  MESSAGE_DESC,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_USERID,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  STATUS,  PROCESS_STATUS,PROCESS_TYPE,  MESSAGE_DATA,  CREATEDDATEMILISEC,  DT_CODE,  DTT_CODE from  (  select   NPSSTRRD.NPSSTRRD_ID,   NPSSTRRD.MSG_ID,   NPSSTRRD.UETR,   NPSSTRRD.PARENT_NPSSTRRD_REFNO,   NPSSTRRD.NPSSTRRD_REFNO,   NPSSTRRD.MESSAGE_DATA,   NPSSTRRD.PROCESS_CODE,   NPSSTRRD.PROCESS_DETAIL,   NPSSTRRD.EXHF_ID,   NPSSTRRD.PROCESS_NAME,   NPSSTRRD.MESSAGE_DESC,   NPSSTRRD.CHANNEL_ID,   NPSSTRRD.CHANNEL_REFNO,   NPSSTRRD.CHANNEL_USERID,   NPSSTRRD.CHANNEL_PRODUCT,   NPSSTRRD.CHANNEL_SUB_PRODUCT,   NPSSTRRD.CHANNEL_TRAN_CODE,   NPSSTRRD.CREATED_BY,   NPSSTRRD.CREATED_BY_NAME,   NPSSTRRD.CREATED_DATE,   NPSSTRRD.DT_CODE,   NPSSTRRD.DT_DESCRIPTION,   NPSSTRRD.DTT_CODE,   NPSSTRRD.DTT_DESCRIPTION,   NPSSTRRD.MODIFIED_BY,   NPSSTRRD.MODIFIED_BY_NAME,   NPSSTRRD.MODIFIED_DATE,   NPSSTRRD.STATUS,   NPSSTRRD.PROCESS_STATUS,NT.PROCESS_TYPE,   NPSSTRRD.SYSTEM_ID,   NPSSTRRD.SYSTEM_NAME,   NPSSTRRD.TENANT_ID,   NPSSTRRD.APP_ID,   NPSSTRRD.VERSION_NO,   TO_CHAR(NPSSTRRD.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC  from   <TRAN_DB>.NPSS_TRN_REQ_RESP_DTLS NPSSTRRD  inner join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NPSSTRRD.UETR = NT.UETR) RR $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS REQ RES CCD","filter":[{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Created Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Desc","target_column":"MESSAGE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Detail","target_column":"PROCESS_DETAIL","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	navigation_ui_view_process_log__brfq_for_hdl() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_17","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676294645842","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS HST Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1666177568065","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1666177568243","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1666177568420","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1666177568588","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1666177568740","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1666177568908","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1666177569084","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1666177779261","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1666177779430","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1666177779582","date_format":true},{"column_name":"RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666177862396","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1666177862551","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1666177873590","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1666329436524","date_format":true},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809408","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809610","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1666781809810","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1666865255337","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255505","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255657","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936092675","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093146","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093458","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1667544156161","date_format":false},{"column_name":"ADDITIONAL_INFO","alias_name":"","mq_id":"MQ_1713241927843","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  PROCESS_STATUS,  STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DEPARTMENT_CODE,  DT_CODE,  DTT_CODE,  PROCESS_TYPE,  AMOUNT_CREDITED,  AMT_CR_LOC_CUR,  CHARGE_AMOUNT,  BUY_CURRENCY,  SELL_CURRENCY,  DEALT_AMOUNT,  EXCHANGE_RATE,  CONTRA_AMOUNT,  ADDITIONAL_INFO from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   NT.PROCESS_TYPE,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   NT.DEPARTMENT_CODE,   NT.NPSST_ID,   A.ADDITIONAL_INFO,   A.AMOUNT_CREDITED,   A.AMT_CR_LOC_CUR,   A.CHARGE_AMOUNT,   A.BUY_CURRENCY,   A.SELL_CURRENCY,   A.DEALT_AMOUNT,   A.EXCHANGE_RATE,   A.CONTRA_AMOUNT,   T24RC.ERROR_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE,   '-',   T24RC.ERROR_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE,   '-',   CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE,   '-',   CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   <TRAN_DB>.NPSS_TRN_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_ERROR_CODES T24RC on   T24RC.ERROR_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  left join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NT.UETR = A.UETR  order by   A.NPSSTPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Hst Process Log","filter":[{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBS Return Code","target_column":"T24_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui close"
	navigation_ui_close__spap_fro_close_btn() { 
		let Dest_Is_ctrl=true
	...
	navigation_ui_close__cui_from_close_to_tremark_ui() { 
		...
		let parent_source_id=""
		let event_code="e_1679748948775"
	...
	remark_ui_save__ve_for_c_save_btn() { 
		...
		let destn_id="remark_ui"
		let parent_source_id=""
		let event_code="e_1679747570848"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1679747593297"
		...
		let handler_code="custom_connectors"
		let internals="cc_for_c_save_btn__ssp_after_close_cc_success,cc_for_c_save_btn__cp_for_cc_success_for_close,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for c save btn"
	cc_for_c_save_btn__ssp_after_close_cc_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1679747677310"
		let event_params={"caller_name":"cc_for_c_save_btn__ssp_after_close_cc_success","event_desc":"SSP after Close CC Success","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"remark_ui_save","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_after_close_cc_success__brfq_after_close_cc_success,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id=""
		let parent_source_id="ve_for_c_save_btn"
		let event_code="e_1679749569560"
	...
	//Handler for INTERNAL event of "ssp after close cc success"
	ssp_after_close_cc_success__brfq_after_close_cc_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_after_close_cc_success"
		let destn_id="transaction_list"
		let parent_source_id="cc_for_c_save_btn"
		let event_code="e_1679747769052"
		let event_params={"caller_name":"ssp_after_close_cc_success__brfq_after_close_cc_success","event_desc":"BRFQ after Close CC Success","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"remark_ui_save","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="brfq_after_close_cc_success__sfr_after_close_cc_success,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "brfq after close cc success"
	brfq_after_close_cc_success__sfr_after_close_cc_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="brfq_after_close_cc_success"
		let destn_id="transaction_list"
		let parent_source_id="ssp_after_close_cc_success"
		let event_code="e_1679747907194"
		let event_params={"caller_name":"brfq_after_close_cc_success__sfr_after_close_cc_success","event_desc":"SFR after Close CC Success","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"remark_ui_save","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals="sfr_after_close_cc_success__tbc_after_close_and_brfq_failure,sfr_after_close_cc_success__tbc_after_close_and_brfq_success,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.select_first_record(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "sfr after close cc success"
	sfr_after_close_cc_success__tbc_after_close_and_brfq_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="FAILURE"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="sfr_after_close_cc_success"
		let destn_id="navigation_ui_trg_failure_close_info_btn"
		let parent_source_id="brfq_after_close_cc_success"
		let event_code="e_1679748355315"
		let event_params={"caller_name":"sfr_after_close_cc_success__tbc_after_close_and_brfq_failure","event_desc":"TBC after Close and BRFQ Failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"remark_ui_save","raiseparam":{},"parent_event_result":"FAILURE"}
		let handler_code="trigger_button_click"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "sfr after close cc success"
	sfr_after_close_cc_success__tbc_after_close_and_brfq_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="sfr_after_close_cc_success"
		let destn_id="navigation_ui_trg_success_close_info_btn"
		let parent_source_id="brfq_after_close_cc_success"
		let event_code="e_1679748405993"
		let event_params={"caller_name":"sfr_after_close_cc_success__tbc_after_close_and_brfq_success","event_desc":"TBC after Close and BRFQ Success","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"remark_ui_save","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="trigger_button_click"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui approve"
	navigation_ui_approve__cc_for_show_hide_for_approve() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_approve"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1678076897511"
		let event_params={"caller_name":"navigation_ui_approve__cc_for_show_hide_for_approve","event_desc":"cc for show hide for approve","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_approve","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals="cc_for_show_hide_for_approve__ssp_from_approve_ide_call,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for show hide for approve"
	cc_for_show_hide_for_approve__ssp_from_approve_ide_call(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="cc_for_show_hide_for_approve"
		let destn_id="search"
		let parent_source_id="navigation_ui_approve"
		let event_code="e_1679743753556"
		let event_params={"caller_name":"cc_for_show_hide_for_approve__ssp_from_approve_ide_call","event_desc":"SSP from approve ide call","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_approve","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_from_approve_ide_call__approve_brfq_for_after_ssp,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp from approve ide call"
	ssp_from_approve_ide_call__approve_brfq_for_after_ssp(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_from_approve_ide_call"
		let destn_id="transaction_list"
		let parent_source_id="cc_for_show_hide_for_approve"
		let event_code="e_1679743777357"
		let event_params={"caller_name":"ssp_from_approve_ide_call__approve_brfq_for_after_ssp","event_desc":"approve BRFQ for after ssp","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_approve","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="approve_brfq_for_after_ssp__approve_sfr_for_after_brfq,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "approve brfq for after ssp"
	approve_brfq_for_after_ssp__approve_sfr_for_after_brfq(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="approve_brfq_for_after_ssp"
		let destn_id="transaction_list"
		let parent_source_id="ssp_from_approve_ide_call"
		let event_code="e_1679744315356"
		let event_params={"caller_name":"approve_brfq_for_after_ssp__approve_sfr_for_after_brfq","event_desc":"approve SFR for after BRFQ","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_approve","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals="approve_sfr_for_after_brfq__approve_inmsg_for_sfr_success,approve_sfr_for_after_brfq__approve_inmsg_for_sfr_failure,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.select_first_record(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "approve sfr for after brfq"
	approve_sfr_for_after_brfq__approve_inmsg_for_sfr_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="approve_sfr_for_after_brfq"
		let destn_id=""
		let parent_source_id="approve_brfq_for_after_ssp"
		let event_code="e_1679744330961"
		let event_params={"caller_name":"approve_sfr_for_after_brfq__approve_inmsg_for_sfr_success","event_desc":"approve INMSG for sfr success","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Transaction(s) has been approved successfully","root_source_id":"navigation_ui_approve","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
		let handler_code="info_msg"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "approve sfr for after brfq"
	approve_sfr_for_after_brfq__approve_inmsg_for_sfr_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="FAILURE"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="approve_sfr_for_after_brfq"
		let destn_id=""
		let parent_source_id="approve_brfq_for_after_ssp"
		let event_code="e_1679744358952"
		let event_params={"caller_name":"approve_sfr_for_after_brfq__approve_inmsg_for_sfr_failure","event_desc":"approve INMSG for sfr failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Transaction(s) has been approved successfully","root_source_id":"navigation_ui_approve","raiseparam":{"info_msg":""},"parent_event_result":"FAILURE"}
		let handler_code="info_msg"
		let internals="approve_inmsg_for_sfr_failure__rs_for_approve_failure,"
		let event_data={}
		let data_source={}
		try {
			this.handler.info_msg(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "approve inmsg for sfr failure"
	approve_inmsg_for_sfr_failure__rs_for_approve_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="approve_inmsg_for_sfr_failure"
		let destn_id=""
		let parent_source_id="approve_sfr_for_after_brfq"
		let event_code="e_1679744373064"
		let event_params={"caller_name":"approve_inmsg_for_sfr_failure__rs_for_approve_failure","event_desc":"RS for approve failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_approve","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="refresh_screen"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui reject"
	navigation_ui_reject__cc_for_show_hide_for_reject() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_reject"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1678076967132"
		let event_params={"caller_name":"navigation_ui_reject__cc_for_show_hide_for_reject","event_desc":"cc for show hide for reject","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_reject","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals="cc_for_show_hide_for_reject__ssp_from_reject_ide_call,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for show hide for reject"
	cc_for_show_hide_for_reject__ssp_from_reject_ide_call(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="cc_for_show_hide_for_reject"
		let destn_id="search"
		let parent_source_id="navigation_ui_reject"
		let event_code="e_1679743263719"
		let event_params={"caller_name":"cc_for_show_hide_for_reject__ssp_from_reject_ide_call","event_desc":"SSP from reject ide call","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_reject","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_from_reject_ide_call__reject_brfq_for_after_ssp,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp from reject ide call"
	ssp_from_reject_ide_call__reject_brfq_for_after_ssp(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_from_reject_ide_call"
		let destn_id="transaction_list"
		let parent_source_id="cc_for_show_hide_for_reject"
		let event_code="e_1679743289108"
		let event_params={"caller_name":"ssp_from_reject_ide_call__reject_brfq_for_after_ssp","event_desc":"reject BRFQ for after ssp","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_reject","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="reject_brfq_for_after_ssp__reject_sfr_for_after_brfq,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "reject brfq for after ssp"
	reject_brfq_for_after_ssp__reject_sfr_for_after_brfq(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="reject_brfq_for_after_ssp"
		let destn_id="transaction_list"
		let parent_source_id="ssp_from_reject_ide_call"
		let event_code="e_1679743304739"
		let event_params={"caller_name":"reject_brfq_for_after_ssp__reject_sfr_for_after_brfq","event_desc":"reject SFR for after BRFQ","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_reject","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals="reject_sfr_for_after_brfq__inmsg_for_sfr_reject_success,reject_sfr_for_after_brfq__inmsg_for_sfr_reject__failure,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1676295830946","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP RCT Investigation Tran MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1676367641515","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1676367641665","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1676367641809","date_format":false,"currency_format":true},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1676367641969","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1676367668584","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1676367668735","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1676367668904","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1676367669072","date_format":false},{"column_name":"outwardfileName","alias_name":"","mq_id":"MQ_1709624919027","date_format":false},{"column_name":"OutwardReturnFileName","alias_name":"","mq_id":"MQ_1713334052027","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  MODIFIED_DATE_UTC,  DATEMI,  VALUE_DATE,  CBS_REF_NO,  CREATED_DATE,  CDTR_ACCT_NO,  CDTR_ACCT_NAME,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  FN_PCIDSS_DECRYPT(CR_ACCT_IDENTIFICATION,  $PCIDSS_KEY) as CR_ACCT_IDENTIFICATION,  FN_PCIDSS_DECRYPT(DBTR_ACCT_NO,  $PCIDSS_KEY) as DBTR_ACCT_NO,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CR_SORT_CODE,  UETR,  HDR_MSG_ID,  PRODUCT_CODE,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  PROCESS_TYPE,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  CDTR_IBAN,  CLRSYSREF,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  EXHF_ID,  PROCESS_STATUS,  STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  VERSION_NO,  DEPARTMENT_CODE,  PROCESS_GROUP,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  ACCP_DATE_TIME,  PROCESSING_SYSTEM,  PROCESS_NAME,  outwardfileName,  OutwardReturnFileName from  (  select    NPSST_ID,   MODIFIED_DATE_UTC,   DATEMI,   VALUE_DATE,   CBS_REF_NO,   CREATED_DATE,   CDTR_ACCT_NO,   CDTR_ACCT_NAME,   INTRBK_STTLM_AMNT,   INTRBK_STTLM_CUR,   CR_ACCT_IDENTIFICATION,   DBTR_ACCT_NO,   DBTR_ACCT_NAME,   DR_SORT_CODE,   CR_SORT_CODE,   UETR,   HDR_MSG_ID,   PRODUCT_CODE,   CHANNEL_ID,   CHANNEL_REFNO,   CHANNEL_PRODUCT,   CHANNEL_SUB_PRODUCT,   CHANNEL_TRAN_CODE,   PROCESS_TYPE,   DBTR_PHONE_NO,   DBTR_EMAIL_ID,   DBTR_DOCUMENT_ID,   DBTR_IBAN,   CDTR_PHONE_NO,   CDTR_EMAIL_ID,   CDTR_DOCUMENT_ID,   CDTR_IBAN,   CLRSYSREF,   PAYMENT_ENDTOEND_ID,   TRAN_REF_ID,   EXHF_ID,   PROCESS_STATUS,   STATUS,   TENANT_ID,   DT_CODE,   DTT_CODE,   TS_ID,   LOCKED_BY,   LOCKED_BY_NAME,   VERSION_NO,   DEPARTMENT_CODE,   PROCESS_GROUP,   DBTR_PRVT_ID,   DBTR_OTHER_ISSUER,   ACCP_DATE_TIME,   outwardfileName,   OutwardReturnFileName,   PROCESSING_SYSTEM,   PROCESS_NAME,   row_number() over (partition by PL_UETR  order by   NPSSTPL_ID desc) as ROW_NUM  from   (   select    A.NPSST_ID,    A.VALUE_DATE,    A.CBS_REF_NO,    A.MODIFIED_DATE_UTC,    A.CREATED_DATE,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,    A.CDTR_ACCT_NO,    A.CDTR_ACCT_NAME,    A.INTRBK_STTLM_AMNT,    A.INTRBK_STTLM_CUR,    A.DBTR_ACCT_NO,    A.CR_ACCT_IDENTIFICATION,    A.DBTR_ACCT_NAME,    A.DR_SORT_CODE,    A.CR_SORT_CODE,    A.DEPARTMENT_CODE,    A.UETR,    A.HDR_MSG_ID,    A.PRODUCT_CODE,    A.CHANNEL_ID,    A.CHANNEL_REFNO,    A.CHANNEL_PRODUCT,    A.CHANNEL_SUB_PRODUCT,    A.CHANNEL_TRAN_CODE,    A.PROCESS_TYPE,    A.DBTR_PHONE_NO,    A.DBTR_EMAIL_ID,    A.DBTR_DOCUMENT_ID,    A.DBTR_IBAN,    A.CDTR_PHONE_NO,    A.CDTR_EMAIL_ID,    A.CDTR_DOCUMENT_ID,    A.CDTR_IBAN,    A.CLRSYSREF,    A.PROCESS_GROUP,    A.PAYMENT_ENDTOEND_ID,    A.ACCP_DATE_TIME,    A.TRAN_REF_ID,    A.EXHF_ID,    A.REMITTANCE_INFO,    A.INWARD_FILE_NAME,    A.PROCESS_STATUS,    A.STATUS,    A.TENANT_ID,    A.DT_CODE,    A.DTT_CODE,    A.VERSION_NO,    A.DBTR_PRVT_ID,    A.DBTR_OTHER_ISSUER,    TS.TS_ID,    TS.LOCKED_BY,    TS.LOCKED_BY_NAME,    A.PROCESSING_SYSTEM,    NTPL.PROCESS_NAME,    NTPL.NPSSTPL_ID,    NTPL.UETR as PL_UETR,    case     when A.status = 'OP_BCT_STAT_PENDING' then A.OUTWARD_FILE_NAME    end as outwardfileName,    case     when A.status = 'OP_BCT_RTN_STAT_PENDING' then A.OP_PACS004_FILE_NAME    end as OutwardReturnFileName   from    NPSS_TRANSACTIONS A   inner join NPSS_TRN_PROCESS_LOG ntpl on    NTPL.UETR = A.UETR   inner join TRANSACTION_SET TS on    TS.TRN_ID = A.NPSST_ID    and TS.DTT_CODE = A.DTT_CODE   order by    A.NPSST_ID desc) VW $WHERE ) B where  ROW_NUM = 1  and PROCESS_NAME in ('Place Pacs028', 'Download Pacs002')"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP RCT Investigation Tran CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward File Name","target_column":"outwardfileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Outward Return File Name","target_column":"OutwardReturnFileName","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.select_first_record(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "reject sfr for after brfq"
	reject_sfr_for_after_brfq__inmsg_for_sfr_reject_success(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="reject_sfr_for_after_brfq"
		let destn_id=""
		let parent_source_id="reject_brfq_for_after_ssp"
		let event_code="e_1679743324360"
		let event_params={"caller_name":"reject_sfr_for_after_brfq__inmsg_for_sfr_reject_success","event_desc":"INMSG for sfr reject success","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Transaction(s) has been rejected successfully","root_source_id":"navigation_ui_reject","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
		let handler_code="info_msg"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "reject sfr for after brfq"
	reject_sfr_for_after_brfq__inmsg_for_sfr_reject__failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="FAILURE"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="reject_sfr_for_after_brfq"
		let destn_id=""
		let parent_source_id="reject_brfq_for_after_ssp"
		let event_code="e_1679743363657"
		let event_params={"caller_name":"reject_sfr_for_after_brfq__inmsg_for_sfr_reject__failure","event_desc":"INMSG for sfr reject  failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Transaction(s) has been rejected successfully","root_source_id":"navigation_ui_reject","raiseparam":{"info_msg":""},"parent_event_result":"FAILURE"}
		let handler_code="info_msg"
		let internals="inmsg_for_sfr_reject__failure__rs_for_reject_failure,"
		let event_data={}
		let data_source={}
		try {
			this.handler.info_msg(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "inmsg for sfr reject  failure"
	inmsg_for_sfr_reject__failure__rs_for_reject_failure(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="inmsg_for_sfr_reject__failure"
		let destn_id=""
		let parent_source_id="reject_sfr_for_after_brfq"
		let event_code="e_1679743385537"
		let event_params={"caller_name":"inmsg_for_sfr_reject__failure__rs_for_reject_failure","event_desc":"RS for reject failure","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_reject","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="refresh_screen"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui trg failure close info btn"
	navigation_ui_trg_failure_close_info_btn__sec_for_close_info_message() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_trg_failure_close_info_btn"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679473275422"
		let event_params={"caller_name":"navigation_ui_trg_failure_close_info_btn__sec_for_close_info_message","event_desc":"SEC for Close Info Message","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_trg_failure_close_info_btn","raiseparam":{}}
		let handler_code="set_event_context"
		let internals=""
		let event_data={"navigation_ui_trg_failure_close_info_btn":{"e_1679473275422":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGCC_41","event_code":"E_1679473275422","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[],"get_from_memory":[],"set_event_context":"Y","sec_value":{"type":"SESSION_LEVEL","value":"APP_USER_ROLES"}}}}}}}}}
		let data_source={}
		try {
	...
	navigation_ui_trg_failure_close_info_btn__im_for_checker(peventcontext) { 
		...
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679473306242"
	...
	navigation_ui_trg_failure_close_info_btn__im_for_maker(peventcontext) { 
		...
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679473317353"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1679473339450"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id=""
		let parent_source_id="navigation_ui_trg_failure_close_info_btn"
		let event_code="e_1679473351126"
	...
	navigation_ui_trg_success_close_info_btn__sec_for_trg_close_success() { 
		...
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679748640699"
		...
		let handler_code="set_event_context"
		let internals=""
		let event_data={"navigation_ui_trg_success_close_info_btn":{"e_1679748640699":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGCC_42","event_code":"E_1679748640699","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[],"get_from_memory":[],"set_event_context":"Y","sec_value":{"type":"SESSION_LEVEL","value":"APP_USER_ROLES"}}}}}}}}}
		let data_source={}
		try {
			return this.handler.set_event_context(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui trg success close info btn"
	navigation_ui_trg_success_close_info_btn__im_for_manually_closed(peventcontext) { 
		let Dest_Is_ctrl=true
		let eventcontext =["708"]
		if(eventcontext.indexOf(peventcontext)==-1) return true;
		let source_id="navigation_ui_trg_success_close_info_btn"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679749111540"
		let event_params={"caller_name":"navigation_ui_trg_success_close_info_btn__im_for_manually_closed","event_desc":"IM FOR MANUALLY CLOSED","event_type":"ACTION_BUTTON_CLICK","caller_event_context":708,"message_text":"Transaction has been manually closed successfully","root_source_id":"navigation_ui_trg_success_close_info_btn","raiseparam":{"info_msg":""},"eventcontext":["708"]}
		let handler_code="info_msg"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui trg success close info btn"
	navigation_ui_trg_success_close_info_btn__im_sent_to_checker(peventcontext) { 
		let Dest_Is_ctrl=true
		let eventcontext =["705"]
		if(eventcontext.indexOf(peventcontext)==-1) return true;
		let source_id="navigation_ui_trg_success_close_info_btn"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1679749153448"
		let event_params={"caller_name":"navigation_ui_trg_success_close_info_btn__im_sent_to_checker","event_desc":"IM SENT TO CHECKER","event_type":"ACTION_BUTTON_CLICK","caller_event_context":705,"message_text":"Transaction has been sent to checker successfully","root_source_id":"navigation_ui_trg_success_close_info_btn","raiseparam":{"info_msg":""},"eventcontext":["705"]}
		let handler_code="info_msg"
		let internals=""
		let event_data={}
		let data_source={}
