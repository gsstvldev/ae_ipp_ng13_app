...
Form Name       : NPSS RCT Tran SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_rct_tran_srch',
  templateUrl: './f_npss_rct_tran_srch.component.html',
  styleUrls: ['./f_npss_rct_tran_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_rct_tran_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_rct_tran_srch') form;
  @ViewChild('npss_rct_tran_srch_value_date') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.value_date.view_name = "f_npss_rct_tran_srch"
		this.ctrl.value_date.ctrl_id = "npss_rct_tran_srch_value_date"
		this.ctrl.npss_rct_tran_srch_value_date = {}
		this.ctrl.npss_rct_tran_srch_value_date.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.memory63.view_name = "f_npss_rct_tran_srch"
		this.ctrl.memory63.ctrl_id = "npss_rct_tran_srch_memory63"
		this.ctrl.npss_rct_tran_srch_memory63 = {}
		this.ctrl.npss_rct_tran_srch_memory63.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cdtr_iban.view_name = "f_npss_rct_tran_srch"
		this.ctrl.cdtr_iban.ctrl_id = "npss_rct_tran_srch_cdtr_iban"
		this.ctrl.npss_rct_tran_srch_cdtr_iban = {}
		this.ctrl.npss_rct_tran_srch_cdtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cr_acct_identification.view_name = "f_npss_rct_tran_srch"
		this.ctrl.cr_acct_identification.ctrl_id = "npss_rct_tran_srch_cr_acct_identification"
		this.ctrl.npss_rct_tran_srch_cr_acct_identification = {}
		this.ctrl.npss_rct_tran_srch_cr_acct_identification.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cdtr_acct_name
		this.ctrl.cdtr_acct_name = {}
		this.ctrl.cdtr_acct_name.id = "RN11CN5"
		...
		this.ctrl.cdtr_acct_name.view_name = "f_npss_rct_tran_srch"
		this.ctrl.cdtr_acct_name.ctrl_id = "npss_rct_tran_srch_cdtr_acct_name"
		this.ctrl.npss_rct_tran_srch_cdtr_acct_name = {}
		this.ctrl.npss_rct_tran_srch_cdtr_acct_name.onChangecomponent = new EventEmitter<any>()
	
		//Properties of dbtr_iban
		this.ctrl.dbtr_iban = {}
		this.ctrl.dbtr_iban.id = "RN21CN6"
		...
		this.ctrl.dbtr_iban.view_name = "f_npss_rct_tran_srch"
		this.ctrl.dbtr_iban.ctrl_id = "npss_rct_tran_srch_dbtr_iban"
		this.ctrl.npss_rct_tran_srch_dbtr_iban = {}
		this.ctrl.npss_rct_tran_srch_dbtr_iban.onChangecomponent = new EventEmitter<any>()
	
		//Properties of uetr
		this.ctrl.uetr = {}
		this.ctrl.uetr.id = "RN21CN10"
		...
		this.ctrl.uetr.view_name = "f_npss_rct_tran_srch"
		this.ctrl.uetr.ctrl_id = "npss_rct_tran_srch_uetr"
		this.ctrl.npss_rct_tran_srch_uetr = {}
		this.ctrl.npss_rct_tran_srch_uetr.onChangecomponent = new EventEmitter<any>()
	
		//Properties of clrsysref
		this.ctrl.clrsysref = {}
		this.ctrl.clrsysref.id = "RN21CN9"
		...
		this.ctrl.clrsysref.view_name = "f_npss_rct_tran_srch"
		this.ctrl.clrsysref.ctrl_id = "npss_rct_tran_srch_clrsysref"
		this.ctrl.npss_rct_tran_srch_clrsysref = {}
		this.ctrl.npss_rct_tran_srch_clrsysref.onChangecomponent = new EventEmitter<any>()
	
		//Properties of payment_endtoend_id
		this.ctrl.payment_endtoend_id = {}
		this.ctrl.payment_endtoend_id.id = "RN31CN11"
		...
		this.ctrl.payment_endtoend_id.view_name = "f_npss_rct_tran_srch"
		this.ctrl.payment_endtoend_id.ctrl_id = "npss_rct_tran_srch_payment_endtoend_id"
		this.ctrl.npss_rct_tran_srch_payment_endtoend_id = {}
		this.ctrl.npss_rct_tran_srch_payment_endtoend_id.onChangecomponent = new EventEmitter<any>()
	
		//Properties of processing_system
		this.ctrl.processing_system = {}
		this.ctrl.processing_system.id = "RN31CN12"
		...
		this.ctrl.processing_system.view_name = "f_npss_rct_tran_srch"
		this.ctrl.processing_system.ctrl_id = "npss_rct_tran_srch_processing_system"
		this.ctrl.npss_rct_tran_srch_processing_system = {}
		this.ctrl.npss_rct_tran_srch_processing_system.onChangecomponent = new EventEmitter<any>()
	
		//Properties of intrbk_sttlm_amnt
		this.ctrl.intrbk_sttlm_amnt = {}
		this.ctrl.intrbk_sttlm_amnt.id = "RN51CN11"
		...
		this.ctrl.intrbk_sttlm_amnt.view_name = "f_npss_rct_tran_srch"
		this.ctrl.intrbk_sttlm_amnt.ctrl_id = "npss_rct_tran_srch_intrbk_sttlm_amnt"
		this.ctrl.npss_rct_tran_srch_intrbk_sttlm_amnt = {}
		this.ctrl.npss_rct_tran_srch_intrbk_sttlm_amnt.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_rct_tran_srch.model = {"VALUE_DATE":"setcurrentdate(),{}","MEMORY63":"setcurrentdate(),{}","CDTR_IBAN":"","CR_ACCT_IDENTIFICATION":"","CDTR_ACCT_NAME":"","DBTR_IBAN":"","UETR":"","CLRSYSREF":"","PAYMENT_ENDTOEND_ID":"","PROCESSING_SYSTEM":"","INTRBK_STTLM_AMNT":""}
		this.screen_instance[this.comp_id].f_npss_rct_tran_srch.Meta = [{"CTLR_CODE":"CDN_DATE","DATA_TYPE":"DATETIME","TARGET_COLUMN":"VALUE_DATE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CR_ACCT_IDENTIFICATION"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_ACCT_NAME"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"DBTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CLRSYSREF"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PAYMENT_ENDTOEND_ID"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESSING_SYSTEM"},{"CTLR_CODE":"CDN_CUR_CTRL","DATA_TYPE":"NUMBER","TARGET_COLUMN":"INTRBK_STTLM_AMNT"}]
		this.screen_instance[this.comp_id].f_npss_rct_tran_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_rct_tran_srch.dtt_code = "dtt_1304_1665901217208"
		this.screen_instance[this.comp_id].f_npss_rct_tran_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_rct_tran_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_rct_tran_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_rct_tran_srch[control][property] = value;
  }
