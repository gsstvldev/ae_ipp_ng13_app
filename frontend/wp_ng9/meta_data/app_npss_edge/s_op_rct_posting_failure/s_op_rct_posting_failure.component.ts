...
export class s_op_rct_posting_failureComponent implements OnInit,AfterViewInit {
	...
	transaction_list__checked_changed(){
		...
		this.transaction_list__e_1678108470465()
	...
	//Handler for CHECKED_CHANGED event of "transaction list"
	transaction_list__e_1678108470465() { 
		let Dest_Is_ctrl=true
		
		let source_id="transaction_list"
		let destn_id="navigation_ui_trg_btn"
		let parent_source_id=""
		let event_code="e_1678108470465"
		let event_params={"caller_name":"transaction_list__e_1678108470465","event_desc":"E_1678108470465","event_type":"CHECKED_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{}}
		let handler_code="trigger_button_click"
		let internals=""
		let event_data={}
		let data_source={}
