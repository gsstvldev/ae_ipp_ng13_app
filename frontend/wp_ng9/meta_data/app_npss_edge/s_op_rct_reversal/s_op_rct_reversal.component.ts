...
Build ID        : 27466 
Modified By     : Admin 
Modified Date   : 2022-Dec-20 11:17 AM 
...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_cs_reversal_initiateService,npss_cs_rct_rev_approveService]
})
...
export class s_op_rct_reversalComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_change_routingkeyService:torus_cs_change_routingkeyService,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_reversal_initiateService:npss_cs_reversal_initiateService,private npss_cs_rct_rev_approveService:npss_cs_rct_rev_approveService) {
	...
	navigation_ui_search__action_button_click(){
		...
		this.navigation_ui_search__svm_for_search__search()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui search"
	navigation_ui_search__svm_for_search__search() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_search"
		let destn_id="navigation_ui_search"
		let parent_source_id=""
		let event_code="e_1671533133859"
		let event_params={"caller_name":"navigation_ui_search__svm_for_search__search","event_desc":"SVM for search","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_search","raiseparam":{}}
		let handler_code="set_value_to_memory"
		let internals=""
		let event_data={"control":{"e_1671533133859":{"dts":{"dt_1304_1665901130705":{"dtts":{"dtt_1304_1665901217208":{"uicgc_code":"CONTROL","event_code":"E_1671533133859","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"HARDCODED","column_name":"2022-12-06","level":"MI_LEVEL","name":"MI_LEVEL_CD","setd3name":""}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
