...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_cs_set_reversal_prd_system_setup_dateService,npss_cs_reversal_initiateService,npss_cs_rct_rev_approveService,npss_cs_reversal_send_to_makerService]
})
...
export class s_op_rct_reversalComponent implements OnInit,AfterViewInit {
	...
	uicgc_6 : string = "view_transaction_list"
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_change_routingkeyService:torus_cs_change_routingkeyService,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_set_reversal_prd_system_setup_dateService:npss_cs_set_reversal_prd_system_setup_dateService,private npss_cs_reversal_initiateService:npss_cs_reversal_initiateService,private npss_cs_rct_rev_approveService:npss_cs_rct_rev_approveService,private npss_cs_reversal_send_to_makerService:npss_cs_reversal_send_to_makerService) {
	...
	ngOnInit() {
		...
		// "Save" Button of "Initate UI" component
		this.initate_ui_save.label_name = "Save"
		this.initate_ui_save.show = true
		this.initate_ui_save.disabled = false
		this.initate_ui_save.params = {"icon_only":false,"uicgcc_style":"fa fa-floppy-o"}
		this.initate_ui_save.dynamic_param = {}
		this.initate_ui_save.role = []
		this.initate_ui_save.action = ""
		...
		this.reversal_details.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_22","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1677756429103","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP Reversal  Reversal code MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"reversal_code","alias_name":"","mq_id":"MQ_1677755761450","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1677755761593","date_format":false}],"joins":[]},"eq_text":"select  ntpl.uetr,  nt.npsst_id,   nt.dtt_code,  nt.dt_code,   reversal_code,  ntpl.STATUS,  ntpl.process_status,   CONCAT(NTPL.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION from  npss_trn_process_log ntpl inner join npss_transactions nt on   NTPL.UETR = nt.UETR left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = NTPL.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.STATUS = 'APPROVED' $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP Reversal  Code Desc CCD","filter":[],"databinding":[{"header":"Reversal Code","target_column":"reversal_code","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	navigation_ui_search__action_button_click(){
		...
		this.navigation_ui_search__cc_for_set_reversal_period_date()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "initate ui save"
	initate_ui_save__action_button_click(){
		this.initate_ui_save__cc_for_initate_ide()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui search"
	navigation_ui_search__cc_for_set_reversal_period_date() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_search"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1671542567068"
		let event_params={"caller_name":"navigation_ui_search__cc_for_set_reversal_period_date","event_desc":"CC for Set reversal period date","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_search","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "initate ui save"
	initate_ui_save__cc_for_initate_ide() { 
		let Dest_Is_ctrl=true
		
		let source_id="initate_ui_save"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1671188945594"
		let event_params={"caller_name":"initate_ui_save__cc_for_initate_ide","event_desc":"CC for initate ide","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"initate_ui_save","raiseparam":{}}
		let handler_code="custom_connectors"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let destn_id=""
		let parent_source_id="initate_ui_save"
		let event_code="e_1671188972977"
		let event_params={"caller_name":"cc_for_initate_ide__info_for_initate","event_desc":"info for initate","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Reversal Request has been initiated successfully","root_source_id":"initate_ui_save","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1671188997520"
		let event_params={"caller_name":"info_for_initate__rs_for_initate","event_desc":"RS for Initate","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"initate_ui_save","raiseparam":{},"parent_event_result":"SUCCESS"}
