...
@Component({
	selector: 's_op_view_dashboard',
	templateUrl: './s_op_view_dashboard.component.html',
	styleUrls: ['./s_op_view_dashboard.component.css'],
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService]
})
    
// Start of class 
export class s_op_view_dashboardComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_op_view_dashboard"
	wftpa_id : string = "WFT_NPSS_P_1304_1672920394409_0"
	cg_code : string = "CG_1304_1672918934601"
	...
	forms : any = ["uicgc_14","uicgc_16","uicgc_4","uicgc_18","uicgc_17","uicgc_12","uicgc_13","uicgc_15","uicgc_8","uicgc_6","uicgc_3"]
	...
	ngOnInit() {
		...
		this.dashboard.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_19","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672920886459","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP PL DASHBOARD MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"RESPONSE_DETAIL","alias_name":"","mq_id":"MQ_1672915674534","date_format":false},{"column_name":"RESPONSE_DETAIL_COUNT","alias_name":"","mq_id":"MQ_1672915675846","date_format":false}],"joins":[]},"eq_text":"select  COUNT (RESPONSE_DETAIL) as RESPONSE_DETAIL_COUNT,  RESPONSE_DETAIL,  RESPONSE_DETAIL_ORDER from  (  select   case    when response_code = 'ACCP'    and cbuae_return_code is null then 'ACK response received'    when response_code = 'RJCT'    and cbuae_return_code is null then 'NAK Response received'    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 'Accepted by Bene'    when response_code = 'RJCT'    and cbuae_return_code is not null then 'Rejected by Bene'    when ntpl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 'Posting Completed'    else 'Pending'   end as RESPONSE_DETAIL,   case    when response_code = 'ACCP'    and cbuae_return_code is null then 1    when response_code = 'RJCT'    and cbuae_return_code is null then 2    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 3    when response_code = 'RJCT'    and cbuae_return_code is not null then 4    when ntpl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 5    else 6   end as RESPONSE_DETAIL_ORDER,   case    when ntpl.status like 'OP%' then 'OP'   end as PROCESSTYPE,   NT.CREATED_DATE,   NT.TENANT_ID,   NT.department_code,   NT.process_type   from   npss_trn_process_log ntpl    inner join npss_transactions nt on NT.uetr= NTPL.uetr) G $WHERE group by  RESPONSE_DETAIL_ORDER,  RESPONSE_DETAIL order by  RESPONSE_DETAIL_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP PL Dashboard CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"DEPARTMENT_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"MI_LEVEL_PROCESS_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Detail","target_column":"RESPONSE_DETAIL","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Detail Count","target_column":"RESPONSE_DETAIL_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	search_search__action_button_click(){
		this.search_search__ssp_for_pl_process_type_list()
		this.search_search__cu_for_pl()
		this.search_search__cp_after_search()
		this.search_search__cu_for_tl()
	}

	//Handler for INTERNAL event of "ssp for pl process type list"
	ssp_for_pl_process_type_list__internal(parent_event_result){
		this.ssp_for_pl_process_type_list__brfq_for_process_type_list(parent_event_result)
	}

	//Handler for INTERNAL event of "brfq for process type list"
	brfq_for_process_type_list__internal(parent_event_result){
		this.brfq_for_process_type_list__sfr_for_process_type_list(parent_event_result)
	}
	...
	//Handler for INTERNAL event of "svm for pocess type list"
	svm_for_pocess_type_list__internal(parent_event_result){
		this.svm_for_pocess_type_list__ssp_for_dashboard_list(parent_event_result)
	}

	//Handler for INTERNAL event of "ssp for dashboard list"
	ssp_for_dashboard_list__internal(parent_event_result){
		this.ssp_for_dashboard_list__brfq_for_dashboard(parent_event_result)
	}
	...
	process_log_list__selection_changed(){
		...
		this.process_log_list__ee_for_back_in_vertical_tran()
		this.process_log_list__e_1672920956936()
		this.process_log_list__e_1672920994207()
		this.process_log_list__e_1672921113088()
		this.process_log_list__e_1672921136623()
	}
	...
	brfq_for_pll__internal(parent_event_result){
		this.brfq_for_pll__sfr_process_log_list(parent_event_result)
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "search search"
	search_search__ssp_for_pl_process_type_list() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"search_search__ssp_for_pl_process_type_list","event_desc":"SSP for PL Process Type list","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{}}
		let handler_code="set_search_params"
		let internals="ssp_for_pl_process_type_list__brfq_for_process_type_list,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "ssp for pl process type list"
	ssp_for_pl_process_type_list__brfq_for_process_type_list(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_for_pl_process_type_list"
		let destn_id="process_type_list"
		let parent_source_id="search_search"
		let event_code="e_1666857183261"
		let event_params={"caller_name":"ssp_for_pl_process_type_list__brfq_for_process_type_list","event_desc":"BRFQ for Process type list","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="brfq_for_process_type_list__sfr_for_process_type_list,"
		let event_data={}
	...
	//Handler for INTERNAL event of "brfq for process type list"
	brfq_for_process_type_list__sfr_for_process_type_list(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="brfq_for_process_type_list"
		let destn_id="process_type_list"
		let parent_source_id="ssp_for_pl_process_type_list"
		let event_code="e_1672921871974"
		let event_params={"caller_name":"brfq_for_process_type_list__sfr_for_process_type_list","event_desc":"SFR for Process type list","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{},"parent_event_result":"SUCCESS"}
	...
	process_type_list__svm_for_pocess_type_list() { 
		...
		let internals="svm_for_pocess_type_list__ssp_for_dashboard_list,"
	...
	//Handler for INTERNAL event of "svm for pocess type list"
	svm_for_pocess_type_list__ssp_for_dashboard_list(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="svm_for_pocess_type_list"
		let destn_id="search"
		let parent_source_id="process_type_list"
		let event_code="e_1672921463872"
		let event_params={"caller_name":"svm_for_pocess_type_list__ssp_for_dashboard_list","event_desc":"SSP for DASHBOARD list","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"process_type_list","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
		let internals="ssp_for_dashboard_list__brfq_for_dashboard,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp for dashboard list"
	ssp_for_dashboard_list__brfq_for_dashboard(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_for_dashboard_list"
		let destn_id="dashboard"
		let parent_source_id="svm_for_pocess_type_list"
		let event_code="e_1672921473709"
		let event_params={"caller_name":"ssp_for_dashboard_list__brfq_for_dashboard","event_desc":"BRFQ for Dashboard","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"process_type_list","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"BAR","chart_label":"RESPONSE_DETAIL","chart_series":"","chart_data":"RESPONSE_DETAIL_COUNT","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_19","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672920886459","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP PL DASHBOARD MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"RESPONSE_DETAIL","alias_name":"","mq_id":"MQ_1672915674534","date_format":false},{"column_name":"RESPONSE_DETAIL_COUNT","alias_name":"","mq_id":"MQ_1672915675846","date_format":false}],"joins":[]},"eq_text":"select  COUNT (RESPONSE_DETAIL) as RESPONSE_DETAIL_COUNT,  RESPONSE_DETAIL,  RESPONSE_DETAIL_ORDER from  (  select   case    when response_code = 'ACCP'    and cbuae_return_code is null then 'ACK response received'    when response_code = 'RJCT'    and cbuae_return_code is null then 'NAK Response received'    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 'Accepted by Bene'    when response_code = 'RJCT'    and cbuae_return_code is not null then 'Rejected by Bene'    when ntpl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 'Posting Completed'    else 'Pending'   end as RESPONSE_DETAIL,   case    when response_code = 'ACCP'    and cbuae_return_code is null then 1    when response_code = 'RJCT'    and cbuae_return_code is null then 2    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 3    when response_code = 'RJCT'    and cbuae_return_code is not null then 4    when ntpl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 5    else 6   end as RESPONSE_DETAIL_ORDER,   case    when ntpl.status like 'OP%' then 'OP'   end as PROCESSTYPE,   NT.CREATED_DATE,   NT.TENANT_ID,   NT.department_code,   NT.process_type   from   npss_trn_process_log ntpl    inner join npss_transactions nt on NT.uetr= NTPL.uetr) G $WHERE group by  RESPONSE_DETAIL_ORDER,  RESPONSE_DETAIL order by  RESPONSE_DETAIL_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP PL Dashboard CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"DEPARTMENT_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"MI_LEVEL_PROCESS_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Detail","target_column":"RESPONSE_DETAIL","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Detail Count","target_column":"RESPONSE_DETAIL_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__ee_for_back_in_vertical_tran() { 
		let Dest_Is_ctrl=true
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__e_1672920956936() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"process_log_list__e_1672920956936","event_desc":"E_1672920956936","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"process_log_list","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"","hide_except":"","hide_column":"","expression":""}}
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__e_1672920994207() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"process_log_list__e_1672920994207","event_desc":"E_1672920994207","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"process_log_list","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"","hide_except":"","hide_column":"","expression":""}}
		let handler_code="show_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__e_1672921113088() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"process_log_list__e_1672921113088","event_desc":"E_1672921113088","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"process_log_list","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"","hide_except":"","hide_column":"","expression":""}}
		let handler_code="show_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "process log list"
	process_log_list__e_1672921136623() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"process_log_list__e_1672921136623","event_desc":"E_1672921136623","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"process_log_list","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"","hide_except":"","hide_column":"","expression":""}}
		let handler_code="show_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	navigation_ui_view_process_log__brfq_for_hd() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_11","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672922086507","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS HST Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1666177568065","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1666177568243","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1666177568420","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1666177568588","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1666177568740","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1666177568908","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1666177569084","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1666177779261","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1666177779430","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1666177779582","date_format":true},{"column_name":"RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666177862396","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1666177862551","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1666177873590","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1666329436524","date_format":true},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809408","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809610","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1666781809810","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1666865255337","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255505","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255657","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936092675","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093146","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093458","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1667544156161","date_format":false}],"joins":[]},"eq_text":"SELECT REVERSAL_DESCRIPTION,        T24_RETURN_DESCRIPTION,        CBUAE_RETURN_DESCRIPTION,        NPSSTPL_ID,        MSG_ID,        UETR,        NPSSTRRD_REFNO,        PROCESS_NAME,        PROCESSING_SYSTEM,        RESPONSE_CODE,        PROCESS_REF_NO,        RESPONSE_DATA,        CREATED_DATE,        CREATEDDATEMILISEC,        PROCESS_STATUS,        STATUS,        REQUEST_DATA_JSON,        RESPONSE_DATA_JSON,        T24_RETURN_CODE,        CBUAE_RETURN_CODE,        REVERSAL_CODE,        REVERSAL_DESC,        T24_RETURN_DESC,        CBUAE_RETURN_DESC,        TENANT_ID,        DEPARTMENT_CODE,        DT_CODE,        DTT_CODE,AMOUNT_CREDITED,AMT_CR_LOC_CUR,CHARGE_AMOUNT,BUY_CURRENCY,SELL_CURRENCY,DEALT_AMOUNT,EXCHANGE_RATE,CONTRA_AMOUNT   FROM (SELECT A.NPSSTPL_ID,                A.MSG_ID,                A.UETR,                A.NPSSTRRD_REFNO,                A.PROCESS_NAME,                A.PROCESSING_SYSTEM,                A.RESPONSE_CODE,                A.PROCESS_REF_NO,                A.RESPONSE_DATA,                TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') AS CREATEDDATEMILISEC,                A.CREATED_DATE,                A.PROCESS_STATUS,                A.STATUS,                A.DT_CODE,                A.DTT_CODE,                A.TENANT_ID,                A.REQUEST_DATA_JSON,                A.RESPONSE_DATA_JSON,                A.T24_RETURN_CODE,                NT.DEPARTMENT_CODE,                A.ADDITIONAL_INFO,A.AMOUNT_CREDITED,A.AMT_CR_LOC_CUR,A.CHARGE_AMOUNT,A.BUY_CURRENCY,A.SELL_CURRENCY,A.DEALT_AMOUNT,A.EXCHANGE_RATE,A.CONTRA_AMOUNT,                T24RC.RETURN_DESCRIPTION AS T24_RETURN_DESC,                CONCAT(A.T24_RETURN_CODE, '-', T24RC.RETURN_DESCRIPTION) AS T24_RETURN_DESCRIPTION,                A.CBUAE_RETURN_CODE,                CBUAERC.RETURN_DESCRIPTION AS CBUAE_RETURN_DESC,                CONCAT(A.CBUAE_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) AS CBUAE_RETURN_DESCRIPTION,                A.REVERSAL_CODE,                CCD.CD_DESCRIPTION AS REVERSAL_DESC,                CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) AS REVERSAL_DESCRIPTION           FROM NPSS_TRN_PROCESS_LOG A           LEFT JOIN <tran_db>.CORE_NC_CODE_DESCRIPTIONS CCD ON CCD.CD_CODE =                                                                   A.REVERSAL_CODE                                                               AND CCD.CD_CATEGORY =                                                                   'REVERSAL_REASON_IDENTIFIER_CODE' AND CCD.STATUS = 'APPROVED'           LEFT JOIN <tran_db>.CORE_NC_RETURN_CODES T24RC ON T24RC.RETURN_CODE =                                                                A.T24_RETURN_CODE                                                            AND T24RC.PROCESSING_SYSTEM =                                                                'T24' AND T24RC.STATUS = 'APPROVED'           LEFT JOIN <tran_db>.CORE_NC_RETURN_CODES CBUAERC ON CBUAERC.RETURN_CODE =                                                                  A.CBUAE_RETURN_CODE                                                              AND CBUAERC.PROCESSING_SYSTEM =                                                                  'CBUAE' AND CBUAERC.STATUS = 'APPROVED'          INNER JOIN NPSS_TRANSACTIONS NT ON NT.UETR = A.UETR          ORDER BY A.NPSSTPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Hst Process Log","filter":[{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"T24 Return Description","target_column":"T24_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	navigation_ui_view_message_log__brfq_for_vm() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665903906193":{"st_ds":{"default":{"uicgc_code":"UICGC_10","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665903906193","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672921765669","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS REQ RESP MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_CODE","alias_name":"","mq_id":"MQ_1668573850306","date_format":false},{"column_name":"PROCESS_DETAIL","alias_name":"","mq_id":"MQ_1668573852117","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1668573852786","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1668573853731","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1668573854459","date_format":false},{"column_name":"NPSSTRRD_ID","alias_name":"","mq_id":"MQ_1668573869044","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1668573871186","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573874178","date_format":false},{"column_name":"PARENT_NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573876315","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1668573884586","date_format":false},{"column_name":"EXHF_ID","alias_name":"","mq_id":"MQ_1668573900766","date_format":false},{"column_name":"MESSAGE_DESC","alias_name":"","mq_id":"MQ_1668573911947","date_format":false},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1668573917043","date_format":false},{"column_name":"CHANNEL_PRODUCT","alias_name":"","mq_id":"MQ_1668573918291","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1668573918796","date_format":false},{"column_name":"CHANNEL_SUB_PRODUCT","alias_name":"","mq_id":"MQ_1668573919355","date_format":false},{"column_name":"CHANNEL_TRAN_CODE","alias_name":"","mq_id":"MQ_1668573919955","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1668573925605","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1668587107858","date_format":false}],"joins":[]},"eq_text":"SELECT NPSSTRRD_ID,        MSG_ID,        UETR,        PARENT_NPSSTRRD_REFNO,        NPSSTRRD_REFNO,        PROCESS_CODE,        PROCESS_DETAIL,        EXHF_ID,        PROCESS_NAME,        MESSAGE_DESC,        CHANNEL_ID,        CHANNEL_REFNO,        CHANNEL_USERID,        CHANNEL_PRODUCT,        CHANNEL_SUB_PRODUCT,        CHANNEL_TRAN_CODE,        STATUS,        PROCESS_STATUS,        MESSAGE_DATA,        CREATEDDATEMILISEC,        DT_CODE,        DTT_CODE   FROM (SELECT NPSSTRRD.NPSSTRRD_ID,                NPSSTRRD.MSG_ID,                NPSSTRRD.UETR,                NPSSTRRD.PARENT_NPSSTRRD_REFNO,                NPSSTRRD.NPSSTRRD_REFNO,                NPSSTRRD.MESSAGE_DATA,                NPSSTRRD.PROCESS_CODE,                NPSSTRRD.PROCESS_DETAIL,                NPSSTRRD.EXHF_ID,                NPSSTRRD.PROCESS_NAME,                NPSSTRRD.MESSAGE_DESC,                NPSSTRRD.CHANNEL_ID,                NPSSTRRD.CHANNEL_REFNO,                NPSSTRRD.CHANNEL_USERID,                NPSSTRRD.CHANNEL_PRODUCT,                NPSSTRRD.CHANNEL_SUB_PRODUCT,                NPSSTRRD.CHANNEL_TRAN_CODE,                NPSSTRRD.CREATED_BY,                NPSSTRRD.CREATED_BY_NAME,                NPSSTRRD.CREATED_DATE,                NPSSTRRD.DT_CODE,                NPSSTRRD.DT_DESCRIPTION,                NPSSTRRD.DTT_CODE,                NPSSTRRD.DTT_DESCRIPTION,                NPSSTRRD.MODIFIED_BY,                NPSSTRRD.MODIFIED_BY_NAME,                NPSSTRRD.MODIFIED_DATE,                NPSSTRRD.STATUS,                NPSSTRRD.PROCESS_STATUS,                NPSSTRRD.SYSTEM_ID,                NPSSTRRD.SYSTEM_NAME,                NPSSTRRD.TENANT_ID,                NPSSTRRD.APP_ID,                NPSSTRRD.VERSION_NO,                TO_CHAR(NPSSTRRD.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC           FROM NPSS_TRN_REQ_RESP_DTLS NPSSTRRD) RR $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS REQ RES CCD","filter":[{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Created Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Desc","target_column":"MESSAGE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Detail","target_column":"PROCESS_DETAIL","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let handler_code="bind_record_from_query"
		let internals="brfq_for_pll__sfr_process_log_list,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672921064299","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP PL DETAIL DASHBOARD","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1672916190160","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1672916480353","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1672916480536","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1672916490145","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1672916522769","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1672916530921","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1672916554769","date_format":false}],"joins":[]},"eq_text":"select  DATEMI,  CHANNEL_ID ,  PROCESS_TYPE ,  TENANT_ID,  UETR,  NPSST_ID ,  VALUE_DATE,  CDTR_IBAN,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  DEPARTMENT_CODE ,  PROCESSING_SYSTEM,  PAYMENT_TYPE,  PROCESS_STATUS,  STATUS,  PROCESS_NAME,  CLRSYSREF,  NPSSTPL_ID,  DT_CODE,  DTT_CODE,  request_data_json,  response_data_json,  RESPONSE_DETAIL from  (  select   TO_CHAR(PL.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,   T.CHANNEL_ID ,   T.PROCESS_TYPE ,   T.TENANT_ID,   T.UETR,   T.npsst_id ,   T.VALUE_DATE ,   T.CDTR_IBAN ,   T.INTRBK_STTLM_AMNT ,   T.INTRBK_STTLM_CUR ,   T.PAYMENT_ENDTOEND_ID ,   T.TRAN_REF_ID ,   T.DEPARTMENT_CODE ,   T.PROCESSING_SYSTEM,   T.CLRSYSREF,   case    when T.EXHF_ID is null then 'RCT'    else 'BCT'   end as PAYMENT_TYPE,   PL.PROCESS_STATUS,   PL.STATUS,   PL.PROCESS_NAME,   PL.DT_CODE,   PL.DTT_CODE,   PL.NPSSTPL_ID,   PL.request_data_json,   PL.response_data_json,   case    when response_code = 'ACCP'    and cbuae_return_code is null then 'ACK response received'    when response_code = 'RJCT'    and cbuae_return_code is null then 'NAK Response received'    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 'Accepted by Bene'    when response_code = 'RJCT'    and cbuae_return_code is not null then 'Rejected by Bene'    when pl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 'Posting Completed'    else 'Pending'   end as RESPONSE_DETAIL,   case    when PL.status like 'OP%' then 'OP'   end as PROCESSTYPE,   PL.CREATED_DATE  from   NPSS_TRANSACTIONS T  inner join NPSS_TRN_PROCESS_LOG PL on   PL.UETR = T.UETR) V $WHERE order by  NPSST_ID desc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP PL Detail Dashboard","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"DEPARTMENT_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"MI_LEVEL_PROCESS_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"RESPONSE_DETAIL","binding_name":"RESPONSE_DETAIL","binding_value":"","source_name":"MI_LEVEL_RESPONSE_DETAIL","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Type","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "brfq for pll"
	brfq_for_pll__sfr_process_log_list(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"brfq_for_pll__sfr_process_log_list","event_desc":"SFR Process Log list","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"dashboard","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1672921064299","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP PL DETAIL DASHBOARD","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1672916190160","date_format":false},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1672916480353","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1672916480536","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1672916490145","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1672916522769","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1672916530921","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1672916554769","date_format":false}],"joins":[]},"eq_text":"select  DATEMI,  CHANNEL_ID ,  PROCESS_TYPE ,  TENANT_ID,  UETR,  NPSST_ID ,  VALUE_DATE,  CDTR_IBAN,  INTRBK_STTLM_AMNT,  INTRBK_STTLM_CUR,  PAYMENT_ENDTOEND_ID,  TRAN_REF_ID,  DEPARTMENT_CODE ,  PROCESSING_SYSTEM,  PAYMENT_TYPE,  PROCESS_STATUS,  STATUS,  PROCESS_NAME,  CLRSYSREF,  NPSSTPL_ID,  DT_CODE,  DTT_CODE,  request_data_json,  response_data_json,  RESPONSE_DETAIL from  (  select   TO_CHAR(PL.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,   T.CHANNEL_ID ,   T.PROCESS_TYPE ,   T.TENANT_ID,   T.UETR,   T.npsst_id ,   T.VALUE_DATE ,   T.CDTR_IBAN ,   T.INTRBK_STTLM_AMNT ,   T.INTRBK_STTLM_CUR ,   T.PAYMENT_ENDTOEND_ID ,   T.TRAN_REF_ID ,   T.DEPARTMENT_CODE ,   T.PROCESSING_SYSTEM,   T.CLRSYSREF,   case    when T.EXHF_ID is null then 'RCT'    else 'BCT'   end as PAYMENT_TYPE,   PL.PROCESS_STATUS,   PL.STATUS,   PL.PROCESS_NAME,   PL.DT_CODE,   PL.DTT_CODE,   PL.NPSSTPL_ID,   PL.request_data_json,   PL.response_data_json,   case    when response_code = 'ACCP'    and cbuae_return_code is null then 'ACK response received'    when response_code = 'RJCT'    and cbuae_return_code is null then 'NAK Response received'    when response_code = 'ACCP'    and cbuae_return_code is not null    and process_name not in ('Receive pacs004') then 'Accepted by Bene'    when response_code = 'RJCT'    and cbuae_return_code is not null then 'Rejected by Bene'    when pl.status in ('OP_P2P_POSTING_SUCCESS', 'OP_P2B_FUND_AUTHORIZED') then 'Posting Completed'    else 'Pending'   end as RESPONSE_DETAIL,   case    when PL.status like 'OP%' then 'OP'   end as PROCESSTYPE,   PL.CREATED_DATE  from   NPSS_TRANSACTIONS T  inner join NPSS_TRN_PROCESS_LOG PL on   PL.UETR = T.UETR) V $WHERE order by  NPSST_ID desc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP PL Detail Dashboard","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"DEPARTMENT_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESSTYPE","binding_value":"","source_name":"MI_LEVEL_PROCESS_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"RESPONSE_DETAIL","binding_name":"RESPONSE_DETAIL","binding_value":"","source_name":"MI_LEVEL_RESPONSE_DETAIL","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Type","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
