...
export class s_op_view_transactionComponent implements OnInit,AfterViewInit {
	...
	process_type_list__svm_for_process_type() { 
		...
		let event_data={"process_type_list":{"e_1672903554786":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGC_23","event_code":"E_1672903554786","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Transactions","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"PROCESS_TYPE","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_TYPE","setd3name":"PROCESS_TYPE"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_STATUS","setd3name":"MI_LEVEL_PROCESS_STATUS"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_CHANNEL_ID","setd3name":"MI_LEVEL_CHANNEL_ID"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_GROUP","setd3name":"MI_LEVEL_PROCESS_GROUP"},{"type":"LOCAL","column_name":"CREATED_DATE","level":"MI_LEVEL","name":"MI_LEVEL_CREATED_DATE","setd3name":"CREATED_DATE"},{"type":"LOCAL","column_name":"datemi","level":"MI_LEVEL","name":"MI_LEVEL_datemi","setd3name":"datemi"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672904704815","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Processtype Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"process_type_count","alias_name":"","mq_id":"MQ_1672903315183","date_format":false},{"column_name":"processtype","alias_name":"","mq_id":"MQ_1672903315670","date_format":false},{"column_name":"process_type","alias_name":"","mq_id":"MQ_1672903316398","date_format":false},{"column_name":"datemi","alias_name":"","mq_id":"MQ_1672903337102","date_format":false}],"joins":[]},"eq_text":"select  count(processtype) as process_type_count,  processtype,  process_type,  datemi,created_date from  (  select   t.created_date,   to_char(t.created_date, 'YYYY-MM-DD') as datemi,   t.process_type ,   t.department_code,   case    when process_type = upper('OP') then initcap('Total Outward Payments')    when process_type = upper('IP') then initcap('Total Inward Payments')    when process_type is null then upper('unknown')   end as processtype,   t.tenant_id  from   npss_transactions t) v $WHERE group by  processtype,  process_type,  datemi,created_date"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Processtype Dashboard MQ CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Transaction Date","target_column":"datemi","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Type","target_column":"processtype","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"process_type_count","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
