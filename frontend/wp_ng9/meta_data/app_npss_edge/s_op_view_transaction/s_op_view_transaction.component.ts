...
export class s_op_view_transactionComponent implements OnInit,AfterViewInit {
	...
	uicgc_21 : string = "chart"
	uicgc_22 : string = "process_log"
	key_events : any = {}
	...
	forms : any = ["uicgc_4","uicgc_17","uicgc_16","uicgc_18","uicgc_12","uicgc_14","uicgc_13","uicgc_15","uicgc_8","uicgc_6","uicgc_3"]
	...
	ngOnInit() {
		...
		this.history_detail.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_11","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828373142","ds_final":"","final_state":"","property_json":"","system_type":"DEFAULT","eq_info":{},"listing_mode":"","locking_mode":"","locking_parameter":"","filter":[{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[]}}}}}}
		...
		this.chart.uicgc_code = "uicgc_21"
		this.chart.params = {}
		this.chart.datasource = {"e_1672827523878":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827523878","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828850258","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP Channel Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CHANNEL_COUNT","alias_name":"","mq_id":"MQ_1672829934302","date_format":false},{"column_name":"channel_id","alias_name":"","mq_id":"MQ_1672829934741","date_format":false}],"joins":[]},"eq_text":"select   COUNT(channel_id) as CHANNEL_COUNT,   channel_id  from   (   select    T.created_date,    T.channel_id ,    T.process_type ,    T.tenant_id   from    npss_transactions T) V $WHERE group by channel_id"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP Channel Dashboard CCD","filter":[{"filter_name":"CHANNEL_ID","binding_name":"CHANNEL_ID","binding_value":"","source_name":"MI_LEVEL_CHANNEL_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Channel ID","target_column":"channel_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"CHANNEL_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}},"e_1672827601812":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827601812","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828872945","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Queue Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_STATUS_COUNT","alias_name":"","mq_id":"MQ_1672833641472","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1672833641606","date_format":false}],"joins":[]},"eq_text":"SELECT   COUNT(PROCESS_STATUS) AS PROCESS_STATUS_COUNT,   PROCESS_STATUS FROM   (  SELECT    T.CREATED_DATE,    T.CHANNEL_ID ,    T.PROCESS_TYPE ,    T.TENANT_ID,    CASE    WHEN T.EXHF_ID IS NULL THEN 'RCT'    ELSE 'BCT'   END AS PAYMENT_TYPE,   PL.PROCESS_STATUS  FROM   NPSS_TRANSACTIONS T  INNER JOIN (   SELECT    T.NPSSTPL_ID,    T.UETR,    T.STATUS,    T.PROCESS_STATUS,    T.ROW_NUM   FROM    (    SELECT     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     ROW_NUMBER() OVER( PARTITION BY A.UETR    ORDER BY     A.NPSSTPL_ID DESC) AS ROW_NUM    FROM     NPSS_TRN_PROCESS_LOG A )T   WHERE    T.ROW_NUM = 1) PL ON   PL.UETR = T.UETR) V $WHERE GROUP BY  PROCESS_STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Queue Dashboard CCD","filter":[{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESS_STATUS_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}},"e_1672827442157":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827442157","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828860133","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP Payment Type Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PAYMENT_TYPE_COUNT","alias_name":"","mq_id":"MQ_1672830209207","date_format":false},{"column_name":"PAYMENT_TYPE","alias_name":"","mq_id":"MQ_1672830209366","date_format":false}],"joins":[]},"eq_text":"select   COUNT(PAYMENT_TYPE) as PAYMENT_TYPE_COUNT,   PAYMENT_TYPE from   (  select    T.created_date,    T.channel_id ,    T.process_type ,    T.tenant_id,    case    when T.EXHF_ID is null then 'RCT'    else 'BCT'   end as PAYMENT_TYPE  from    npss_trn_process_log PL  inner join npss_transactions T on    PL.uetr = T.uetr) V $WHERE group by  PAYMENT_TYPE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Payment Type Dashboard CCD","filter":[{"filter_name":"PAYMENT_TYPE","binding_name":"PAYMENT_TYPE","binding_value":"","source_name":"MI_LEVEL_PAYMENT_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Payment Type","target_column":"PAYMENT_TYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PAYMENT_TYPE_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}},"e_1672827541423":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827541423","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828838586","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Process Name Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_NAME_COUNT","alias_name":"","mq_id":"MQ_1672835105850","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1672835108736","date_format":false}],"joins":[]},"eq_text":"SELECT   COUNT(PROCESS_NAME) AS PROCESS_NAME_COUNT,   PROCESS_NAME FROM   (  SELECT    T.CREATED_DATE,    T.CHANNEL_ID ,    T.PROCESS_TYPE ,    T.TENANT_ID,    CASE    WHEN T.EXHF_ID IS NULL THEN 'RCT'    ELSE 'BCT'   END AS PAYMENT_TYPE,   PL.PROCESS_STATUS,   PL.STATUS,   PL.PROCESS_NAME  FROM   NPSS_TRANSACTIONS T  INNER JOIN (   SELECT    PLR.NPSSTPL_ID,    PLR.UETR,    PLR.STATUS,    PLR.PROCESS_STATUS,    PLR.PROCESS_NAME,    PLR.ROW_NUM   FROM    (    SELECT     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     A.CREATED_DATE,     ROW_NUMBER() OVER( PARTITION BY A.UETR    ORDER BY     A.NPSSTPL_ID DESC) AS ROW_NUM    FROM     NPSS_TRN_PROCESS_LOG A ) PLR   WHERE    PLR.ROW_NUM = 1) PL ON   PL.UETR = T.UETR) V $WHERE GROUP BY  PROCESS_NAME"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Process Name Dashboard CCD","filter":[{"filter_name":"PROCESS_NAME","binding_name":"PROCESS_NAME","binding_value":"","source_name":"MI_LEVEL_PROCESS_NAME","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESS_NAME_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.process_log.uicgc_code = "uicgc_22"
		this.process_log.params = {"need_pag_datatable":"Y","need_search":"N"}
		this.process_log.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_22","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672830939547","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Process Log AQ","eq_type":"S","eq_mode":"A","eq_designer_json":{"columns":{"class":"go.GraphLinksModel","copiesarrays":true,"copiesarrayobjects":true,"linkfromportidproperty":"fromPort","linktoportidproperty":"toPort","nodedataarray":[{"key":"NPSS_TRN_PROCESS_LOG ~NPSSTPL","category":"NPSS_TRN_PROCESS_LOG","loc":"96.99675934606216 351.00347044680905","leftarray":[],"rightarray":[],"toparray":[],"bottomarray":[],"npsstpl_id_checked":true,"created_by_checked":true,"created_by_name_checked":true,"created_by_sts_id_checked":true,"created_date_checked":true,"dtg_code_checked":true,"dtg_description_checked":true,"dt_code_checked":true,"dt_description_checked":true,"modified_by_checked":true,"modified_by_name_checked":true,"modified_by_sts_id_checked":true,"modified_date_checked":true,"prct_id_checked":true,"status_checked":true,"process_status_checked":true,"system_id_checked":true,"system_name_checked":true,"tenant_id_checked":true,"app_id_checked":true,"version_no_checked":true,"process_name_checked":true,"uetr_checked":true,"processing_system_checked":true,"msg_id_checked":true,"npsstrrd_refno_checked":true,"response_code_checked":true,"process_ref_no_checked":true,"response_data_checked":true,"request_data_json_checked":true,"response_data_json_checked":true,"t24_return_code_checked":true,"cbuae_return_code_checked":true,"reversal_code_checked":true,"additional_info_checked":true,"v_code_checked":true,"amount_credited_checked":true,"amt_cr_loc_cur_checked":true,"charge_amount_checked":true,"buy_currency_checked":true,"sell_currency_checked":true,"dealt_amount_checked":true,"exchange_rate_checked":true,"contra_amount_checked":true,"sort_order_checked":true,"process_time_checked":true,"process_type_checked":true}],"linkdataarray":[]},"joins":[],"dtts":["DTT_1304_1665905039255"],"app_dtts":[]},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"UETR","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MSG_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_DATA","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"REQUEST_DATA_JSON","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_DATA_JSON","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"T24_RETURN_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"REVERSAL_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"ADDITIONAL_INFO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"V_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"AMOUNT_CREDITED","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"AMT_CR_LOC_CUR","alias_name":"NPSSTPL","date_format":false,"currency_format":true},{"column_name":"CHARGE_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":true},{"column_name":"BUY_CURRENCY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SELL_CURRENCY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DEALT_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"EXCHANGE_RATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CONTRA_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SORT_ORDER","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_TYPE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_TIME","alias_name":"NPSSTPL","date_format":true,"currency_format":false},{"column_name":"CREATED_BY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_BY_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_BY_STS_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_DATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DTG_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DTG_DESCRIPTION","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DT_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DT_DESCRIPTION","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY_STS_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_DATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PRCT_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"STATUS","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_STATUS","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SYSTEM_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SYSTEM_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"TENANT_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"APP_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"VERSION_NO","alias_name":"NPSSTPL","date_format":false,"currency_format":false}],"joins":[{"table_name":"NPSS_TRN_PROCESS_LOG ","alias_name":"NPSSTPL","join_type":"","condition":"","sort_order":""}]},"eq_text":"SELECT NPSSTPL_ID,UETR,PROCESS_NAME,PROCESSING_SYSTEM,MSG_ID,NPSSTRRD_REFNO,RESPONSE_CODE,PROCESS_REF_NO,RESPONSE_DATA,REQUEST_DATA_JSON,RESPONSE_DATA_JSON,T24_RETURN_CODE,CBUAE_RETURN_CODE,REVERSAL_CODE,ADDITIONAL_INFO,V_CODE,AMOUNT_CREDITED,AMT_CR_LOC_CUR,CHARGE_AMOUNT,BUY_CURRENCY,SELL_CURRENCY,DEALT_AMOUNT,EXCHANGE_RATE,CONTRA_AMOUNT,SORT_ORDER,PROCESS_TYPE,PROCESS_TIME,CREATED_BY,CREATED_BY_NAME,CREATED_BY_STS_ID,CREATED_DATE,DT_CODE,DT_DESCRIPTION,DTT_CODE,DTT_DESCRIPTION,MODIFIED_BY,MODIFIED_BY_NAME,MODIFIED_BY_STS_ID,MODIFIED_DATE,PRCT_ID,STATUS,PROCESS_STATUS,SYSTEM_ID,SYSTEM_NAME,TENANT_ID,APP_ID,VERSION_NO,'SELECTED' NODE_CATEGORY FROM(SELECT NPSSTPL.NPSSTPL_ID,NPSSTPL.UETR,NPSSTPL.PROCESS_NAME,NPSSTPL.PROCESSING_SYSTEM,NPSSTPL.MSG_ID,NPSSTPL.NPSSTRRD_REFNO,NPSSTPL.RESPONSE_CODE,NPSSTPL.PROCESS_REF_NO,NPSSTPL.RESPONSE_DATA,NPSSTPL.REQUEST_DATA_JSON,NPSSTPL.RESPONSE_DATA_JSON,NPSSTPL.T24_RETURN_CODE,NPSSTPL.CBUAE_RETURN_CODE,NPSSTPL.REVERSAL_CODE,NPSSTPL.ADDITIONAL_INFO,NPSSTPL.V_CODE,NPSSTPL.AMOUNT_CREDITED,NPSSTPL.AMT_CR_LOC_CUR,NPSSTPL.CHARGE_AMOUNT,NPSSTPL.BUY_CURRENCY,NPSSTPL.SELL_CURRENCY,NPSSTPL.DEALT_AMOUNT,NPSSTPL.EXCHANGE_RATE,NPSSTPL.CONTRA_AMOUNT,NPSSTPL.SORT_ORDER,NPSSTPL.PROCESS_TYPE,NPSSTPL.PROCESS_TIME,NPSSTPL.CREATED_BY,NPSSTPL.CREATED_BY_NAME,NPSSTPL.CREATED_BY_STS_ID,NPSSTPL.CREATED_DATE,NPSSTPL.DT_CODE,NPSSTPL.DT_DESCRIPTION,NPSSTPL.DTT_CODE,NPSSTPL.DTT_DESCRIPTION,NPSSTPL.MODIFIED_BY,NPSSTPL.MODIFIED_BY_NAME,NPSSTPL.MODIFIED_BY_STS_ID,NPSSTPL.MODIFIED_DATE,NPSSTPL.PRCT_ID,NPSSTPL.STATUS,NPSSTPL.PROCESS_STATUS,NPSSTPL.SYSTEM_ID,NPSSTPL.SYSTEM_NAME,NPSSTPL.TENANT_ID,NPSSTPL.APP_ID,NPSSTPL.VERSION_NO FROM NPSS_TRN_PROCESS_LOG  NPSSTPL)T $WHERE order by NPSSTPL_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Process Log Dashboard CCD","filter":[{"filter_name":"CHANNEL_ID","binding_name":"CHANNEL_ID","binding_value":"","source_name":"MI_LEVEL_CHANNEL_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PAYMENT_TYPE","binding_name":"PAYMENT_TYPE","binding_value":"","source_name":"MI_LEVEL_PAYMENT_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_NAME","binding_name":"PROCESS_NAME","binding_value":"","source_name":"MI_LEVEL_PROCESS_NAME","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Process Type","target_column":"PROCESS_TYPE","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Process Status","target_column":"PROCESS_STATUS","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Status","target_column":"STATUS","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"UETR","target_column":"UETR","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false}]}}}}}}
	...
	ssp_for_pl_channel_group__internal(parent_event_result){
		this.ssp_for_pl_channel_group__brfq_for_queue(parent_event_result)
		this.ssp_for_pl_channel_group__brfq_for_channel_to_chart(parent_event_result)
	}
	...
	svm_for_channel__internal(parent_event_result){
		this.svm_for_channel__cc_for_queue(parent_event_result)
	...
	payment_type_group__selection_changed(){
		...
		this.payment_type_group__ee_for_back_in_vertical_tran()
		this.payment_type_group__ee_for_tran_to_vd()
		this.payment_type_group__ee_for_vlh()
		this.payment_type_group__ee_for_vm()
	}
	...
	search_search__ssp_for_pl_channel_group() { 
		...
		let internals="ssp_for_pl_channel_group__brfq_for_queue,ssp_for_pl_channel_group__brfq_for_channel_to_chart,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "ssp for pl channel group"
	ssp_for_pl_channel_group__brfq_for_queue(parent_event_result) { 
		let Dest_Is_ctrl=true
	...
	//Handler for INTERNAL event of "ssp for pl channel group"
	ssp_for_pl_channel_group__brfq_for_channel_to_chart(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="ssp_for_pl_channel_group"
		let destn_id="chart"
		let parent_source_id="search_search"
		let event_code="e_1672827523878"
		let event_params={"caller_name":"ssp_for_pl_channel_group__brfq_for_channel_to_chart","event_desc":"BRFQ For Channel to chart","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"PIE","chart_label":"STATUS","chart_series":"PROCESS_STATUS_COUNT","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"e_1672827523878":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827523878","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828850258","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP Channel Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CHANNEL_COUNT","alias_name":"","mq_id":"MQ_1672829934302","date_format":false},{"column_name":"channel_id","alias_name":"","mq_id":"MQ_1672829934741","date_format":false}],"joins":[]},"eq_text":"select   COUNT(channel_id) as CHANNEL_COUNT,   channel_id  from   (   select    T.created_date,    T.channel_id ,    T.process_type ,    T.tenant_id   from    npss_transactions T) V $WHERE group by channel_id"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP Channel Dashboard CCD","filter":[{"filter_name":"CHANNEL_ID","binding_name":"CHANNEL_ID","binding_value":"","source_name":"MI_LEVEL_CHANNEL_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Channel ID","target_column":"channel_id","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"CHANNEL_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for INTERNAL event of "svm for channel"
	svm_for_channel__cc_for_queue(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"svm_for_channel__cc_for_queue","event_desc":"CC for Queue","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"channel_group","raiseparam":{},"parent_event_result":"SUCCESS"}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"ssp_for_payment_type_list__brfq_for_payment_type_to_chart","event_desc":"BRFQ For Payment type to chart","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"channel_group","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"PIE","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"e_1672827442157":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827442157","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828860133","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP Payment Type Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PAYMENT_TYPE_COUNT","alias_name":"","mq_id":"MQ_1672830209207","date_format":false},{"column_name":"PAYMENT_TYPE","alias_name":"","mq_id":"MQ_1672830209366","date_format":false}],"joins":[]},"eq_text":"select   COUNT(PAYMENT_TYPE) as PAYMENT_TYPE_COUNT,   PAYMENT_TYPE from   (  select    T.created_date,    T.channel_id ,    T.process_type ,    T.tenant_id,    case    when T.EXHF_ID is null then 'RCT'    else 'BCT'   end as PAYMENT_TYPE  from    npss_trn_process_log PL  inner join npss_transactions T on    PL.uetr = T.uetr) V $WHERE group by  PAYMENT_TYPE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Payment Type Dashboard CCD","filter":[{"filter_name":"PAYMENT_TYPE","binding_name":"PAYMENT_TYPE","binding_value":"","source_name":"MI_LEVEL_PAYMENT_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Payment Type","target_column":"PAYMENT_TYPE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PAYMENT_TYPE_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for SELECTION_CHANGED event of "payment type group"
	payment_type_group__ee_for_back_in_vertical_tran() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"payment_type_group__ee_for_back_in_vertical_tran","event_desc":"EE for Back in Vertical tran","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_type_group","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
	...
	//Handler for SELECTION_CHANGED event of "payment type group"
	payment_type_group__ee_for_tran_to_vd() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"payment_type_group__ee_for_tran_to_vd","event_desc":"EE for Tran to VD","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_type_group","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "payment type group"
	payment_type_group__ee_for_vlh() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"payment_type_group__ee_for_vlh","event_desc":"EE for VLH","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_type_group","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	payment_type_group__ee_for_vm() { 
		...
		let event_params={"caller_name":"payment_type_group__ee_for_vm","event_desc":"EE For VM","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_type_group","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"ssp_for_ptg_to_queue__brfq_for_queue_to_chart","event_desc":"BRFQ For Queue to chart","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"payment_type_group","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"PIE","chart_label":"STATUS","chart_series":"STATUS_COUNT","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"e_1672827601812":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827601812","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828872945","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Queue Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_STATUS_COUNT","alias_name":"","mq_id":"MQ_1672833641472","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1672833641606","date_format":false}],"joins":[]},"eq_text":"SELECT   COUNT(PROCESS_STATUS) AS PROCESS_STATUS_COUNT,   PROCESS_STATUS FROM   (  SELECT    T.CREATED_DATE,    T.CHANNEL_ID ,    T.PROCESS_TYPE ,    T.TENANT_ID,    CASE    WHEN T.EXHF_ID IS NULL THEN 'RCT'    ELSE 'BCT'   END AS PAYMENT_TYPE,   PL.PROCESS_STATUS  FROM   NPSS_TRANSACTIONS T  INNER JOIN (   SELECT    T.NPSSTPL_ID,    T.UETR,    T.STATUS,    T.PROCESS_STATUS,    T.ROW_NUM   FROM    (    SELECT     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     ROW_NUMBER() OVER( PARTITION BY A.UETR    ORDER BY     A.NPSSTPL_ID DESC) AS ROW_NUM    FROM     NPSS_TRN_PROCESS_LOG A )T   WHERE    T.ROW_NUM = 1) PL ON   PL.UETR = T.UETR) V $WHERE GROUP BY  PROCESS_STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Queue Dashboard CCD","filter":[{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESS_STATUS_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	navigation_ui_view_process_log__brfq_for_hd() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_11","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828373142","ds_final":"","final_state":"","property_json":"","system_type":"DEFAULT","eq_info":{},"listing_mode":"","locking_mode":"","locking_parameter":"","filter":[{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"ssp_for_queue_group__brfq_for__message_type_to_chart","event_desc":"BRFQ For  Message type to chart","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"queue_group","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"PIE","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"e_1672827541423":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_21","event_code":"E_1672827541423","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672828838586","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Process Name Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_NAME_COUNT","alias_name":"","mq_id":"MQ_1672835105850","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1672835108736","date_format":false}],"joins":[]},"eq_text":"SELECT   COUNT(PROCESS_NAME) AS PROCESS_NAME_COUNT,   PROCESS_NAME FROM   (  SELECT    T.CREATED_DATE,    T.CHANNEL_ID ,    T.PROCESS_TYPE ,    T.TENANT_ID,    CASE    WHEN T.EXHF_ID IS NULL THEN 'RCT'    ELSE 'BCT'   END AS PAYMENT_TYPE,   PL.PROCESS_STATUS,   PL.STATUS,   PL.PROCESS_NAME  FROM   NPSS_TRANSACTIONS T  INNER JOIN (   SELECT    PLR.NPSSTPL_ID,    PLR.UETR,    PLR.STATUS,    PLR.PROCESS_STATUS,    PLR.PROCESS_NAME,    PLR.ROW_NUM   FROM    (    SELECT     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     A.CREATED_DATE,     ROW_NUMBER() OVER( PARTITION BY A.UETR    ORDER BY     A.NPSSTPL_ID DESC) AS ROW_NUM    FROM     NPSS_TRN_PROCESS_LOG A ) PLR   WHERE    PLR.ROW_NUM = 1) PL ON   PL.UETR = T.UETR) V $WHERE GROUP BY  PROCESS_NAME"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Process Name Dashboard CCD","filter":[{"filter_name":"PROCESS_NAME","binding_name":"PROCESS_NAME","binding_value":"","source_name":"MI_LEVEL_PROCESS_NAME","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESS_NAME_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"svm_for_chart__e_1672830905015","event_desc":"E_1672830905015","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"chart","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="set_search_params"
	...
	e_1672830905015__e_1672830918342() { 
		...
		let event_params={"caller_name":"e_1672830905015__e_1672830918342","event_desc":"E_1672830918342","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"chart","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N"}}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_22","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1672830939547","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"Process Log AQ","eq_type":"S","eq_mode":"A","eq_designer_json":{"columns":{"class":"go.GraphLinksModel","copiesarrays":true,"copiesarrayobjects":true,"linkfromportidproperty":"fromPort","linktoportidproperty":"toPort","nodedataarray":[{"key":"NPSS_TRN_PROCESS_LOG ~NPSSTPL","category":"NPSS_TRN_PROCESS_LOG","loc":"96.99675934606216 351.00347044680905","leftarray":[],"rightarray":[],"toparray":[],"bottomarray":[],"npsstpl_id_checked":true,"created_by_checked":true,"created_by_name_checked":true,"created_by_sts_id_checked":true,"created_date_checked":true,"dtg_code_checked":true,"dtg_description_checked":true,"dt_code_checked":true,"dt_description_checked":true,"modified_by_checked":true,"modified_by_name_checked":true,"modified_by_sts_id_checked":true,"modified_date_checked":true,"prct_id_checked":true,"status_checked":true,"process_status_checked":true,"system_id_checked":true,"system_name_checked":true,"tenant_id_checked":true,"app_id_checked":true,"version_no_checked":true,"process_name_checked":true,"uetr_checked":true,"processing_system_checked":true,"msg_id_checked":true,"npsstrrd_refno_checked":true,"response_code_checked":true,"process_ref_no_checked":true,"response_data_checked":true,"request_data_json_checked":true,"response_data_json_checked":true,"t24_return_code_checked":true,"cbuae_return_code_checked":true,"reversal_code_checked":true,"additional_info_checked":true,"v_code_checked":true,"amount_credited_checked":true,"amt_cr_loc_cur_checked":true,"charge_amount_checked":true,"buy_currency_checked":true,"sell_currency_checked":true,"dealt_amount_checked":true,"exchange_rate_checked":true,"contra_amount_checked":true,"sort_order_checked":true,"process_time_checked":true,"process_type_checked":true}],"linkdataarray":[]},"joins":[],"dtts":["DTT_1304_1665905039255"],"app_dtts":[]},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"UETR","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MSG_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_DATA","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"REQUEST_DATA_JSON","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"RESPONSE_DATA_JSON","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"T24_RETURN_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"REVERSAL_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"ADDITIONAL_INFO","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"V_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"AMOUNT_CREDITED","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"AMT_CR_LOC_CUR","alias_name":"NPSSTPL","date_format":false,"currency_format":true},{"column_name":"CHARGE_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":true},{"column_name":"BUY_CURRENCY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SELL_CURRENCY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DEALT_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"EXCHANGE_RATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CONTRA_AMOUNT","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SORT_ORDER","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_TYPE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_TIME","alias_name":"NPSSTPL","date_format":true,"currency_format":false},{"column_name":"CREATED_BY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_BY_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_BY_STS_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"CREATED_DATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DTG_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DTG_DESCRIPTION","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DT_CODE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"DT_DESCRIPTION","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_BY_STS_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"MODIFIED_DATE","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PRCT_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"STATUS","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"PROCESS_STATUS","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SYSTEM_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"SYSTEM_NAME","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"TENANT_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"APP_ID","alias_name":"NPSSTPL","date_format":false,"currency_format":false},{"column_name":"VERSION_NO","alias_name":"NPSSTPL","date_format":false,"currency_format":false}],"joins":[{"table_name":"NPSS_TRN_PROCESS_LOG ","alias_name":"NPSSTPL","join_type":"","condition":"","sort_order":""}]},"eq_text":"SELECT NPSSTPL_ID,UETR,PROCESS_NAME,PROCESSING_SYSTEM,MSG_ID,NPSSTRRD_REFNO,RESPONSE_CODE,PROCESS_REF_NO,RESPONSE_DATA,REQUEST_DATA_JSON,RESPONSE_DATA_JSON,T24_RETURN_CODE,CBUAE_RETURN_CODE,REVERSAL_CODE,ADDITIONAL_INFO,V_CODE,AMOUNT_CREDITED,AMT_CR_LOC_CUR,CHARGE_AMOUNT,BUY_CURRENCY,SELL_CURRENCY,DEALT_AMOUNT,EXCHANGE_RATE,CONTRA_AMOUNT,SORT_ORDER,PROCESS_TYPE,PROCESS_TIME,CREATED_BY,CREATED_BY_NAME,CREATED_BY_STS_ID,CREATED_DATE,DT_CODE,DT_DESCRIPTION,DTT_CODE,DTT_DESCRIPTION,MODIFIED_BY,MODIFIED_BY_NAME,MODIFIED_BY_STS_ID,MODIFIED_DATE,PRCT_ID,STATUS,PROCESS_STATUS,SYSTEM_ID,SYSTEM_NAME,TENANT_ID,APP_ID,VERSION_NO,'SELECTED' NODE_CATEGORY FROM(SELECT NPSSTPL.NPSSTPL_ID,NPSSTPL.UETR,NPSSTPL.PROCESS_NAME,NPSSTPL.PROCESSING_SYSTEM,NPSSTPL.MSG_ID,NPSSTPL.NPSSTRRD_REFNO,NPSSTPL.RESPONSE_CODE,NPSSTPL.PROCESS_REF_NO,NPSSTPL.RESPONSE_DATA,NPSSTPL.REQUEST_DATA_JSON,NPSSTPL.RESPONSE_DATA_JSON,NPSSTPL.T24_RETURN_CODE,NPSSTPL.CBUAE_RETURN_CODE,NPSSTPL.REVERSAL_CODE,NPSSTPL.ADDITIONAL_INFO,NPSSTPL.V_CODE,NPSSTPL.AMOUNT_CREDITED,NPSSTPL.AMT_CR_LOC_CUR,NPSSTPL.CHARGE_AMOUNT,NPSSTPL.BUY_CURRENCY,NPSSTPL.SELL_CURRENCY,NPSSTPL.DEALT_AMOUNT,NPSSTPL.EXCHANGE_RATE,NPSSTPL.CONTRA_AMOUNT,NPSSTPL.SORT_ORDER,NPSSTPL.PROCESS_TYPE,NPSSTPL.PROCESS_TIME,NPSSTPL.CREATED_BY,NPSSTPL.CREATED_BY_NAME,NPSSTPL.CREATED_BY_STS_ID,NPSSTPL.CREATED_DATE,NPSSTPL.DT_CODE,NPSSTPL.DT_DESCRIPTION,NPSSTPL.DTT_CODE,NPSSTPL.DTT_DESCRIPTION,NPSSTPL.MODIFIED_BY,NPSSTPL.MODIFIED_BY_NAME,NPSSTPL.MODIFIED_BY_STS_ID,NPSSTPL.MODIFIED_DATE,NPSSTPL.PRCT_ID,NPSSTPL.STATUS,NPSSTPL.PROCESS_STATUS,NPSSTPL.SYSTEM_ID,NPSSTPL.SYSTEM_NAME,NPSSTPL.TENANT_ID,NPSSTPL.APP_ID,NPSSTPL.VERSION_NO FROM NPSS_TRN_PROCESS_LOG  NPSSTPL)T $WHERE order by NPSSTPL_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Process Log Dashboard CCD","filter":[{"filter_name":"CHANNEL_ID","binding_name":"CHANNEL_ID","binding_value":"","source_name":"MI_LEVEL_CHANNEL_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PAYMENT_TYPE","binding_name":"PAYMENT_TYPE","binding_value":"","source_name":"MI_LEVEL_PAYMENT_TYPE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_NAME","binding_name":"PROCESS_NAME","binding_value":"","source_name":"MI_LEVEL_PROCESS_NAME","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Process Type","target_column":"PROCESS_TYPE","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Process Status","target_column":"PROCESS_STATUS","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"Status","target_column":"STATUS","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false},{"header":"UETR","target_column":"UETR","alias_name":"NPSSTPL","alignment":"Left","width":"","format":"","date_format":false,"currency_format":false}]}}}}}}
