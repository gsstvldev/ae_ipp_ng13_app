...
Build ID        : 35095 
Modified By     : Admin 
Modified Date   : 2024-Apr-05 6:19 AM 
...
import { s_outward_arc_transactions_detailsRoutingModule } from './s_outward_arc_transactions_details.routing.module';
...
import { f_npss_op_arc_transaction_report_srchComponent } from './f_npss_op_arc_transaction_report_srch/f_npss_op_arc_transaction_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_outward_arc_transactions_detailsRoutingModule,
  ...
  declarations: [s_outward_arc_transactions_detailsComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_op_arc_transaction_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_outward_arc_transactions_detailsModule { }
