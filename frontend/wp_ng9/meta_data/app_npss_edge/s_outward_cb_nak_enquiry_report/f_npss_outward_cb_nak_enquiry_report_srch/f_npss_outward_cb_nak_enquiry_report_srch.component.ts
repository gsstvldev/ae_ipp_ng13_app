...
Form Name       : NPSS Outward CB NAK Enquiry Report SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_outward_cb_nak_enquiry_report_srch',
  templateUrl: './f_npss_outward_cb_nak_enquiry_report_srch.component.html',
  styleUrls: ['./f_npss_outward_cb_nak_enquiry_report_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_outward_cb_nak_enquiry_report_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_outward_cb_nak_enquiry_report_srch') form;
  @ViewChild('npss_outward_cb_nak_enquiry_report_srch_memory118') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory118.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.memory118.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_memory118"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_memory118 = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_memory118.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.payment_endtoend_id.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.payment_endtoend_id.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_payment_endtoend_id"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_payment_endtoend_id = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_payment_endtoend_id.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.department_code.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.department_code.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_department_code"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_department_code = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_department_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch.department_code = {}
		...
		this.ctrl.dbtr_iban.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.dbtr_iban.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_dbtr_iban"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_dbtr_iban = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_dbtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.intrbk_sttlm_amnt.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.intrbk_sttlm_amnt.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_intrbk_sttlm_amnt"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_intrbk_sttlm_amnt = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_intrbk_sttlm_amnt.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.process_group.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.process_group.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_process_group"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_process_group = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_process_group.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch.process_group = {}
		...
		this.ctrl.memory63.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.memory63.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_memory63"
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_memory63 = {}
		this.ctrl.npss_outward_cb_nak_enquiry_report_srch_memory63.onChangecomponent = new EventEmitter<any>()
	
		//Properties of memory142
		this.ctrl.memory142 = {}
		this.ctrl.memory142.id = "RN21CN8"
		this.ctrl.memory142.desc = "Bene Bank Name"
		this.ctrl.memory142.visible = true
		this.ctrl.memory142.label_name = "Bene Bank Name"
		...
		this.ctrl.memory142.view_name = "f_npss_outward_cb_nak_enquiry_report_srch"
		this.ctrl.memory142.ctrl_id = "npss_outward_cb_nak_enquiry_report_srch_memory142"
		...
		this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_outward_cb_nak_enquiry_report_srch[control][property] = value;
  }
