...
import { s_outward_cb_nak_enquiry_reportRoutingModule } from './s_outward_cb_nak_enquiry_report.routing.module';
...
import { f_npss_outward_cb_nak_enquiry_report_srchComponent } from './f_npss_outward_cb_nak_enquiry_report_srch/f_npss_outward_cb_nak_enquiry_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_outward_cb_nak_enquiry_reportRoutingModule,
  ...
  declarations: [s_outward_cb_nak_enquiry_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_outward_cb_nak_enquiry_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_outward_cb_nak_enquiry_reportModule { }
