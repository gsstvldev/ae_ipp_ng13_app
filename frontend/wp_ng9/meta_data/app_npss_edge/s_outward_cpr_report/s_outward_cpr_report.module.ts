...
import { s_outward_cpr_reportRoutingModule } from './s_outward_cpr_report.routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    s_outward_cpr_reportRoutingModule,
  ...
  declarations: [s_outward_cpr_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_inward_cpr_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_outward_cpr_reportModule { }
