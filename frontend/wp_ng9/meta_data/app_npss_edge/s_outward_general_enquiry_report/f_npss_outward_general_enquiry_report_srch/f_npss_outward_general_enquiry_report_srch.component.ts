...
Form Name       : NPSS Outward General Enquiry Report SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_outward_general_enquiry_report_srch',
  templateUrl: './f_npss_outward_general_enquiry_report_srch.component.html',
  styleUrls: ['./f_npss_outward_general_enquiry_report_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_outward_general_enquiry_report_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_outward_general_enquiry_report_srch') form;
  @ViewChild('npss_outward_general_enquiry_report_srch_memory75') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory75.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.memory75.ctrl_id = "npss_outward_general_enquiry_report_srch_memory75"
		this.ctrl.npss_outward_general_enquiry_report_srch_memory75 = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_memory75.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.memory75 = {}
	
		//Properties of memory108
		this.ctrl.memory108 = {}
		this.ctrl.memory108.id = "RN01CN2001"
		...
		this.ctrl.memory108.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.memory108.ctrl_id = "npss_outward_general_enquiry_report_srch_memory108"
		this.ctrl.npss_outward_general_enquiry_report_srch_memory108 = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_memory108.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.memory108 = {}
		...
		this.ctrl.department_code.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.department_code.ctrl_id = "npss_outward_general_enquiry_report_srch_department_code"
		this.ctrl.npss_outward_general_enquiry_report_srch_department_code = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_department_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.department_code = {}
	
		//Properties of process_type
		this.ctrl.process_type = {}
		this.ctrl.process_type.id = "RN11CN4"
		...
		this.ctrl.process_type.data_source = {"ds_code":"UDS_1304_1680240394650","ds_description":"Process Type OP cdb","rows":[{"value":"OP","code":"OP"}],"type":"DPS_STATIC","value_member":"CODE","display_member":"VALUE","first_record_display":"","column_list":"CODE;VALUE","order_by":"","target_table":"","context":"","filters":[],"type_desc":"Combo Binding Static","conditional_operator":"CONTAINS","need_first_item_selection":true,"sel_columns":[]}
		...
		this.ctrl.process_type.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.process_type.ctrl_id = "npss_outward_general_enquiry_report_srch_process_type"
		this.ctrl.npss_outward_general_enquiry_report_srch_process_type = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_process_type.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.process_type = {}
		...
		this.ctrl.process_group.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.process_group.ctrl_id = "npss_outward_general_enquiry_report_srch_process_group"
		this.ctrl.npss_outward_general_enquiry_report_srch_process_group = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_process_group.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.process_group = {}
		...
		this.ctrl.channel_id.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.channel_id.ctrl_id = "npss_outward_general_enquiry_report_srch_channel_id"
		this.ctrl.npss_outward_general_enquiry_report_srch_channel_id = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_channel_id.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.channel_id = {}
	
		//Properties of payment_endtoend_id
		this.ctrl.payment_endtoend_id = {}
		this.ctrl.payment_endtoend_id.id = "RN11CN5"
		...
		this.ctrl.payment_endtoend_id.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.payment_endtoend_id.ctrl_id = "npss_outward_general_enquiry_report_srch_payment_endtoend_id"
		this.ctrl.npss_outward_general_enquiry_report_srch_payment_endtoend_id = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_payment_endtoend_id.onChangecomponent = new EventEmitter<any>()
	
		//Properties of value_date
		this.ctrl.value_date = {}
		this.ctrl.value_date.id = "RN11CN6"
		...
		this.ctrl.value_date.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.value_date.ctrl_id = "npss_outward_general_enquiry_report_srch_value_date"
		this.ctrl.npss_outward_general_enquiry_report_srch_value_date = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_value_date.onChangecomponent = new EventEmitter<any>()
	
		//Properties of memory63
		this.ctrl.memory63 = {}
		this.ctrl.memory63.id = "RN21CN8"
		...
		this.ctrl.memory63.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.memory63.ctrl_id = "npss_outward_general_enquiry_report_srch_memory63"
		this.ctrl.npss_outward_general_enquiry_report_srch_memory63 = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_memory63.onChangecomponent = new EventEmitter<any>()
	
		//Properties of memory149
		this.ctrl.memory149 = {}
		this.ctrl.memory149.id = "RN21CN22"
		...
		this.ctrl.memory149.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.memory149.ctrl_id = "npss_outward_general_enquiry_report_srch_memory149"
		this.ctrl.npss_outward_general_enquiry_report_srch_memory149 = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_memory149.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.dbtr_iban.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.dbtr_iban.ctrl_id = "npss_outward_general_enquiry_report_srch_dbtr_iban"
		this.ctrl.npss_outward_general_enquiry_report_srch_dbtr_iban = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_dbtr_iban.onChangecomponent = new EventEmitter<any>()
	
		//Properties of dbtr_acct_name
		this.ctrl.dbtr_acct_name = {}
		this.ctrl.dbtr_acct_name.id = "RN31CN11"
		...
		this.ctrl.dbtr_acct_name.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.dbtr_acct_name.ctrl_id = "npss_outward_general_enquiry_report_srch_dbtr_acct_name"
		this.ctrl.npss_outward_general_enquiry_report_srch_dbtr_acct_name = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_dbtr_acct_name.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cdtr_iban
		this.ctrl.cdtr_iban = {}
		this.ctrl.cdtr_iban.id = "RN31CN12"
		...
		this.ctrl.cdtr_iban.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.cdtr_iban.ctrl_id = "npss_outward_general_enquiry_report_srch_cdtr_iban"
		this.ctrl.npss_outward_general_enquiry_report_srch_cdtr_iban = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_cdtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cdtr_acct_name.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.cdtr_acct_name.ctrl_id = "npss_outward_general_enquiry_report_srch_cdtr_acct_name"
		this.ctrl.npss_outward_general_enquiry_report_srch_cdtr_acct_name = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_cdtr_acct_name.onChangecomponent = new EventEmitter<any>()
	
		//Properties of intrbk_sttlm_amnt
		this.ctrl.intrbk_sttlm_amnt = {}
		this.ctrl.intrbk_sttlm_amnt.id = "RN41CN14"
		...
		this.ctrl.intrbk_sttlm_amnt.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.intrbk_sttlm_amnt.ctrl_id = "npss_outward_general_enquiry_report_srch_intrbk_sttlm_amnt"
		this.ctrl.npss_outward_general_enquiry_report_srch_intrbk_sttlm_amnt = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_intrbk_sttlm_amnt.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cr_sort_code
		this.ctrl.cr_sort_code = {}
		this.ctrl.cr_sort_code.id = "RN41CN15"
		...
		this.ctrl.cr_sort_code.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.cr_sort_code.ctrl_id = "npss_outward_general_enquiry_report_srch_cr_sort_code"
		this.ctrl.npss_outward_general_enquiry_report_srch_cr_sort_code = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_cr_sort_code.onChangecomponent = new EventEmitter<any>()
	
		//Properties of tran_ref_id
		this.ctrl.tran_ref_id = {}
		this.ctrl.tran_ref_id.id = "RN51CN20"
		...
		this.ctrl.tran_ref_id.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.tran_ref_id.ctrl_id = "npss_outward_general_enquiry_report_srch_tran_ref_id"
		this.ctrl.npss_outward_general_enquiry_report_srch_tran_ref_id = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_tran_ref_id.onChangecomponent = new EventEmitter<any>()
	
		//Properties of uetr
		this.ctrl.uetr = {}
		this.ctrl.uetr.id = "RN81CN27"
		...
		this.ctrl.uetr.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.uetr.ctrl_id = "npss_outward_general_enquiry_report_srch_uetr"
		this.ctrl.npss_outward_general_enquiry_report_srch_uetr = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_uetr.onChangecomponent = new EventEmitter<any>()
	
		//Properties of memory101
		this.ctrl.memory101 = {}
		this.ctrl.memory101.id = "RN81CN28"
		...
		this.ctrl.memory101.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.memory101.ctrl_id = "npss_outward_general_enquiry_report_srch_memory101"
		this.ctrl.npss_outward_general_enquiry_report_srch_memory101 = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_memory101.onChangecomponent = new EventEmitter<any>()
	
		//Properties of ext_purpose_code
		this.ctrl.ext_purpose_code = {}
		this.ctrl.ext_purpose_code.id = "RN51CN19"
		...
		this.ctrl.ext_purpose_code.view_name = "f_npss_outward_general_enquiry_report_srch"
		this.ctrl.ext_purpose_code.ctrl_id = "npss_outward_general_enquiry_report_srch_ext_purpose_code"
		this.ctrl.npss_outward_general_enquiry_report_srch_ext_purpose_code = {}
		this.ctrl.npss_outward_general_enquiry_report_srch_ext_purpose_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.ext_purpose_code = {}
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.model = {"MEMORY75":"","MEMORY108":"","DEPARTMENT_CODE":"","PROCESS_TYPE":"","PROCESS_GROUP":"","CHANNEL_ID":"","PAYMENT_ENDTOEND_ID":"","VALUE_DATE":"setcurrentdate(),{}","MEMORY63":"setcurrentdate(),{}","MEMORY149":"","DBTR_IBAN":"","DBTR_ACCT_NAME":"","CDTR_IBAN":"","CDTR_ACCT_NAME":"","INTRBK_STTLM_AMNT":"","CR_SORT_CODE":"","TRAN_REF_ID":"","UETR":"","MEMORY101":"","EXT_PURPOSE_CODE":""}
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.Meta = [{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"DEPARTMENT_CODE"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_TYPE"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_GROUP"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"CHANNEL_ID"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PAYMENT_ENDTOEND_ID"},{"CTLR_CODE":"CDN_DATE","DATA_TYPE":"DATETIME","TARGET_COLUMN":"VALUE_DATE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"DBTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"DBTR_ACCT_NAME"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_ACCT_NAME"},{"CTLR_CODE":"CDN_CUR_CTRL","DATA_TYPE":"NUMBER","TARGET_COLUMN":"INTRBK_STTLM_AMNT"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CR_SORT_CODE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"TRAN_REF_ID"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"EXT_PURPOSE_CODE"}]
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.dtt_code = "dtt_1304_1665901217208"
		this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_outward_general_enquiry_report_srch[control][property] = value;
  }
