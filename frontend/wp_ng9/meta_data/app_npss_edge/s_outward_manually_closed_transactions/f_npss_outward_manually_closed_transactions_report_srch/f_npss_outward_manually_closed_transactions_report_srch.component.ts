...
Build ID        : 34789 
Modified By     : Admin 
Modified Date   : 2024-Mar-15 13:31 PM 
Generated From  : TORUS Low Code Platform 
Copyright       : Torus Innovations Pvt Ltd © Copyright 2018 
Screen Name     : s_outward_manually_closed_transactions
Form Name       : NPSS Outward Manually Closed Transactions Report SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_outward_manually_closed_transactions_report_srch',
  templateUrl: './f_npss_outward_manually_closed_transactions_report_srch.component.html',
  styleUrls: ['./f_npss_outward_manually_closed_transactions_report_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_outward_manually_closed_transactions_report_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_outward_manually_closed_transactions_report_srch') form;
  @ViewChild('npss_outward_manually_closed_transactions_report_srch_value_date') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.value_date.id = "RN01CN2"
		...
		this.ctrl.value_date.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.value_date.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_value_date"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_value_date = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_value_date.onChangecomponent = new EventEmitter<any>()
	
		//Properties of dbtr_iban
		this.ctrl.dbtr_iban = {}
		this.ctrl.dbtr_iban.id = "RN01CN4"
		...
		this.ctrl.dbtr_iban.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.dbtr_iban.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_dbtr_iban"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_dbtr_iban = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_dbtr_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.cdtr_iban.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.cdtr_iban.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_cdtr_iban"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_cdtr_iban = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_cdtr_iban.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cr_sort_code
		this.ctrl.cr_sort_code = {}
		this.ctrl.cr_sort_code.id = "RN11CN7"
		...
		this.ctrl.cr_sort_code.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.cr_sort_code.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_cr_sort_code"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_cr_sort_code = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_cr_sort_code.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.payment_endtoend_id.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.payment_endtoend_id.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_payment_endtoend_id"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_payment_endtoend_id = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_payment_endtoend_id.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.uetr.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.uetr.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_uetr"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_uetr = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_uetr.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.intrbk_sttlm_amnt.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.intrbk_sttlm_amnt.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_intrbk_sttlm_amnt"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_intrbk_sttlm_amnt = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_intrbk_sttlm_amnt.onChangecomponent = new EventEmitter<any>()
	
		//Properties of department_code
		this.ctrl.department_code = {}
		this.ctrl.department_code.id = "RN31CN11"
		...
		this.ctrl.department_code.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.department_code.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_department_code"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_department_code = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_department_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.department_code = {}
	
		//Properties of memory106
		this.ctrl.memory106 = {}
		this.ctrl.memory106.id = "RN11CN6"
		...
		this.ctrl.memory106.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.memory106.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_memory106"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_memory106 = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_memory106.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.memory106 = {}
		...
		this.ctrl.process_group.view_name = "f_npss_outward_manually_closed_transactions_report_srch"
		this.ctrl.process_group.ctrl_id = "npss_outward_manually_closed_transactions_report_srch_process_group"
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_process_group = {}
		this.ctrl.npss_outward_manually_closed_transactions_report_srch_process_group.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.process_group = {}
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.model = {"VALUE_DATE":"setcurrentdate(),{}","DBTR_IBAN":"","CDTR_IBAN":"","CR_SORT_CODE":"","PAYMENT_ENDTOEND_ID":"","UETR":"","INTRBK_STTLM_AMNT":"","DEPARTMENT_CODE":"","MEMORY106":"","PROCESS_GROUP":""}
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.Meta = [{"CTLR_CODE":"CDN_DATE","DATA_TYPE":"DATETIME","TARGET_COLUMN":"VALUE_DATE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"DBTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CDTR_IBAN"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"CR_SORT_CODE"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PAYMENT_ENDTOEND_ID"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"},{"CTLR_CODE":"CDN_CUR_CTRL","DATA_TYPE":"NUMBER","TARGET_COLUMN":"INTRBK_STTLM_AMNT"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"DEPARTMENT_CODE"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_GROUP"}]
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.dtt_code = "dtt_1304_1665901217208"
		this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_outward_manually_closed_transactions_report_srch[control][property] = value;
  }
