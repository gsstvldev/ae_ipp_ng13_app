...
export class s_outward_manually_closed_transactionsComponent implements OnInit,AfterViewInit {
	...
	search_search__ssp_from_search_btn_to_search_cmnt() { 
		...
		let destn_id="search"
		let parent_source_id=""
		let event_code="e_1710411725992"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1710411744332"
