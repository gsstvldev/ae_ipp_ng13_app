...
export class s_outward_transactions_detailsComponent implements OnInit,AfterViewInit {
	...
	uicgc_3 : string = "outward_transactions_details"
	...
	outward_transactions_details : any = {}
	search : any = {}
	search_clear : any = {}
	search_search : any = {}
	...
	ngOnInit() {
		...
		// Component level properties - "Outward Transactions Details" 
		this.outward_transactions_details.uictrl_code = "label"
		this.outward_transactions_details.uicgc_desc = "Outward Transactions Details"
		this.outward_transactions_details.uicgc_code = "uicgc_3"
		this.outward_transactions_details.params = {}
		this.outward_transactions_details.datasource = {}
		this.outward_transactions_details.context_menu = []
		this.outward_transactions_details.views = {}
		this.outward_transactions_details.onChangecomponent = new EventEmitter<any>()
		this.outward_transactions_details.show = true
		this.outward_transactions_details.dynamic_param = {}
	...
	page_load__tbc_from_pl_to_search_btn() { 
		...
		let parent_source_id=""
		let event_code="e_1708327485849"
