...
Form Name       : NPSS P2B Request UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_p2b_request_ui',
  templateUrl: './f_npss_p2b_request_ui.component.html',
  styleUrls: ['./f_npss_p2b_request_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_p2b_request_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_p2b_request_ui') form;
  @ViewChild('npss_p2b_request_ui_memory10') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory10.view_name = "f_npss_p2b_request_ui"
		this.ctrl.memory10.ctrl_id = "npss_p2b_request_ui_memory10"
		this.ctrl.npss_p2b_request_ui_memory10 = {}
		this.ctrl.npss_p2b_request_ui_memory10.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_p2b_request_ui.model = {"MEMORY10":""}
		this.screen_instance[this.comp_id].f_npss_p2b_request_ui.Meta = []
		this.screen_instance[this.comp_id].f_npss_p2b_request_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_p2b_request_ui.dtt_code = "dtt_1304_1665905039255"
		this.screen_instance[this.comp_id].f_npss_p2b_request_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_p2b_request_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_p2b_request_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_p2b_request_ui[control][property] = value;
  }
