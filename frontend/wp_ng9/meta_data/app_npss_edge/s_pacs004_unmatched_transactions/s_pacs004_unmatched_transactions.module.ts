...
import { s_pacs004_unmatched_transactionsRoutingModule } from './s_pacs004_unmatched_transactions.routing.module';
...
import { f_pacs004_unmatched_transactions_srchComponent } from './f_pacs004_unmatched_transactions_srch/f_pacs004_unmatched_transactions_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_pacs004_unmatched_transactionsRoutingModule,
  ...
  declarations: [s_pacs004_unmatched_transactionsComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_pacs004_unmatched_transactions_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_pacs004_unmatched_transactionsModule { }
