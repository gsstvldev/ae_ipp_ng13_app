...
export class s_payment_detailComponent implements OnInit,AfterViewInit {
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_from_fetch_btn_click__im_from_fetch_btn_click","event_desc":"IM from fetch btn click","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Core API Payment Details has been called successfully","root_source_id":"api_input_ui_actions_fetch","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	//Handler for SELECTION_CHANGED event of "request"
	request__bt_for_list() { 
		let Dest_Is_ctrl=true
		
		let source_id="request"
		let destn_id="api_details"
		let parent_source_id=""
		let event_code="e_1678185156490"
		let event_params={"caller_name":"request__bt_for_list","event_desc":"BT for list","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"request","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
