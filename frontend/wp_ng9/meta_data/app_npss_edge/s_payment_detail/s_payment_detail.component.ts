...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_payment_detaiService]
})
...
export class s_payment_detailComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_payment_detaiService:npss_cs_payment_detaiService) {
	...
	ngOnInit() {
		...
		this.api_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS Payment Detail UI","tab_order":0,"tab_name":"","uicgc_description":"API Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
		this.api_details.onChangecomponent = new EventEmitter<any>()
		this.api_details.show = true
		this.api_details.dynamic_param = {}
		this.api_details.f_npss_payment_detail_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.api_details.form_name = "f_npss_payment_detail_ui"
	}
	// Methods
	ngAfterViewInit() {
		this.page_load();
	...
	inf_for_save_api__internal(parent_event_result){
		this.inf_for_save_api__rs_for_save_apoi(parent_event_result)
	}
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__de_for_process_namepds__api_details()
	}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1677334627452"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1677334671417"
		...
		let internals="inf_for_save_api__rs_for_save_apoi,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "inf for save api"
	inf_for_save_api__rs_for_save_apoi(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1677334734462"
		let event_params={"caller_name":"inf_for_save_api__rs_for_save_apoi","event_desc":"RS for Save APOI","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_save","raiseparam":{},"parent_event_result":"SUCCESS"}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__de_for_process_namepds__api_details() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"destn_comp_id":"api_details","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__de_for_process_namepds__api_details","event_desc":"DE for Process namePDS","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
