...
Form Name       : NPSS Payment List SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_payment_list_srch',
  templateUrl: './f_npss_payment_list_srch.component.html',
  styleUrls: ['./f_npss_payment_list_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_payment_list_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_payment_list_srch') form;
  @ViewChild('npss_payment_list_srch_senderbic') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.senderbic.view_name = "f_npss_payment_list_srch"
		this.ctrl.senderbic.ctrl_id = "npss_payment_list_srch_senderbic"
		this.ctrl.npss_payment_list_srch_senderbic = {}
		this.ctrl.npss_payment_list_srch_senderbic.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.fromdate.view_name = "f_npss_payment_list_srch"
		this.ctrl.fromdate.ctrl_id = "npss_payment_list_srch_fromdate"
		this.ctrl.npss_payment_list_srch_fromdate = {}
		this.ctrl.npss_payment_list_srch_fromdate.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.todate.view_name = "f_npss_payment_list_srch"
		this.ctrl.todate.ctrl_id = "npss_payment_list_srch_todate"
		this.ctrl.npss_payment_list_srch_todate = {}
		this.ctrl.npss_payment_list_srch_todate.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_payment_list_srch.model = {"SENDERBIC":"","FROMDATE":"setcurrentdate(),{}","TODATE":"setcurrentdate(),{}"}
		this.screen_instance[this.comp_id].f_npss_payment_list_srch.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"SENDERBIC"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"FROMDATE"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"TODATE"}]
		this.screen_instance[this.comp_id].f_npss_payment_list_srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_payment_list_srch.dtt_code = "dtt_1304_1670589169341"
		this.screen_instance[this.comp_id].f_npss_payment_list_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_payment_list_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_payment_list_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_payment_list_srch[control][property] = value;
  }
