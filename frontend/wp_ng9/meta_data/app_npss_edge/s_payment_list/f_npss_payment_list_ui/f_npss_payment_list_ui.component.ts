...
Form Name       : NPSS Payment List UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_payment_list_ui',
  templateUrl: './f_npss_payment_list_ui.component.html',
  styleUrls: ['./f_npss_payment_list_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_payment_list_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_payment_list_ui') form;
  @ViewChild('npss_payment_list_ui_process_name') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.process_name.default_value = "paymentList"
		...
		this.ctrl.process_name.view_name = "f_npss_payment_list_ui"
		this.ctrl.process_name.ctrl_id = "npss_payment_list_ui_process_name"
		this.ctrl.npss_payment_list_ui_process_name = {}
		this.ctrl.npss_payment_list_ui_process_name.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.senderbic.ctrl_id = "npss_payment_list_ui_senderbic"
		this.ctrl.npss_payment_list_ui_senderbic = {}
		this.ctrl.npss_payment_list_ui_senderbic.onChangecomponent = new EventEmitter<any>()
	
		//Properties of fromdate
		this.ctrl.fromdate = {}
		this.ctrl.fromdate.id = "RN11CN3"
		this.ctrl.fromdate.desc = "Date From"
		this.ctrl.fromdate.visible = true
		this.ctrl.fromdate.label_name = "Date From"
		...
		this.ctrl.fromdate.ctrl_id = "npss_payment_list_ui_fromdate"
		this.ctrl.npss_payment_list_ui_fromdate = {}
		this.ctrl.npss_payment_list_ui_fromdate.onChangecomponent = new EventEmitter<any>()
	
		//Properties of todate
		this.ctrl.todate = {}
		this.ctrl.todate.id = "RN11CN4"
		this.ctrl.todate.desc = "Date To"
		this.ctrl.todate.visible = true
		this.ctrl.todate.label_name = "Date To"
		...
		this.ctrl.todate.ctrl_id = "npss_payment_list_ui_todate"
		this.ctrl.npss_payment_list_ui_todate = {}
		this.ctrl.npss_payment_list_ui_todate.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.fromtime.view_name = "f_npss_payment_list_ui"
		this.ctrl.fromtime.ctrl_id = "npss_payment_list_ui_fromtime"
		this.ctrl.npss_payment_list_ui_fromtime = {}
		this.ctrl.npss_payment_list_ui_fromtime.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.totime.view_name = "f_npss_payment_list_ui"
		this.ctrl.totime.ctrl_id = "npss_payment_list_ui_totime"
		this.ctrl.npss_payment_list_ui_totime = {}
		this.ctrl.npss_payment_list_ui_totime.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.datasource.view_name = "f_npss_payment_list_ui"
		...
		//Properties of pl_status
		this.ctrl.pl_status = {}
		this.ctrl.pl_status.id = "RN31CN8"
		this.ctrl.pl_status.desc = "Status"
		this.ctrl.pl_status.visible = true
		this.ctrl.pl_status.label_name = "Status"
		this.ctrl.pl_status.df_code = "DF_1304_1670589236195"
		this.ctrl.pl_status.df_description = "Column Group 1"
		this.ctrl.pl_status.uictrl_code = "CBO"
		this.ctrl.pl_status.target_column = "PL_STATUS"
		this.ctrl.pl_status.data_type = "TEXT"
		this.ctrl.pl_status.data_length = 256
		this.ctrl.pl_status.zone_df_code = "DF_1304_1670589236195"
		this.ctrl.pl_status.default_value = ""
		this.ctrl.pl_status.is_memory_ctrl = ""
		this.ctrl.pl_status.field_coordinates = ""
		this.ctrl.pl_status.sub_details = ""
		this.ctrl.pl_status.accept_char = ""
		this.ctrl.pl_status.currency_format = ""
		this.ctrl.pl_status.data_scale = ""
		this.ctrl.pl_status.hide_label = false
		this.ctrl.pl_status.depends_on = ""
		this.ctrl.pl_status.placeholder = ""
		this.ctrl.pl_status.dynamic_param = ""
		this.ctrl.pl_status.style_code = ""
		this.ctrl.pl_status.data_source = {"ds_code":"UDS_1304_1678277557865","ds_description":"NPSS PL Status CDB","rows":[],"type":"DPS_TABLE","value_member":"CD_CODE","display_member":"CD_DESCRIPTION","first_record_display":"Select","column_list":"","order_by":"SORT_ORDER ASC","target_table":"CORE_NC_CODE_DESCRIPTIONS","context":"","filters":[{"filter_name":"Filter1","binding_name":"TENANT_ID","id":"DF_1678283994890","binding_value":"SESSION_LEVEL.TENANT_ID","source_name":"TENANT_ID","source_value":"SESSION_LEVEL.TENANT_ID","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"F.BINDING_VALUE = global.SessionInfo['undefined']","is_cluster_key":"N","filter_values":"SESSION_LEVEL"},{"filter_name":"Filter2","binding_name":"CD_CATEGORY","id":"DF_1678283994890","binding_value":"CORE_API_PL_STATUS","source_name":"CD_CATEGORY","source_value":"CORE_API_PL_STATUS","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"},{"filter_name":"Filter3","binding_name":"NEED_SYNC","id":"DF_1678283994890","binding_value":"Y","source_name":"NEED_SYNC","source_value":"Y","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"}],"type_desc":"Combo Binding SQL","conditional_operator":"CONTAINS","rules":{"group":{"operator":"AND","rules":[{"operators":"=","data_type":"TEXT","binding_name":"TENANT_ID","binding_value":"SESSION_LEVEL.TENANT_ID","sort_order":1,"conjuction_operator":"","is_cluster_key":"N","filter_values":"SESSION_LEVEL","temp_value":"TENANT_ID"},{"operators":"=","data_type":"TEXT","binding_name":"CD_CATEGORY","binding_value":"CORE_API_PL_STATUS","sort_order":2,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"CORE_API_PL_STATUS"},{"operators":"=","data_type":"TEXT","binding_name":"NEED_SYNC","binding_value":"Y","sort_order":3,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"Y"}]},"query":"(TENANT_ID = SESSION_LEVEL.TENANT_ID AND CD_CATEGORY = CORE_API_PL_STATUS AND NEED_SYNC = Y)"},"sel_columns":[],"need_first_item_selection":false,"has_parent":false}
		this.ctrl.pl_status.image_association = ""
		...
		this.ctrl.pl_status.ctrl_id = "npss_payment_list_ui_pl_status"
		this.ctrl.npss_payment_list_ui_pl_status = {}
		this.ctrl.npss_payment_list_ui_pl_status.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_payment_list_ui.pl_status = {}
		this.screen_instance[this.comp_id].f_npss_payment_list_ui.model = {"PROCESS_NAME":"paymentList","SENDERBIC":"","FROMDATE":"setcurrentdate(),{}","TODATE":"setcurrentdate(),{}","FROMTIME":"","TOTIME":"","DATASOURCE":"PRODUCTION","PL_STATUS":""}
		this.screen_instance[this.comp_id].f_npss_payment_list_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_NAME"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"SENDERBIC"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"FROMDATE"},{"CTLR_CODE":"DTP","DATA_TYPE":"DATETIME","TARGET_COLUMN":"TODATE"},{"CTLR_CODE":"TMR","DATA_TYPE":"TEXT","TARGET_COLUMN":"FROMTIME"},{"CTLR_CODE":"TMR","DATA_TYPE":"TEXT","TARGET_COLUMN":"TOTIME"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"DATASOURCE"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"PL_STATUS"}]
		...
		this.screen_instance[this.comp_id].f_npss_payment_list_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_payment_list_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_payment_list_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_payment_list_ui[control][property] = value;
  }
