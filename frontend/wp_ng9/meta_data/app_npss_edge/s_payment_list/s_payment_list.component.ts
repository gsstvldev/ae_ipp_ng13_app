...
Build ID        : 28578 
Modified By     : Admin 
Modified Date   : 2023-Mar-08 14:0 PM 
...
export class s_payment_listComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.api_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS Payment List UI","tab_order":0,"tab_name":"","uicgc_description":"API Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
	...
	api_input_ui_actions_trg_hide__action_button_click(){
		this.api_input_ui_actions_trg_hide__de_for_process_name__api_details()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "api input ui actions trg hide"
	api_input_ui_actions_trg_hide__de_for_process_name__api_details() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"destn_comp_id":"api_details","destn_ctrl_id":"process_name","caller_name":"api_input_ui_actions_trg_hide__de_for_process_name__api_details","event_desc":"DE for process name","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"api_input_ui_actions_trg_hide","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
