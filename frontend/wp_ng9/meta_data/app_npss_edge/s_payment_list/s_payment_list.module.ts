...
@NgModule({
  ...
  imports: [
    ...
    npss_cs_daily_liquidity_position_responseModule,torus_cs_show_hideModule,npss_cs_payment_listModule
  ],
  declarations: [s_payment_listComponent,p_main_layoutComponent,f_npss_payment_list_uiComponent,f_api_input_ui_actionsComponent,p_search_layoutComponent,f_npss_payment_list_srchComponent,],
