...
import { p_custom_layoutComponent } from './p_custom_layout/p_custom_layout.component'
...
@NgModule({
  ...
  imports: [
    ...
    npss_cs_payment_listModule,torus_cs_show_hideModule
  ],
  declarations: [s_payment_listComponent,p_main_layoutComponent,f_npss_payment_list_srchComponent,f_npss_payment_list_uiComponent,f_api_input_ui_actionsComponent,p_custom_layoutComponent,],
