...
import { f_npss_post_dashboard_srchComponent } from './f_npss_post_dashboard_srch/f_npss_post_dashboard_srch.component'
...
@NgModule({
  ...
  declarations: [s_post_view_transactionsComponent,p_main_layoutComponent,f_navigation_uiComponent,p_search_layoutComponent,f_npss_post_dashboard_srchComponent,p_vertical_layoutComponent,f_back_uiComponent,],
