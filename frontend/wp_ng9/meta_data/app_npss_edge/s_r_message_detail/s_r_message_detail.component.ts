...
export class s_r_message_detailComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.input_details.views = {"first":"DTT_1304_1670589169341","is_tab_mode":"N","dtt_1304_1670589169341":{"0":[{"dttv_id":"NPSS R Msg Detail UI","tab_order":0,"tab_name":"","uicgc_description":"Input Details","role_description":"default","dtt_description":"Core API Process Log"}]}}
		this.input_details.onChangecomponent = new EventEmitter<any>()
		this.input_details.show = true
		this.input_details.dynamic_param = {}
		this.input_details.f_npss_r_msg_detail_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.input_details.form_name = "f_npss_r_msg_detail_ui"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let data_source={}
		try {
			this.npss_cs_rmessage_detailsService.fn_npss_cs_rmessage_details(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
			console.log(e); 
 		} 
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_from_fetch_btn_click__im_from_fetch_btn_click","event_desc":"IM from fetch btn click","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Core API rMessageDetail has been called successfully.","root_source_id":"api_input_ui_actions_fetch","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui export as pdf"
	navigation_ui_export_as_pdf__e_1682420632433() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_export_as_pdf"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1682420632433"
		let event_params={"caller_name":"navigation_ui_export_as_pdf__e_1682420632433","event_desc":"E_1682420632433","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_export_as_pdf","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
