...
export class s_rct_investigationComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_11","uicgc_10","uicgc_15","uicgc_4","uicgc_12","uicgc_16","uicgc_13","uicgc_14","uicgc_7","uicgc_3"]
	...
	navigation_ui_view_message_details__sp_for_vmd() { 
		...
		let event_params={"caller_name":"navigation_ui_view_message_details__sp_for_vmd","event_desc":"SP for VMD","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_message_details","raiseparam":{"profile_code":"BTL_1304_1669368481197"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	message_detail_action_show_message__sp_for_view_message_data() { 
		...
		let event_params={"caller_name":"message_detail_action_show_message__sp_for_view_message_data","event_desc":"SP for view message DATA","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"message_detail_action_show_message","raiseparam":{"profile_code":"BTL_1304_1669368410590"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
