...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.screen_instance[this.comp_id].f_npss_manual_initiation_srch.model = {"MEMORY91":"","MEMORY89":"","MEMORY92":"","PAYMENT_ENDTOEND_ID":"","UETR":""}
		this.screen_instance[this.comp_id].f_npss_manual_initiation_srch.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"PAYMENT_ENDTOEND_ID"},{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"}]
