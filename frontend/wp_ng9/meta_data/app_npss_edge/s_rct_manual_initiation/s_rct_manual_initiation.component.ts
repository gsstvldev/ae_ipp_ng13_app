...
Build ID        : 28522 
Modified By     : Admin 
Modified Date   : 2023-Mar-07 11:23 AM 
...
export class s_rct_manual_initiationComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_initiate__action_button_click(peventcontext){
		...
		this.navigation_ui_initiate__de_for_txn_currency__payment_processing_details_ui()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui initiate"
	navigation_ui_initiate__de_for_txn_currency__payment_processing_details_ui() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_initiate"
		let destn_id="npss_manual_initiation_ui_intrbk_sttlm_cur"
		let parent_source_id=""
		let event_code="e_1674641743393"
		let event_params={"destn_comp_id":"payment_processing_details_ui","destn_ctrl_id":"intrbk_sttlm_cur","caller_name":"navigation_ui_initiate__de_for_txn_currency__payment_processing_details_ui","event_desc":"DE for TXN Currency","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_initiate","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
