...
export class s_rct_manual_initiationComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_sent_to_checker : any = {}
	navigation_ui_accept : any = {}
	...
	ngOnInit() {
		...
		// "Sent to Checker" Button of "Navigation UI" component
		this.navigation_ui_sent_to_checker.label_name = "Sent to Checker"
		this.navigation_ui_sent_to_checker.show = true
		this.navigation_ui_sent_to_checker.disabled = false
		this.navigation_ui_sent_to_checker.params = {"icon_only":false,"uicgcc_style":"fa fa-plus-square-o"}
		this.navigation_ui_sent_to_checker.dynamic_param = {}
		this.navigation_ui_sent_to_checker.role = []
		this.navigation_ui_sent_to_checker.action = ""
		
		// "Accept" Button of "Navigation UI" component
		this.navigation_ui_accept.label_name = "Accept"
		this.navigation_ui_accept.show = true
		this.navigation_ui_accept.disabled = false
		this.navigation_ui_accept.params = {"icon_only":false,"uicgcc_style":"fa fa-check"}
		this.navigation_ui_accept.dynamic_param = {}
		this.navigation_ui_accept.role = []
		this.navigation_ui_accept.action = ""
		...
		this.payment_processing_details.params = {"need_pag_datatable":"Y","need_search":"N","need_vertical":"Y"}
	...
	payment_processing_details_ui_save__action_button_click(){
		this.payment_processing_details_ui_save__e_1672490357652()
	}

	//Handler for INTERNAL event of "e 1672490357652"
	e_1672490357652__internal(parent_event_result){
		this.e_1672490357652__e_1672490376756(parent_event_result)
	}

	//Handler for INTERNAL event of "e 1672490376756"
	e_1672490376756__internal(parent_event_result){
		this.e_1672490376756__e_1672490415546(parent_event_result)
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "payment processing details ui save"
	payment_processing_details_ui_save__e_1672490357652() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"payment_processing_details_ui_save__e_1672490357652","event_desc":"E_1672490357652","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"payment_processing_details_ui_save","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals="e_1672490357652__e_1672490376756,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "e 1672490357652"
	e_1672490357652__e_1672490376756(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="e_1672490357652"
		let destn_id=""
		let parent_source_id="payment_processing_details_ui_save"
		let event_code="e_1672490376756"
		let event_params={"caller_name":"e_1672490357652__e_1672490376756","event_desc":"E_1672490376756","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Transaction has been initiated successfully","root_source_id":"payment_processing_details_ui_save","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
		let handler_code="info_msg"
		let internals="e_1672490376756__e_1672490415546,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "e 1672490376756"
	e_1672490376756__e_1672490415546(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="e_1672490376756"
		let destn_id=""
		let parent_source_id="e_1672490357652"
		let event_code="e_1672490415546"
		let event_params={"caller_name":"e_1672490376756__e_1672490415546","event_desc":"E_1672490415546","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"payment_processing_details_ui_save","raiseparam":{},"parent_event_result":"SUCCESS"}
