...
Build ID        : 28768 
Modified By     : Admin 
Modified Date   : 2023-Mar-17 14:23 PM 
...
export class s_rct_manual_initiationComponent implements OnInit,AfterViewInit {
	...
	page_load(){
		...
		this.page_load__e_1679058181470()
	}
	...
	payment_processing_details__selection_changed(){
		...
		this.payment_processing_details__e_1679058302185()
	}
	...
	//Handler for DPSINIT event of "page_load"
	page_load__e_1679058181470() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="payment_processing_details_ui_get_deal"
		let parent_source_id=""
		let event_code="e_1679058181470"
		let event_params={"caller_name":"page_load__e_1679058181470","event_desc":"E_1679058181470","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "payment processing details"
	payment_processing_details__e_1679058302185() { 
		let Dest_Is_ctrl=true
		
		let source_id="payment_processing_details"
		let destn_id="payment_processing_details_ui_get_deal"
		let parent_source_id=""
		let event_code="e_1679058302185"
		let event_params={"caller_name":"payment_processing_details__e_1679058302185","event_desc":"E_1679058302185","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_processing_details","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"AED","hide_except":"","hide_column":"ACCOUNT_CURRENCY","expression":""}}
