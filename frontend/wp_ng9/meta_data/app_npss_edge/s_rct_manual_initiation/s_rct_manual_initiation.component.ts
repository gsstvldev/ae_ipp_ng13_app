...
Build ID        : 27664 
Modified By     : Admin 
Modified Date   : 2023-Jan-02 15:14 PM 
...
export class s_rct_manual_initiationComponent implements OnInit,AfterViewInit {
	...
	svm_for_queue__internal(parent_event_result){
		...
		this.svm_for_queue__cc_for_set_rule(parent_event_result)
	}
	...
	//Handler for INTERNAL event of "svm for queue"
	svm_for_queue__cc_for_set_rule(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="svm_for_queue"
		let destn_id=""
		let parent_source_id="queue"
		let event_code="e_1672659293201"
		let event_params={"caller_name":"svm_for_queue__cc_for_set_rule","event_desc":"CC for set rule","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"queue","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
