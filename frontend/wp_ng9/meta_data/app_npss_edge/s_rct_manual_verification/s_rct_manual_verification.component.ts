...
export class s_rct_manual_verificationComponent implements OnInit,AfterViewInit {
	...
	transaction_list__ee_for_review() { 
		...
		let event_params={"caller_name":"transaction_list__ee_for_review","event_desc":"EE for REVIEW","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	transaction_list__ee_for_stc() { 
		...
		let event_params={"caller_name":"transaction_list__ee_for_stc","event_desc":"EE for STC","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
