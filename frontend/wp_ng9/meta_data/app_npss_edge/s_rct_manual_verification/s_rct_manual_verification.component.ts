...
export class s_rct_manual_verificationComponent implements OnInit,AfterViewInit {
	...
	payment_processing_details__selection_changed(){
		...
		this.payment_processing_details__bind_tran()
	}
	...
	//Handler for SELECTION_CHANGED event of "payment processing details"
	payment_processing_details__bind_tran() { 
		let Dest_Is_ctrl=true
		
		let source_id="payment_processing_details"
		let destn_id="get_deal_ui"
		let parent_source_id=""
		let event_code="e_1684150067591"
		let event_params={"caller_name":"payment_processing_details__bind_tran","event_desc":"Bind Tran","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"payment_processing_details","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
