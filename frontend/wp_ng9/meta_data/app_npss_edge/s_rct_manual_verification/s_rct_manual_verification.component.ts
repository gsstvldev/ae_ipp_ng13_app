...
export class s_rct_manual_verificationComponent implements OnInit,AfterViewInit {
	...
	transaction_list__selection_changed(){
		...
		this.transaction_list__e_1684146168478()
	}
	...
	navigation_ui_review__action_button_click(peventcontext){
		...
		this.navigation_ui_review__e_1684146205187()
	}
	...
	//Handler for SELECTION_CHANGED event of "transaction list"
	transaction_list__e_1684146168478() { 
		let Dest_Is_ctrl=true
		
		let source_id="transaction_list"
		let destn_id="get_deal_ui"
		let parent_source_id=""
		let event_code="e_1684146168478"
		let event_params={"caller_name":"transaction_list__e_1684146168478","event_desc":"E_1684146168478","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"transaction_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui review"
	navigation_ui_review__e_1684146205187() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_review"
		let destn_id="get_deal_ui"
		let parent_source_id=""
		let event_code="e_1684146205187"
		let event_params={"caller_name":"navigation_ui_review__e_1684146205187","event_desc":"E_1684146205187","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_review","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
