...
import {npss_cs_manual_verification_bind_dataModule} from '../../../custom_widget/npss_cs_manual_verification_bind_data/npss_cs_manual_verification_bind_data.module'
...
import {npss_csget_deal_btn_show_hideModule} from '../../../custom_widget/npss_csget_deal_btn_show_hide/npss_csget_deal_btn_show_hide.module'
...
@NgModule({
  ...
  imports: [
    ...
    npss_cs_rev_get_usable_balanceModule,torus_cs_change_routingkeyModule,torus_cs_show_hideModule,torus_cs_set_rule_mi_paramModule,npss_cs_manual_verification_bind_dataModule,npss_cs_manual_initiation_rejectModule,npss_cs_send_to_checkerModule,npss_cs_manual_initiation_approveModule,npss_cs_manual_initiation_force_to_postModule,npss_csget_deal_btn_show_hideModule,npss_cs_manual_initiation_get_dealModule,npss_c_date_validation_for_reportModule
  ],
