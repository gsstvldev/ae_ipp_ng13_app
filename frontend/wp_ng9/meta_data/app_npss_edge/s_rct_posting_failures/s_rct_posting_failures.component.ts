...
@Component({
	...
	providers:[torus_cs_show_hideService,npss_cs_rct_retryService]
})
...
export class s_rct_posting_failuresComponent implements OnInit,AfterViewInit {
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_rct_retryService:npss_cs_rct_retryService) {
