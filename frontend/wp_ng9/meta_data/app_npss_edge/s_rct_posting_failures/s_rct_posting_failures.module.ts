...
import { f_npss_rct_ip_posting_failure_srchComponent } from './f_npss_rct_ip_posting_failure_srch/f_npss_rct_ip_posting_failure_srch.component'
...
import { p_return_layoutComponent } from './p_return_layout/p_return_layout.component'
import { f_npss_posting_failures_return_uiComponent } from './f_npss_posting_failures_return_ui/f_npss_posting_failures_return_ui.component'
import { f_save_uiComponent } from './f_save_ui/f_save_ui.component'
...
@NgModule({
  ...
  imports: [
    ...
    torus_cs_change_routingkeyModule,torus_cs_show_hideModule,npss_cs_check_uetrModule,npss_cs_rct_inward_posting_failure_retry_repostModule,npss_cs_rct_inward_posting_failure_closeModule,npss_c_disable_action_by_multiselectModule,npss_cs_rct_already_postingModule,npss_cs_cc_postingModule,npss_cs_enquiryModule,npss_cs_t24_postingModule,npss_cs_rct_completeModule,npss_cs_inward_posting_failure_force_to_postModule,npss_cs_outward_posting_failure_send_to_checkerModule
  ],
  declarations: [s_rct_posting_failuresComponent,p_main_layoutComponent,f_navigation_uiComponent,p_search_layoutComponent,f_npss_rct_ip_posting_failure_srchComponent,p_vertical_tran_detail_profileComponent,f_back_uiComponent,p_view_history_layoutComponent,f_process_log_uiComponent,p_view_message_list_layoutComponent,f_message_detail_actionComponent,p_view_message_ui_layoutComponent,f_message_back_uiComponent,f_npss_message_data_uiComponent,p_view_req_and_resComponent,f_single_back_uiComponent,f_npss_target_request_uiComponent,f_npss_target_response_uiComponent,p_cbs_layoutComponent,f_npss_bct_ref_no_uiComponent,p_send_to_maker_layoutComponent,f_npss_send_to_maker_remarks_uiComponent,p_return_layoutComponent,f_npss_posting_failures_return_uiComponent,f_save_uiComponent,p_view_request_layoutComponent,p_view_response_layoutComponent,],
