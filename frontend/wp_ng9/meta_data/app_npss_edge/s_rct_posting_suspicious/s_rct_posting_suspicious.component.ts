...
export class s_rct_posting_suspiciousComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_view_message_history__sp_for_vmd() { 
		...
		let event_params={"caller_name":"navigation_ui_view_message_history__sp_for_vmd","event_desc":"SP for VMD","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_message_history","raiseparam":{"profile_code":"BTL_1304_1669458390905"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
