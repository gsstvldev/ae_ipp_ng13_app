...
Form Name       : NPSS Reject Return UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_reject_return_ui',
  templateUrl: './f_npss_reject_return_ui.component.html',
  styleUrls: ['./f_npss_reject_return_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_reject_return_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_reject_return_ui') form;
  @ViewChild('npss_reject_return_ui_memory90') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory90.view_name = "f_npss_reject_return_ui"
		this.ctrl.memory90.ctrl_id = "npss_reject_return_ui_memory90"
		this.ctrl.npss_reject_return_ui_memory90 = {}
		this.ctrl.npss_reject_return_ui_memory90.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_reject_return_ui.model = {"MEMORY90":""}
		this.screen_instance[this.comp_id].f_npss_reject_return_ui.Meta = []
		this.screen_instance[this.comp_id].f_npss_reject_return_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_reject_return_ui.dtt_code = "dtt_1304_1665901217208"
		this.screen_instance[this.comp_id].f_npss_reject_return_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_reject_return_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_reject_return_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_reject_return_ui[control][property] = value;
  }
