...
export class s_rct_rejected_returnsComponent implements OnInit,AfterViewInit {
	...
	cc_for_show_hide_btn__internal(parent_event_result){
		this.cc_for_show_hide_btn__set_params_mi_level(parent_event_result)
	}
	...
	cf_for_pageload__cc_for_show_hide_btn() { 
		...
		let handler_code="custom_connectors"
		let internals="cc_for_show_hide_btn__set_params_mi_level,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cc for show hide btn"
	cc_for_show_hide_btn__set_params_mi_level(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_for_show_hide_btn__set_params_mi_level","event_desc":"SET PARAMS MI LEVEL","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let parent_source_id="cc_for_show_hide_btn"
