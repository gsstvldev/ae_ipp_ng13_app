...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,npss_c_set_mi_level_valueService,torus_cs_show_hideService,torus_cs_set_rule_mi_paramService,npss_c_disable_action_by_multiselectService,npss_cs_inward_rejected_return_re_submitService,npss_cs_inward_reject_return_closeService]
})
