...
@NgModule({
  ...
  imports: [
    ...
    torus_cs_change_routingkeyModule,torus_cs_show_hideModule,npss_cs_inward_reject_return_closeModule,npss_cs_inward_rejected_return_re_submitModule,npss_c_disable_action_by_multiselectModule
  ],
