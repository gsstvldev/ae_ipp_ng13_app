...
Form Name       : NPSS PL Change Cancel Reason UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_pl_change_cancel_reason_ui',
  templateUrl: './f_npss_pl_change_cancel_reason_ui.component.html',
  styleUrls: ['./f_npss_pl_change_cancel_reason_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_pl_change_cancel_reason_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_pl_change_cancel_reason_ui') form;
  @ViewChild('npss_pl_change_cancel_reason_ui_t24_return_code') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.t24_return_code.id = "b9576b4c-6ec6-4d85-ad5d-90633f7a7b65_1671195816628"
		...
		this.ctrl.t24_return_code.view_name = "f_npss_pl_change_cancel_reason_ui"
		this.ctrl.t24_return_code.ctrl_id = "npss_pl_change_cancel_reason_ui_t24_return_code"
		this.ctrl.npss_pl_change_cancel_reason_ui_t24_return_code = {}
		this.ctrl.npss_pl_change_cancel_reason_ui_t24_return_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.t24_return_code = {}
	
		//Properties of cbuae_return_code
		this.ctrl.cbuae_return_code = {}
		this.ctrl.cbuae_return_code.id = "50b697de-385d-43d7-b99a-19a393460482_1671195816628"
		...
		this.ctrl.cbuae_return_code.view_name = "f_npss_pl_change_cancel_reason_ui"
		this.ctrl.cbuae_return_code.ctrl_id = "npss_pl_change_cancel_reason_ui_cbuae_return_code"
		this.ctrl.npss_pl_change_cancel_reason_ui_cbuae_return_code = {}
		this.ctrl.npss_pl_change_cancel_reason_ui_cbuae_return_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.cbuae_return_code = {}
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.model = {"T24_RETURN_CODE":"","CBUAE_RETURN_CODE":""}
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.Meta = [{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"T24_RETURN_CODE"},{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"CBUAE_RETURN_CODE"}]
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.dtt_code = "dtt_1304_1665905039255"
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui[control][property] = value;
  }
