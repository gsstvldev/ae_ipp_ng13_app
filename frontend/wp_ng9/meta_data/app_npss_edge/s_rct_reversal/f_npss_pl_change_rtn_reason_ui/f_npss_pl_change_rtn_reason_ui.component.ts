...
export class f_npss_pl_change_rtn_reason_uiComponent implements OnInit {
  ...
  @ViewChild('npss_pl_change_rtn_reason_ui_cbuae_return_code') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.cbuae_return_code.data_source = {"ds_code":"UDS_1304_1666863101383","ds_description":"NPSS CBUAE Destination Return Mapping SQL CDB","rows":[],"type":"DPS_TABLE","value_member":"DESTINATION_RETURN_CODE","display_member":"DST_CODE_DESC","first_record_display":"Select","column_list":"","order_by":"DESTINATION_RETURN_CODE","target_table":"NPSS_VW_DST_RTN_MAP","context":"","filters":[{"filter_name":"Filter1","binding_name":"DESTINATION_SYSTEM","id":"DF_1678253944660","binding_value":"CBUAE","source_name":"DESTINATION_SYSTEM","source_value":"CBUAE","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"},{"filter_name":"Filter2","binding_name":"TENANT_ID","id":"DF_1678253944660","binding_value":"SESSION_LEVEL.TENANT_ID","source_name":"TENANT_ID","source_value":"SESSION_LEVEL.TENANT_ID","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"F.BINDING_VALUE = global.SessionInfo['undefined']","is_cluster_key":"N","filter_values":"SESSION_LEVEL"},{"filter_name":"Filter3","binding_name":"NEED_SYNC","id":"DF_1678253944660","binding_value":"Y","source_name":"NEED_SYNC","source_value":"Y","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"}],"type_desc":"Combo Binding SQL","conditional_operator":"CONTAINS","rules":{"group":{"operator":"AND","rules":[{"operators":"=","data_type":"TEXT","binding_name":"DESTINATION_SYSTEM","binding_value":"CBUAE","sort_order":1,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"CBUAE"},{"operators":"=","data_type":"TEXT","binding_name":"TENANT_ID","binding_value":"SESSION_LEVEL.TENANT_ID","sort_order":2,"conjuction_operator":"","is_cluster_key":"N","filter_values":"SESSION_LEVEL","temp_value":"TENANT_ID"},{"operators":"=","data_type":"TEXT","binding_name":"NEED_SYNC","binding_value":"Y","sort_order":3,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"Y"}]},"query":"(DESTINATION_SYSTEM = CBUAE AND TENANT_ID = SESSION_LEVEL.TENANT_ID AND NEED_SYNC = Y)"},"sel_columns":[],"need_first_item_selection":false,"has_parent":false}
		...
		this.screen_instance[this.comp_id].f_npss_pl_change_rtn_reason_ui.model = {"CBUAE_RETURN_CODE":""}
		this.screen_instance[this.comp_id].f_npss_pl_change_rtn_reason_ui.Meta = [{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"CBUAE_RETURN_CODE"}]
