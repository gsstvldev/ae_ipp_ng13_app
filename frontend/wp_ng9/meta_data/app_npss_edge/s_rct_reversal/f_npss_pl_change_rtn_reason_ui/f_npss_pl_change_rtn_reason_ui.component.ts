...
Build ID        : 26910 
Modified By     : Admin 
Modified Date   : 2022-Nov-16 12:38 PM 
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.t24_return_code.data_source = {"ds_code":"UDS_1304_1666862953229","ds_description":"NPSS T24 Source Return Mapping SQL CDB","rows":[],"type":"DPS_TABLE","value_member":"SOURCE_RETURN_CODE","display_member":"SRC_CODE_DESC","first_record_display":"Select","column_list":"","order_by":"SOURCE_RETURN_CODE","target_table":"NPSS_VW_SRC_RTN_MAP","context":"","filters":[{"filter_name":"Filter1","binding_name":"SOURCE_SYSTEM","id":"DF_1666863087103","binding_value":"T24","source_name":"SOURCE_SYSTEM","source_value":"T24","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"},{"filter_name":"Filter2","binding_name":"TENANT_ID","id":"DF_1666863087103","binding_value":"SESSION_LEVEL.TENANT_ID","source_name":"TENANT_ID","source_value":"SESSION_LEVEL.TENANT_ID","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"F.BINDING_VALUE = global.SessionInfo['undefined']","is_cluster_key":"N","filter_values":"SESSION_LEVEL"}],"type_desc":"Combo Binding SQL","conditional_operator":"CONTAINS","rules":{"group":{"operator":"AND","rules":[{"operators":"=","data_type":"TEXT","binding_name":"SOURCE_SYSTEM","binding_value":"T24","sort_order":1,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"T24"},{"operators":"=","data_type":"TEXT","binding_name":"TENANT_ID","binding_value":"SESSION_LEVEL.TENANT_ID","sort_order":2,"conjuction_operator":"","is_cluster_key":"N","filter_values":"SESSION_LEVEL","temp_value":"TENANT_ID"}]},"query":"(SOURCE_SYSTEM = T24 AND TENANT_ID = SESSION_LEVEL.TENANT_ID)"},"sel_columns":[]}
		...
		this.ctrl.cbuae_return_code.data_source = {"ds_code":"UDS_1304_1666863101383","ds_description":"NPSS CBUAE Destination Return Mapping SQL CDB","rows":[],"type":"DPS_TABLE","value_member":"DESTINATION_RETURN_CODE","display_member":"DST_CODE_DESC","first_record_display":"Select","column_list":"","order_by":"DESTINATION_RETURN_CODE","target_table":"NPSS_VW_DST_RTN_MAP","context":"","filters":[{"filter_name":"Filter1","binding_name":"DESTINATION_SYSTEM","id":"DF_1666863506232","binding_value":"CBUAE","source_name":"DESTINATION_SYSTEM","source_value":"CBUAE","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"","is_cluster_key":"N","filter_values":"HARDCODED"},{"filter_name":"Filter2","binding_name":"TENANT_ID","id":"DF_1666863506232","binding_value":"SESSION_LEVEL.TENANT_ID","source_name":"TENANT_ID","source_value":"SESSION_LEVEL.TENANT_ID","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":"","assign_binding_value":"F.BINDING_VALUE = global.SessionInfo['undefined']","is_cluster_key":"N","filter_values":"SESSION_LEVEL"}],"type_desc":"Combo Binding SQL","conditional_operator":"CONTAINS","rules":{"group":{"operator":"AND","rules":[{"operators":"=","data_type":"TEXT","binding_name":"DESTINATION_SYSTEM","binding_value":"CBUAE","sort_order":1,"conjuction_operator":"","is_cluster_key":"N","filter_values":"HARDCODED","temp_value":"CBUAE"},{"operators":"=","data_type":"TEXT","binding_name":"TENANT_ID","binding_value":"SESSION_LEVEL.TENANT_ID","sort_order":2,"conjuction_operator":"","is_cluster_key":"N","filter_values":"SESSION_LEVEL","temp_value":"TENANT_ID"}]},"query":"(DESTINATION_SYSTEM = CBUAE AND TENANT_ID = SESSION_LEVEL.TENANT_ID)"},"sel_columns":[]}
