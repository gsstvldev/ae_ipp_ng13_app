...
export class f_npss_reject_uiComponent implements OnInit {
  ...
  @ViewChild('npss_reject_ui_t24_return_code') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.t24_return_code.id = "80cf7fb5-7c27-47be-b05f-5a71a3c6b313_1671282374640"
		...
		this.ctrl.t24_return_code.view_name = "f_npss_reject_ui"
		this.ctrl.t24_return_code.ctrl_id = "npss_reject_ui_t24_return_code"
		this.ctrl.npss_reject_ui_t24_return_code = {}
		this.ctrl.npss_reject_ui_t24_return_code.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_reject_ui.t24_return_code = {}
		...
		this.screen_instance[this.comp_id].f_npss_reject_ui.model = {"T24_RETURN_CODE":"","CBUAE_RETURN_CODE":""}
		this.screen_instance[this.comp_id].f_npss_reject_ui.Meta = [{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"T24_RETURN_CODE"},{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"CBUAE_RETURN_CODE"}]
