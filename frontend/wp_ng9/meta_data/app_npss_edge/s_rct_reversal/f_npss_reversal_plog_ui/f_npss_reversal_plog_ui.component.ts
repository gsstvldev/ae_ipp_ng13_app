...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.gm_margin = {}
		this.ctrl.gm_margin.id = "RN01CN5"
		this.ctrl.gm_margin.desc = "GM Margin"
		this.ctrl.gm_margin.visible = true
		this.ctrl.gm_margin.label_name = "GM Margin"
		...
		this.ctrl.gm_margin.data_length = 1
		...
		this.ctrl.gm_margin.data_scale = "19"
		...
		this.screen_instance[this.comp_id].f_npss_reversal_plog_ui.model = {"PROCESS_REF_NO":"","AMOUNT_CREDITED":"","AMT_CR_LOC_CUR":"","CHARGE_AMOUNT":"","GM_MARGIN":""}
