...
export class s_rct_reversalComponent implements OnInit,AfterViewInit {
	...
	uicgc_11 : string = "view_transaction_details"
	...
	ngOnInit() {
		...
		this.view_transaction_details.uicgc_code = "uicgc_11"
		this.view_transaction_details.params = {"advance_dynamic_search":"N","need_vertical":"Y","need_search":"N"}
