...
export class s_rct_reversalComponent implements OnInit,AfterViewInit {
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"cc_for_force_post__info_for_force_post","event_desc":"info for force post","event_type":"INTERNAL","caller_event_context":"SUCCESS","message_text":"Data has been force to posted successfully","root_source_id":"reversal_action_ui_force_post","raiseparam":{"info_msg":""},"parent_event_result":"SUCCESS"}
		let handler_code="info_msg"
