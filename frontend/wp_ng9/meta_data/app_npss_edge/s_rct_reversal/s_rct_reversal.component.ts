...
export class s_rct_reversalComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_9","uicgc_5","uicgc_24","uicgc_10","uicgc_6","uicgc_23","uicgc_20","uicgc_25","uicgc_17","uicgc_19","uicgc_15","uicgc_12","uicgc_4","uicgc_3"]
	...
	ngOnInit() {
		...
		this.navigation_view_message_details.params = {"icon_only":true,"uicgcc_style":"fa fa-eye"}
