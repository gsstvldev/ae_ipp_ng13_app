...
export class f_npss_pl_change_cancel_reason_uiComponent implements OnInit {
  ...
  @ViewChild('npss_pl_change_cancel_reason_ui_cbuae_return_code') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.model = {"CBUAE_RETURN_CODE":""}
		this.screen_instance[this.comp_id].f_npss_pl_change_cancel_reason_ui.Meta = [{"CTLR_CODE":"CBO_LIST","DATA_TYPE":"TEXT","TARGET_COLUMN":"CBUAE_RETURN_CODE"}]
