...
export class f_npss_send_to_maker_uiComponent implements OnInit {
  ...
  @ViewChild('npss_send_to_maker_ui_remarks') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.remarks = {}
		this.ctrl.remarks.id = "2086ea74-ec42-4957-a42a-ad4ea056ab21_1672138563509"
		...
		this.ctrl.remarks.view_name = "f_npss_send_to_maker_ui"
		this.ctrl.remarks.ctrl_id = "npss_send_to_maker_ui_remarks"
		this.ctrl.npss_send_to_maker_ui_remarks = {}
		this.ctrl.npss_send_to_maker_ui_remarks.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_send_to_maker_ui.model = {"REMARKS":""}
		this.screen_instance[this.comp_id].f_npss_send_to_maker_ui.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"REMARKS"}]
