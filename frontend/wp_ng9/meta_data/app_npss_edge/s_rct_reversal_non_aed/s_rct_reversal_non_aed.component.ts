...
export class s_rct_reversal_non_aedComponent implements OnInit,AfterViewInit {
	...
	navigation_review__brfq_success_sp() { 
		...
		let event_params={"caller_name":"navigation_review__brfq_success_sp","event_desc":"BRFQ success SP","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_review","raiseparam":{"profile_code":"BTL_1304_1678260505149"}}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation review"
	navigation_review__brfq_for_list_review() { 
		let Dest_Is_ctrl=true
