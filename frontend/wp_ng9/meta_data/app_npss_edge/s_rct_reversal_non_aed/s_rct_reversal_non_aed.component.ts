...
export class s_rct_reversal_non_aedComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.vertical_list.uicgc_code = "uicgc_37"
		this.vertical_list.params = {"need_pag_datatable":"Y","need_search":"N","need_vertical":"Y"}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_params={"caller_name":"brfq_for_process_log__brfq_success_sp","event_desc":"BRFQ success SP","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_review","raiseparam":{"profile_code":"BTL_1304_1677742578614"},"parent_event_result":"SUCCESS"}
