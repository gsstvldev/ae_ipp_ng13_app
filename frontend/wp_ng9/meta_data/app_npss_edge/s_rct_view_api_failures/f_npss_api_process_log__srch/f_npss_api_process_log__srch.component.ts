...
Build ID        : 27231 
Modified By     : Admin 
Modified Date   : 2022-Dec-08 12:13 PM 
Generated From  : TORUS Low Code Platform 
Copyright       : Torus Innovations Pvt Ltd © Copyright 2018 
Screen Name     : s_rct_view_api_failures
Form Name       : NPSS API Process Log  SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_api_process_log__srch',
  templateUrl: './f_npss_api_process_log__srch.component.html',
  styleUrls: ['./f_npss_api_process_log__srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_api_process_log__srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_api_process_log__srch') form;
  @ViewChild('npss_api_process_log__srch_memory9') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory9 = {}
		this.ctrl.memory9.id = "ec0a3279-b262-4d0c-b5f0-51801010cacc_1670071030494"
		...
		this.ctrl.memory9.view_name = "f_npss_api_process_log__srch"
		this.ctrl.memory9.ctrl_id = "npss_api_process_log__srch_memory9"
		this.ctrl.npss_api_process_log__srch_memory9 = {}
		this.ctrl.npss_api_process_log__srch_memory9.onChangecomponent = new EventEmitter<any>()
	
		//Properties of uetr
		this.ctrl.uetr = {}
		this.ctrl.uetr.id = "ee526312-cec4-4839-af02-32c78b92618a_1670071030495"
		...
		this.ctrl.uetr.view_name = "f_npss_api_process_log__srch"
		this.ctrl.uetr.ctrl_id = "npss_api_process_log__srch_uetr"
		this.ctrl.npss_api_process_log__srch_uetr = {}
		this.ctrl.npss_api_process_log__srch_uetr.onChangecomponent = new EventEmitter<any>()
	
		//Properties of process_name
		this.ctrl.process_name = {}
		this.ctrl.process_name.id = "3628790d-1725-455c-8193-01c349da98fe_1670071030495"
		...
		this.ctrl.process_name.view_name = "f_npss_api_process_log__srch"
		this.ctrl.process_name.ctrl_id = "npss_api_process_log__srch_process_name"
		this.ctrl.npss_api_process_log__srch_process_name = {}
		this.ctrl.npss_api_process_log__srch_process_name.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.process_name = {}
	
		//Properties of processing_system
		this.ctrl.processing_system = {}
		this.ctrl.processing_system.id = "5238d0f7-bb63-4cbd-b01e-8c4ab8b431b0_1670071030495"
		...
		this.ctrl.processing_system.view_name = "f_npss_api_process_log__srch"
		this.ctrl.processing_system.ctrl_id = "npss_api_process_log__srch_processing_system"
		this.ctrl.npss_api_process_log__srch_processing_system = {}
		this.ctrl.npss_api_process_log__srch_processing_system.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.model = {"MEMORY9":"setcurrentdate(),{}","UETR":"","PROCESS_NAME":"","PROCESSING_SYSTEM":""}
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.Meta = [{"CTLR_CODE":"TXT","DATA_TYPE":"TEXT","TARGET_COLUMN":"UETR"},{"CTLR_CODE":"CBO","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESS_NAME"},{"CTLR_CODE":"CDN_CTRL","DATA_TYPE":"TEXT","TARGET_COLUMN":"PROCESSING_SYSTEM"}]
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.dtt_code = "dtt_1304_1665905039255"
		this.screen_instance[this.comp_id].f_npss_api_process_log__srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_api_process_log__srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_api_process_log__srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_api_process_log__srch[control][property] = value;
  }
