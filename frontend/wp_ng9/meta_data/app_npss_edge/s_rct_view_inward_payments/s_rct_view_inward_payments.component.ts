...
export class s_rct_view_inward_paymentsComponent implements OnInit,AfterViewInit {
	...
	uicgc_5 : string = "view_dr_cr_tran_details"
	...
	ngOnInit() {
		...
		this.view_dr_cr_tran_details.uicgc_code = "uicgc_5"
		this.view_dr_cr_tran_details.params = {"need_search":"N","advance_dynamic_search":"N","need_vertical":"Y"}
	...
	search_search__action_button_click(){
		...
		this.search_search__de_from_search_to_navigation_search()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "search search"
	search_search__de_from_search_to_navigation_search() { 
		let Dest_Is_ctrl=true
		
		let source_id="search_search"
		let destn_id="navigation_ui_search"
		let parent_source_id=""
		let event_code="e_1669196161313"
		let event_params={"caller_name":"search_search__de_from_search_to_navigation_search","event_desc":"DE from Search to Navigation Search","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"search_search","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
