...
export class s_rct_view_inward_paymentsComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_show_message__sp_for_show_message_main_layout() { 
		...
		let event_params={"caller_name":"navigation_ui_show_message__sp_for_show_message_main_layout","event_desc":"SP for Show Message Main Layout","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_show_message","raiseparam":{"profile_code":"BTL_1304_1669632768345"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	navigation_ui_trg_disable_view_data_ui__de_from_trg_to_view_message_on_main_page() { 
		...
		let destn_id="navigation_ui_show_message"
		let parent_source_id=""
		let event_code="e_1669633239956"
		let event_params={"caller_name":"navigation_ui_trg_disable_view_data_ui__de_from_trg_to_view_message_on_main_page","event_desc":"DE from TRG to View Message on Main Page","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_trg_disable_view_data_ui","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
