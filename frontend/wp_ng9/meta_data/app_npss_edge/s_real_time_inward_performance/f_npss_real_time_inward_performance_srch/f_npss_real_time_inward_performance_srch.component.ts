...
Form Name       : NPSS Real Time Inward Performance SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_real_time_inward_performance_srch',
  templateUrl: './f_npss_real_time_inward_performance_srch.component.html',
  styleUrls: ['./f_npss_real_time_inward_performance_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_real_time_inward_performance_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_real_time_inward_performance_srch') form;
  @ViewChild('npss_real_time_inward_performance_srch_memory63') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory63.view_name = "f_npss_real_time_inward_performance_srch"
		...
		this.screen_instance[this.comp_id].f_npss_real_time_inward_performance_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_real_time_inward_performance_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_real_time_inward_performance_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_real_time_inward_performance_srch[control][property] = value;
  }
