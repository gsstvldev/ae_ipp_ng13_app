...
@Component({
	selector: 's_real_time_inward_performance',
	templateUrl: './s_real_time_inward_performance.component.html',
	styleUrls: ['./s_real_time_inward_performance.component.css'],
...
// Start of class 
export class s_real_time_inward_performanceComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_real_time_inward_performance"
	wftpa_id : string = "WFT_NPSS_P_1304_1712149184594_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712208637230","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Real Time Inward Performance MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"UETR","alias_name":"","mq_id":"MQ_1712207907943","date_format":false},{"column_name":"CDTR_IBAN","alias_name":"","mq_id":"MQ_1712207908541","date_format":false},{"column_name":"CDTR_ACCT_NAME","alias_name":"","mq_id":"MQ_1712207908725","date_format":false},{"column_name":"CR_SORT_CODE","alias_name":"","mq_id":"MQ_1712207909037","date_format":false},{"column_name":"START_DATE","alias_name":"","mq_id":"MQ_1712207948645","date_format":false},{"column_name":"END_DATE","alias_name":"","mq_id":"MQ_1712207948893","date_format":false},{"column_name":"DIFFERENCE","alias_name":"","mq_id":"MQ_1712207992070","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1712208003861","date_format":false},{"column_name":"DBTR_ACCT_NAME","alias_name":"","mq_id":"MQ_1712208004077","date_format":false},{"column_name":"DR_SORT_CODE","alias_name":"","mq_id":"MQ_1712208023366","date_format":false},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1712208023629","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1712208037285","date_format":false,"currency_format":true}],"joins":[]},"eq_text":"SELECT UETR,  CDTR_IBAN,  CDTR_ACCT_NAME,  CR_SORT_CODE,  DBTR_IBAN,  DBTR_ACCT_NAME,  DR_SORT_CODE,  CLRSYSREF,  INTRBK_STTLM_AMNT,  PROCESS_TYPE,  PAYMENT_TYPE,  START_DATE,  END_DATE,  D_SECONDS,  D_MINUTES,  D_HOURS,  CREATED_DATE,  PROCESS_GROUP,  CASE      WHEN D_SECONDS IS NOT NULL THEN ROUND(V.D_SECONDS)      WHEN D_MINUTES IS NOT NULL THEN ROUND(V.D_MINUTES)      WHEN D_HOURS IS NOT NULL THEN ROUND(V.D_HOURS)  END AS DIFFERENCE FROM  (SELECT NT.UETR,    NT.CDTR_IBAN,    NT.CDTR_ACCT_NAME,    NT.CR_SORT_CODE,    NT.DBTR_IBAN,    NT.DBTR_ACCT_NAME,    NT.DR_SORT_CODE,    NT.CLRSYSREF,    NT.INTRBK_STTLM_AMNT,    NT.TENANT_ID,    NT.PRODUCT_CODE,    NT.PROCESS_TYPE,    CASE        WHEN NT.EXHF_ID IS NULL THEN UPPER('rct')        ELSE UPPER('bct')    END AS PAYMENT_TYPE,    PL.CREATED_DATE AS PL_CREATED_DATE,    PL1.CREATED_DATE AS PL1_CREATED_DATE,    TO_CHAR(PL1.CREATED_DATE,      'YYYY-MM-DD HH:MI:SS:MS AM') AS START_DATE,    TO_CHAR(PL.CREATED_DATE,      'YYYY-MM-DD HH:MI:SS:MS AM') AS END_DATE,    EXTRACT(EPOCH            FROM (PL.CREATED_DATE - PL1.CREATED_DATE)) AS D_SECONDS,    EXTRACT(EPOCH            FROM (PL.CREATED_DATE - PL1.CREATED_DATE)) / 60 AS D_MINUTES,    EXTRACT(EPOCH            FROM (PL.CREATED_DATE - PL1.CREATED_DATE)) / (60 * 60) AS D_HOURS,    NT.CREATED_DATE,    NT.PROCESS_GROUP   FROM NPSS_TRANSACTIONS NT   INNER JOIN    (SELECT PLR.NPSSTPL_ID,      PLR.UETR,      PLR.CREATED_DATE,      PLR.ROW_NUM     FROM      (SELECT A.NPSSTPL_ID,        A.UETR,        A.CREATED_DATE,        ROW_NUMBER() OVER(PARTITION BY A.UETR                          ORDER BY A.NPSSTPL_ID DESC) AS ROW_NUM       FROM NPSS_TRN_PROCESS_LOG A) PLR     WHERE PLR.ROW_NUM = 1) PL ON PL.UETR = NT.UETR   INNER JOIN    (SELECT PLR1.NPSSTPL_ID,      PLR1.UETR,      PLR1.CREATED_DATE,      PLR1.ROW_NUM     FROM      (SELECT A1.NPSSTPL_ID,        A1.UETR,        A1.CREATED_DATE,        ROW_NUMBER() OVER(PARTITION BY A1.UETR                          ORDER BY A1.NPSSTPL_ID ASC) AS ROW_NUM       FROM NPSS_TRN_PROCESS_LOG A1) PLR1     WHERE PLR1.ROW_NUM = 1) PL1 ON PL1.UETR = NT.UETR)V WHERE PAYMENT_TYPE = UPPER('rct')  AND PROCESS_TYPE = 'IP' $AND"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Real Time Inward Performance MQ CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payee IBAN","target_column":"CDTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payee Name","target_column":"CDTR_ACCT_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payee BIC","target_column":"CR_SORT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Start Time","target_column":"START_DATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End Time","target_column":"END_DATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Difference (Sec)","target_column":"DIFFERENCE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payer IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payer Name","target_column":"DBTR_ACCT_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Payer BIC","target_column":"DR_SORT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing Sys Ref","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Right","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"NPSS Real Time Inward Performance SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_real_time_inward_performance_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_real_time_inward_performance_srch"
