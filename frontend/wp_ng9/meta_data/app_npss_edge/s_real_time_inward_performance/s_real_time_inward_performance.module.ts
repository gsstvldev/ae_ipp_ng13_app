...
import { s_real_time_inward_performanceRoutingModule } from './s_real_time_inward_performance.routing.module';
...
import { f_npss_real_time_inward_performance_srchComponent } from './f_npss_real_time_inward_performance_srch/f_npss_real_time_inward_performance_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_real_time_inward_performanceRoutingModule,
  ...
  declarations: [s_real_time_inward_performanceComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_real_time_inward_performance_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_real_time_inward_performanceModule { }
