...
@Component({
	selector: 's_salary_file_download',
	templateUrl: './s_salary_file_download.component.html',
	styleUrls: ['./s_salary_file_download.component.css'],
	providers:[gms_cv_date_of_intimationService]
})
    
// Start of class 
export class s_salary_file_downloadComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_salary_file_download"
	wftpa_id : string = "WFT_NPSS_P_1304_1665404012775_0"
	cg_code : string = "CG_1408_1652362447065"
	...
	queue__selection_changed(){
		...
		this.queue__enable_element_for_navi_continue()
	}
	...
	navigation_continue__action_button_click(){
		this.navigation_continue__show_profile_for_navi_continue()
		this.navigation_continue__show_element_for_navi_back()
		this.navigation_continue__hide_element_for_navi_continue()
	}

	//Handler for ACTION_BUTTON_CLICK event of "navigation back"
	navigation_back__action_button_click(){
		this.navigation_back__refresh_screen_for_navi_back()
	}
	...
	//Handler for SELECTION_CHANGED event of "queue"
	queue__enable_element_for_navi_continue() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"queue__enable_element_for_navi_continue","event_desc":"enable element for navi continue","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"queue","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation continue"
	navigation_continue__show_profile_for_navi_continue() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_continue__show_profile_for_navi_continue","event_desc":"show profile for navi continue","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_continue","raiseparam":{"profile_code":"BTL_1408_1599718695457"}}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation continue"
	navigation_continue__show_element_for_navi_back() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_continue__show_element_for_navi_back","event_desc":"show element for navi back","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_continue","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":"","hide_for":"","hide_except":"","hide_column":"","expression":""}}
		let handler_code="show_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation continue"
	navigation_continue__hide_element_for_navi_continue() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_continue__hide_element_for_navi_continue","event_desc":"hide element for navi continue","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_continue","raiseparam":{"visible_collapse_count":"","visible_collapse_locked_by":""}}
		let handler_code="hide_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation back"
	navigation_back__refresh_screen_for_navi_back() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_back__refresh_screen_for_navi_back","event_desc":"refresh screen for navi back","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_back","raiseparam":{}}
