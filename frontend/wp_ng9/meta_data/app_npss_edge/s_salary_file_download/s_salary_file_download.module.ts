...
import { s_salary_file_downloadRoutingModule } from './s_salary_file_download.routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    s_salary_file_downloadRoutingModule,
    torus_cs_show_hideModule
  ],
  declarations: [s_salary_file_downloadComponent,p_exchange_queueComponent,f_navigationComponent,p_exchange_layoutsComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_salary_file_downloadModule { }
