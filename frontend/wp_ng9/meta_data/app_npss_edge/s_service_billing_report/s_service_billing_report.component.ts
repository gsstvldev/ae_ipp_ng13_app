...
export class s_service_billing_reportComponent implements OnInit,AfterViewInit {
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1681974712398":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dtt_code":"DTT_1304_1681974712398","ds_eligible":"DS_1712216165853","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Service Billing Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSSBR_ID","alias_name":"","mq_id":"MQ_1712215863427","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1712215863594","date_format":false},{"column_name":"SERVICE_NAME","alias_name":"","mq_id":"MQ_1712215863793","date_format":false},{"column_name":"VOLUME_VALUE_SIZE","alias_name":"","mq_id":"MQ_1712215863993","date_format":false},{"column_name":"TOTAL_CHARGE_AMOUNT","alias_name":"","mq_id":"MQ_1712215901890","date_format":false,"currency_format":true}],"joins":[]},"eq_text":"SELECT NPSSSBR_ID,  SERVICE_NAME,  VOLUME_VALUE_SIZE,  TOTAL_CHARGE_AMOUNT,  TENANT_ID,  CREATED_DATE,  DT_CODE,  DTT_CODE,  VERSION_NO FROM  (SELECT NSBR.NPSSSBR_ID,    NSBR.SERVICE_NAME,    NSBR.VOLUME_VALUE_SIZE,    NSBR.TOTAL_CHARGE_AMOUNT,    NSBR.TENANT_ID,    NSBR.CREATED_DATE,    NSBR.DT_CODE,    NSBR.DTT_CODE,    NSBR.VERSION_NO   FROM <TRAN_DB>.NPSS_SER_BILLING_REPORT NSBR)V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Service Billing Report MQ CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Tran ID","target_column":"NPSSSBR_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Date","target_column":"CREATED_DATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Service Name","target_column":"SERVICE_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Volume Value Size","target_column":"VOLUME_VALUE_SIZE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Total Charge Amount","target_column":"TOTAL_CHARGE_AMOUNT","alias_name":"","alignment":"Right","width":"","format":"CURRENCY:د.إ","date_format":false,"currency_format":true}]}}}}}}
		try {
