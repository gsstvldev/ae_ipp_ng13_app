...
import { s_user_access_matrix_reportRoutingModule } from './s_user_access_matrix_report.routing.module';
...
import { f_user_access_matrix_report_srchComponent } from './f_user_access_matrix_report_srch/f_user_access_matrix_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_user_access_matrix_reportRoutingModule,
  ...
  declarations: [s_user_access_matrix_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_user_access_matrix_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_user_access_matrix_reportModule { }
