...
export class s_user_activitiesComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.tabview.params = [{"desc":"User Sessions","profile_code":"BTL_1304_1673614486990","id":1673614596012},{"desc":"Menu Access","profile_code":"BTL_1304_1673614684841","id":1673614631612},{"desc":"Password History","profile_code":"BTL_1304_1673614707921","id":1673614639076},{"desc":"Activities","profile_code":"BTL_1304_1673614734718","id":1673614643467}]
	...
	cf_for_pl__internal(parent_event_result){
		this.cf_for_pl__tbc_for_search(parent_event_result)
	}
	...
	page_load__cf_for_pl() { 
		...
		let internals="cf_for_pl__tbc_for_search,"
		let event_data={}
		let data_source={}
		try {
	...
	//Handler for INTERNAL event of "cf for pl"
	cf_for_pl__tbc_for_search(parent_event_result) { 
		let Dest_Is_ctrl=true
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1673615503008"
		let event_params={"caller_name":"cf_for_pl__tbc_for_search","event_desc":"TBC for SEarch","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{},"parent_event_result":"SUCCESS"}
	...
	users__svm_for_search_users() { 
		...
		let internals="svm_for_search_users__brfq_for_user_sessions,svm_for_search_users__brfq_for_menu_access,svm_for_search_users__brfq_for_activities,svm_for_search_users__brfq_for_password_histroy,"
	...
	navigation_search__spap_for_search() { 
		...
		let event_params={"caller_name":"navigation_search__spap_for_search","event_desc":"SPAP for Search","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_search","raiseparam":{"popup_category":"profile","variable":"p_search_layout__spap_for_search","selector":"p_search_layout","profile_code":"BTL_1304_1673614342707","window_title":"Search","window_height":450,"window_width":"700px","window_close_icon":"Y","eventdes":"spap_for_search","eventcode":"E_1673615368498"}}
