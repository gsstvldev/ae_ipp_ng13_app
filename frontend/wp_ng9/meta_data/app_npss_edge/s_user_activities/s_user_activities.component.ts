...
export class s_user_activitiesComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.authentication_history.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_9","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS TRN REQ RESP DTLS","ds_eligible":"DS_1676609482672","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Authentication History MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"LOGIN_STATUS","alias_name":"","mq_id":"MQ_1676609342442","date_format":false},{"column_name":"REMARKS","alias_name":"","mq_id":"MQ_1676609342808","date_format":false}],"joins":[]},"eq_text":"select  LOGIN_STATUS,  REMARKS,U_ID,  TENANT_ID from  (  select      U.U_ID,   UAL.LOGIN_NAME,   UAL.REMARKS ,   UAL.TENANT_ID ,   UAL.LOGIN_STATUS  from   <CLT_CAS>.USER_AUTHENTICATION_LOG UAL   inner join <CLT_CAS>.USERS U on   UAL.LOGIN_NAME = U.LOGIN_NAME) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Authentication History CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"U_ID","binding_name":"U_ID","binding_value":"","source_name":"MI_LEVEL_U_ID","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Login Status","target_column":"LOGIN_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Remarks","target_column":"REMARKS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
