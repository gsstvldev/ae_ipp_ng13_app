...
@NgModule({
  ...
  declarations: [s_user_activitiesComponent,p_main_layoutComponent,f_navigationComponent,t_tabviewComponent,p_user_sessions_layoutComponent,p_menu_access_layoutComponent,p_password_history_layoutComponent,p_activitiesComponent,p_search_layoutComponent,f_npss_user_log_srchComponent,],
