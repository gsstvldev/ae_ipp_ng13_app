...
@Component({
	selector: 's_user_activity_report',
	templateUrl: './s_user_activity_report.component.html',
	styleUrls: ['./s_user_activity_report.component.css'],
...
// Start of class 
export class s_user_activity_reportComponent implements OnInit,AfterViewInit {
	// Variables 
