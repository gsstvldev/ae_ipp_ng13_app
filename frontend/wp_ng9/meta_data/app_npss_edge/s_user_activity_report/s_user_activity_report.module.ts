...
import { s_user_activity_reportRoutingModule } from './s_user_activity_report.routing.module';
...
import { f_user_activity_report_srchComponent } from './f_user_activity_report_srch/f_user_activity_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_user_activity_reportRoutingModule,
  ...
  declarations: [s_user_activity_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_user_activity_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_user_activity_reportModule { }
