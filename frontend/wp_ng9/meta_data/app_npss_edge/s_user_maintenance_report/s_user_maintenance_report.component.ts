...
@Component({
	selector: 's_user_maintenance_report',
	templateUrl: './s_user_maintenance_report.component.html',
	styleUrls: ['./s_user_maintenance_report.component.css'],
...
// Start of class 
export class s_user_maintenance_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_user_maintenance_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1712150828941_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712295462183","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"User Maintenance Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"LOGIN_NAME","alias_name":"","mq_id":"MQ_1712216628572","date_format":false},{"column_name":"FIRST_NAME","alias_name":"","mq_id":"MQ_1712216628979","date_format":false},{"column_name":"LAST_NAME","alias_name":"","mq_id":"MQ_1712216629371","date_format":false},{"column_name":"APP_DESCRIPTION","alias_name":"","mq_id":"MQ_1712216629539","date_format":false},{"column_name":"ROLE_DESCRIPTION","alias_name":"","mq_id":"MQ_1712216629723","date_format":false},{"column_name":"EMAIL_ID","alias_name":"","mq_id":"MQ_1712216630203","date_format":false},{"column_name":"MOBILE_NO","alias_name":"","mq_id":"MQ_1712216630939","date_format":false},{"column_name":"START_ACTIVE_DATE","alias_name":"","mq_id":"MQ_1712216718044","date_format":false},{"column_name":"END_ACTIVE_DATE","alias_name":"","mq_id":"MQ_1712216718426","date_format":false},{"column_name":"LAST_SUCCESSFUL_LOGIN","alias_name":"","mq_id":"MQ_1712216718674","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1712216783732","date_format":false},{"column_name":"ACCOUNT_LOCKED_DATE","alias_name":"","mq_id":"MQ_1712216784162","date_format":false},{"column_name":"REMARKS","alias_name":"","mq_id":"MQ_1712216822498","date_format":false},{"column_name":"STARTACTIVEDATE","alias_name":"","mq_id":"MQ_1719484939248","date_format":false},{"column_name":"ENDACTIVEDATE","alias_name":"","mq_id":"MQ_1719484946152","date_format":false},{"column_name":"LASTSUCCESSFULLOGIN","alias_name":"","mq_id":"MQ_1721036322738","date_format":false}],"joins":[]},"eq_text":"select  FIRST_NAME,  MIDDLE_NAME,  LAST_NAME ,  LOGIN_NAME,  APP_DESCRIPTION,  ROLE_DESCRIPTION,  EMAIL_ID ,  MOBILE_NO ,  START_ACTIVE_DATE,  END_ACTIVE_DATE,  LAST_SUCCESSFUL_LOGIN,  STARTACTIVEDATE,  ENDACTIVEDATE ,  SESSION_TIMEOUT ,  ALLOCATED_IP ,  DOUBLE_AUTHENTICATION ,  DOUBLE_AUTHENTICATION_MODEL,  ENFORCE_CHANGE_PASSWORD ,  NEED_EXTERNAL_AUTH,  LASTSUCCESSFULLOGIN,  TENANT_ID,  STATUS,  ACCOUNT_LOCKED_DATE,  REMARKS from  (  select   U.FIRST_NAME,   U.MIDDLE_NAME,   U.LAST_NAME ,   U.LOGIN_NAME,   U.EMAIL_ID ,   U.MOBILE_NO ,   TO_CHAR(U.START_ACTIVE_DATE,'YYYY-MM-DD HH:MI:SS AM') as STARTACTIVEDATE ,   TO_CHAR(U.END_ACTIVE_DATE,'YYYY-MM-DD HH:MI:SS AM') as ENDACTIVEDATE ,   TO_CHAR(U.LAST_SUCCESSFUL_LOGIN,'YYYY-MM-DD HH:MI:SS AM') as LASTSUCCESSFULLOGIN ,   U.START_ACTIVE_DATE,   U.END_ACTIVE_DATE,   U.LAST_SUCCESSFUL_LOGIN,   U.SESSION_TIMEOUT ,   U.ALLOCATED_IP ,   U.DOUBLE_AUTHENTICATION ,   U.DOUBLE_AUTHENTICATION_MODEL,   U.ENFORCE_CHANGE_PASSWORD ,   U.NEED_EXTERNAL_AUTH,   U.TENANT_ID,   U.STATUS,   U.REMARKS,   U.ACCOUNT_LOCKED_DATE,   A.APP_DESCRIPTION,   AR.ROLE_DESCRIPTION  from   <CLT_CAS>.USERS U  inner join <CLT_CAS>.APP_USERS AU on   AU.U_ID = U.U_ID  inner join <CLT_CAS>.APP_USER_ROLES AUR on   AUR.APPU_ID = AU.APPU_ID  inner join <CLT_CAS>.APP_ROLES AR on   AR.APPR_ID = AUR.APPR_ID  inner join <CLT_CAS>.APPLICATIONS A on   A.APP_ID = AU.APP_ID)V where  LOGIN_NAME not in ('VPH_ADMIN', 'TORUS_ADMIN', 'NPSS_ADMIN') $AND order by  LOGIN_NAME asc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"User Maintenance Report CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Login Name","target_column":"LOGIN_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"First Name","target_column":"FIRST_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last Name","target_column":"LAST_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Application Name","target_column":"APP_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Role Name","target_column":"ROLE_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Email","target_column":"EMAIL_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Mobile Number","target_column":"MOBILE_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Start Active Date","target_column":"STARTACTIVEDATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"End Active Date","target_column":"ENDACTIVEDATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Last successful login","target_column":"LASTSUCCESSFULLOGIN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Locked On","target_column":"ACCOUNT_LOCKED_DATE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Remarks","target_column":"REMARKS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"User Maintenance Report SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_user_maintenance_report_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_user_maintenance_report_srch"
