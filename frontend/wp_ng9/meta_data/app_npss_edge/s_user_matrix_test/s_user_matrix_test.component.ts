...
// Start of class 
export class s_user_matrix_testComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_user_matrix_test"
	wftpa_id : string = "WFT_NPSS_P_1304_1674450561983_0"
	...
	forms : any = ["uicgc_4","uicgc_17","uicgc_15","uicgc_16","uicgc_13","uicgc_10","uicgc_12","uicgc_14","uicgc_6","uicgc_3"]
	...
	ngOnInit() {
		...
		this.queue.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1674451973932","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS UM QUEUE MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1674452704641","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1674452704983","date_format":false}],"joins":[]},"eq_text":"select  distinct PROCESS_STATUS,  STATUS,  PROCESSING_SYSTEM from  (  select   NT.CREATED_DATE,   NT.VALUE_DATE,   NT.STATUS,   NT.PROCESS_STATUS,   NT.UETR,   NT.PROCESSING_SYSTEM,   NT.TENANT_ID,   NT.CREATED_DATE_UTC,   NT.MODIFIED_DATE,   NT.MODIFIED_DATE_UTC,   TS.TS_ID,   TS.LOCKED_BY,   TS.LOCKED_BY_NAME,   NT.CREATED_BY,   NT.CREATED_BY_NAME,   NT.SYSTEM_ID,   NT.DEPARTMENT_CODE,   NT.CR_ACCT_IDENTIFICATION ,   NT.CDTR_ACCT_NO ,   NT.CDTR_IBAN ,   NT.DBTR_ACCT_NO ,   NT.DBTR_IBAN,   NT.TRAN_REF_ID,   NT.CLRSYSREF,   NT.PAYMENT_ENDTOEND_ID,   NT.INTRBK_STTLM_AMNT,   NT.PROCESS_TYPE,   NTPL.PROCESS_NAME   from   NPSS_TRANSACTIONS NT  inner join NPSS_TRN_PROCESS_LOG NTPL on NTPL.UETR = NT.UETR  left join TRANSACTION_SET TS on   NT.NPSST_ID = TS.TRN_ID   and NT.DTT_CODE = TS.DTT_CODE) VW $WHERE order by  PROCESSING_SYSTEM,  PROCESS_STATUS,  STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS UM CCD","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"DEPARTMENT_CODE","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"OR","group_no":""},{"filter_name":"Department_code_user","binding_name":"Department_code","binding_value":"","source_name":"USER_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"FROM_AMOUNT","binding_name":"INTRBK_STTLM_AMNT","binding_value":"","source_name":"USER_EXTENDED_INFO.from_amount","source_value":"","source_type":"SESSION_LEVEL","oprtr":">=","data_type":"NUMBER","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TO_AMOUNT","binding_name":"INTRBK_STTLM_AMNT","binding_value":"","source_name":"USER_EXTENDED_INFO.to_amount","source_value":"","source_type":"SESSION_LEVEL","oprtr":"<=","data_type":"NUMBER","conj_operator":"AND","group_no":""}],"databinding":[{"header":"PROCESS_STATUS","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"STATUS","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
