...
import { s_user_menu_access_reportRoutingModule } from './s_user_menu_access_report.routing.module';
...
import { f_npss_user_menu_access_report_srchComponent } from './f_npss_user_menu_access_report_srch/f_npss_user_menu_access_report_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_user_menu_access_reportRoutingModule,
  ...
  declarations: [s_user_menu_access_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_user_menu_access_report_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_user_menu_access_reportModule { }
