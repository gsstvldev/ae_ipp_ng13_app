...
export class f_npss_user_password_history_srchComponent implements OnInit {
  ...
  @ViewChild('npss_user_password_history_srch_memory153') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory153.view_name = "f_npss_user_password_history_srch"
		this.ctrl.memory153.ctrl_id = "npss_user_password_history_srch_memory153"
		this.ctrl.npss_user_password_history_srch_memory153 = {}
		this.ctrl.npss_user_password_history_srch_memory153.onChangecomponent = new EventEmitter<any>()
		...
		this.screen_instance[this.comp_id].f_npss_user_password_history_srch.model = {"MEMORY153":"","MEMORY63":"setcurrentdate(),{}"}
