...
@Component({
	selector: 's_user_password_history_report',
	templateUrl: './s_user_password_history_report.component.html',
	styleUrls: ['./s_user_password_history_report.component.css'],
...
// Start of class 
export class s_user_password_history_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_user_password_history_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1712205192338_0"
	...
	ngOnInit() {
		...
		this.search.views = {"first":"DTT_1304_1665901217208","is_tab_mode":"N","dtt_1304_1665901217208":{"0":[{"dttv_id":"NPSS User Password History SRCH","tab_order":0,"tab_name":"","uicgc_description":"Search","role_description":"default","dtt_description":"NPSS Transactions"}]}}
		this.search.onChangecomponent = new EventEmitter<any>()
		this.search.show = true
		this.search.dynamic_param = {}
		this.search.f_npss_user_password_history_srch = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.search.form_name = "f_npss_user_password_history_srch"
