...
Build ID        : 35106 
Modified By     : Admin 
Modified Date   : 2024-Apr-05 8:15 AM 
...
import { s_user_password_history_reportComponent } from './s_user_password_history_report.component';
import { s_user_password_history_reportRoutingModule } from './s_user_password_history_report.routing.module';
...
import { f_npss_user_password_history_srchComponent } from './f_npss_user_password_history_srch/f_npss_user_password_history_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_user_password_history_reportRoutingModule,
  ...
  declarations: [s_user_password_history_reportComponent,p_main_layoutComponent,f_navigationComponent,p_search_layoutComponent,f_npss_user_password_history_srchComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_user_password_history_reportModule { }
