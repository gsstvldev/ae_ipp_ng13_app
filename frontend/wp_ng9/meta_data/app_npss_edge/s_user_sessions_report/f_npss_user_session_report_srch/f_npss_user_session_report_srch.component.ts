...
Form Name       : NPSS User Session Report SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_user_session_report_srch',
  templateUrl: './f_npss_user_session_report_srch.component.html',
  styleUrls: ['./f_npss_user_session_report_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_user_session_report_srchComponent implements OnInit {
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory63.view_name = "f_npss_user_session_report_srch"
		...
		this.screen_instance[this.comp_id].f_npss_user_session_report_srch.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_user_session_report_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_user_session_report_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_user_session_report_srch[control][property] = value;
  }
