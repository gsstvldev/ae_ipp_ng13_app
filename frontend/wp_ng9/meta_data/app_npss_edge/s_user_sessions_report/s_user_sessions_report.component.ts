...
Build ID        : 35858 
Modified By     : Admin 
Modified Date   : 2024-Jun-27 11:48 AM 
...
@Component({
	selector: 's_user_sessions_report',
	templateUrl: './s_user_sessions_report.component.html',
	styleUrls: ['./s_user_sessions_report.component.css'],
...
// Start of class 
export class s_user_sessions_reportComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_user_sessions_report"
	wftpa_id : string = "WFT_NPSS_P_1304_1712205099543_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Transactions","ds_eligible":"DS_1712214850733","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS User Sessions Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"USER_NAME","alias_name":"","mq_id":"MQ_1712214644571","date_format":false},{"column_name":"LOGON_TIME","alias_name":"","mq_id":"MQ_1712214644786","date_format":false},{"column_name":"LOGOUT_TIME","alias_name":"","mq_id":"MQ_1712214644978","date_format":false},{"column_name":"LOGONTIME","alias_name":"","mq_id":"MQ_1719484547444","date_format":false},{"column_name":"LOGOUTTIME","alias_name":"","mq_id":"MQ_1719484547610","date_format":false}],"joins":[]},"eq_text":"select  USER_NAME,  U_ID,  LOGIN_IP,  LOGON_TIME,  LOGOUT_TIME,  LOGONTIME,  LOGOUTTIME from  (  select   HUS.LOGIN_NAME as USER_NAME,   HUS.U_ID,   HUS.LOGIN_IP, to_char(HUS.LOGON_TIME, 'DD/MM/YYYY') as LOGONTIME,  to_char(HUS.LOGOUT_TIME, 'DD/MM/YYYY') as LOGOUTTIME,   HUS.LOGON_TIME,   HUS.LOGOUT_TIME,   HUS.CREATED_DATE  from  HST_USER_SESSIONS HUS  inner join USERS U on   HUS.U_ID = U.U_ID)V $WHERE group by  USER_NAME,  U_ID,  LOGIN_IP,  LOGON_TIME,  LOGOUT_TIME,  LOGONTIME,  LOGOUTTIME order by  LOGON_TIME asc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS User Sessions Report MQ CCD","filter":[],"databinding":[{"header":"User Name","target_column":"USER_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Login Time","target_column":"LOGONTIME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Logout Time","target_column":"LOGOUTTIME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
