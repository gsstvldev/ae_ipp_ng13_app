...
export class s_view_all_op_arc_transactionsComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_14","uicgc_11","uicgc_4","uicgc_22","uicgc_12","uicgc_25","uicgc_24","uicgc_17","uicgc_21","uicgc_19","uicgc_10","uicgc_15","uicgc_13","uicgc_7","uicgc_6","uicgc_3"]
	...
	ngOnInit() {
		...
		this.process_log_search.f_process_log_search = {"show":true}
		this.process_log_search.current_view = "f_process_log_search"
