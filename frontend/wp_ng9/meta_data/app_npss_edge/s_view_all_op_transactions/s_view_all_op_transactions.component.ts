...
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	...
	navigation_ui_view_api_failure__action_button_click(){
		this.navigation_ui_view_api_failure__brfq_view_api()
		this.navigation_ui_view_api_failure__e_1681969976914()
	}

	//Handler for INTERNAL event of "brfq view api"
	brfq_view_api__internal(parent_event_result){
		this.brfq_view_api__e_1681967066879(parent_event_result)
	}
	...
	view_api_failure__action_ui_back__action_button_click(){
		this.view_api_failure__action_ui_back__e_1681967182099()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view api failure"
	navigation_ui_view_api_failure__e_1681969976914() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_api_failure"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1681969976914"
		let event_params={"caller_name":"navigation_ui_view_api_failure__e_1681969976914","event_desc":"E_1681969976914","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_api_failure","raiseparam":{"profile_code":"BTL_1304_1681966202861"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "brfq view api"
	brfq_view_api__e_1681967066879(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="brfq_view_api"
		let destn_id="view_process_log_list"
		let parent_source_id="navigation_ui_view_api_failure"
		let event_code="e_1681967066879"
		let event_params={"caller_name":"brfq_view_api__e_1681967066879","event_desc":"E_1681967066879","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_api_failure","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_20","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681969216071","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS API Process Log Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1670064116426","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1670064116672","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1670064116880","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1670064117056","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149613","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149805","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149981","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1670064150149","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1670064177325","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1670064177533","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1670064177885","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1670064178117","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1670064218603","date_format":true},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1670064218787","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1670064218971","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1670064286961","date_format":false},{"column_name":"REQUEST_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287161","date_format":false},{"column_name":"RESPONSE_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287345","date_format":false},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287537","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287721","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1670064320760","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1670064320967","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064321183","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064344727","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1670064345223","date_format":false},{"column_name":"DT_CODE","alias_name":"","mq_id":"MQ_1670064359759","date_format":false},{"column_name":"DTT_CODE","alias_name":"","mq_id":"MQ_1670064359975","date_format":false},{"column_name":"V_CODE","alias_name":"","mq_id":"MQ_1677935697826","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  PROCESS_STATUS,  STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DT_CODE,  DTT_CODE,  V_CODE from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.ADDITIONAL_INFO,   A.V_CODE,   T24RC.RETURN_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE, '-', T24RC.RETURN_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   NPSS_TRN_PROCESS_LOG A  left join <tran_db>.CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES T24RC on   T24RC.RETURN_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  order by   A.NPSSTPL_ID DESC) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS API Process Log Detail CCD","filter":[{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"OP_AC_VAL_FAILED,OP_AC_MAND_VAL_FAILED,OP_AC_DUPL_VAL_FAILED,OP_AC_PCODE_VAL_FAILED,OP_AC_PBANK_VAL_FAILED,OP_P2P_SENDER_IBAN_FAILED,OP_P2P_PAYMENT_FAILED,OP_P2P_POSTING_FAILURE,OP_P2P_POSTING_SUSPICIOUS,OP_P2B_FUND_UNFREEZED,OP_P2B_PAYMENT_FAILED,OP_P2B_FUND_RES_FAILURE,OP_P2B_FUND_RES_SUSPICIOUS,OP_P2B_FUND_UNFR_FAILURE,OP_P2B_FUND_UNFR_SUSPICIOUS,OP_P2B_FUND_AUTH_FAILURE,OP_P2B_FUND_AUTH_SUSPICIOUS","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Validation Code","target_column":"V_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Error Code","target_column":"RESPONSE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view api failure  action ui back"
	view_api_failure__action_ui_back__e_1681967182099() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_api_failure__action_ui_back"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1681967182099"
		let event_params={"caller_name":"view_api_failure__action_ui_back__e_1681967182099","event_desc":"E_1681967182099","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_api_failure__action_ui_back","raiseparam":{"profile_code":"BTL_1304_1666856599156"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
