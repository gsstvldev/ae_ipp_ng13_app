...
Build ID        : 29987 
Modified By     : Admin 
Modified Date   : 2023-Jun-07 13:1 PM 
...
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	...
	process_log_ui_view_req_and_resp__action_button_click(){
		...
		this.process_log_ui_view_req_and_resp__e_1686142646533()
	}
	...
	process_log_search_search__action_button_click(){
		...
		this.process_log_search_search__e_1686142565258()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "process log ui view req and resp"
	process_log_ui_view_req_and_resp__e_1686142646533() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"process_log_ui_view_req_and_resp__e_1686142646533","event_desc":"E_1686142646533","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"process_log_ui_view_req_and_resp","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "process log search search"
	process_log_search_search__e_1686142565258() { 
		let Dest_Is_ctrl=true
		
		let source_id="process_log_search_search"
		let destn_id="process_log_list"
		let parent_source_id=""
		let event_code="e_1686142565258"
		let event_params={"caller_name":"process_log_search_search__e_1686142565258","event_desc":"E_1686142565258","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"process_log_search_search","raiseparam":{"need_reset_key_column":"N"}}
		let handler_code="clear_ui"
		let internals=""
		let event_data={}
		let data_source={}
