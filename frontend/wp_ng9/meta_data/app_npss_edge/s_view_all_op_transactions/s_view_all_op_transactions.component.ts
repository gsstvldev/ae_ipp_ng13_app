...
Build ID        : 29373 
Modified By     : Admin 
Modified Date   : 2023-May-24 14:1 PM 
...
@Component({
	...
	providers:[torus_cs_change_routingkeyService,torus_cs_show_hideService,npss_cs_rct_already_postingService]
})
...
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_22","uicgc_4","uicgc_12","uicgc_14","uicgc_24","uicgc_11","uicgc_17","uicgc_21","uicgc_19","uicgc_10","uicgc_15","uicgc_13","uicgc_7","uicgc_6","uicgc_3"]
	...
	// Constructor 
	constructor(private handler:AppHandlerService ,private torus_cs_change_routingkeyService:torus_cs_change_routingkeyService,private torus_cs_show_hideService:torus_cs_show_hideService,private npss_cs_rct_already_postingService:npss_cs_rct_already_postingService) {
	...
	navigation_ui_view_api_transactions__action_button_click(){
		...
		this.navigation_ui_view_api_transactions__brfq_for_api_queue_list()
	}
	...
	view_process_log_list__selection_changed(){
		this.view_process_log_list__e_1681967257508()
		this.view_process_log_list__e_1681967383501()
		this.view_process_log_list__e_1681967394348()
		this.view_process_log_list__e_1681967528863()
		this.view_process_log_list__e_1681967544709()
		this.view_process_log_list__e_1681989250949()
	}
	...
	view_api_failure__action_ui_view_req_and_res__action_button_click(){
		this.view_api_failure__action_ui_view_req_and_res__e_1681967355207()
		this.view_api_failure__action_ui_view_req_and_res__e_1681967369196()
	...
	ssp_from_search_btn_to_search_component__internal(parent_event_result){
		this.ssp_from_search_btn_to_search_component__brfq_from_ssp_to_view_list(parent_event_result)
	}

	//Handler for INTERNAL event of "brfq from ssp to view list"
	brfq_from_ssp_to_view_list__internal(parent_event_result){
		this.brfq_from_ssp_to_view_list__e_1684318887983(parent_event_result)
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view api transactions"
	navigation_ui_view_api_transactions__brfq_for_api_queue_list() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_api_transactions"
		let destn_id="api_queue"
		let parent_source_id=""
		let event_code="e_1681975000562"
		let event_params={"caller_name":"navigation_ui_view_api_transactions__brfq_for_api_queue_list","event_desc":"BRFQ for API Queue list","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_api_transactions","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681967257508() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681967257508","event_desc":"E_1681967257508","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681967383501() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681967383501","event_desc":"E_1681967383501","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681967394348() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681967394348","event_desc":"E_1681967394348","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681967528863() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681967528863","event_desc":"E_1681967528863","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681967544709() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681967544709","event_desc":"E_1681967544709","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"","disable_column":"","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "view process log list"
	view_process_log_list__e_1681989250949() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"view_process_log_list__e_1681989250949","event_desc":"E_1681989250949","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"view_process_log_list","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view api failure  action ui view req and res"
	view_api_failure__action_ui_view_req_and_res__e_1681967355207() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_api_failure__action_ui_view_req_and_res"
		let destn_id="response_ui"
		let parent_source_id=""
		let event_code="e_1681967355207"
		let event_params={"caller_name":"view_api_failure__action_ui_view_req_and_res__e_1681967355207","event_desc":"E_1681967355207","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_api_failure__action_ui_view_req_and_res","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view api failure  action ui view req and res"
	view_api_failure__action_ui_view_req_and_res__e_1681967369196() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_api_failure__action_ui_view_req_and_res"
		let destn_id="request_ui"
		let parent_source_id=""
		let event_code="e_1681967369196"
		let event_params={"caller_name":"view_api_failure__action_ui_view_req_and_res__e_1681967369196","event_desc":"E_1681967369196","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_api_failure__action_ui_view_req_and_res","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
	...
	process_log_search_search__ssp_from_search_btn_to_search_component() { 
		...
		let handler_code="set_search_params"
		let internals="ssp_from_search_btn_to_search_component__brfq_from_ssp_to_view_list,"
		let event_data={}
		let data_source={}
		try {
			this.handler.set_search_params(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "ssp from search btn to search component"
	ssp_from_search_btn_to_search_component__brfq_from_ssp_to_view_list(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1684312806213"
		let event_params={"caller_name":"ssp_from_search_btn_to_search_component__brfq_from_ssp_to_view_list","event_desc":"BRFQ from SSP to View List","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"process_log_search_search","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"},"parent_event_result":"SUCCESS"}
		let handler_code="bind_record_from_query"
		let internals="brfq_from_ssp_to_view_list__e_1684318887983,"
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_20","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681969216071","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS API Process Log Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1670064116426","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1670064116672","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1670064116880","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1670064117056","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149613","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149805","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149981","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1670064150149","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1670064177325","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1670064177533","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1670064177885","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1670064178117","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1670064218603","date_format":true},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1670064218787","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1670064218971","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1670064286961","date_format":false},{"column_name":"REQUEST_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287161","date_format":false},{"column_name":"RESPONSE_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287345","date_format":false},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287537","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287721","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1670064320760","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1670064320967","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064321183","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064344727","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1670064345223","date_format":false},{"column_name":"DT_CODE","alias_name":"","mq_id":"MQ_1670064359759","date_format":false},{"column_name":"DTT_CODE","alias_name":"","mq_id":"MQ_1670064359975","date_format":false},{"column_name":"V_CODE","alias_name":"","mq_id":"MQ_1677935697826","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1682507278805","date_format":false},{"column_name":"AMOUNT","alias_name":"","mq_id":"MQ_1682507279043","date_format":false,"currency_format":true},{"column_name":"TRAN_REF_ID","alias_name":"","mq_id":"MQ_1682507279243","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  API_PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  API_PROCESS_STATUS,  API_STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DT_CODE,  DTT_CODE,  V_CODE,  DBTR_IBAN,  AMOUNT,  TRAN_REF_ID from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS as API_PROCESS_STATUS,   A.STATUS as API_STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.ADDITIONAL_INFO,   A.V_CODE,   A.DBTR_IBAN,   A.AMOUNT,   A.TRAN_REF_ID,   T24RC.RETURN_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE, '-', T24RC.RETURN_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   NPSS_TRN_PROCESS_LOG A  left join <tran_db>.CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES T24RC on   T24RC.RETURN_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  order by   A.NPSSTPL_ID desc) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS API Process Log Detail CCD","filter":[{"filter_name":"API_PROCESS_STATUS","binding_name":"API_PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_API_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"API_PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_API_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"STATUS","binding_name":"API_STATUS","binding_value":"","source_name":"MI_LEVEL_API_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Validation Code","target_column":"V_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Error Code","target_column":"RESPONSE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"AMOUNT","alias_name":"","alignment":"Right","width":"","format":"","date_format":false,"currency_format":true},{"header":"Tran Ref ID","target_column":"TRAN_REF_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Uetr","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
	...
	//Handler for INTERNAL event of "brfq from ssp to view list"
	brfq_from_ssp_to_view_list__e_1684318887983(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		let source_id="brfq_from_ssp_to_view_list"
		let destn_id="view_process_log_list"
		let parent_source_id="ssp_from_search_btn_to_search_component"
		let event_code="e_1684318887983"
		let event_params={"caller_name":"brfq_from_ssp_to_view_list__e_1684318887983","event_desc":"E_1684318887983","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"process_log_search_search","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="select_first_record"
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_20","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681969216071","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS API Process Log Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1670064116426","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1670064116672","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1670064116880","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1670064117056","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149613","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149805","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1670064149981","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1670064150149","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1670064177325","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1670064177533","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1670064177885","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1670064178117","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1670064218603","date_format":true},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1670064218787","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1670064218971","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1670064286961","date_format":false},{"column_name":"REQUEST_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287161","date_format":false},{"column_name":"RESPONSE_DATA_JSON","alias_name":"","mq_id":"MQ_1670064287345","date_format":false},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287537","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1670064287721","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1670064320760","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1670064320967","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064321183","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1670064344727","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1670064345223","date_format":false},{"column_name":"DT_CODE","alias_name":"","mq_id":"MQ_1670064359759","date_format":false},{"column_name":"DTT_CODE","alias_name":"","mq_id":"MQ_1670064359975","date_format":false},{"column_name":"V_CODE","alias_name":"","mq_id":"MQ_1677935697826","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1682507278805","date_format":false},{"column_name":"AMOUNT","alias_name":"","mq_id":"MQ_1682507279043","date_format":false,"currency_format":true},{"column_name":"TRAN_REF_ID","alias_name":"","mq_id":"MQ_1682507279243","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  API_PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  API_PROCESS_STATUS,  API_STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DT_CODE,  DTT_CODE,  V_CODE,  DBTR_IBAN,  AMOUNT,  TRAN_REF_ID from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS as API_PROCESS_STATUS,   A.STATUS as API_STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.ADDITIONAL_INFO,   A.V_CODE,   A.DBTR_IBAN,   A.AMOUNT,   A.TRAN_REF_ID,   T24RC.RETURN_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE, '-', T24RC.RETURN_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE, '-', CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE, '-', CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   NPSS_TRN_PROCESS_LOG A  left join <tran_db>.CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES T24RC on   T24RC.RETURN_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join <tran_db>.CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  order by   A.NPSSTPL_ID desc) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS API Process Log Detail CCD","filter":[{"filter_name":"API_PROCESS_STATUS","binding_name":"API_PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_API_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"API_PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_API_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"STATUS","binding_name":"API_STATUS","binding_value":"","source_name":"MI_LEVEL_API_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Validation Code","target_column":"V_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Error Code","target_column":"RESPONSE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"AMOUNT","alias_name":"","alignment":"Right","width":"","format":"","date_format":false,"currency_format":true},{"header":"Tran Ref ID","target_column":"TRAN_REF_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Uetr","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
