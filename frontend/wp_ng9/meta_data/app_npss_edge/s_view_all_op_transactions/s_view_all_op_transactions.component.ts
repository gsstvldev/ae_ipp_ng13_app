...
@Component({
	selector: 's_view_all_op_transactions',
	templateUrl: './s_view_all_op_transactions.component.html',
	styleUrls: ['./s_view_all_op_transactions.component.css'],
...
// Start of class 
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_view_all_op_transactions"
	wftpa_id : string = "WFT_NPSS_P_1304_1673672537964_0"
	cg_code : string = "CG_1304_1681965269222"
	...
	key_events : any = {}
	btl_1304_1687777564722 : string = "p_view_process_log_view_req_and_res_layout"
	btl_1304_1686902736273 : string = "p_view_failures_layout"
	...
	forms : any = ["uicgc_22","uicgc_4","uicgc_12","uicgc_28","uicgc_14","uicgc_24","uicgc_11","uicgc_30","uicgc_29","uicgc_25","uicgc_17","uicgc_21","uicgc_19","uicgc_10","uicgc_15","uicgc_13","uicgc_7","uicgc_6","uicgc_3"]
	...
	process_log_ui_view_failure : any = {}
	...
	ngOnInit() {
		...
		this.queue.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681968174506","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS View All PL LR Queue MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1673673515165","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1675427757575","date_format":false}],"joins":[]},"eq_text":"select  distinct PROCESSING_SYSTEM,  PROCESS_STATUS from  (  select   NT.NPSST_ID,   NT.UETR,   NT.VALUE_DATE,   NT.ACCP_DATE_TIME,   NT.CREATED_DATE,   TO_CHAR(NT.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,   NT.DEPARTMENT_CODE,   NT.TENANT_ID,   NT.EXHF_ID,   NT.CDTR_IBAN,   NT.TRAN_REF_ID,   NT.PAYMENT_ENDTOEND_ID,   NT.CLRSYSREF,   NT.CDTR_ACCT_NO,   NT.DBTR_ACCT_NO,   NT.INTRBK_STTLM_CUR,   NT.INTRBK_STTLM_AMNT,   NT.STATUS,   NT.PROCESSING_SYSTEM,   NT.PROCESS_STATUS,   NT.DBTR_ACCT_NAME,   NT.PROCESS_TYPE,   NT.DBTR_PHONE_NO,   NT.DBTR_EMAIL_ID,   NT.DBTR_DOCUMENT_ID,   NT.DBTR_IBAN,   NT.DBTR_CUST_TYPE,   NT.DBTR_PRVT_ID,   NT.DBTR_OTHER_ISSUER,   NT.CDTR_ACCT_NAME,   NT.CDTR_PHONE_NO,   NT.CDTR_EMAIL_ID,   NT.CDTR_DOCUMENT_ID,   NT.DR_SORT_CODE,   NT.CR_SORT_CODE,   NT.CATEGORY_PURPOSE,   NT.CATEGORY_PURPOSE_PRTY,   NT.CR_ACCT_IDENTIFICATION,   NT.BASE_CURRENCY,   NT.BASE_AMOUNT,   NT.HDR_TOTAL_RECORDS,   NT.HDR_TOTAL_AMOUNT,   NT.HDR_CLEARING_SYSTEM,   NT.CHARGE_BEARER,   NT.REMITTANCE_INFO,   NT.ACCOUNT_CURRENCY,   NT.CHANNEL_ID,   NT.CHANNEL_REFNO,   NT.CHANNEL_USERID,   NT.CHANNEL_PRODUCT,   NT.CHANNEL_SUB_PRODUCT,   NT.CHANNEL_TRAN_CODE,   NT.ISSUER_TYPE_CODE,   NT.CBS_REF_NO,   NT.CBS_POSTING_FLAG,   case    when NT.process_group = 'BCT' then 'Y'    else 'N'   end as Batch_Payment_Flag,   NT.OUTWARD_FILE_NAME,   NT.INWARD_FILE_NAME  from   <TRAN_DB>.NPSS_TRANSACTIONS NT )v $WHERE order by  PROCESSING_SYSTEM,  PROCESS_STATUS"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS View All Queue","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.transaction_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681968843919","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP View all transaction MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"DATEMI","alias_name":"","mq_id":"MQ_1684843969634","date_format":false},{"column_name":"NPSST_ID","alias_name":"","mq_id":"MQ_1684843969807","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1684843969983","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1684843970159","date_format":false},{"column_name":"VALUE_DATE","alias_name":"","mq_id":"MQ_1684844040173","date_format":true},{"column_name":"CLRSYSREF","alias_name":"","mq_id":"MQ_1684844040348","date_format":false},{"column_name":"INTRBK_STTLM_AMNT","alias_name":"","mq_id":"MQ_1684844040516","date_format":false,"currency_format":true},{"column_name":"INTRBK_STTLM_CUR","alias_name":"","mq_id":"MQ_1684844040708","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1684844092498","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1684844092682","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1684844092858","date_format":false},{"column_name":"DEPARTMENT_CODE","alias_name":"","mq_id":"MQ_1684844119058","date_format":false},{"column_name":"PAYMENT_ENDTOEND_ID","alias_name":"","mq_id":"MQ_1684844119242","date_format":false},{"column_name":"CDTR_IBAN","alias_name":"","mq_id":"MQ_1684844119410","date_format":false},{"column_name":"PROCESS_GROUP","alias_name":"","mq_id":"MQ_1684844119577","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1684844150057","date_format":false},{"column_name":"cr_acct_identification_mask","alias_name":"","mq_id":"MQ_1684844150216","date_format":false},{"column_name":"Batch_Payment_Flag","alias_name":"","mq_id":"MQ_1710399952527","date_format":false},{"column_name":"OUTWARD_FILE_NAME","alias_name":"","mq_id":"MQ_1710399953309","date_format":false}],"joins":[]},"eq_text":"select  NPSST_ID,  FN_CARD_DECRYPT_AND_MASK_RPT(CR_ACCT_IDENTIFICATION) as CR_ACCT_IDENTIFICATION_MASK,  CR_ACCT_IDENTIFICATION,  UETR,  VALUE_DATE,  ACCP_DATE_TIME,  CREATED_DATE,  DATEMI,  EXHF_ID,  CDTR_IBAN,  TENANT_ID,  TRAN_REF_ID,  DEPARTMENT_CODE,  PAYMENT_ENDTOEND_ID,  CLRSYSREF,  CDTR_ACCT_NO,  DBTR_ACCT_NO,  INTRBK_STTLM_CUR,  INTRBK_STTLM_AMNT,  STATUS,  PROCESSING_SYSTEM,  PROCESS_STATUS,  DBTR_ACCT_NAME,  DBTR_PHONE_NO,  DBTR_EMAIL_ID,  DBTR_DOCUMENT_ID,  DBTR_IBAN,  DBTR_CUST_TYPE,  DBTR_PRVT_ID,  DBTR_OTHER_ISSUER,  CDTR_ACCT_NAME,  CDTR_PHONE_NO,  CDTR_EMAIL_ID,  CDTR_DOCUMENT_ID,  DR_SORT_CODE,  CR_SORT_CODE,  CATEGORY_PURPOSE,  CATEGORY_PURPOSE_PRTY,  BASE_CURRENCY,  BASE_AMOUNT,  HDR_TOTAL_RECORDS,  HDR_TOTAL_AMOUNT,  HDR_CLEARING_SYSTEM,  CHARGE_BEARER,  REMITTANCE_INFO,  ACCOUNT_CURRENCY,  CHANNEL_ID,  CHANNEL_REFNO,  TS_ID,  LOCKED_BY,  LOCKED_BY_NAME,  PROCESS_GROUP,  CHANNEL_USERID,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  ISSUER_TYPE_CODE,  CBS_REF_NO,  CBS_POSTING_FLAG,  PROCESS_TYPE,  BATCH_PAYMENT_FLAG,  OUTWARD_FILE_NAME from  (  select   NT.NPSST_ID,   NT.UETR,   NT.VALUE_DATE,   NT.ACCP_DATE_TIME,   NT.CREATED_DATE,   TO_CHAR(NT.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as DATEMI,   NT.DEPARTMENT_CODE,   NT.TENANT_ID,   NT.EXHF_ID,   NT.CDTR_IBAN,   NT.TRAN_REF_ID,   NT.PAYMENT_ENDTOEND_ID,   NT.CLRSYSREF,   NT.CDTR_ACCT_NO,   NT.DBTR_ACCT_NO,   NT.INTRBK_STTLM_CUR,   NT.INTRBK_STTLM_AMNT,   NT.STATUS,   NT.PROCESSING_SYSTEM,   NT.PROCESS_STATUS,   NT.DBTR_ACCT_NAME,   NT.DBTR_PHONE_NO,   NT.DBTR_EMAIL_ID,   NT.DBTR_DOCUMENT_ID,   NT.DBTR_IBAN,   NT.DBTR_CUST_TYPE,   NT.DBTR_PRVT_ID,   NT.DBTR_OTHER_ISSUER,   NT.CDTR_ACCT_NAME,   NT.CDTR_PHONE_NO,   NT.CDTR_EMAIL_ID,   NT.CDTR_DOCUMENT_ID,   NT.DR_SORT_CODE,   NT.CR_SORT_CODE,   NT.CATEGORY_PURPOSE,   NT.CATEGORY_PURPOSE_PRTY,   NT.CR_ACCT_IDENTIFICATION,   NT.BASE_CURRENCY,   NT.BASE_AMOUNT,   NT.HDR_TOTAL_RECORDS,   NT.HDR_TOTAL_AMOUNT,   NT.HDR_CLEARING_SYSTEM,   NT.CHARGE_BEARER,   NT.REMITTANCE_INFO,   NT.ACCOUNT_CURRENCY,   NT.CHANNEL_ID,   NT.PROCESS_GROUP,   NT.CHANNEL_REFNO,   NT.CHANNEL_USERID,   NT.CHANNEL_PRODUCT,   NT.CHANNEL_SUB_PRODUCT,   NT.CHANNEL_TRAN_CODE,   NT.ISSUER_TYPE_CODE,   NT.CBS_REF_NO,   TS.TS_ID,   TS.LOCKED_BY,   TS.LOCKED_BY_NAME,   NT.CBS_POSTING_FLAG,   NT.PROCESS_TYPE,   case    when NT.PROCESS_GROUP = 'BCT' then 'Y'    else 'N'   end as BATCH_PAYMENT_FLAG,   NT.OUTWARD_FILE_NAME  from   <TRAN_DB>.NPSS_TRANSACTIONS NT  inner join <TRAN_DB>.TRANSACTION_SET TS on   TS.TRN_ID = NT.NPSST_ID   and TS.DTT_CODE = NT.DTT_CODE) V $WHERE order by  NPSST_ID desc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS View All Transaction","filter":[{"filter_name":"DEPARTMENT_CODE","binding_name":"DEPARTMENT_CODE","binding_value":"","source_name":"SYSTEM_EXTENDED_INFO.department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_STATUS","binding_name":"PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"STATUS","binding_name":"STATUS","binding_value":"","source_name":"MI_LEVEL_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"DATEMI","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Currency","target_column":"INTRBK_STTLM_CUR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Amount","target_column":"INTRBK_STTLM_AMNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false,"currency_format":true},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"E2E Ref ID","target_column":"PAYMENT_ENDTOEND_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Clearing System Ref No","target_column":"CLRSYSREF","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Group","target_column":"PROCESS_GROUP","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Department Code","target_column":"DEPARTMENT_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Batch Payment Flag","target_column":"Batch_Payment_Flag","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"File Name","target_column":"OUTWARD_FILE_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		// "View Failure" Button of "Process Log UI" component
		this.process_log_ui_view_failure.label_name = "View Failure"
		this.process_log_ui_view_failure.show = true
		this.process_log_ui_view_failure.disabled = false
		this.process_log_ui_view_failure.params = {"icon_only":false,"uicgcc_style":"fa fa-eye"}
		this.process_log_ui_view_failure.dynamic_param = {}
		this.process_log_ui_view_failure.role = []
		this.process_log_ui_view_failure.action = ""
		...
		this.history_detail.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_18","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681967889801","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS View All History Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1713244563680","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1713244563862","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1713244564030","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1713244564191","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1713244564374","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1713244564550","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1713244564694","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1713244654374","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1713244654926","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1713244655142","date_format":true},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1713244687694","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1713244687910","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1713244930284","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1713244930508","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1713244950476","date_format":true},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1713244950628","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1713244950804","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1713244950940","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1713244951140","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1713245064363","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1713245064523","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1713245064683","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1713245064851","date_format":false},{"column_name":"AdditionalInfo","alias_name":"","mq_id":"MQ_1713245107955","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  PROCESS_STATUS,  STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DEPARTMENT_CODE,  DT_CODE,  DTT_CODE,  PROCESS_TYPE,  AMOUNT_CREDITED,  AMT_CR_LOC_CUR,  CHARGE_AMOUNT,  BUY_CURRENCY,  SELL_CURRENCY,  DEALT_AMOUNT,  EXCHANGE_RATE,  CONTRA_AMOUNT,  AdditionalInfo from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   NT.PROCESS_TYPE,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   NT.DEPARTMENT_CODE,   NT.NPSST_ID,   case    when A.STATUS in ('OP_AC_STATUS_REJECTED', 'OP_P2P_STATUS_REJECTED', 'OP_P2B_STATUS_REJECTED', 'IP_RCT_STATUS_RECEIVED') then A.ADDITIONAL_INFO   end as AdditionalInfo,   A.AMOUNT_CREDITED,   A.AMT_CR_LOC_CUR,   A.CHARGE_AMOUNT,   A.BUY_CURRENCY,   A.SELL_CURRENCY,   A.DEALT_AMOUNT,   A.EXCHANGE_RATE,   A.CONTRA_AMOUNT,   T24RC.ERROR_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE,   '-',   T24RC.ERROR_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE,   '-',   CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE,   '-',   CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   <TRAN_DB>.NPSS_TRN_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_ERROR_CODES T24RC on   T24RC.ERROR_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  left join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NT.UETR = A.UETR  order by   A.NPSSTPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS History Detail MQ CCD","filter":[{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBS Return Code","target_column":"T24_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Additional Info","target_column":"AdditionalInfo","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"FT Number/ProcessRefNo","target_column":"PROCESS_REF_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Status","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.view_process_log_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_20","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681969216071","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP VA API Process Log Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1695968947819","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1695968948001","date_format":false},{"column_name":"V_CODE","alias_name":"","mq_id":"MQ_1695968948184","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1695968948360","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1695968948536","date_format":false},{"column_name":"DBTR_IBAN","alias_name":"","mq_id":"MQ_1695969014702","date_format":false},{"column_name":"AMOUNT","alias_name":"","mq_id":"MQ_1695969016230","date_format":false,"currency_format":true},{"column_name":"TRAN_REF_ID","alias_name":"","mq_id":"MQ_1695969038079","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1695969040574","date_format":false}],"joins":[]},"eq_text":"select  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  API_PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  API_PROCESS_STATUS,  API_STATUS,  TENANT_ID,  DT_CODE,  DTT_CODE,  V_CODE,  DBTR_IBAN,  AMOUNT,  TRAN_REF_ID,  ROW_NUM from  (  select   NPSSTPL_ID,   MSG_ID,   UETR,   NPSSTRRD_REFNO,   PROCESS_NAME,   API_PROCESSING_SYSTEM,   RESPONSE_CODE,   PROCESS_REF_NO,   RESPONSE_DATA,   CREATEDDATEMILISEC,   CREATED_DATE,   API_PROCESS_STATUS,   API_STATUS,   DT_CODE,   DTT_CODE,   TENANT_ID,   REQUEST_DATA_JSON,   RESPONSE_DATA_JSON,   T24_RETURN_CODE,   ADDITIONAL_INFO,   V_CODE,   DBTR_IBAN,   AMOUNT,   TRAN_REF_ID,   ROW_NUM  from   (   select    A.NPSSTPL_ID,    A.MSG_ID,    A.UETR,    A.NPSSTRRD_REFNO,    A.PROCESS_NAME,    A.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,    A.RESPONSE_CODE,    A.PROCESS_REF_NO,    A.RESPONSE_DATA,    TO_CHAR(A.CREATED_DATE,    'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,    A.CREATED_DATE,    A.PROCESS_STATUS as API_PROCESS_STATUS,    A.STATUS as API_STATUS,    A.DT_CODE,    A.DTT_CODE,    A.TENANT_ID,    A.REQUEST_DATA_JSON,    A.RESPONSE_DATA_JSON,    A.T24_RETURN_CODE,    A.ADDITIONAL_INFO,    A.V_CODE,    A.DBTR_IBAN,    A.AMOUNT,    A.TRAN_REF_ID,    row_number() over(partition by A.UETR   order by    A.NPSSTPL_ID desc) as ROW_NUM   from    <TRAN_DB>.NPSS_TRN_PROCESS_LOG A)VV  where   ROW_NUM = 1   and API_STATUS in ('OP_AC_MAND_VAL_FAILED', 'OP_AC_DUPL_VAL_FAILED', 'OP_P2B_FUND_RESERVED', 'OP_AC_PCODE_VAL_FAILED', 'OP_AC_PBANK_VAL_FAILED', 'OP_P2P_SENDER_IBAN_FAILED', 'OP_P2P_PAYMENT_FAILED', 'OP_P2P_POSTING_FAILURE', 'OP_P2P_POSTING_SUSPICIOUS', 'OP_P2B_FUND_UNFREEZED', 'OP_P2B_PAYMENT_FAILED', 'OP_P2B_FUND_RES_FAILURE', 'OP_P2B_FUND_RES_SUSPICIOUS', 'OP_P2B_FUND_UNFR_FAILURE', 'OP_P2B_FUND_UNFR_SUSPICIOUS', 'OP_P2B_FUND_AUTH_FAILURE', 'OP_P2B_FUND_AUTH_SUSPICIOUS', 'OP_P2P_DEBIT_POSTING_SUCCESS', 'OP_P2B_DEBIT_POSTING_SUCCESS', 'OP_INAU_DEBIT_POSTING_SUCCESS', 'OP_AUTH_DEBIT_POSTING_SUCCESS', 'OP_UNFREEZE_DEBIT_POSTING_SUCCESS', 'OP_P2P_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2B_DEBIT_POSTING_SUSCIPIOUS', 'OP_INAU_DEBIT_POSTING_SUSCIPIOUS', 'OP_AUTH_DEBIT_POSTING_SUSCIPIOUS', 'OP_UNFREEZE_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2P_POSTING_NOT_HAPPENED', 'OP_P2B_POSTING_NOT_HAPPENED', 'OP_INAU_POSTING_NOT_HAPPENED', 'OP_AUTH_POSTING_NOT_HAPPENED', 'OP_UNFREEZE_POSTING_NOT_HAPPENED', 'OP_P2B_REV_POSTING_SUCCESS', 'OP_P2P_REV_POSTING_SUCCESS', 'OP_P2P_REV_POSTING_FAILURE', 'OP_P2B_REV_POSTING_FAILURE', 'P2B_SCT_INITIATION_FAILED') union  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS as API_PROCESS_STATUS,   A.STATUS as API_STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   A.ADDITIONAL_INFO,   A.V_CODE,   A.DBTR_IBAN,   A.AMOUNT,   A.TRAN_REF_ID,   case    when A.STATUS in ('OP_AC_VAL_FAILED', 'OP_AC_POSTING_FAILURE', 'OP_AC_POSTING_FAILURE','OP_AC_POSTING_SUSPICIOUS') then 1   end as ROW_NUM  from   <TRAN_DB>.NPSS_TRN_PROCESS_LOG A  where   A.STATUS in ('OP_AC_VAL_FAILED', 'OP_AC_POSTING_FAILURE', 'OP_AC_POSTING_FAILURE','OP_AC_POSTING_SUSPICIOUS')) V where  ROW_NUM = 1 $AND order by  NPSSTPL_ID desc"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP VA API Process Log Detail CCD","filter":[{"filter_name":"API_PROCESS_STATUS","binding_name":"API_PROCESS_STATUS","binding_value":"","source_name":"MI_LEVEL_API_PROCESS_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESSING_SYSTEM","binding_name":"API_PROCESSING_SYSTEM","binding_value":"","source_name":"MI_LEVEL_API_PROCESSING_SYSTEM","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"STATUS","binding_name":"API_STATUS","binding_value":"","source_name":"MI_LEVEL_API_STATUS","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Validation Code","target_column":"V_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Error Code","target_column":"RESPONSE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Dr IBAN","target_column":"DBTR_IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"AMOUNT","target_column":"AMOUNT","alias_name":"","alignment":"Right","width":"","format":"","date_format":false},{"header":"Tran Ref ID","target_column":"TRAN_REF_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Uetr","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.api_queue.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681975219058","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP VA API Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"API_PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1695967040553","date_format":false},{"column_name":"API_PROCESS_STATUS","alias_name":"","mq_id":"MQ_1695967041423","date_format":false},{"column_name":"API_STATUS","alias_name":"","mq_id":"MQ_1695967041895","date_format":false}],"joins":[]},"eq_text":"select  distinct API_PROCESSING_SYSTEM,  API_PROCESS_STATUS,  API_STATUS from  (  select   CREATED_DATE,   API_STATUS,   API_PROCESS_STATUS,   UETR,   PROCESS_NAME,   API_PROCESSING_SYSTEM,   TENANT_ID,   SYSTEM_ID,   NPSSTPL_ID,   DBTR_IBAN  from   (   select    CREATED_DATE,    API_STATUS,    API_PROCESS_STATUS,    UETR,    PROCESS_NAME,    API_PROCESSING_SYSTEM,    TENANT_ID,    SYSTEM_ID,    NPSSTPL_ID,    DBTR_IBAN,    row_number() over(partition by UETR   order by    NPSSTPL_ID desc) as ROW_NUM   from    (    select     UETR,     NPSSTPL_ID,     CREATED_DATE,     TENANT_ID,     STATUS as API_STATUS,     PROCESS_STATUS as API_PROCESS_STATUS,     PROCESS_NAME,     PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,     SYSTEM_ID,     DBTR_IBAN    from     <TRAN_DB>.NPSS_TRN_PROCESS_LOG A $WHERE)A1) A2  where   ROW_NUM = 1   and API_STATUS in ('OP_AC_MAND_VAL_FAILED', 'OP_AC_DUPL_VAL_FAILED', 'OP_P2B_FUND_RESERVED', 'OP_AC_PCODE_VAL_FAILED', 'OP_AC_PBANK_VAL_FAILED', 'OP_P2P_SENDER_IBAN_FAILED', 'OP_P2P_PAYMENT_FAILED', 'OP_P2P_POSTING_FAILURE', 'OP_P2P_POSTING_SUSPICIOUS', 'OP_P2B_FUND_UNFREEZED', 'OP_P2B_PAYMENT_FAILED', 'OP_P2B_FUND_RES_FAILURE', 'OP_P2B_FUND_RES_SUSPICIOUS', 'OP_P2B_FUND_UNFR_FAILURE', 'OP_P2B_FUND_UNFR_SUSPICIOUS', 'OP_P2B_FUND_AUTH_FAILURE', 'OP_P2B_FUND_AUTH_SUSPICIOUS', 'OP_P2P_DEBIT_POSTING_SUCCESS', 'OP_P2B_DEBIT_POSTING_SUCCESS', 'OP_INAU_DEBIT_POSTING_SUCCESS', 'OP_AUTH_DEBIT_POSTING_SUCCESS', 'OP_UNFREEZE_DEBIT_POSTING_SUCCESS', 'OP_P2P_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2B_DEBIT_POSTING_SUSCIPIOUS', 'OP_INAU_DEBIT_POSTING_SUSCIPIOUS', 'OP_AUTH_DEBIT_POSTING_SUSCIPIOUS', 'OP_UNFREEZE_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2P_POSTING_NOT_HAPPENED', 'OP_P2B_POSTING_NOT_HAPPENED', 'OP_INAU_POSTING_NOT_HAPPENED', 'OP_AUTH_POSTING_NOT_HAPPENED', 'OP_UNFREEZE_POSTING_NOT_HAPPENED', 'OP_P2B_REV_POSTING_SUCCESS', 'OP_P2P_REV_POSTING_SUCCESS', 'OP_P2P_REV_POSTING_FAILURE', 'OP_P2B_REV_POSTING_FAILURE', 'P2B_SCT_INITIATION_FAILED') union all  select   CREATED_DATE,   API_STATUS,   API_PROCESS_STATUS,   UETR,   PROCESS_NAME,   API_PROCESSING_SYSTEM,   TENANT_ID,   SYSTEM_ID,   NPSSTPL_ID,   DBTR_IBAN  from   (   select    CREATED_DATE,    STATUS as API_STATUS,    PROCESS_STATUS as API_PROCESS_STATUS,    UETR,    PROCESS_NAME,    PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,    TENANT_ID,    SYSTEM_ID,    NPSSTPL_ID,    DBTR_IBAN   from    <TRAN_DB>.NPSS_TRN_PROCESS_LOG T $WHERE) G  where   API_STATUS in ('OP_AC_VAL_FAILED', 'OP_AC_POSTING_FAILURE', 'OP_AC_POSTING_SUSPICIOUS') ) V1"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP VA API Process Log CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Processing System","target_column":"API_PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"API_PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"API_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.view_failures_actions_back.params = {"icon_only":false,"uicgcc_style":"fa fa-fast-backward"}
	...
	page_load(){
		...
		this.page_load__de_for_view_failure()
	}
	...
	history_detail__selection_changed(){
		...
		this.history_detail__e_1686902863348()
		this.history_detail__ee_for_view_failure()
	}

	//Handler for INTERNAL event of "svtm from history detail"
	svtm_from_history_detail__internal(parent_event_result){
		this.svtm_from_history_detail__shwhide(parent_event_result)
	}
	...
	navigation_ui_view_process_log__action_button_click(){
		...
		this.navigation_ui_view_process_log__e_1722509495521()
	}
	...
	view_api_failure__action_ui_view_req_and_res__action_button_click(){
		...
		this.view_api_failure__action_ui_view_req_and_res__e_1686903417624()
	}
	...
	//Handler for ACTION_BUTTON_CLICK event of "process log ui view failure"
	process_log_ui_view_failure__action_button_click(){
		this.process_log_ui_view_failure__e_1686902994353()
		this.process_log_ui_view_failure__e_1686903057267()
	}

	//Handler for ACTION_BUTTON_CLICK event of "view failures actions back"
	view_failures_actions_back__action_button_click(){
		this.view_failures_actions_back__e_1686903049577()
	}
	...
	view_process_log_ui_view_req_and_res__action_button_click(){
		this.view_process_log_ui_view_req_and_res__sp_from_view_req_and_res_btn()
		this.view_process_log_ui_view_req_and_res__cc_for_view_api_req_and_res_btn()
	}
	...
	//Handler for DPSINIT event of "page_load"
	page_load__de_for_view_failure() { 
		let Dest_Is_ctrl=true
		
		let source_id="page_load"
		let destn_id="process_log_ui_view_failure"
		let parent_source_id=""
		let event_code="e_1722508533987"
		let event_params={"caller_name":"page_load__de_for_view_failure","event_desc":"DE for View Failure","event_type":"DPSINIT","caller_event_context":"SUCCESS","root_source_id":"dps_initialize","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	history_detail__svtm_from_history_detail() { 
		...
		let handler_code="set_value_to_memory"
		let internals="svtm_from_history_detail__shwhide,"
		let event_data={"history_detail":{"e_1685948589446":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGC_18","event_code":"E_1685948589446","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Trn Process Log","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"PROCESS_NAME","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_NAME","setd3name":"PROCESS_NAME"},{"type":"LOCAL","column_name":"NPSSTPL_ID","level":"MI_LEVEL","name":"MI_LEVEL_NPSSTPL_ID","setd3name":"NPSSTPL_ID"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_18","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681967889801","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS View All History Detail MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1713244563680","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1713244563862","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1713244564030","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1713244564191","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1713244564374","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1713244564550","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1713244564694","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1713244654374","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1713244654926","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1713244655142","date_format":true},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1713244687694","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1713244687910","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1713244930284","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1713244930508","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1713244950476","date_format":true},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1713244950628","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1713244950804","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1713244950940","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1713244951140","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1713245064363","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1713245064523","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1713245064683","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1713245064851","date_format":false},{"column_name":"AdditionalInfo","alias_name":"","mq_id":"MQ_1713245107955","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  PROCESS_STATUS,  STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DEPARTMENT_CODE,  DT_CODE,  DTT_CODE,  PROCESS_TYPE,  AMOUNT_CREDITED,  AMT_CR_LOC_CUR,  CHARGE_AMOUNT,  BUY_CURRENCY,  SELL_CURRENCY,  DEALT_AMOUNT,  EXCHANGE_RATE,  CONTRA_AMOUNT,  AdditionalInfo from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   NT.PROCESS_TYPE,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   NT.DEPARTMENT_CODE,   NT.NPSST_ID,   case    when A.STATUS in ('OP_AC_STATUS_REJECTED', 'OP_P2P_STATUS_REJECTED', 'OP_P2B_STATUS_REJECTED', 'IP_RCT_STATUS_RECEIVED') then A.ADDITIONAL_INFO   end as AdditionalInfo,   A.AMOUNT_CREDITED,   A.AMT_CR_LOC_CUR,   A.CHARGE_AMOUNT,   A.BUY_CURRENCY,   A.SELL_CURRENCY,   A.DEALT_AMOUNT,   A.EXCHANGE_RATE,   A.CONTRA_AMOUNT,   T24RC.ERROR_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE,   '-',   T24RC.ERROR_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE,   '-',   CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE,   '-',   CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   <TRAN_DB>.NPSS_TRN_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_ERROR_CODES T24RC on   T24RC.ERROR_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  left join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NT.UETR = A.UETR  order by   A.NPSSTPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS History Detail MQ CCD","filter":[{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBS Return Code","target_column":"T24_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Additional Info","target_column":"AdditionalInfo","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"FT Number/ProcessRefNo","target_column":"PROCESS_REF_NO","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Status","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for SELECTION_CHANGED event of "history detail"
	history_detail__e_1686902863348() { 
		let Dest_Is_ctrl=true
		
		let source_id="history_detail"
		let destn_id="view_failures_ui"
		let parent_source_id=""
		let event_code="e_1686902863348"
		let event_params={"caller_name":"history_detail__e_1686902863348","event_desc":"E_1686902863348","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"history_detail","raiseparam":{}}
		let handler_code="set_selected_row"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for SELECTION_CHANGED event of "history detail"
	history_detail__ee_for_view_failure() { 
		let Dest_Is_ctrl=true
		
		let source_id="history_detail"
		let destn_id="process_log_ui_view_failure"
		let parent_source_id=""
		let event_code="e_1722508685502"
		let event_params={"caller_name":"history_detail__ee_for_view_failure","event_desc":"EE for View Failure","event_type":"SELECTION_CHANGED","caller_event_context":"SUCCESS","root_source_id":"history_detail","raiseparam":{"enable_disable_count":"","enable_disable_locked_by":"","disable_for":"","disable_except":"OP_AC_VAL_FAILED","disable_column":"STATUS","expression":""}}
		let handler_code="enable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for INTERNAL event of "svtm from history detail"
	svtm_from_history_detail__shwhide(parent_event_result) { 
		let Dest_Is_ctrl=true
		let parentEventResult ="SUCCESS"
	if(parentEventResult!=parent_event_result) return true;
		...
		let event_code="e_1686902157925"
		let event_params={"caller_name":"svtm_from_history_detail__shwhide","event_desc":"shwhide","event_type":"INTERNAL","caller_event_context":"SUCCESS","root_source_id":"history_detail","raiseparam":{},"parent_event_result":"SUCCESS"}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	message_detail__svm_from_message_detail() { 
		...
		let parent_source_id=""
		let event_code="e_1687246505033"
		...
		let handler_code="set_value_to_memory"
		let internals=""
		let event_data={"message_detail":{"e_1687246505033":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGC_16","event_code":"E_1687246505033","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Trn Process Log","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"NPSSTRRD_ID","level":"MI_LEVEL","name":"MI_LEVEL_NPSSTRRD_ID","setd3name":"NPSSTRRD_ID"},{"type":"LOCAL","column_name":"PROCESS_NAME","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_NAME","setd3name":"PROCESS_NAME"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665903906193":{"st_ds":{"default":{"uicgc_code":"UICGC_16","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665903906193","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681967964693","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS REQ RESP MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESS_CODE","alias_name":"","mq_id":"MQ_1668573850306","date_format":false},{"column_name":"PROCESS_DETAIL","alias_name":"","mq_id":"MQ_1668573852117","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1668573852786","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1668573853731","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1668573854459","date_format":false},{"column_name":"NPSSTRRD_ID","alias_name":"","mq_id":"MQ_1668573869044","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1668573871186","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573874178","date_format":false},{"column_name":"PARENT_NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1668573876315","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1668573884586","date_format":false},{"column_name":"EXHF_ID","alias_name":"","mq_id":"MQ_1668573900766","date_format":false},{"column_name":"MESSAGE_DESC","alias_name":"","mq_id":"MQ_1668573911947","date_format":false},{"column_name":"CHANNEL_ID","alias_name":"","mq_id":"MQ_1668573917043","date_format":false},{"column_name":"CHANNEL_PRODUCT","alias_name":"","mq_id":"MQ_1668573918291","date_format":false},{"column_name":"CHANNEL_REFNO","alias_name":"","mq_id":"MQ_1668573918796","date_format":false},{"column_name":"CHANNEL_SUB_PRODUCT","alias_name":"","mq_id":"MQ_1668573919355","date_format":false},{"column_name":"CHANNEL_TRAN_CODE","alias_name":"","mq_id":"MQ_1668573919955","date_format":false},{"column_name":"CHANNEL_USERID","alias_name":"","mq_id":"MQ_1668573925605","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1668587107858","date_format":false}],"joins":[]},"eq_text":"select  NPSSTRRD_ID,  MSG_ID,  UETR,  PARENT_NPSSTRRD_REFNO,  NPSSTRRD_REFNO,  PROCESS_CODE,  PROCESS_DETAIL,  EXHF_ID,  PROCESS_NAME,  MESSAGE_DESC,  CHANNEL_ID,  CHANNEL_REFNO,  CHANNEL_USERID,  CHANNEL_PRODUCT,  CHANNEL_SUB_PRODUCT,  CHANNEL_TRAN_CODE,  STATUS,  PROCESS_STATUS,PROCESS_TYPE,  MESSAGE_DATA,  CREATEDDATEMILISEC,  DT_CODE,  DTT_CODE from  (  select   NPSSTRRD.NPSSTRRD_ID,   NPSSTRRD.MSG_ID,   NPSSTRRD.UETR,   NPSSTRRD.PARENT_NPSSTRRD_REFNO,   NPSSTRRD.NPSSTRRD_REFNO,   NPSSTRRD.MESSAGE_DATA,   NPSSTRRD.PROCESS_CODE,   NPSSTRRD.PROCESS_DETAIL,   NPSSTRRD.EXHF_ID,   NPSSTRRD.PROCESS_NAME,   NPSSTRRD.MESSAGE_DESC,   NPSSTRRD.CHANNEL_ID,   NPSSTRRD.CHANNEL_REFNO,   NPSSTRRD.CHANNEL_USERID,   NPSSTRRD.CHANNEL_PRODUCT,   NPSSTRRD.CHANNEL_SUB_PRODUCT,   NPSSTRRD.CHANNEL_TRAN_CODE,   NPSSTRRD.CREATED_BY,   NPSSTRRD.CREATED_BY_NAME,   NPSSTRRD.CREATED_DATE,   NPSSTRRD.DT_CODE,   NPSSTRRD.DT_DESCRIPTION,   NPSSTRRD.DTT_CODE,   NPSSTRRD.DTT_DESCRIPTION,   NPSSTRRD.MODIFIED_BY,   NPSSTRRD.MODIFIED_BY_NAME,   NPSSTRRD.MODIFIED_DATE,   NPSSTRRD.STATUS,   NPSSTRRD.PROCESS_STATUS,NT.PROCESS_TYPE,   NPSSTRRD.SYSTEM_ID,   NPSSTRRD.SYSTEM_NAME,   NPSSTRRD.TENANT_ID,   NPSSTRRD.APP_ID,   NPSSTRRD.VERSION_NO,   TO_CHAR(NPSSTRRD.CREATED_DATE, 'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC  from   <TRAN_DB>.NPSS_TRN_REQ_RESP_DTLS NPSSTRRD  inner join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NPSSTRRD.UETR = NT.UETR) RR $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS REQ RES CCD","filter":[{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"OP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Created Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Desc","target_column":"MESSAGE_DESC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"UETR","target_column":"UETR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Detail","target_column":"PROCESS_DETAIL","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view process log"
	navigation_ui_view_process_log__e_1722509495521() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_process_log"
		let destn_id="process_log_ui_view_failure"
		let parent_source_id=""
		let event_code="e_1722509495521"
		let event_params={"caller_name":"navigation_ui_view_process_log__e_1722509495521","event_desc":"E_1722509495521","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_process_log","raiseparam":{}}
		let handler_code="disable_element"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view api failure  action ui view req and res"
	view_api_failure__action_ui_view_req_and_res__e_1686903417624() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_api_failure__action_ui_view_req_and_res"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1686903417624"
		let event_params={"caller_name":"view_api_failure__action_ui_view_req_and_res__e_1686903417624","event_desc":"E_1686903417624","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_api_failure__action_ui_view_req_and_res","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	view_api_failure__action_ui_view_process_log__brfq_for_history_details() { 
		...
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_27","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1686637362366","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS HST Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"NPSSTPL_ID","alias_name":"","mq_id":"MQ_1666177568065","date_format":false},{"column_name":"MSG_ID","alias_name":"","mq_id":"MQ_1666177568243","date_format":false},{"column_name":"UETR","alias_name":"","mq_id":"MQ_1666177568420","date_format":false},{"column_name":"NPSSTRRD_REFNO","alias_name":"","mq_id":"MQ_1666177568588","date_format":false},{"column_name":"PROCESS_NAME","alias_name":"","mq_id":"MQ_1666177568740","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1666177568908","date_format":false},{"column_name":"RESPONSE_CODE","alias_name":"","mq_id":"MQ_1666177569084","date_format":false},{"column_name":"PROCESS_REF_NO","alias_name":"","mq_id":"MQ_1666177779261","date_format":false},{"column_name":"RESPONSE_DATA","alias_name":"","mq_id":"MQ_1666177779430","date_format":false},{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1666177779582","date_format":true},{"column_name":"RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666177862396","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1666177862551","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1666177873590","date_format":false},{"column_name":"CREATEDDATEMILISEC","alias_name":"","mq_id":"MQ_1666329436524","date_format":true},{"column_name":"T24_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809408","date_format":false},{"column_name":"CBUAE_RETURN_CODE","alias_name":"","mq_id":"MQ_1666781809610","date_format":false},{"column_name":"REVERSAL_CODE","alias_name":"","mq_id":"MQ_1666781809810","date_format":false},{"column_name":"REVERSAL_DESC","alias_name":"","mq_id":"MQ_1666865255337","date_format":false},{"column_name":"T24_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255505","date_format":false},{"column_name":"CBUAE_RETURN_DESC","alias_name":"","mq_id":"MQ_1666865255657","date_format":false},{"column_name":"REVERSAL_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936092675","date_format":false},{"column_name":"T24_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093146","date_format":false},{"column_name":"CBUAE_RETURN_DESCRIPTION","alias_name":"","mq_id":"MQ_1666936093458","date_format":false},{"column_name":"TENANT_ID","alias_name":"","mq_id":"MQ_1667544156161","date_format":false},{"column_name":"ADDITIONAL_INFO","alias_name":"","mq_id":"MQ_1713241927843","date_format":false}],"joins":[]},"eq_text":"select  REVERSAL_DESCRIPTION,  T24_RETURN_DESCRIPTION,  CBUAE_RETURN_DESCRIPTION,  NPSSTPL_ID,  MSG_ID,  UETR,  NPSSTRRD_REFNO,  PROCESS_NAME,  PROCESSING_SYSTEM,  RESPONSE_CODE,  PROCESS_REF_NO,  RESPONSE_DATA,  CREATED_DATE,  CREATEDDATEMILISEC,  PROCESS_STATUS,  STATUS,  REQUEST_DATA_JSON,  RESPONSE_DATA_JSON,  T24_RETURN_CODE,  CBUAE_RETURN_CODE,  REVERSAL_CODE,  REVERSAL_DESC,  T24_RETURN_DESC,  CBUAE_RETURN_DESC,  TENANT_ID,  DEPARTMENT_CODE,  DT_CODE,  DTT_CODE,  PROCESS_TYPE,  AMOUNT_CREDITED,  AMT_CR_LOC_CUR,  CHARGE_AMOUNT,  BUY_CURRENCY,  SELL_CURRENCY,  DEALT_AMOUNT,  EXCHANGE_RATE,  CONTRA_AMOUNT,  ADDITIONAL_INFO from  (  select   A.NPSSTPL_ID,   A.MSG_ID,   A.UETR,   NT.PROCESS_TYPE,   A.NPSSTRRD_REFNO,   A.PROCESS_NAME,   A.PROCESSING_SYSTEM,   A.RESPONSE_CODE,   A.PROCESS_REF_NO,   A.RESPONSE_DATA,   TO_CHAR(A.CREATED_DATE,   'YYYY-MM-DD HH:MI:SS:MS AM') as CREATEDDATEMILISEC,   A.CREATED_DATE,   A.PROCESS_STATUS,   A.STATUS,   A.DT_CODE,   A.DTT_CODE,   A.TENANT_ID,   A.REQUEST_DATA_JSON,   A.RESPONSE_DATA_JSON,   A.T24_RETURN_CODE,   NT.DEPARTMENT_CODE,   NT.NPSST_ID,   A.ADDITIONAL_INFO,   A.AMOUNT_CREDITED,   A.AMT_CR_LOC_CUR,   A.CHARGE_AMOUNT,   A.BUY_CURRENCY,   A.SELL_CURRENCY,   A.DEALT_AMOUNT,   A.EXCHANGE_RATE,   A.CONTRA_AMOUNT,   T24RC.ERROR_DESCRIPTION as T24_RETURN_DESC,   CONCAT(A.T24_RETURN_CODE,   '-',   T24RC.ERROR_DESCRIPTION) as T24_RETURN_DESCRIPTION,   A.CBUAE_RETURN_CODE,   CBUAERC.RETURN_DESCRIPTION as CBUAE_RETURN_DESC,   CONCAT(A.CBUAE_RETURN_CODE,   '-',   CBUAERC.RETURN_DESCRIPTION) as CBUAE_RETURN_DESCRIPTION,   A.REVERSAL_CODE,   CCD.CD_DESCRIPTION as REVERSAL_DESC,   CONCAT(A.REVERSAL_CODE,   '-',   CCD.CD_DESCRIPTION) as REVERSAL_DESCRIPTION  from   <TRAN_DB>.NPSS_TRN_PROCESS_LOG A  left join CORE_NC_CODE_DESCRIPTIONS CCD on   CCD.CD_CODE = A.REVERSAL_CODE   and CCD.CD_CATEGORY = 'REVERSAL_REASON_IDENTIFIER_CODE'   and CCD.NEED_SYNC = 'Y'  left join CORE_NC_ERROR_CODES T24RC on   T24RC.ERROR_CODE = A.T24_RETURN_CODE   and T24RC.PROCESSING_SYSTEM = 'T24'   and T24RC.NEED_SYNC = 'Y'  left join CORE_NC_RETURN_CODES CBUAERC on   CBUAERC.RETURN_CODE = A.CBUAE_RETURN_CODE   and CBUAERC.PROCESSING_SYSTEM = 'CBUAE'   and CBUAERC.NEED_SYNC = 'Y'  left join <TRAN_DB>.NPSS_TRANSACTIONS NT on   NT.UETR = A.UETR  order by   A.NPSSTPL_ID) V $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Hst Process Log","filter":[{"filter_name":"UETR","binding_name":"UETR","binding_value":"","source_name":"MI_LEVEL_UETR","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Transaction Date & Time","target_column":"CREATEDDATEMILISEC","alias_name":"","alignment":"Left","width":"","format":"","date_format":true},{"header":"Process Name","target_column":"PROCESS_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBS Return Code","target_column":"T24_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"CBUAE Return Description","target_column":"CBUAE_RETURN_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Reversal Description","target_column":"REVERSAL_DESCRIPTION","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Id","target_column":"MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.bind_record_from_query(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
 			console.log("Handler Error");
	...
	//Handler for ACTION_BUTTON_CLICK event of "process log ui view failure"
	process_log_ui_view_failure__e_1686902994353() { 
		let Dest_Is_ctrl=true
		
		let source_id="process_log_ui_view_failure"
		let destn_id="view_failures_ui"
		let parent_source_id=""
		let event_code="e_1686902994353"
		let event_params={"caller_name":"process_log_ui_view_failure__e_1686902994353","event_desc":"E_1686902994353","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"process_log_ui_view_failure","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "process log ui view failure"
	process_log_ui_view_failure__e_1686903057267() { 
		let Dest_Is_ctrl=true
		
		let source_id="process_log_ui_view_failure"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1686903057267"
		let event_params={"caller_name":"process_log_ui_view_failure__e_1686903057267","event_desc":"E_1686903057267","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"process_log_ui_view_failure","raiseparam":{"profile_code":"BTL_1304_1686902736273"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view failures actions back"
	view_failures_actions_back__e_1686903049577() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_failures_actions_back"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1686903049577"
		let event_params={"caller_name":"view_failures_actions_back__e_1686903049577","event_desc":"E_1686903049577","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_failures_actions_back","raiseparam":{"profile_code":"BTL_1304_1669457979784"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view process log ui view req and res"
	view_process_log_ui_view_req_and_res__sp_from_view_req_and_res_btn() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_process_log_ui_view_req_and_res"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1687776460026"
		let event_params={"caller_name":"view_process_log_ui_view_req_and_res__sp_from_view_req_and_res_btn","event_desc":"SP from view req and res btn","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_process_log_ui_view_req_and_res","raiseparam":{"profile_code":"BTL_1304_1687777564722"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view process log ui view req and res"
	view_process_log_ui_view_req_and_res__cc_for_view_api_req_and_res_btn() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_process_log_ui_view_req_and_res"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1687776515201"
		let event_params={"caller_name":"view_process_log_ui_view_req_and_res__cc_for_view_api_req_and_res_btn","event_desc":"CC for view api req and res btn","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_process_log_ui_view_req_and_res","raiseparam":{}}
		let handler_code="custom_connectors"
		let internals=""
		let event_data={}
		let data_source={}
	...
	view_pro_log_req_and_res_ui_back__sp_for_back_btn() { 
		...
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1687777952272"
