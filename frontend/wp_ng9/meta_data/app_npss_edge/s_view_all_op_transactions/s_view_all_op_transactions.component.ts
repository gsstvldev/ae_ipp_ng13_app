...
Build ID        : 32456 
Modified By     : Admin 
Modified Date   : 2023-Sep-29 13:12 PM 
...
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.api_queue.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681975219058","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS OP VA API Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"API_PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1695967040553","date_format":false},{"column_name":"API_PROCESS_STATUS","alias_name":"","mq_id":"MQ_1695967041423","date_format":false},{"column_name":"API_STATUS","alias_name":"","mq_id":"MQ_1695967041895","date_format":false}],"joins":[]},"eq_text":"select  distinct API_PROCESSING_SYSTEM,  API_PROCESS_STATUS,  API_STATUS,  row_num from  (  select   T.CREATED_DATE,   T.STATUS as API_STATUS,   T.PROCESS_STATUS as API_PROCESS_STATUS,   T.UETR,   T.PROCESS_NAME,   T.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,   T.ADDITIONAL_INFO,   T.TENANT_ID,   T.MODIFIED_DATE,   T.MODIFIED_DATE_UTC,   T.CREATED_BY,   T.CREATED_BY_NAME,   T.SYSTEM_ID,   row_number() over( partition by t.uetr  order by   t.npsstpl_id desc) as row_num  from   NPSS_TRN_PROCESS_LOG T where t.status in ('OP_AC_MAND_VAL_FAILED', 'OP_AC_DUPL_VAL_FAILED', 'OP_P2B_FUND_RESERVED', 'OP_AC_PCODE_VAL_FAILED', 'OP_AC_PBANK_VAL_FAILED', 'OP_P2P_SENDER_IBAN_FAILED', 'OP_P2P_PAYMENT_FAILED', 'OP_P2P_POSTING_FAILURE', 'OP_P2P_POSTING_SUSPICIOUS', 'OP_P2B_FUND_UNFREEZED', 'OP_P2B_PAYMENT_FAILED', 'OP_P2B_FUND_RES_FAILURE', 'OP_P2B_FUND_RES_SUSPICIOUS', 'OP_P2B_FUND_UNFR_FAILURE', 'OP_P2B_FUND_UNFR_SUSPICIOUS', 'OP_P2B_FUND_AUTH_FAILURE', 'OP_P2B_FUND_AUTH_SUSPICIOUS', 'OP_P2P_DEBIT_POSTING_SUCCESS', 'OP_P2B_DEBIT_POSTING_SUCCESS', 'OP_INAU_DEBIT_POSTING_SUCCESS', 'OP_AUTH_DEBIT_POSTING_SUCCESS', 'OP_UNFREEZE_DEBIT_POSTING_SUCCESS', 'OP_P2P_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2B_DEBIT_POSTING_SUSCIPIOUS', 'OP_INAU_DEBIT_POSTING_SUSCIPIOUS', 'OP_AUTH_DEBIT_POSTING_SUSCIPIOUS', 'OP_UNFREEZE_DEBIT_POSTING_SUSCIPIOUS', 'OP_P2P_POSTING_NOT_HAPPENED', 'OP_P2B_POSTING_NOT_HAPPENED', 'OP_INAU_POSTING_NOT_HAPPENED', 'OP_AUTH_POSTING_NOT_HAPPENED', 'OP_UNFREEZE_POSTING_NOT_HAPPENED', 'OP_P2B_REV_POSTING_SUCCESS', 'OP_P2P_REV_POSTING_SUCCESS',  'OP_P2P_REV_POSTING_FAILURE', 'OP_P2B_REV_POSTING_FAILURE') union  select   T.CREATED_DATE,   T.STATUS as API_STATUS,   T.PROCESS_STATUS as API_PROCESS_STATUS,   T.UETR,   T.PROCESS_NAME,   T.PROCESSING_SYSTEM as API_PROCESSING_SYSTEM,   T.ADDITIONAL_INFO,   T.TENANT_ID,   T.MODIFIED_DATE,   T.MODIFIED_DATE_UTC,   T.CREATED_BY,   T.CREATED_BY_NAME,   T.SYSTEM_ID,   case    when t.status = 'OP_AC_VAL_FAILED' then 1   end as row_num  from   \"ad_gss_tran\".NPSS_TRN_PROCESS_LOG T  where   t.status = 'OP_AC_VAL_FAILED') VW where  row_num = 1 $AND"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS OP VA API Process Log CCD","filter":[{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"Processing System","target_column":"API_PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"API_PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"API_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
