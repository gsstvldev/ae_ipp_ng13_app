...
export class s_view_all_op_transactionsComponent implements OnInit,AfterViewInit {
	...
	forms : any = ["uicgc_22","uicgc_4","uicgc_12","uicgc_17","uicgc_11","uicgc_21","uicgc_19","uicgc_10","uicgc_14","uicgc_15","uicgc_13","uicgc_7","uicgc_6","uicgc_3"]
	...
	navigation_ui_view_api_failure : any = {}
	search : any = {}
	search_search : any = {}
	search_clear : any = {}
	...
	ngOnInit() {
		...
		// "View API Failure" Button of "Navigation UI" component
		this.navigation_ui_view_api_failure.label_name = "View API Failure"
		this.navigation_ui_view_api_failure.show = true
		this.navigation_ui_view_api_failure.disabled = false
		this.navigation_ui_view_api_failure.params = {"icon_only":false,"uicgcc_style":"fa fa-eye-slash"}
		this.navigation_ui_view_api_failure.dynamic_param = {}
		this.navigation_ui_view_api_failure.role = []
		this.navigation_ui_view_api_failure.action = ""
		...
		this.message_back_ui.views = {"first":"DTT_1304_1665903906193","is_tab_mode":"N","dtt_1304_1665903906193":{"0":[{"dttv_id":"NPSS Message Data UI","tab_order":0,"tab_name":"","uicgc_description":"Message Back UI","role_description":"default","dtt_description":"NPSS TRN REQ RESP DTLS"}]}}
		...
		this.message_back_ui.f_npss_message_data_ui = {"show":false,"form_instance":{"ctrl":{},"dt_code":"","dtt_code":"","meta":[]}}
		this.message_back_ui.form_name = "f_npss_message_data_ui"
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view api failure"
	navigation_ui_view_api_failure__action_button_click(){
		this.navigation_ui_view_api_failure__e_1681974805898()
		this.navigation_ui_view_api_failure__brfq_for_api_queue_list()
	}
	...
	view_api_failure__action_ui_view_failure__action_button_click(){
		this.view_api_failure__action_ui_view_failure__e_1681967242177()
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view api failure"
	navigation_ui_view_api_failure__e_1681974805898() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_api_failure"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1681974805898"
		let event_params={"caller_name":"navigation_ui_view_api_failure__e_1681974805898","event_desc":"E_1681974805898","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_api_failure","raiseparam":{"profile_code":"BTL_1304_1681966202861"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view api failure"
	navigation_ui_view_api_failure__brfq_for_api_queue_list() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_ui_view_api_failure__brfq_for_api_queue_list","event_desc":"BRFQ for API Queue list","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_api_failure","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "view api failure  action ui view failure"
	view_api_failure__action_ui_view_failure__e_1681967242177() { 
		let Dest_Is_ctrl=true
		
		let source_id="view_api_failure__action_ui_view_failure"
		let destn_id="view_api_failure__action_ui"
		let parent_source_id=""
		let event_code="e_1681967242177"
		let event_params={"caller_name":"view_api_failure__action_ui_view_failure__e_1681967242177","event_desc":"E_1681967242177","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"view_api_failure__action_ui_view_failure","raiseparam":{"prevent_default_event":"N","need_blockchain_storage":"N","dt_code":"","dtt_code":"","key_column":"","key_value_level":"","key_value":"","change_detection":""}}
		let handler_code="bind_tran"
		let internals=""
		let event_data={}
		let data_source={}
	...
	api_queue__svm_for_api_queue() { 
		...
		let event_data={"api_queue":{"e_1681975061939":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGC_23","event_code":"E_1681975061939","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Trn Process Log","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"API_STATUS","level":"MI_LEVEL","name":"MI_LEVEL_API_STATUS","setd3name":"API_STATUS"},{"type":"LOCAL","column_name":"API_PROCESS_STATUS","level":"MI_LEVEL","name":"MI_LEVEL_API_PROCESS_STATUS","setd3name":"API_PROCESS_STATUS"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1681975219058","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS API Process Log MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1670063504284","date_format":false},{"column_name":"PROCESS_STATUS","alias_name":"","mq_id":"MQ_1670063504716","date_format":false},{"column_name":"STATUS","alias_name":"","mq_id":"MQ_1670063504948","date_format":false},{"column_name":"API_STATUS","alias_name":"","mq_id":"MQ_1681975635396","date_format":false},{"column_name":"API_PROCESS_STATUS","alias_name":"","mq_id":"MQ_1681975769773","date_format":false}],"joins":[]},"eq_text":"select  distinct PROCESSING_SYSTEM,  API_PROCESS_STATUS,  API_STATUS from  (  select   T.CREATED_DATE,   T.STATUS as API_STATUS,   T.PROCESS_STATUS as API_PROCESS_STATUS,   T.UETR,   T.PROCESS_NAME,   T.PROCESSING_SYSTEM,   T.ADDITIONAL_INFO,   T.TENANT_ID,   T.MODIFIED_DATE,   T.MODIFIED_DATE_UTC,   TS.TS_ID,   TS.LOCKED_BY,   TS.LOCKED_BY_NAME,   T.CREATED_BY,   T.CREATED_BY_NAME,   T.SYSTEM_ID  from   NPSS_TRN_PROCESS_LOG T  left join TRANSACTION_SET TS on   T.NPSSTPL_ID = TS.TRN_ID   and T.DTT_CODE = TS.DTT_CODE) VW $WHERE"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS API Process Log CCD","filter":[{"filter_name":"STATUS","binding_name":"API_STATUS","binding_value":"","source_name":"OP_AC_VAL_FAILED,OP_AC_MAND_VAL_FAILED,OP_AC_DUPL_VAL_FAILED,OP_AC_PCODE_VAL_FAILED,OP_AC_PBANK_VAL_FAILED,OP_P2P_SENDER_IBAN_FAILED,OP_P2P_PAYMENT_FAILED,OP_P2P_POSTING_FAILURE,OP_P2P_POSTING_SUSPICIOUS,OP_P2B_FUND_UNFREEZED,OP_P2B_PAYMENT_FAILED,OP_P2B_FUND_RES_FAILURE,OP_P2B_FUND_RES_SUSPICIOUS,OP_P2B_FUND_UNFR_FAILURE,OP_P2B_FUND_UNFR_SUSPICIOUS,OP_P2B_FUND_AUTH_FAILURE,OP_P2B_FUND_AUTH_SUSPICIOUS","source_value":"","source_type":"HARDCODED","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Queue","target_column":"API_PROCESS_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Status","target_column":"API_STATUS","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
			this.handler.set_value_to_memory(source_id,destn_id,parent_source_id,event_code,event_params,this,internals,handler_code,event_data,data_source)
		} catch(e) {
