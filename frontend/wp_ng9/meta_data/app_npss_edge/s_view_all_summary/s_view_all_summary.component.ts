...
export class s_view_all_summaryComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.summary_tran_level_chart.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_2","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1668504004768","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Summary Chart MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"KEY_COLUMN","alias_name":"","mq_id":"MQ_1668495396199","date_format":false},{"column_name":"KEY_VALUE","alias_name":"","mq_id":"MQ_1668495396703","date_format":false}],"joins":[]},"eq_text":"SELECT KEY_COLUMN, SORT_ORDER, TRAN_LEVEL, SUM(KEY_VALUE) AS KEY_VALUE   FROM (SELECT KEY_COLUMN,                '' AS TRAN_LEVEL,                MEM_PAYMENT_METHOD,                UETR,                CREATED_DATE,                ACCP_DATE_TIME,                VALUE_DATE,                DBTR_ACCT_NO,                CDTR_ACCT_NO,                CDTR_IBAN,                DBTR_IBAN,                INTRBK_STTLM_AMNT,                PAYMENT_ENDTOEND_ID,                PROCESS_TYPE,                SORT_ORDER,                CLRSYSREF,                COUNT(UETR) AS KEY_VALUE           FROM (SELECT 'TOTAL' AS KEY_COLUMN,                        1 AS SORT_ORDER,                        STATUS,                        CASE                          WHEN EXHF_ID IS NULL THEN                           'RCT'                          ELSE                           'BCT'                        END AS MEM_PAYMENT_METHOD,                        UETR,                        CREATED_DATE,                        ACCP_DATE_TIME,                        VALUE_DATE,                        DBTR_ACCT_NO,                        CDTR_ACCT_NO,                        CDTR_IBAN,                        DBTR_IBAN,                        INTRBK_STTLM_AMNT,                        PAYMENT_ENDTOEND_ID,                        PROCESS_TYPE,                        CLRSYSREF                   FROM NPSS_TRANSACTIONS NT) A          GROUP BY SORT_ORDER,                   KEY_COLUMN,                   MEM_PAYMENT_METHOD,                   UETR,                   CREATED_DATE,                   ACCP_DATE_TIME,                   VALUE_DATE,                   DBTR_ACCT_NO,                   CDTR_ACCT_NO,                   CDTR_IBAN,                   DBTR_IBAN,                   INTRBK_STTLM_AMNT,                   PAYMENT_ENDTOEND_ID,                   PROCESS_TYPE,                   CLRSYSREF         UNION ALL         SELECT KEY_COLUMN,                'COMPLETED' AS TRAN_LEVEL,                MEM_PAYMENT_METHOD,                UETR,                CREATED_DATE,                ACCP_DATE_TIME,                VALUE_DATE,                DBTR_ACCT_NO,                CDTR_ACCT_NO,                CDTR_IBAN,                DBTR_IBAN,                INTRBK_STTLM_AMNT,                PAYMENT_ENDTOEND_ID,                PROCESS_TYPE,                SORT_ORDER,                CLRSYSREF,                COUNT(UETR) AS KEY_VALUE           FROM (SELECT 'COMPLETED' AS KEY_COLUMN,                        2 AS SORT_ORDER,                        STATUS,                        PROCESS_STATUS,                        CASE                          WHEN EXHF_ID IS NULL THEN                           'RCT'                          ELSE                           'BCT'                        END AS MEM_PAYMENT_METHOD,                        UETR,                        CREATED_DATE,                        ACCP_DATE_TIME,                        VALUE_DATE,                        DBTR_ACCT_NO,                        CDTR_ACCT_NO,                        CDTR_IBAN,                        DBTR_IBAN,                        INTRBK_STTLM_AMNT,                        PAYMENT_ENDTOEND_ID,                        PROCESS_TYPE,                        CLRSYSREF                   FROM NPSS_TRANSACTIONS NT) A          WHERE (UPPER(PROCESS_STATUS)) LIKE (UPPER('%COMPLETED'))          GROUP BY SORT_ORDER,                   KEY_COLUMN,                   MEM_PAYMENT_METHOD,                   UETR,                   CREATED_DATE,                   ACCP_DATE_TIME,                   VALUE_DATE,                   DBTR_ACCT_NO,                   CDTR_ACCT_NO,                   CDTR_IBAN,                   DBTR_IBAN,                   INTRBK_STTLM_AMNT,                   PAYMENT_ENDTOEND_ID,                   PROCESS_TYPE,                   CLRSYSREF         UNION ALL         SELECT KEY_COLUMN,                'INPROGRESS' AS TRAN_LEVEL,                MEM_PAYMENT_METHOD,                UETR,                CREATED_DATE,                ACCP_DATE_TIME,                VALUE_DATE,                DBTR_ACCT_NO,                CDTR_ACCT_NO,                CDTR_IBAN,                DBTR_IBAN,                INTRBK_STTLM_AMNT,                PAYMENT_ENDTOEND_ID,                PROCESS_TYPE,                SORT_ORDER,                CLRSYSREF,                COUNT(UETR) AS KEY_VALUE           FROM (SELECT 'INPROGRESS' AS KEY_COLUMN,                        3 AS SORT_ORDER,                        STATUS,                        PROCESS_STATUS,                        CASE                          WHEN EXHF_ID IS NULL THEN                           'RCT'                          ELSE                           'BCT'                        END AS MEM_PAYMENT_METHOD,                        UETR,                        CREATED_DATE,                        ACCP_DATE_TIME,                        VALUE_DATE,                        DBTR_ACCT_NO,                        CDTR_ACCT_NO,                        CDTR_IBAN,                        DBTR_IBAN,                        INTRBK_STTLM_AMNT,                        PAYMENT_ENDTOEND_ID,                        PROCESS_TYPE,                        CLRSYSREF                   FROM NPSS_TRANSACTIONS NT) A          WHERE (UPPER(PROCESS_STATUS)) NOT LIKE (UPPER('%COMPLETED'))          GROUP BY SORT_ORDER,                   KEY_COLUMN,                   TRAN_LEVEL,                   MEM_PAYMENT_METHOD,                   UETR,                   CREATED_DATE,                   ACCP_DATE_TIME,                   VALUE_DATE,                   DBTR_ACCT_NO,                   CDTR_ACCT_NO,                   CDTR_IBAN,                   DBTR_IBAN,                   INTRBK_STTLM_AMNT,                   PAYMENT_ENDTOEND_ID,                   PROCESS_TYPE,                   CLRSYSREF) V $WHERE  GROUP BY KEY_COLUMN, SORT_ORDER, TRAN_LEVEL  ORDER BY SORT_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Summary Chart CCD","filter":[{"filter_name":"Department_code","binding_name":"Department_code","binding_value":"","source_name":"Department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"","group_no":""}],"databinding":[{"header":"KEY_VALUE","target_column":"KEY_VALUE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"KEY_COLUMN","target_column":"KEY_COLUMN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
