...
Form Name       : Chart Response UI--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_chart_response_ui',
  templateUrl: './f_chart_response_ui.component.html',
  styleUrls: ['./f_chart_response_ui.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_chart_response_uiComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_chart_response_ui') form;
  @ViewChild('chart_response_ui_memory11') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.memory11.view_name = "f_chart_response_ui"
		this.ctrl.memory11.ctrl_id = "chart_response_ui_memory11"
		this.ctrl.chart_response_ui_memory11 = {}
		this.ctrl.chart_response_ui_memory11.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_chart_response_ui.model = {"MEMORY11":""}
		this.screen_instance[this.comp_id].f_chart_response_ui.Meta = []
		this.screen_instance[this.comp_id].f_chart_response_ui.dt_code = "dt_1304_1665901130705"
		this.screen_instance[this.comp_id].f_chart_response_ui.dtt_code = "dtt_1304_1665905039255"
		this.screen_instance[this.comp_id].f_chart_response_ui.controls = this.screen_instance[this.comp_id].form_instance.ctrl
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_chart_response_ui[control]==undefined) {
      this.screen_instance[this.comp_id].f_chart_response_ui[control] = {}
    }
    this.screen_instance[this.comp_id].f_chart_response_ui[control][property] = value;
  }
