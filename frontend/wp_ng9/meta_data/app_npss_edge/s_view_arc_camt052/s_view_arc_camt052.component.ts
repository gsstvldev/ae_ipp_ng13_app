...
@Component({
	selector: 's_view_arc_camt052',
	templateUrl: './s_view_arc_camt052.component.html',
	styleUrls: ['./s_view_arc_camt052.component.css'],
	providers:[]
})
    
// Start of class 
export class s_view_arc_camt052Component implements OnInit,AfterViewInit {
	// Variables 
  	wftpa_description : string = "s_view_arc_camt052"
	wftpa_id : string = "WFT_NPSS_P_1304_1686730125630_0"
	...
	ngOnInit() {
		...
		this.list.datasource = {"default":{"dt_1304_1672471156312":{"dtt_1304_1672471459948":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1672471156312","dt_desc":"NPSS Liquidity Management Group","dtt_code":"DTT_1304_1672471459948","dtt_desc":"NPSS CAMT Account Report","ds_eligible":"DS_1686730361851","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS ARC CAMT Act Report MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"HEADER_MSG_ID","alias_name":"","mq_id":"MQ_1686728988426","date_format":false},{"column_name":"REPORT_ID","alias_name":"","mq_id":"MQ_1686728988816","date_format":false},{"column_name":"RPT_CREATED_DATETIME","alias_name":"","mq_id":"MQ_1686728989144","date_format":false},{"column_name":"ACCOUNT_CURRENCY","alias_name":"","mq_id":"MQ_1686728990024","date_format":false},{"column_name":"ACCOUNT_NAME","alias_name":"","mq_id":"MQ_1686728990544","date_format":false},{"column_name":"BIC","alias_name":"","mq_id":"MQ_1686728991040","date_format":false},{"column_name":"BALANCE_TYPE_CODE","alias_name":"","mq_id":"MQ_1686728991552","date_format":false},{"column_name":"BALANCE_AMOUNT","alias_name":"","mq_id":"MQ_1686728992112","date_format":false},{"column_name":"CR_DR_INDICATOR","alias_name":"","mq_id":"MQ_1686728992600","date_format":false},{"column_name":"RPT_BAL_DATETIME","alias_name":"","mq_id":"MQ_1686728993040","date_format":false},{"column_name":"IBAN","alias_name":"","mq_id":"MQ_1686729223444","date_format":false}],"joins":[]},"eq_text":"SELECT NCAR_ID,  REPORT_ID,  RPT_CREATED_DATETIME,  IBAN,  ACCOUNT_CURRENCY,  BIC,  CR_DR_INDICATOR,  HEADER_MSG_ID,  ACCOUNT_NAME,  BALANCE_TYPE_CODE,  BALANCE_AMOUNT,  RPT_BAL_DATETIME,  MESSAGE_DATA,  CREATED_BY,  CREATED_BY_NAME,  CREATED_BY_STS_ID,  CREATED_DATE,  DT_CODE,  DT_DESCRIPTION,  DTT_CODE,  DTT_DESCRIPTION,  MODIFIED_BY,  MODIFIED_BY_NAME,  MODIFIED_BY_STS_ID,  MODIFIED_DATE,  PRCT_ID,  STATUS,  PROCESS_STATUS,  SYSTEM_ID,  SYSTEM_NAME,  TENANT_ID,  APP_ID,  VERSION_NO,  'SELECTED' NODE_CATEGORY FROM  (SELECT NCAR.NCAR_ID,    NCAR.REPORT_ID,    NCAR.RPT_CREATED_DATETIME,    NCAR.IBAN,    NCAR.ACCOUNT_CURRENCY,    NCAR.BIC,    NCAR.CR_DR_INDICATOR,    NCAR.HEADER_MSG_ID,    NCAR.ACCOUNT_NAME,    NCAR.BALANCE_TYPE_CODE,    NCAR.BALANCE_AMOUNT,    NCAR.RPT_BAL_DATETIME,    NCAR.MESSAGE_DATA,    NCAR.CREATED_BY,    NCAR.CREATED_BY_NAME,    NCAR.CREATED_BY_STS_ID,    NCAR.CREATED_DATE,    NCAR.DT_CODE,    NCAR.DT_DESCRIPTION,    NCAR.DTT_CODE,    NCAR.DTT_DESCRIPTION,    NCAR.MODIFIED_BY,    NCAR.MODIFIED_BY_NAME,    NCAR.MODIFIED_BY_STS_ID,    NCAR.MODIFIED_DATE,    NCAR.PRCT_ID,    NCAR.STATUS,    NCAR.PROCESS_STATUS,    NCAR.SYSTEM_ID,    NCAR.SYSTEM_NAME,    NCAR.TENANT_ID,    NCAR.APP_ID,    NCAR.VERSION_NO   FROM <arc_tran_db>.NPSS_CAMT_ACCOUNT_REPORT NCAR)V $WHERE ORDER BY NCAR_ID DESC"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS ARC CAMT Act Report MQ CCD","filter":[],"databinding":[{"header":"Header Msg ID","target_column":"HEADER_MSG_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Report ID","target_column":"REPORT_ID","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Report Created Date & Time","target_column":"RPT_CREATED_DATETIME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Account Number","target_column":"IBAN","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Account Currency","target_column":"ACCOUNT_CURRENCY","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Account Name","target_column":"ACCOUNT_NAME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"BIC","target_column":"BIC","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Balance Type Code","target_column":"BALANCE_TYPE_CODE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Balance Amount","target_column":"BALANCE_AMOUNT","alias_name":"","alignment":"Right","width":"","format":"","date_format":false},{"header":"Cr Dr Indicator","target_column":"CR_DR_INDICATOR","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Report Balance Date","target_column":"RPT_BAL_DATETIME","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
