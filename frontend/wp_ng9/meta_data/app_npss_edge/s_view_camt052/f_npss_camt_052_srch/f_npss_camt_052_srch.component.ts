...
Form Name       : NPSS Camt 052 SRCH--------------------------------------------------------------------------- */

// Component Definition 
import { Component, OnInit,Input,ViewChild,EventEmitter,ElementRef } from '@angular/core';
import {ComponenthelperService} from '../../../../scripts/fx/componenthelper.service';
@Component({
  selector: 'f_npss_camt_052_srch',
  templateUrl: './f_npss_camt_052_srch.component.html',
  styleUrls: ['./f_npss_camt_052_srch.component.css'],
  providers:[ComponenthelperService]
})

// Start of class 
export class f_npss_camt_052_srchComponent implements OnInit {
  @Input() screen_instance: any;
  @Input() comp_id: any; 
  hasHeader:boolean;
  component_header:string;
  @ViewChild('f_npss_camt_052_srch') form;
  @ViewChild('npss_camt_052_srch_report_id') element: ElementRef;
  // Variables 
  show:boolean  
  profile_name
	ctrl : any = {}
...
focustoelement(){
  ...
  ngOnInit() {
    this.screen_instance[this.comp_id].form_instance = this;
		...
		this.ctrl.report_id = {}
		this.ctrl.report_id.id = "RN01CN1"
		...
		this.ctrl.report_id.view_name = "f_npss_camt_052_srch"
		this.ctrl.report_id.ctrl_id = "npss_camt_052_srch_report_id"
		this.ctrl.npss_camt_052_srch_report_id = {}
		this.ctrl.npss_camt_052_srch_report_id.onChangecomponent = new EventEmitter<any>()
	
		//Properties of rpt_created_datetime
		this.ctrl.rpt_created_datetime = {}
		this.ctrl.rpt_created_datetime.id = "RN01CN2"
		this.ctrl.rpt_created_datetime.desc = "Rpt Created Datetime"
		this.ctrl.rpt_created_datetime.visible = true
		this.ctrl.rpt_created_datetime.label_name = "Rpt Created Datetime"
		this.ctrl.rpt_created_datetime.df_code = "DF_1304_1672471516154"
		this.ctrl.rpt_created_datetime.df_description = "Column Group 1"
		this.ctrl.rpt_created_datetime.uictrl_code = "CDN_CTRL"
		this.ctrl.rpt_created_datetime.target_column = "RPT_CREATED_DATETIME"
		this.ctrl.rpt_created_datetime.data_type = "TEXT"
		this.ctrl.rpt_created_datetime.data_length = 35
		this.ctrl.rpt_created_datetime.zone_df_code = "DF_1304_1672471516154"
		this.ctrl.rpt_created_datetime.default_value = ""
		this.ctrl.rpt_created_datetime.is_memory_ctrl = ""
		this.ctrl.rpt_created_datetime.field_coordinates = ""
		this.ctrl.rpt_created_datetime.sub_details = ""
		this.ctrl.rpt_created_datetime.accept_char = ""
		...
		this.ctrl.rpt_created_datetime.style_code = ""
		this.ctrl.rpt_created_datetime.data_source = ""
		this.ctrl.rpt_created_datetime.image_association = ""
		this.ctrl.rpt_created_datetime.show = true
		this.ctrl.rpt_created_datetime.sub_content = ""
		this.ctrl.rpt_created_datetime.required = false
		this.ctrl.rpt_created_datetime.vld_rules = []
		this.ctrl.rpt_created_datetime.targetcolumn_lower = "rpt_created_datetime"
		this.ctrl.rpt_created_datetime.disabled = false
		this.ctrl.rpt_created_datetime.view_name = "f_npss_camt_052_srch"
		this.ctrl.rpt_created_datetime.ctrl_id = "npss_camt_052_srch_rpt_created_datetime"
		this.ctrl.npss_camt_052_srch_rpt_created_datetime = {}
		this.ctrl.npss_camt_052_srch_rpt_created_datetime.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.iban.view_name = "f_npss_camt_052_srch"
		this.ctrl.iban.ctrl_id = "npss_camt_052_srch_iban"
		this.ctrl.npss_camt_052_srch_iban = {}
		this.ctrl.npss_camt_052_srch_iban.onChangecomponent = new EventEmitter<any>()
		...
		this.ctrl.account_currency.view_name = "f_npss_camt_052_srch"
		this.ctrl.account_currency.ctrl_id = "npss_camt_052_srch_account_currency"
		this.ctrl.npss_camt_052_srch_account_currency = {}
		this.ctrl.npss_camt_052_srch_account_currency.onChangecomponent = new EventEmitter<any>()
		this.screen_instance[this.comp_id].f_npss_camt_052_srch.account_currency = {}
	
		//Properties of memory14
		this.ctrl.memory14 = {}
		this.ctrl.memory14.id = "RN21CN5"
		...
		this.ctrl.memory14.view_name = "f_npss_camt_052_srch"
		this.ctrl.memory14.ctrl_id = "npss_camt_052_srch_memory14"
		this.ctrl.npss_camt_052_srch_memory14 = {}
		this.ctrl.npss_camt_052_srch_memory14.onChangecomponent = new EventEmitter<any>()
	
		//Properties of bic
		this.ctrl.bic = {}
		this.ctrl.bic.id = "RN21CN6"
		this.ctrl.bic.desc = "BIC"
		this.ctrl.bic.visible = true
		this.ctrl.bic.label_name = "BIC"
		this.ctrl.bic.df_code = "DF_1304_1672471516154"
		this.ctrl.bic.df_description = "Column Group 1"
		this.ctrl.bic.uictrl_code = "CDN_CTRL"
		this.ctrl.bic.target_column = "BIC"
		this.ctrl.bic.data_type = "TEXT"
		this.ctrl.bic.data_length = 35
		this.ctrl.bic.zone_df_code = "DF_1304_1672471516154"
		this.ctrl.bic.default_value = ""
		this.ctrl.bic.is_memory_ctrl = ""
		this.ctrl.bic.field_coordinates = ""
		this.ctrl.bic.sub_details = ""
		this.ctrl.bic.accept_char = ""
		...
		this.ctrl.bic.style_code = ""
		this.ctrl.bic.data_source = ""
		this.ctrl.bic.image_association = ""
		this.ctrl.bic.show = true
		this.ctrl.bic.sub_content = ""
		this.ctrl.bic.required = false
		this.ctrl.bic.vld_rules = []
		this.ctrl.bic.targetcolumn_lower = "bic"
		this.ctrl.bic.disabled = false
		this.ctrl.bic.view_name = "f_npss_camt_052_srch"
		this.ctrl.bic.ctrl_id = "npss_camt_052_srch_bic"
		this.ctrl.npss_camt_052_srch_bic = {}
		this.ctrl.npss_camt_052_srch_bic.onChangecomponent = new EventEmitter<any>()
	
		//Properties of cr_dr_indicator
		this.ctrl.cr_dr_indicator = {}
		this.ctrl.cr_dr_indicator.id = "RN31CN7"
		...
		this.ctrl.cr_dr_indicator.view_name = "f_npss_camt_052_srch"
		this.ctrl.cr_dr_indicator.ctrl_id = "npss_camt_052_srch_cr_dr_indicator"
		this.ctrl.npss_camt_052_srch_cr_dr_indicator = {}
  ...
  formControlHidden(control,property,value) {
    if(this.screen_instance[this.comp_id].f_npss_camt_052_srch[control]==undefined) {
      this.screen_instance[this.comp_id].f_npss_camt_052_srch[control] = {}
    }
    this.screen_instance[this.comp_id].f_npss_camt_052_srch[control][property] = value;
  }
