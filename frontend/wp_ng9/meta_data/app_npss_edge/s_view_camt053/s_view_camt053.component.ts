...
export class s_view_camt053Component implements OnInit,AfterViewInit {
	...
	uicgc_7 : string = "header_and_settlement_details"
	key_events : any = {}
	...
	ngOnInit() {
		...
		// "View Tran Details" Button of "Navigation UI" component
		this.navigation_ui_view_tran_details.label_name = "View Tran Details"
		this.navigation_ui_view_tran_details.show = true
		this.navigation_ui_view_tran_details.disabled = false
		this.navigation_ui_view_tran_details.params = {"icon_only":false,"uicgcc_style":"fa fa-eye"}
		this.navigation_ui_view_tran_details.dynamic_param = {}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view tran details"
	navigation_ui_view_tran_details__action_button_click(){
		this.navigation_ui_view_tran_details__sp_for_vmd()
		this.navigation_ui_view_tran_details__brfq_from_view_tran_details()
		this.navigation_ui_view_tran_details__brfq_for_view_td()
	}
	...
	page_load__de_from_page_load() { 
		...
		let source_id="page_load"
		let destn_id="navigation_ui_view_tran_details"
		let parent_source_id=""
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view tran details"
	navigation_ui_view_tran_details__sp_for_vmd() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_tran_details"
		let destn_id=""
		let parent_source_id=""
		let event_code="e_1672474945337"
		let event_params={"caller_name":"navigation_ui_view_tran_details__sp_for_vmd","event_desc":"SP for VMD","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_tran_details","raiseparam":{"profile_code":"BTL_1304_1722334616978"}}
		let handler_code="show_profile"
		let internals=""
		let event_data={}
		let data_source={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view tran details"
	navigation_ui_view_tran_details__brfq_from_view_tran_details() { 
		let Dest_Is_ctrl=true
		...
		let event_params={"caller_name":"navigation_ui_view_tran_details__brfq_from_view_tran_details","event_desc":"BRFQ From view tran Details","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_tran_details","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
	...
	//Handler for ACTION_BUTTON_CLICK event of "navigation ui view tran details"
	navigation_ui_view_tran_details__brfq_for_view_td() { 
		let Dest_Is_ctrl=true
		
		let source_id="navigation_ui_view_tran_details"
		let destn_id="header_and_settlement_details"
		let parent_source_id=""
		let event_code="e_1722348010435"
		let event_params={"caller_name":"navigation_ui_view_tran_details__brfq_for_view_td","event_desc":"BRFQ For View TD","event_type":"ACTION_BUTTON_CLICK","caller_event_context":"SUCCESS","root_source_id":"navigation_ui_view_tran_details","raiseparam":{"solr_search_name":null,"need_key_column":"N","chart_type":"","chart_label":"","chart_series":"","chart_data":"","avoid_parent_search_param":"N","avoid_key_column_filter":"N"}}
		let handler_code="bind_record_from_query"
		let internals=""
		let event_data={}
