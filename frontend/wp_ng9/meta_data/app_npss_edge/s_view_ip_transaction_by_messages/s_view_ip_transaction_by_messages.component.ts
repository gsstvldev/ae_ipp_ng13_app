...
export class s_view_ip_transaction_by_messagesComponent implements OnInit,AfterViewInit {
	...
	ngOnInit() {
		...
		this.processing_system_group.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1673439194152","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Processing System Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESSING_SYSTEM_COUNT","alias_name":"","mq_id":"MQ_1673000054600","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1673000055024","date_format":false}],"joins":[]},"eq_text":"select  COUNT(PROCESSING_SYSTEM) as PROCESSING_SYSTEM_COUNT,  PROCESSING_SYSTEM from  (  select   T.CREATED_DATE,   T.CHANNEL_ID ,   T.PROCESS_TYPE ,   T.TENANT_ID,   T.DEPARTMENT_CODE,   case    when T.EXHF_ID is null then upper('RCT')    else upper('BCT')   end as PAYMENT_TYPE,   PL.PROCESS_STATUS,   case when PL.PROCESSING_SYSTEM is null then upper('unknown') else pl.PROCESSING_SYSTEM end as PROCESSING_SYSTEM  from   NPSS_TRANSACTIONS T  inner join (   select    PLR.NPSSTPL_ID,    PLR.UETR,    PLR.STATUS,    PLR.PROCESS_STATUS,    PLR.PROCESSING_SYSTEM,    PLR.ROW_NUM   from    (    select     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     A.PROCESSING_SYSTEM,     row_number() over( partition by A.UETR    order by     A.NPSSTPL_ID desc) as ROW_NUM    from     NPSS_TRN_PROCESS_LOG A )PLR   where    PLR.ROW_NUM = 1) PL on   PL.UETR = T.UETR) V $WHERE group by  PROCESSING_SYSTEM"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Processing System Dashboard CCD","filter":[{"filter_name":"Department_code","binding_name":"Department_code","binding_value":"","source_name":"Department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"MESSAGE","binding_name":"MESSAGE","binding_value":"","source_name":"MI_LEVEL_MESSAGE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"IP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESSING_SYSTEM_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		...
		this.message_type_list.datasource = {"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1673439433830","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS VTM Message Dashboard","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1673359957970","date_format":true},{"column_name":"MESSAGE","alias_name":"","mq_id":"MQ_1673359958148","date_format":false},{"column_name":"MESSAGE_COUNT","alias_name":"","mq_id":"MQ_1673359958292","date_format":false}],"joins":[]},"eq_text":"select  MESSAGE,  MESSAGE_ORDER,  CREATED_DATE,  COUNT (MESSAGE) as MESSAGE_COUNT from  (  select   case    when NTPL.process_name like '%008%' then lower('pacs008')    when NTPL.process_name like '%028%' then lower('pacs028')    when NTPL.process_name like '%007%' then lower('pacs007')    when NTPL.process_name like '%004%' then lower('pacs004')    else upper('others')   end as MESSAGE,   case    when NTPL.process_name like '%008%' then 1    when NTPL.process_name like '%028%' then 4    when NTPL.process_name like '%007%' then 3    when NTPL.process_name like '%004%' then 2    else 5   end as MESSAGE_ORDER,   nt.process_type,   TO_DATE(TO_CHAR(NT.CREATED_DATE, 'DD-MON-YY'), 'DD-MON-YY') as CREATED_DATE,   nt.uetr,   nt.tenant_id,   nt.department_code  from   npss_trn_process_log ntpl  inner join npss_transactions nt on   nt.uetr = ntpl.uetr ) V $WHERE group by  created_date,  MESSAGE,  MESSAGE_ORDER order by  MESSAGE_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS VTM Message Dashboard CCD","filter":[{"filter_name":"MESSAGE","binding_name":"MESSAGE","binding_value":"","source_name":"OTHERS","source_value":"","source_type":"HARDCODED","oprtr":"<>","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"IP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Created Date","target_column":"CREATED_DATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Message","target_column":"MESSAGE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Count","target_column":"MESSAGE_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
	...
	if(parentEventResult!=parent_event_result) return true;
		...
		let internals=""
		let event_data={}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665905039255":{"st_ds":{"default":{"uicgc_code":"UICGC_23","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665905039255","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1673439433830","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS VTM Message Dashboard","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"CREATED_DATE","alias_name":"","mq_id":"MQ_1673359957970","date_format":true},{"column_name":"MESSAGE","alias_name":"","mq_id":"MQ_1673359958148","date_format":false},{"column_name":"MESSAGE_COUNT","alias_name":"","mq_id":"MQ_1673359958292","date_format":false}],"joins":[]},"eq_text":"select  MESSAGE,  MESSAGE_ORDER,  CREATED_DATE,  COUNT (MESSAGE) as MESSAGE_COUNT from  (  select   case    when NTPL.process_name like '%008%' then lower('pacs008')    when NTPL.process_name like '%028%' then lower('pacs028')    when NTPL.process_name like '%007%' then lower('pacs007')    when NTPL.process_name like '%004%' then lower('pacs004')    else upper('others')   end as MESSAGE,   case    when NTPL.process_name like '%008%' then 1    when NTPL.process_name like '%028%' then 4    when NTPL.process_name like '%007%' then 3    when NTPL.process_name like '%004%' then 2    else 5   end as MESSAGE_ORDER,   nt.process_type,   TO_DATE(TO_CHAR(NT.CREATED_DATE, 'DD-MON-YY'), 'DD-MON-YY') as CREATED_DATE,   nt.uetr,   nt.tenant_id,   nt.department_code  from   npss_trn_process_log ntpl  inner join npss_transactions nt on   nt.uetr = ntpl.uetr ) V $WHERE group by  created_date,  MESSAGE,  MESSAGE_ORDER order by  MESSAGE_ORDER"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS VTM Message Dashboard CCD","filter":[{"filter_name":"MESSAGE","binding_name":"MESSAGE","binding_value":"","source_name":"OTHERS","source_value":"","source_type":"HARDCODED","oprtr":"<>","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"IP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Created Date","target_column":"CREATED_DATE","alias_name":"","alignment":"Left","width":"","format":"date:\"dd/MM/yyyy\"","date_format":true},{"header":"Message","target_column":"MESSAGE","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Message Count","target_column":"MESSAGE_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
	...
	processing_system_group__svm_for_channel() { 
		...
		let event_data={"processing_system_group":{"e_1666857327033":{"dts":{"dt_1304_1665901130705":{"dtts":{"":{"uicgc_code":"UICGC_1","event_code":"E_1666857327033","dt_code":"DT_1304_1665901130705","dtt_code":"","dt_desc":"NPSS EDGE Transactions Group","dtt_desc":"NPSS Trn Process Log","eventdata":{"override_dt":"","dt_value":{"type":"","value":""},"override_dtt":"","dtt_value":{"type":"","value":""},"override_keycolumn":"","keycolumn":{"type":"","column_name":"","column_value":""},"override_keyvalue":"","keyvalue":{"type":"","column_value":""},"set_to_memory":[{"type":"LOCAL","column_name":"PROCESSING_SYSTEM","level":"MI_LEVEL","name":"MI_LEVEL_PROCESSING_SYSTEM","setd3name":"PROCESSING_SYSTEM"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_PAYMENT_TYPE","setd3name":"PAYMENT_TYPE"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_PROCESS_STATUS","setd3name":"PROCESS_STATUS"},{"type":"HARDCODED","column_name":"","level":"MI_LEVEL","name":"MI_LEVEL_MESSAGE","setd3name":"MESSAGE"}],"get_from_memory":[],"set_event_context":null,"sec_value":null}}}}}}}}
		let data_source={"default":{"dt_1304_1665901130705":{"dtt_1304_1665901217208":{"st_ds":{"default":{"uicgc_code":"UICGC_1","event_code":"DEFAULT","dt_code":"DT_1304_1665901130705","dt_desc":"NPSS EDGE Transactions Group","dtt_code":"DTT_1304_1665901217208","dtt_desc":"NPSS Trn Process Log","ds_eligible":"DS_1673439194152","ds_final":"","final_state":"","property_json":{"columns":{}},"system_type":"DEFAULT","eq_info":{"eq_code":"NPSS Processing System Dashboard MQ","eq_type":"S","eq_mode":"M","eq_designer_json":{},"eq_json":{"columns":[{"column_name":"PROCESSING_SYSTEM_COUNT","alias_name":"","mq_id":"MQ_1673000054600","date_format":false},{"column_name":"PROCESSING_SYSTEM","alias_name":"","mq_id":"MQ_1673000055024","date_format":false}],"joins":[]},"eq_text":"select  COUNT(PROCESSING_SYSTEM) as PROCESSING_SYSTEM_COUNT,  PROCESSING_SYSTEM from  (  select   T.CREATED_DATE,   T.CHANNEL_ID ,   T.PROCESS_TYPE ,   T.TENANT_ID,   T.DEPARTMENT_CODE,   case    when T.EXHF_ID is null then upper('RCT')    else upper('BCT')   end as PAYMENT_TYPE,   PL.PROCESS_STATUS,   case when PL.PROCESSING_SYSTEM is null then upper('unknown') else pl.PROCESSING_SYSTEM end as PROCESSING_SYSTEM  from   NPSS_TRANSACTIONS T  inner join (   select    PLR.NPSSTPL_ID,    PLR.UETR,    PLR.STATUS,    PLR.PROCESS_STATUS,    PLR.PROCESSING_SYSTEM,    PLR.ROW_NUM   from    (    select     A.NPSSTPL_ID,     A.DT_CODE,     A.DTT_CODE,     A.UETR,     A.STATUS,     A.PROCESS_NAME,     A.PROCESS_STATUS,     A.PROCESSING_SYSTEM,     row_number() over( partition by A.UETR    order by     A.NPSSTPL_ID desc) as ROW_NUM    from     NPSS_TRN_PROCESS_LOG A )PLR   where    PLR.ROW_NUM = 1) PL on   PL.UETR = T.UETR) V $WHERE group by  PROCESSING_SYSTEM"},"listing_mode":"","locking_mode":"","locking_parameter":"","ccd_name":"NPSS Processing System Dashboard CCD","filter":[{"filter_name":"Department_code","binding_name":"Department_code","binding_value":"","source_name":"Department_code","source_value":"","source_type":"SESSION_LEVEL","oprtr":"IN","data_type":"TEXT","conj_operator":"","group_no":""},{"filter_name":"MESSAGE","binding_name":"MESSAGE","binding_value":"","source_name":"MI_LEVEL_MESSAGE","source_value":"","source_type":"MI_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"PROCESS_TYPE","binding_name":"PROCESS_TYPE","binding_value":"","source_name":"IP","source_value":"","source_type":"HARDCODED","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""},{"filter_name":"TENANT_ID","binding_name":"TENANT_ID","binding_value":"","source_name":"TENANT_ID","source_value":"","source_type":"SESSION_LEVEL","oprtr":"=","data_type":"TEXT","conj_operator":"AND","group_no":""}],"databinding":[{"header":"Processing System","target_column":"PROCESSING_SYSTEM","alias_name":"","alignment":"Left","width":"","format":"","date_format":false},{"header":"Count","target_column":"PROCESSING_SYSTEM_COUNT","alias_name":"","alignment":"Left","width":"","format":"","date_format":false}]}}}}}}
		try {
