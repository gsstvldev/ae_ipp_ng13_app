...
import { s_view_ip_transaction_by_psRoutingModule } from './s_view_ip_transaction_by_ps.routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    s_view_ip_transaction_by_psRoutingModule,
    torus_cs_change_routingkeyModule,torus_cs_show_hideModule,npss_cs_rct_already_postingModule
  ],
  declarations: [s_view_ip_transaction_by_psComponent,p_main_layoutComponent,f_navigation_uiComponent,p_search_layoutComponent,f_npss_channel_dashboard_srchComponent,p_view_tran_detail_layoutComponent,f_back_uiComponent,p_view_history_layoutComponent,f_process_log_uiComponent,p_view_message_list_layoutComponent,f_message_detail_actionComponent,p_view_request_layoutComponent,f_npss_target_request_uiComponent,f_single_back_uiComponent,p_view_response_layoutComponent,f_npss_target_response_uiComponent,p_view_req_and_res_profileComponent,p_view_message_ui_layoutComponent,f_message_back_uiComponent,f_npss_message_data_uiComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_view_ip_transaction_by_psModule { }
