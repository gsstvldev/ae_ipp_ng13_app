...
import { s_view_sm_api_failuresRoutingModule } from './s_view_sm_api_failures.routing.module';
...
import { f_npss_sm_failure_srchComponent } from './f_npss_sm_failure_srch/f_npss_sm_failure_srch.component'
...
@NgModule({
  ...
  imports: [
    ...
    s_view_sm_api_failuresRoutingModule,
    torus_cs_show_hideModule
  ],
  declarations: [s_view_sm_api_failuresComponent,p_main_layoutComponent,f_navigation_uiComponent,p_view_request_layoutComponent,f_npss_sm_request_uiComponent,f_single_back_uiComponent,p_view_response_layoutComponent,f_npss_sm_response_uiComponent,p_search_layoutComponent,f_npss_sm_failure_srchComponent,p_view_main_req_and_res_layoutComponent,],
  providers:[AppHandlerService,ComponenthelperService]
})


// Start of class 
export class s_view_sm_api_failuresModule { }
